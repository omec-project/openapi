...
var _ openapi.MappedNullable = &ScpDomainRoutingInformation{}
...
type ScpDomainRoutingInformation struct {
	...
	ScpDomainList map[string]ScpDomainConnectivity `json:"scpDomainList" yaml:"scpDomainList"`
}
...
func (o ScpDomainRoutingInformation) ToMap() (map[string]any, error) {
