...
var _ openapi.MappedNullable = &NfServiceSetCond{}
...
type NfServiceSetCond struct {
	...
	NfServiceSetId string `json:"nfServiceSetId" yaml:"nfServiceSetId"`
...
func (o NfServiceSetCond) ToMap() (map[string]any, error) {
