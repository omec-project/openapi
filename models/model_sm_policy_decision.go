...
var _ openapi.MappedNullable = &SmPolicyDecision{}
...
type SmPolicyDecision struct {
	...
	QosDecs *map[string]QosData `json:"qosDecs,omitempty" yaml:"qosDecs,omitempty"`
	...
	ChgDecs      map[string]ChargingData `json:"chgDecs,omitempty" yaml:"chgDecs,omitempty"`
	...
	UmDecs map[string]UsageMonitoringData `json:"umDecs,omitempty" yaml:"umDecs,omitempty"`
	// Map of QoS characteristics for non standard 5QIs. This map uses the 5QI values as keys.
	QosChars *map[string]QosCharacteristics `json:"qosChars,omitempty" yaml:"qosChars,omitempty"`
	...
	QosMonDecs map[string]QosMonitoringData `json:"qosMonDecs,omitempty" yaml:"qosMonDecs,omitempty"`
	// indicating a time in seconds.
	ReflectiveQoSTimer *int32 `json:"reflectiveQoSTimer,omitempty" yaml:"reflectiveQoSTimer,omitempty"`
	...
	PolicyCtrlReqTriggers []PolicyControlRequestTrigger `json:"policyCtrlReqTriggers,omitempty" yaml:"policyCtrlReqTriggers,omitempty"`
	...
	RedSessIndication *bool `json:"redSessIndication,omitempty" yaml:"redSessIndication,omitempty"`
	// string with format 'bytes' as defined in OpenAPI
	UePolCont        *string                    `json:"uePolCont,omitempty" yaml:"uePolCont,omitempty"`
	SliceUsgCtrlInfo NullableSliceUsgCtrlInfoSm `json:"sliceUsgCtrlInfo" yaml:"sliceUsgCtrlInfo,omitempty"`
	// List of VPLMN Specific offloading information.
	VplmnOffloadInfos []VplmnOffloadingInfo `json:"vplmnOffloadInfos,omitempty" yaml:"vplmnOffloadInfos,omitempty"`
}
...
func (o *SmPolicyDecision) GetSessRules() map[string]SessionRule {
	if o == nil || openapi.IsNil(o.SessRules) {
...
func (o *SmPolicyDecision) GetPccRulesOk() (*map[string]PccRule, bool) {
	if o == nil || openapi.IsNil(o.PccRules) {
		return nil, false
	}
...
func (o *SmPolicyDecision) GetPcscfRestIndication() bool {
	if o == nil || openapi.IsNil(o.PcscfRestIndication) {
		var ret bool
		return ret
	}
...
func (o *SmPolicyDecision) GetQosDecs() map[string]QosData {
	if o == nil || openapi.IsNil(o.QosDecs) {
...
func (o *SmPolicyDecision) GetChgDecsOk() (*map[string]ChargingData, bool) {
	if o == nil || openapi.IsNil(o.ChgDecs) {
		return nil, false
	}
...
func (o *SmPolicyDecision) GetUmDecsOk() (*map[string]UsageMonitoringData, bool) {
	if o == nil || openapi.IsNil(o.UmDecs) {
		return nil, false
	}
...
func (o *SmPolicyDecision) GetQosChars() map[string]QosCharacteristics {
	if o == nil || openapi.IsNil(o.QosChars) {
...
func (o *SmPolicyDecision) GetQosMonDecsOk() (*map[string]QosMonitoringData, bool) {
	if o == nil || openapi.IsNil(o.QosMonDecs) {
		return nil, false
	}
...
func (o *SmPolicyDecision) GetReflectiveQoSTimer() int32 {
	if o == nil || openapi.IsNil(o.ReflectiveQoSTimer) {
		var ret int32
		return ret
	}
...
func (o *SmPolicyDecision) GetCondsOk() (*map[string]ConditionData, bool) {
	if o == nil || openapi.IsNil(o.Conds) {
		return nil, false
	}
	return &o.Conds, true
}
...
func (o *SmPolicyDecision) GetRevalidationTime() time.Time {
	if o == nil || openapi.IsNil(o.RevalidationTime) {
		var ret time.Time
		return ret
	}
...
func (o *SmPolicyDecision) GetOfflineChOnly() bool {
	if o == nil || openapi.IsNil(o.OfflineChOnly) {
		var ret bool
		return ret
	}
...
func (o *SmPolicyDecision) GetPolicyCtrlReqTriggersOk() ([]PolicyControlRequestTrigger, bool) {
	if o == nil || openapi.IsNil(o.PolicyCtrlReqTriggers) {
		return nil, false
	}
...
func (o *SmPolicyDecision) GetLastReqRuleData() []RequestedRuleData {
	if o == nil || openapi.IsNil(o.LastReqRuleData) {
...
func (o *SmPolicyDecision) GetLastReqUsageData() RequestedUsageData {
	if o == nil || openapi.IsNil(o.LastReqUsageData) {
...
func (o *SmPolicyDecision) GetRelCause() SmPolicyAssociationReleaseCause {
	if o == nil || openapi.IsNil(o.RelCause) {
...
func (o *SmPolicyDecision) GetTscNotifUri() string {
...
// and a boolean to check if the value has been set.
func (o *SmPolicyDecision) GetTscNotifUriOk() (*string, bool) {
	if o == nil || openapi.IsNil(o.TscNotifUri) {
		return nil, false
	}
...
func (o *SmPolicyDecision) HasTscNotifUri() bool {
	if o != nil && !openapi.IsNil(o.TscNotifUri) {
		return true
	}
...
func (o *SmPolicyDecision) SetTscNotifUri(v string) {
	o.TscNotifUri = &v
}

// GetTscNotifCorreId returns the TscNotifCorreId field value if set, zero value otherwise.
func (o *SmPolicyDecision) GetTscNotifCorreId() string {
...
// and a boolean to check if the value has been set.
func (o *SmPolicyDecision) GetTscNotifCorreIdOk() (*string, bool) {
	if o == nil || openapi.IsNil(o.TscNotifCorreId) {
		return nil, false
	}
...
func (o *SmPolicyDecision) HasTscNotifCorreId() bool {
	if o != nil && !openapi.IsNil(o.TscNotifCorreId) {
		return true
	}
...
func (o *SmPolicyDecision) SetTscNotifCorreId(v string) {
	o.TscNotifCorreId = &v
}
...
func (o *SmPolicyDecision) GetRedSessIndication() bool {
	if o == nil || openapi.IsNil(o.RedSessIndication) {
		var ret bool
		return ret
	}
...
func (o *SmPolicyDecision) GetUePolCont() string {
...
// and a boolean to check if the value has been set.
func (o *SmPolicyDecision) GetUePolContOk() (*string, bool) {
	if o == nil || openapi.IsNil(o.UePolCont) {
		return nil, false
	}
...
func (o *SmPolicyDecision) HasUePolCont() bool {
	if o != nil && !openapi.IsNil(o.UePolCont) {
		return true
	}
...
func (o *SmPolicyDecision) SetUePolCont(v string) {
	o.UePolCont = &v
}

// GetSliceUsgCtrlInfo returns the SliceUsgCtrlInfo field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *SmPolicyDecision) GetSliceUsgCtrlInfo() SliceUsgCtrlInfoSm {
	if o == nil || openapi.IsNil(o.SliceUsgCtrlInfo.Get()) {
		var ret SliceUsgCtrlInfoSm
		return ret
	}
	return *o.SliceUsgCtrlInfo.Get()
}

// GetSliceUsgCtrlInfoOk returns a tuple with the SliceUsgCtrlInfo field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *SmPolicyDecision) GetSliceUsgCtrlInfoOk() (*SliceUsgCtrlInfoSm, bool) {
	if o == nil {
		return nil, false
	}
	return o.SliceUsgCtrlInfo.Get(), o.SliceUsgCtrlInfo.IsSet()
}

// HasSliceUsgCtrlInfo returns a boolean if a field has been set.
func (o *SmPolicyDecision) HasSliceUsgCtrlInfo() bool {
	if o != nil && o.SliceUsgCtrlInfo.IsSet() {
		return true
	}
...
// SetSliceUsgCtrlInfo gets a reference to the given NullableSliceUsgCtrlInfoSm and assigns it to the SliceUsgCtrlInfo field.
func (o *SmPolicyDecision) SetSliceUsgCtrlInfo(v SliceUsgCtrlInfoSm) {
	o.SliceUsgCtrlInfo.Set(&v)
}

// SetSliceUsgCtrlInfoNil sets the value for SliceUsgCtrlInfo to be an explicit nil
func (o *SmPolicyDecision) SetSliceUsgCtrlInfoNil() {
	o.SliceUsgCtrlInfo.Set(nil)
}

// UnsetSliceUsgCtrlInfo ensures that no value is present for SliceUsgCtrlInfo, not even an explicit nil
func (o *SmPolicyDecision) UnsetSliceUsgCtrlInfo() {
	o.SliceUsgCtrlInfo.Unset()
}

// GetVplmnOffloadInfos returns the VplmnOffloadInfos field value if set, zero value otherwise.
func (o *SmPolicyDecision) GetVplmnOffloadInfos() []VplmnOffloadingInfo {
	if o == nil || openapi.IsNil(o.VplmnOffloadInfos) {
		var ret []VplmnOffloadingInfo
		return ret
	}
	return o.VplmnOffloadInfos
}

// GetVplmnOffloadInfosOk returns a tuple with the VplmnOffloadInfos field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SmPolicyDecision) GetVplmnOffloadInfosOk() ([]VplmnOffloadingInfo, bool) {
	if o == nil || openapi.IsNil(o.VplmnOffloadInfos) {
		return nil, false
	}
	return o.VplmnOffloadInfos, true
}

// HasVplmnOffloadInfos returns a boolean if a field has been set.
func (o *SmPolicyDecision) HasVplmnOffloadInfos() bool {
	if o != nil && !openapi.IsNil(o.VplmnOffloadInfos) {
		return true
	}
...
// SetVplmnOffloadInfos gets a reference to the given []VplmnOffloadingInfo and assigns it to the VplmnOffloadInfos field.
func (o *SmPolicyDecision) SetVplmnOffloadInfos(v []VplmnOffloadingInfo) {
	o.VplmnOffloadInfos = v
}

func (o SmPolicyDecision) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.SessRules) {
		toSerialize["sessRules"] = o.SessRules
	}
	if o.PccRules != nil {
		toSerialize["pccRules"] = o.PccRules
	}
	if !openapi.IsNil(o.PcscfRestIndication) {
		toSerialize["pcscfRestIndication"] = o.PcscfRestIndication
	}
	if !openapi.IsNil(o.QosDecs) {
	...
	if !openapi.IsNil(o.OfflineChOnly) {
	...
	if !openapi.IsNil(o.LastReqRuleData) {
		toSerialize["lastReqRuleData"] = o.LastReqRuleData
	}
	if !openapi.IsNil(o.LastReqUsageData) {
	...
	if !openapi.IsNil(o.RedSessIndication) {
		toSerialize["redSessIndication"] = o.RedSessIndication
	}
	if !openapi.IsNil(o.UePolCont) {
		toSerialize["uePolCont"] = o.UePolCont
	}
	if o.SliceUsgCtrlInfo.IsSet() {
		toSerialize["sliceUsgCtrlInfo"] = o.SliceUsgCtrlInfo.Get()
	}
	if !openapi.IsNil(o.VplmnOffloadInfos) {
		toSerialize["vplmnOffloadInfos"] = o.VplmnOffloadInfos
	}
