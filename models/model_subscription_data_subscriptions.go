...
var _ openapi.MappedNullable = &SubscriptionDataSubscriptions{}
...
type SubscriptionDataSubscriptions struct {
	...
	CallbackReference string `json:"callbackReference" yaml:"callbackReference"`
	// String providing an URI formatted according to RFC 3986.
	OriginalCallbackReference *string  `json:"originalCallbackReference,omitempty" yaml:"originalCallbackReference,omitempty"`
	...
	SdmSubscription     *SdmSubscription     `json:"sdmSubscription,omitempty" yaml:"sdmSubscription,omitempty"`
	HssSubscriptionInfo *HssSubscriptionInfo `json:"hssSubscriptionInfo,omitempty" yaml:"hssSubscriptionInfo,omitempty"`
	SubscriptionId      *string              `json:"subscriptionId,omitempty" yaml:"subscriptionId,omitempty"`
	UniqueSubscription  *bool                `json:"uniqueSubscription,omitempty" yaml:"uniqueSubscription,omitempty"`
	...
	ImmediateReport    *bool               `json:"immediateReport,omitempty" yaml:"immediateReport,omitempty"`
	Report             *ImmediateReportUdr `json:"report,omitempty" yaml:"report,omitempty"`
	AdditionalDataRefs []AdditionalDataRef `json:"additionalDataRefs,omitempty" yaml:"additionalDataRefs,omitempty"`
}
...
func (o *SubscriptionDataSubscriptions) GetHssSubscriptionInfo() HssSubscriptionInfo {
	if o == nil || openapi.IsNil(o.HssSubscriptionInfo) {
...
func (o *SubscriptionDataSubscriptions) GetUniqueSubscription() bool {
	if o == nil || openapi.IsNil(o.UniqueSubscription) {
		var ret bool
		return ret
	}
...
func (o *SubscriptionDataSubscriptions) GetImmediateReport() bool {
	if o == nil || openapi.IsNil(o.ImmediateReport) {
		var ret bool
		return ret
	}
...
func (o *SubscriptionDataSubscriptions) GetReport() ImmediateReportUdr {
	if o == nil || openapi.IsNil(o.Report) {
		var ret ImmediateReportUdr
		return ret
	}
	return *o.Report
}
...
// and a boolean to check if the value has been set.
func (o *SubscriptionDataSubscriptions) GetReportOk() (*ImmediateReportUdr, bool) {
	if o == nil || openapi.IsNil(o.Report) {
		return nil, false
	}
...
// SetReport gets a reference to the given ImmediateReportUdr and assigns it to the Report field.
func (o *SubscriptionDataSubscriptions) SetReport(v ImmediateReportUdr) {
	o.Report = &v
}

// GetAdditionalDataRefs returns the AdditionalDataRefs field value if set, zero value otherwise.
func (o *SubscriptionDataSubscriptions) GetAdditionalDataRefs() []AdditionalDataRef {
	if o == nil || openapi.IsNil(o.AdditionalDataRefs) {
		var ret []AdditionalDataRef
		return ret
	}
	return o.AdditionalDataRefs
}

// GetAdditionalDataRefsOk returns a tuple with the AdditionalDataRefs field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SubscriptionDataSubscriptions) GetAdditionalDataRefsOk() ([]AdditionalDataRef, bool) {
	if o == nil || openapi.IsNil(o.AdditionalDataRefs) {
		return nil, false
	}
	return o.AdditionalDataRefs, true
}

// HasAdditionalDataRefs returns a boolean if a field has been set.
func (o *SubscriptionDataSubscriptions) HasAdditionalDataRefs() bool {
	if o != nil && !openapi.IsNil(o.AdditionalDataRefs) {
		return true
	}
...
// SetAdditionalDataRefs gets a reference to the given []AdditionalDataRef and assigns it to the AdditionalDataRefs field.
func (o *SubscriptionDataSubscriptions) SetAdditionalDataRefs(v []AdditionalDataRef) {
	o.AdditionalDataRefs = v
}

func (o SubscriptionDataSubscriptions) ToMap() (map[string]any, error) {
