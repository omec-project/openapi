...
var _ openapi.MappedNullable = &PolicyCounterInfo{}
...
type PolicyCounterInfo struct {
	...
	PolicyCounterId string `json:"policyCounterId" yaml:"policyCounterId"`
	...
	PenPolCounterStatuses []PendingPolicyCounterStatus `json:"penPolCounterStatuses,omitempty" yaml:"penPolCounterStatuses,omitempty"`
}
...
func (o *PolicyCounterInfo) GetPenPolCounterStatuses() []PendingPolicyCounterStatus {
	if o == nil || openapi.IsNil(o.PenPolCounterStatuses) {
...
func (o PolicyCounterInfo) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["policyCounterId"] = o.PolicyCounterId
	toSerialize["currentStatus"] = o.CurrentStatus
	if !openapi.IsNil(o.PenPolCounterStatuses) {
