...
var _ openapi.MappedNullable = &UePrivacyRequirements{}
...
type UePrivacyRequirements struct {
	LcsServiceAuthInfo *LcsServiceAuth `json:"lcsServiceAuthInfo,omitempty" yaml:"lcsServiceAuthInfo,omitempty"`
	CodeWordCheck      *bool           `json:"codeWordCheck,omitempty" yaml:"codeWordCheck,omitempty"`
}
...
func (o *UePrivacyRequirements) GetLcsServiceAuthInfo() LcsServiceAuth {
	if o == nil || openapi.IsNil(o.LcsServiceAuthInfo) {
...
func (o *UePrivacyRequirements) GetCodeWordCheck() bool {
	if o == nil || openapi.IsNil(o.CodeWordCheck) {
		var ret bool
		return ret
	}
...
func (o UePrivacyRequirements) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.LcsServiceAuthInfo) {
		toSerialize["lcsServiceAuthInfo"] = o.LcsServiceAuthInfo
	}
	if !openapi.IsNil(o.CodeWordCheck) {
