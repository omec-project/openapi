...
type SMSF3GPPRegistrationDocumentAPI interface {
	...
	*/
	CreateSmsfContext3gpp(ctx context.Context, ueId string) ApiCreateSmsfContext3gppRequest

	// CreateSmsfContext3gppExecute executes the request
	//   @return SmsfRegistration
	CreateSmsfContext3gppExecute(r ApiCreateSmsfContext3gppRequest) (*models.SmsfRegistration, *http.Response, error)
	...
	*/
	DeleteSmsfContext3gpp(ctx context.Context, ueId string) ApiDeleteSmsfContext3gppRequest

	// DeleteSmsfContext3gppExecute executes the request
	DeleteSmsfContext3gppExecute(r ApiDeleteSmsfContext3gppRequest) (*http.Response, error)
	...
	*/
	QuerySmsfContext3gpp(ctx context.Context, ueId string) ApiQuerySmsfContext3gppRequest

	// QuerySmsfContext3gppExecute executes the request
	//   @return SmsfRegistration
	QuerySmsfContext3gppExecute(r ApiQuerySmsfContext3gppRequest) (*models.SmsfRegistration, *http.Response, error)
}
...
type ApiCreateSmsfContext3gppRequest struct {
	ctx              context.Context
	ApiService       SMSF3GPPRegistrationDocumentAPI
	ueId             string
	smsfRegistration *models.SmsfRegistration
}

func (r ApiCreateSmsfContext3gppRequest) SmsfRegistration(smsfRegistration models.SmsfRegistration) ApiCreateSmsfContext3gppRequest {
	r.smsfRegistration = &smsfRegistration
	return r
}

func (r ApiCreateSmsfContext3gppRequest) Execute() (*models.SmsfRegistration, *http.Response, error) {
...
//
//	@return SmsfRegistration
func (a *SMSF3GPPRegistrationDocumentAPIService) CreateSmsfContext3gppExecute(r ApiCreateSmsfContext3gppRequest) (*models.SmsfRegistration, *http.Response, error) {
	var (
...
func (r ApiQuerySmsfContext3gppRequest) Execute() (*models.SmsfRegistration, *http.Response, error) {
...
//
//	@return SmsfRegistration
func (a *SMSF3GPPRegistrationDocumentAPIService) QuerySmsfContext3gppExecute(r ApiQuerySmsfContext3gppRequest) (*models.SmsfRegistration, *http.Response, error) {
	var (
