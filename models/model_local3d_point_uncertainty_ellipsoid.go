...
var _ openapi.MappedNullable = &Local3dPointUncertaintyEllipsoid{}

// Local3dPointUncertaintyEllipsoid Local 3D point with uncertainty ellipsoid
type Local3dPointUncertaintyEllipsoid struct {
	GADShape
	LocalOrigin          LocalOrigin               `json:"localOrigin" yaml:"localOrigin"`
	Point                RelativeCartesianLocation `json:"point" yaml:"point"`
	UncertaintyEllipsoid UncertaintyEllipsoid      `json:"uncertaintyEllipsoid" yaml:"uncertaintyEllipsoid"`
	// Indicates value of confidence.
	Confidence int32 `json:"confidence" yaml:"confidence"`
}
...
func (o Local3dPointUncertaintyEllipsoid) ToMap() (map[string]any, error) {
