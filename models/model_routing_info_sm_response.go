...
var _ openapi.MappedNullable = &RoutingInfoSmResponse{}
...
type RoutingInfoSmResponse struct {
	...
	IpSmGw      *IpSmGwInfo       `json:"ipSmGw,omitempty" yaml:"ipSmGw,omitempty"`
	SmsRouter   *SmsRouterInfo    `json:"smsRouter,omitempty" yaml:"smsRouter,omitempty"`
}
...
func (o *RoutingInfoSmResponse) GetIpSmGw() IpSmGwInfo {
	if o == nil || openapi.IsNil(o.IpSmGw) {
		var ret IpSmGwInfo
		return ret
	}
	return *o.IpSmGw
...
func (o *RoutingInfoSmResponse) GetSmsRouter() SmsRouterInfo {
	if o == nil || openapi.IsNil(o.SmsRouter) {
...
func (o RoutingInfoSmResponse) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.IpSmGw) {
		toSerialize["ipSmGw"] = o.IpSmGw
	}
	if !openapi.IsNil(o.SmsRouter) {
