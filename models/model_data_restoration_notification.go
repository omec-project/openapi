...
var _ openapi.MappedNullable = &DataRestorationNotification{}
...
type DataRestorationNotification struct {
	...
	LastReplicationTime *time.Time `json:"lastReplicationTime,omitempty" yaml:"lastReplicationTime,omitempty"`
	// string with format 'date-time' as defined in OpenAPI.
...
func (o *DataRestorationNotification) GetLastReplicationTime() time.Time {
	if o == nil || openapi.IsNil(o.LastReplicationTime) {
		var ret time.Time
		return ret
	}
...
func (o DataRestorationNotification) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.LastReplicationTime) {
