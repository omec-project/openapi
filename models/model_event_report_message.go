...
var _ openapi.MappedNullable = &EventReportMessage{}

// EventReportMessage Indicates an event report message.
type EventReportMessage struct {
	EventClass   EventClass      `json:"eventClass" yaml:"eventClass"`
	EventContent RefToBinaryData `json:"eventContent" yaml:"eventContent"`
}
...
func (o EventReportMessage) ToMap() (map[string]any, error) {
