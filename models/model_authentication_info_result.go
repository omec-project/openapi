...
var _ openapi.MappedNullable = &AuthenticationInfoResult{}
...
type AuthenticationInfoResult struct {
	...
	AuthenticationVector *AuthenticationVector `json:"authenticationVector,omitempty" yaml:"authenticationVector,omitempty"`
	...
	AkmaInd   *bool                  `json:"akmaInd,omitempty" yaml:"akmaInd,omitempty"`
	AuthAaa   *bool                  `json:"authAaa,omitempty" yaml:"authAaa,omitempty"`
	...
	MskInd    *bool                  `json:"mskInd,omitempty" yaml:"mskInd,omitempty"`
}
...
func (o *AuthenticationInfoResult) GetAuthenticationVector() AuthenticationVector {
	if o == nil || openapi.IsNil(o.AuthenticationVector) {
...
func (o *AuthenticationInfoResult) GetAkmaInd() bool {
	if o == nil || openapi.IsNil(o.AkmaInd) {
		var ret bool
		return ret
	}
	return *o.AkmaInd
...
func (o *AuthenticationInfoResult) GetAuthAaa() bool {
	if o == nil || openapi.IsNil(o.AuthAaa) {
		var ret bool
		return ret
	}
	return *o.AuthAaa
...
// GetMskInd returns the MskInd field value if set, zero value otherwise.
func (o *AuthenticationInfoResult) GetMskInd() bool {
	if o == nil || openapi.IsNil(o.MskInd) {
		var ret bool
		return ret
	}
	return *o.MskInd
...
// GetMskIndOk returns a tuple with the MskInd field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AuthenticationInfoResult) GetMskIndOk() (*bool, bool) {
	if o == nil || openapi.IsNil(o.MskInd) {
		return nil, false
	}
	return o.MskInd, true
}

// HasMskInd returns a boolean if a field has been set.
func (o *AuthenticationInfoResult) HasMskInd() bool {
	if o != nil && !openapi.IsNil(o.MskInd) {
		return true
	}
...
// SetMskInd gets a reference to the given bool and assigns it to the MskInd field.
func (o *AuthenticationInfoResult) SetMskInd(v bool) {
	o.MskInd = &v
}

func (o AuthenticationInfoResult) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["authType"] = o.AuthType
	if !openapi.IsNil(o.SupportedFeatures) {
		toSerialize["supportedFeatures"] = o.SupportedFeatures
	}
	if !openapi.IsNil(o.AuthenticationVector) {
		toSerialize["authenticationVector"] = o.AuthenticationVector
	}
	if !openapi.IsNil(o.Supi) {
		toSerialize["supi"] = o.Supi
	}
	if !openapi.IsNil(o.AkmaInd) {
		toSerialize["akmaInd"] = o.AkmaInd
	}
	if !openapi.IsNil(o.AuthAaa) {
	...
	if !openapi.IsNil(o.MskInd) {
		toSerialize["mskInd"] = o.MskInd
	}
