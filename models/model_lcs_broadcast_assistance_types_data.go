...
var _ openapi.MappedNullable = &LcsBroadcastAssistanceTypesData{}
...
type LcsBroadcastAssistanceTypesData struct {
	...
	LocationAssistanceType *os.File `json:"locationAssistanceType" yaml:"locationAssistanceType"`
}
...
func (o LcsBroadcastAssistanceTypesData) ToMap() (map[string]any, error) {
