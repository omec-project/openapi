...
type QueryODBDataBySUPIOrGPSIDocumentAPI interface {
	...
	*/
	...
	//   @return OdbData
	GetOdbDataExecute(r ApiGetOdbDataRequest) (*models.OdbData, *http.Response, error)
}
...
func (r ApiGetOdbDataRequest) Execute() (*models.OdbData, *http.Response, error) {
...
//
//	@return OdbData
func (a *QueryODBDataBySUPIOrGPSIDocumentAPIService) GetOdbDataExecute(r ApiGetOdbDataRequest) (*models.OdbData, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    any
		formFiles           []formFile
		localVarReturnValue *models.OdbData
	)
