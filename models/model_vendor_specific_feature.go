...
var _ openapi.MappedNullable = &VendorSpecificFeature{}
...
type VendorSpecificFeature struct {
	...
	FeatureVersion string `json:"featureVersion" yaml:"featureVersion"`
}
...
func (o VendorSpecificFeature) ToMap() (map[string]any, error) {
