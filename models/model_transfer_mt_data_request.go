...
var _ openapi.MappedNullable = &TransferMtDataRequest{}

// TransferMtDataRequest struct for TransferMtDataRequest
type TransferMtDataRequest struct {
	JsonData     *TransferMtDataReqData `json:"jsonData,omitempty" yaml:"jsonData,omitempty" multipart:"contentType:application/json,ref:{jsonData}"`
...
func (o TransferMtDataRequest) ToMap() (map[string]any, error) {
