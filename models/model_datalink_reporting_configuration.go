...
var _ openapi.MappedNullable = &DatalinkReportingConfiguration{}

// DatalinkReportingConfiguration struct for DatalinkReportingConfiguration
type DatalinkReportingConfiguration struct {
	DddTrafficDes []DddTrafficDescriptor `json:"dddTrafficDes,omitempty" yaml:"dddTrafficDes,omitempty"`
	// String representing a Data Network as defined in clause 9A of 3GPP TS 23.003;  it shall contain either a DNN Network Identifier, or a full DNN with both the Network  Identifier and Operator Identifier, as specified in 3GPP TS 23.003 clause 9.1.1 and 9.1.2. It shall be coded as string in which the labels are separated by dots  (e.g. \"Label1.Label2.Label3\").
	Dnn           *string                `json:"dnn,omitempty" yaml:"dnn,omitempty"`
	Slice         *Snssai                `json:"slice,omitempty" yaml:"slice,omitempty"`
	DddStatusList []DlDataDeliveryStatus `json:"dddStatusList,omitempty" yaml:"dddStatusList,omitempty"`
}
...
func (o *DatalinkReportingConfiguration) GetDddTrafficDes() []DddTrafficDescriptor {
	if o == nil || openapi.IsNil(o.DddTrafficDes) {
...
func (o *DatalinkReportingConfiguration) GetSlice() Snssai {
	if o == nil || openapi.IsNil(o.Slice) {
		var ret Snssai
		return ret
	}
	return *o.Slice
...
func (o *DatalinkReportingConfiguration) GetDddStatusList() []DlDataDeliveryStatus {
	if o == nil || openapi.IsNil(o.DddStatusList) {
...
func (o DatalinkReportingConfiguration) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.DddTrafficDes) {
		toSerialize["dddTrafficDes"] = o.DddTrafficDes
	}
	if !openapi.IsNil(o.Dnn) {
		toSerialize["dnn"] = o.Dnn
	}
	if !openapi.IsNil(o.Slice) {
		toSerialize["slice"] = o.Slice
	}
	if !openapi.IsNil(o.DddStatusList) {
