...
var _ openapi.MappedNullable = &UmtLocationArea5G{}
...
type UmtLocationArea5G struct {
	...
	CivicAddresses []CivicAddress   `json:"civicAddresses,omitempty" yaml:"civicAddresses,omitempty"`
	...
	UmtTime *string `json:"umtTime,omitempty" yaml:"umtTime,omitempty"`
	// Unsigned integer identifying a period of time in units of seconds.
	UmtDuration *int32 `json:"umtDuration,omitempty" yaml:"umtDuration,omitempty"`
}
...
func (o *UmtLocationArea5G) GetGeographicAreas() []GeographicArea {
	if o == nil || openapi.IsNil(o.GeographicAreas) {
...
func (o *UmtLocationArea5G) GetCivicAddresses() []CivicAddress {
	if o == nil || openapi.IsNil(o.CivicAddresses) {
...
func (o *UmtLocationArea5G) GetUmtTime() string {
	if o == nil || openapi.IsNil(o.UmtTime) {
		var ret string
		return ret
	}
	return *o.UmtTime
...
func (o *UmtLocationArea5G) GetUmtDuration() int32 {
	if o == nil || openapi.IsNil(o.UmtDuration) {
		var ret int32
		return ret
	}
