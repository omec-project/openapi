...
var _ openapi.MappedNullable = &NotifSummaryReport{}
...
type NotifSummaryReport struct {
	...
	EventReports []EventParamReport `json:"eventReports" yaml:"eventReports"`
}
...
func NewNotifSummaryReport(eventId NullableDccfEvent, procInterval int32, eventReports []EventParamReport) *NotifSummaryReport {
...
func (o NotifSummaryReport) ToMap() (map[string]any, error) {
