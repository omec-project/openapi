...
var _ openapi.MappedNullable = &ReachableUeInfo{}

// ReachableUeInfo Contains the reachable UE Information
type ReachableUeInfo struct {
	UeList       []string      `json:"ueList" yaml:"ueList"`
	UserLocation *UserLocation `json:"userLocation,omitempty" yaml:"userLocation,omitempty"`
}
...
func (o *ReachableUeInfo) GetUserLocation() UserLocation {
	if o == nil || openapi.IsNil(o.UserLocation) {
...
func (o ReachableUeInfo) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["ueList"] = o.UeList
	if !openapi.IsNil(o.UserLocation) {
