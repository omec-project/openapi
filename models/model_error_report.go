...
var _ openapi.MappedNullable = &ErrorReport{}

// ErrorReport Contains the rule,policy decision and/or condition data error reports.
type ErrorReport struct {
	Error *ProblemDetails `json:"error,omitempty" yaml:"error,omitempty"`
	...
	PolDecFailureReports []PolicyDecisionFailureCode `json:"polDecFailureReports,omitempty" yaml:"polDecFailureReports,omitempty"`
...
func (o *ErrorReport) GetError() ProblemDetails {
	if o == nil || openapi.IsNil(o.Error) {
...
func (o *ErrorReport) GetPolDecFailureReports() []PolicyDecisionFailureCode {
	if o == nil || openapi.IsNil(o.PolDecFailureReports) {
...
func (o ErrorReport) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.Error) {
	...
	if !openapi.IsNil(o.PolDecFailureReports) {
