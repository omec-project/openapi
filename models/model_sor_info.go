...
var _ openapi.MappedNullable = &SorInfo{}

// SorInfo struct for SorInfo
type SorInfo struct {
	SteeringContainer *SteeringContainer `json:"steeringContainer,omitempty" yaml:"steeringContainer,omitempty"`
	// Contains indication whether the acknowledgement from UE is needed.
	AckInd bool `json:"ackInd" yaml:"ackInd"`
	// MAC value for protecting SOR procedure (SoR-MAC-IAUSF and SoR-XMAC-IUE).
	SorMacIausf *string `json:"sorMacIausf,omitempty" yaml:"sorMacIausf,omitempty" validate:"regexp=^[A-Fa-f0-9]{32}$"`
	// CounterSoR.
	Countersor *string `json:"countersor,omitempty" yaml:"countersor,omitempty" validate:"regexp=^[A-Fa-f0-9]{4}$"`
	...
	// string with format 'bytes' as defined in OpenAPI
	SorCmci *string `json:"sorCmci,omitempty" yaml:"sorCmci,omitempty"`
	// string with format 'bytes' as defined in OpenAPI
	SorSnpnSi *string `json:"sorSnpnSi,omitempty" yaml:"sorSnpnSi,omitempty"`
	// string with format 'bytes' as defined in OpenAPI
	SorSnpnSiLs          *string `json:"sorSnpnSiLs,omitempty" yaml:"sorSnpnSiLs,omitempty"`
	StoreSorCmciInMe     *bool   `json:"storeSorCmciInMe,omitempty" yaml:"storeSorCmciInMe,omitempty"`
	UsimSupportOfSorCmci *bool   `json:"usimSupportOfSorCmci,omitempty" yaml:"usimSupportOfSorCmci,omitempty"`
}
...
func (o *SorInfo) GetSteeringContainer() SteeringContainer {
	if o == nil || openapi.IsNil(o.SteeringContainer) {
...
func (o *SorInfo) GetSorMacIausf() string {
	if o == nil || openapi.IsNil(o.SorMacIausf) {
		var ret string
		return ret
	}
...
func (o *SorInfo) GetCountersor() string {
	if o == nil || openapi.IsNil(o.Countersor) {
		var ret string
		return ret
	}
	return *o.Countersor
...
func (o *SorInfo) GetSorCmci() string {
	if o == nil || openapi.IsNil(o.SorCmci) {
		var ret string
		return ret
	}
	return *o.SorCmci
...
// GetSorSnpnSi returns the SorSnpnSi field value if set, zero value otherwise.
func (o *SorInfo) GetSorSnpnSi() string {
	if o == nil || openapi.IsNil(o.SorSnpnSi) {
		var ret string
		return ret
	}
	return *o.SorSnpnSi
...
// GetSorSnpnSiOk returns a tuple with the SorSnpnSi field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SorInfo) GetSorSnpnSiOk() (*string, bool) {
	if o == nil || openapi.IsNil(o.SorSnpnSi) {
		return nil, false
	}
	return o.SorSnpnSi, true
}
...
// SetSorSnpnSi gets a reference to the given string and assigns it to the SorSnpnSi field.
func (o *SorInfo) SetSorSnpnSi(v string) {
	o.SorSnpnSi = &v
}

// GetSorSnpnSiLs returns the SorSnpnSiLs field value if set, zero value otherwise.
func (o *SorInfo) GetSorSnpnSiLs() string {
	if o == nil || openapi.IsNil(o.SorSnpnSiLs) {
		var ret string
		return ret
	}
	return *o.SorSnpnSiLs
}

// GetSorSnpnSiLsOk returns a tuple with the SorSnpnSiLs field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SorInfo) GetSorSnpnSiLsOk() (*string, bool) {
	if o == nil || openapi.IsNil(o.SorSnpnSiLs) {
		return nil, false
	}
	return o.SorSnpnSiLs, true
}
...
// SetSorSnpnSiLs gets a reference to the given string and assigns it to the SorSnpnSiLs field.
...
func (o *SorInfo) GetStoreSorCmciInMe() bool {
	if o == nil || openapi.IsNil(o.StoreSorCmciInMe) {
		var ret bool
		return ret
	}
...
func (o *SorInfo) GetUsimSupportOfSorCmci() bool {
	if o == nil || openapi.IsNil(o.UsimSupportOfSorCmci) {
		var ret bool
		return ret
	}
...
func (o SorInfo) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.SteeringContainer) {
		toSerialize["steeringContainer"] = o.SteeringContainer
	}
	toSerialize["ackInd"] = o.AckInd
	if !openapi.IsNil(o.SorMacIausf) {
		toSerialize["sorMacIausf"] = o.SorMacIausf
	}
	if !openapi.IsNil(o.Countersor) {
	...
	if !openapi.IsNil(o.SorCmci) {
		toSerialize["sorCmci"] = o.SorCmci
	}
	if !openapi.IsNil(o.SorSnpnSi) {
		toSerialize["sorSnpnSi"] = o.SorSnpnSi
	}
	if !openapi.IsNil(o.SorSnpnSiLs) {
		toSerialize["sorSnpnSiLs"] = o.SorSnpnSiLs
	}
	if !openapi.IsNil(o.StoreSorCmciInMe) {
		toSerialize["storeSorCmciInMe"] = o.StoreSorCmciInMe
	}
	if !openapi.IsNil(o.UsimSupportOfSorCmci) {
