...
var _ openapi.MappedNullable = &ClassCriterion{}
...
type ClassCriterion struct {
	DisperClass DispersionClass `json:"disperClass" yaml:"disperClass"`
	// Unsigned integer indicating Sampling Ratio (see clauses 4.15.1 of 3GPP TS 23.502), expressed in percent.
	ClassThreshold int32             `json:"classThreshold" yaml:"classThreshold"`
	ThresMatch     MatchingDirection `json:"thresMatch" yaml:"thresMatch"`
}
...
func (o ClassCriterion) ToMap() (map[string]any, error) {
