...
var _ openapi.MappedNullable = &RtpPayloadInfo{}

// RtpPayloadInfo RtpPayloadInfo contains Rtp payload type and format.
type RtpPayloadInfo struct {
	RtpPayloadTypeList []int32           `json:"rtpPayloadTypeList,omitempty" yaml:"rtpPayloadTypeList,omitempty"`
	RtpPayloadFormat   *RtpPayloadFormat `json:"rtpPayloadFormat,omitempty" yaml:"rtpPayloadFormat,omitempty"`
}
...
func (o *RtpPayloadInfo) GetRtpPayloadTypeList() []int32 {
	if o == nil || openapi.IsNil(o.RtpPayloadTypeList) {
		var ret []int32
		return ret
	}
...
func (o *RtpPayloadInfo) GetRtpPayloadFormat() RtpPayloadFormat {
	if o == nil || openapi.IsNil(o.RtpPayloadFormat) {
...
func (o RtpPayloadInfo) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.RtpPayloadTypeList) {
		toSerialize["rtpPayloadTypeList"] = o.RtpPayloadTypeList
	}
	if !openapi.IsNil(o.RtpPayloadFormat) {
