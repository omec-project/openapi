...
var _ openapi.MappedNullable = &InterFreqTargetInfo{}
...
type InterFreqTargetInfo struct {
	...
	DlCarrierFreq int32 `json:"dlCarrierFreq" yaml:"dlCarrierFreq"`
	...
	CellIdList []int32 `json:"cellIdList,omitempty" yaml:"cellIdList,omitempty"`
}
...
func (o *InterFreqTargetInfo) GetCellIdList() []int32 {
	if o == nil || openapi.IsNil(o.CellIdList) {
		var ret []int32
		return ret
	}
	return o.CellIdList
...
func (o InterFreqTargetInfo) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["dlCarrierFreq"] = o.DlCarrierFreq
	if !openapi.IsNil(o.CellIdList) {
