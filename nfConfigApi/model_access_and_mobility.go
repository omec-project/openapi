...
var _ openapi.MappedNullable = &AccessAndMobility{}
...
type AccessAndMobility struct {
	...
	Tacs                 []string `json:"tacs,omitempty" yaml:"tacs,omitempty"`
...
func (o *AccessAndMobility) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varAccessAndMobility)
	...
	*o = AccessAndMobility(varAccessAndMobility)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "tacs")
