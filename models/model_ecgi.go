...
var _ openapi.MappedNullable = &Ecgi{}
...
type Ecgi struct {
	...
	EutraCellId string `json:"eutraCellId" yaml:"eutraCellId" validate:"regexp=^[A-Fa-f0-9]{7}$"`
...
func (o Ecgi) ToMap() (map[string]any, error) {
