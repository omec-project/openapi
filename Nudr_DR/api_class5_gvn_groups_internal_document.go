...
type Class5GVNGroupsInternalDocumentAPI interface {
	...
	*/
	Query5GVnGroupInternal(ctx context.Context) ApiQuery5GVnGroupInternalRequest

	// Query5GVnGroupInternalExecute executes the request
	//   @return map[string]FiveGVnGroupConfiguration
	Query5GVnGroupInternalExecute(r ApiQuery5GVnGroupInternalRequest) (*map[string]models.FiveGVnGroupConfiguration, *http.Response, error)
}
...
type ApiQuery5GVnGroupInternalRequest struct {
	ctx              context.Context
	ApiService       Class5GVNGroupsInternalDocumentAPI
...
func (r ApiQuery5GVnGroupInternalRequest) Execute() (*map[string]models.FiveGVnGroupConfiguration, *http.Response, error) {
...
//
//	@return map[string]FiveGVnGroupConfiguration
func (a *Class5GVNGroupsInternalDocumentAPIService) Query5GVnGroupInternalExecute(r ApiQuery5GVnGroupInternalRequest) (*map[string]models.FiveGVnGroupConfiguration, *http.Response, error) {
	var (
