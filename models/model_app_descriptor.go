...
var _ openapi.MappedNullable = &AppDescriptor{}

// AppDescriptor struct for AppDescriptor
type AppDescriptor struct {
	// Represents the Operating System of the served UE.
	OsId  *string `json:"osId,omitempty" yaml:"osId,omitempty"`
...
func (o AppDescriptor) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.OsId) {
