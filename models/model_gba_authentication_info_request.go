...
func (o *GbaAuthenticationInfoRequest) GetResynchronizationInfo() ResynchronizationInfo {
...
// and a boolean to check if the value has been set.
func (o *GbaAuthenticationInfoRequest) GetResynchronizationInfoOk() (*ResynchronizationInfo, bool) {
	if o == nil || openapi.IsNil(o.ResynchronizationInfo) {
		return nil, false
	}
...
func (o *GbaAuthenticationInfoRequest) SetResynchronizationInfo(v ResynchronizationInfo) {
...
func (o GbaAuthenticationInfoRequest) ToMap() (map[string]any, error) {
