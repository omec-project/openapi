...
var _ openapi.MappedNullable = &PolicyDataSubscription{}
...
type PolicyDataSubscription struct {
	...
	MonResItems           []ResourceItem `json:"monResItems,omitempty" yaml:"monResItems,omitempty"`
	ExcludedResItems      []ResourceItem `json:"excludedResItems,omitempty" yaml:"excludedResItems,omitempty"`
	...
	ImmReports []PolicyDataChangeNotification `json:"immReports,omitempty" yaml:"immReports,omitempty"`
	...
	SubsId            *string  `json:"subsId,omitempty" yaml:"subsId,omitempty"`
}
...
func (o *PolicyDataSubscription) GetMonResItems() []ResourceItem {
	if o == nil || openapi.IsNil(o.MonResItems) {
...
func (o *PolicyDataSubscription) GetExcludedResItems() []ResourceItem {
	if o == nil || openapi.IsNil(o.ExcludedResItems) {
		var ret []ResourceItem
		return ret
	}
...
// GetSubsId returns the SubsId field value if set, zero value otherwise.
func (o *PolicyDataSubscription) GetSubsId() string {
	if o == nil || openapi.IsNil(o.SubsId) {
		var ret string
		return ret
	}
	return *o.SubsId
...
// GetSubsIdOk returns a tuple with the SubsId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PolicyDataSubscription) GetSubsIdOk() (*string, bool) {
	if o == nil || openapi.IsNil(o.SubsId) {
		return nil, false
	}
	return o.SubsId, true
}

// HasSubsId returns a boolean if a field has been set.
func (o *PolicyDataSubscription) HasSubsId() bool {
	if o != nil && !openapi.IsNil(o.SubsId) {
		return true
	}
...
// SetSubsId gets a reference to the given string and assigns it to the SubsId field.
func (o *PolicyDataSubscription) SetSubsId(v string) {
	o.SubsId = &v
}

func (o PolicyDataSubscription) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.MonResItems) {
		toSerialize["monResItems"] = o.MonResItems
	}
	if !openapi.IsNil(o.ExcludedResItems) {
	...
	if !openapi.IsNil(o.SubsId) {
		toSerialize["subsId"] = o.SubsId
	}
