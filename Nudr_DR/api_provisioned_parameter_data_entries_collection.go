...
type ProvisionedParameterDataEntriesCollectionAPI interface {
	...
	*/
	GetMultiplePPDataEntries(ctx context.Context, ueId models.GetMultiplePPDataEntriesUeIdParameter) ApiGetMultiplePPDataEntriesRequest

	// GetMultiplePPDataEntriesExecute executes the request
	//   @return PpDataEntryList
	GetMultiplePPDataEntriesExecute(r ApiGetMultiplePPDataEntriesRequest) (*models.PpDataEntryList, *http.Response, error)
}
...
type ApiGetMultiplePPDataEntriesRequest struct {
	ctx               context.Context
	ApiService        ProvisionedParameterDataEntriesCollectionAPI
	ueId              models.GetMultiplePPDataEntriesUeIdParameter
...
func (r ApiGetMultiplePPDataEntriesRequest) Execute() (*models.PpDataEntryList, *http.Response, error) {
...
GetMultiplePPDataEntries get a list of Parameter Provisioning Data Entries
	...
	@return ApiGetMultiplePPDataEntriesRequest
*/
func (a *ProvisionedParameterDataEntriesCollectionAPIService) GetMultiplePPDataEntries(ctx context.Context, ueId models.GetMultiplePPDataEntriesUeIdParameter) ApiGetMultiplePPDataEntriesRequest {
	return ApiGetMultiplePPDataEntriesRequest{
		ApiService: a,
		ctx:        ctx,
		ueId:       ueId,
...
//
//	@return PpDataEntryList
func (a *ProvisionedParameterDataEntriesCollectionAPIService) GetMultiplePPDataEntriesExecute(r ApiGetMultiplePPDataEntriesRequest) (*models.PpDataEntryList, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    any
		formFiles           []formFile
		localVarReturnValue *models.PpDataEntryList
	)
