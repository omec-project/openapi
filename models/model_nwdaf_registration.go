...
var _ openapi.MappedNullable = &NwdafRegistration{}
...
type NwdafRegistration struct {
	...
	AnalyticsIds    []EventId `json:"analyticsIds" yaml:"analyticsIds"`
	...
	NwdafSetId *string `json:"nwdafSetId,omitempty" yaml:"nwdafSetId,omitempty"`
...
func (o *NwdafRegistration) GetNwdafSetId() string {
	if o == nil || openapi.IsNil(o.NwdafSetId) {
		var ret string
		return ret
	}
	return *o.NwdafSetId
