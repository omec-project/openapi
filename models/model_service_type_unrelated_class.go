...
var _ openapi.MappedNullable = &ServiceTypeUnrelatedClass{}

// ServiceTypeUnrelatedClass struct for ServiceTypeUnrelatedClass
type ServiceTypeUnrelatedClass struct {
	// LCS service type.
	ServiceType               int32                      `json:"serviceType" yaml:"serviceType"`
	...
	CodeWordInd               *CodeWordInd               `json:"codeWordInd,omitempty" yaml:"codeWordInd,omitempty"`
	ValidTimePeriod           *ValidTimePeriod           `json:"validTimePeriod,omitempty" yaml:"validTimePeriod,omitempty"`
	CodeWordList              []string                   `json:"codeWordList,omitempty" yaml:"codeWordList,omitempty"`
}
...
func (o *ServiceTypeUnrelatedClass) GetCodeWordInd() CodeWordInd {
	if o == nil || openapi.IsNil(o.CodeWordInd) {
		var ret CodeWordInd
		return ret
	}
...
func (o *ServiceTypeUnrelatedClass) GetCodeWordList() []string {
	if o == nil || openapi.IsNil(o.CodeWordList) {
		var ret []string
		return ret
	}
...
func (o ServiceTypeUnrelatedClass) ToMap() (map[string]any, error) {
