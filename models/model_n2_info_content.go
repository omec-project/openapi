...
var _ openapi.MappedNullable = &N2InfoContent{}
...
type N2InfoContent struct {
	...
	NgapMessageType *int32          `json:"ngapMessageType,omitempty" yaml:"ngapMessageType,omitempty"`
	NgapIeType      *NgapIeType     `json:"ngapIeType,omitempty" yaml:"ngapIeType,omitempty"`
	NgapData        RefToBinaryData `json:"ngapData" yaml:"ngapData"`
}
...
func (o *N2InfoContent) GetNgapMessageType() int32 {
	if o == nil || openapi.IsNil(o.NgapMessageType) {
		var ret int32
		return ret
	}
...
func (o *N2InfoContent) GetNgapIeType() NgapIeType {
	if o == nil || openapi.IsNil(o.NgapIeType) {
		var ret NgapIeType
		return ret
	}
	return *o.NgapIeType
...
func (o N2InfoContent) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.NgapMessageType) {
		toSerialize["ngapMessageType"] = o.NgapMessageType
	}
	if !openapi.IsNil(o.NgapIeType) {
