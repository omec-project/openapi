...
var _ openapi.MappedNullable = &PortManagementContainer{}
...
type PortManagementContainer struct {
	...
	PortManCont string `json:"portManCont" yaml:"portManCont"`
	// Unsigned Integer, i.e. only value 0 and integers above 0 are permissible.
	PortNum int32 `json:"portNum" yaml:"portNum"`
}
...
func (o PortManagementContainer) ToMap() (map[string]any, error) {
