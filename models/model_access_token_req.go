...
var _ openapi.MappedNullable = &AccessTokenReq{}
...
type AccessTokenReq struct {
	...
	TargetNfType *NFType `json:"targetNfType,omitempty" yaml:"targetNfType,omitempty"`
	Scope        string  `json:"scope" yaml:"scope" validate:"regexp=^([a-zA-Z0-9_:-]+)( [a-zA-Z0-9_:-]+)*$"`
	// String uniquely identifying a NF instance. The format of the NF Instance ID shall be a  Universally Unique Identifier (UUID) version 4, as described in IETF RFC 4122.
	TargetNfInstanceId  *string  `json:"targetNfInstanceId,omitempty" yaml:"targetNfInstanceId,omitempty"`
	RequesterPlmn       *PlmnId  `json:"requesterPlmn,omitempty" yaml:"requesterPlmn,omitempty"`
	...
	TargetSnssaiList  []Snssai    `json:"targetSnssaiList,omitempty" yaml:"targetSnssaiList,omitempty"`
	TargetNsiList     []string    `json:"targetNsiList,omitempty" yaml:"targetNsiList,omitempty"`
	...
	TargetNfSetId *string `json:"targetNfSetId,omitempty" yaml:"targetNfSetId,omitempty"`
	...
	TargetNfServiceSetId *string `json:"targetNfServiceSetId,omitempty" yaml:"targetNfServiceSetId,omitempty"`
	// String providing an URI formatted according to RFC 3986.
	HnrfAccessTokenUri *string `json:"hnrfAccessTokenUri,omitempty" yaml:"hnrfAccessTokenUri,omitempty"`
	// String uniquely identifying a NF instance. The format of the NF Instance ID shall be a  Universally Unique Identifier (UUID) version 4, as described in IETF RFC 4122.
	SourceNfInstanceId *string `json:"sourceNfInstanceId,omitempty" yaml:"sourceNfInstanceId,omitempty"`
}
...
func (o *AccessTokenReq) GetTargetNfType() NFType {
	if o == nil || openapi.IsNil(o.TargetNfType) {
		var ret NFType
		return ret
	}
...
func (o *AccessTokenReq) GetTargetNfInstanceId() string {
	if o == nil || openapi.IsNil(o.TargetNfInstanceId) {
		var ret string
		return ret
	}
...
func (o *AccessTokenReq) GetRequesterPlmn() PlmnId {
	if o == nil || openapi.IsNil(o.RequesterPlmn) {
		var ret PlmnId
		return ret
	}
...
func (o *AccessTokenReq) GetRequesterPlmnList() []PlmnId {
	if o == nil || openapi.IsNil(o.RequesterPlmnList) {
		var ret []PlmnId
		return ret
	}
...
func (o *AccessTokenReq) GetRequesterSnssaiList() []Snssai {
	if o == nil || openapi.IsNil(o.RequesterSnssaiList) {
		var ret []Snssai
		return ret
	}
...
func (o *AccessTokenReq) GetRequesterFqdn() string {
	if o == nil || openapi.IsNil(o.RequesterFqdn) {
		var ret string
		return ret
	}
...
func (o *AccessTokenReq) GetRequesterSnpnList() []PlmnIdNid {
	if o == nil || openapi.IsNil(o.RequesterSnpnList) {
		var ret []PlmnIdNid
		return ret
	}
...
func (o *AccessTokenReq) GetTargetPlmn() PlmnId {
	if o == nil || openapi.IsNil(o.TargetPlmn) {
		var ret PlmnId
		return ret
	}
	return *o.TargetPlmn
...
func (o *AccessTokenReq) GetTargetSnpn() PlmnIdNid {
	if o == nil || openapi.IsNil(o.TargetSnpn) {
		var ret PlmnIdNid
		return ret
	}
	return *o.TargetSnpn
...
func (o *AccessTokenReq) GetTargetSnssaiList() []Snssai {
	if o == nil || openapi.IsNil(o.TargetSnssaiList) {
		var ret []Snssai
		return ret
	}
...
func (o *AccessTokenReq) GetTargetNsiList() []string {
	if o == nil || openapi.IsNil(o.TargetNsiList) {
		var ret []string
		return ret
	}
...
func (o *AccessTokenReq) GetTargetNfServiceSetId() string {
	if o == nil || openapi.IsNil(o.TargetNfServiceSetId) {
		var ret string
		return ret
	}
...
func (o *AccessTokenReq) GetHnrfAccessTokenUri() string {
	if o == nil || openapi.IsNil(o.HnrfAccessTokenUri) {
		var ret string
		return ret
	}
...
func (o *AccessTokenReq) GetSourceNfInstanceId() string {
	if o == nil || openapi.IsNil(o.SourceNfInstanceId) {
		var ret string
		return ret
	}
...
func (o AccessTokenReq) ToMap() (map[string]any, error) {
