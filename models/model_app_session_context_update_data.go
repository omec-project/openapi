...
var _ openapi.MappedNullable = &AppSessionContextUpdateData{}
...
type AppSessionContextUpdateData struct {
	...
	AspId *string `json:"aspId,omitempty" yaml:"aspId,omitempty"`
	// string identifying a BDT Reference ID as defined in clause 5.3.3 of 3GPP TS 29.154.
	BdtRefId *string                      `json:"bdtRefId,omitempty" yaml:"bdtRefId,omitempty"`
	EvSubsc  NullableEventsSubscReqDataRm `json:"evSubsc" yaml:"evSubsc,omitempty"`
	// Indication of MCPTT service request.
	McpttId *string `json:"mcpttId,omitempty" yaml:"mcpttId,omitempty"`
	// Indication of modification of MCVideo service.
	McVideoId *string `json:"mcVideoId,omitempty" yaml:"mcVideoId,omitempty"`
	// Contains media component information. The key of the map is the medCompN attribute.
	MedComponents *map[string]MediaComponentRm `json:"medComponents,omitempty" yaml:"medComponents,omitempty"`
	MpsAction     *MpsAction                   `json:"mpsAction,omitempty" yaml:"mpsAction,omitempty"`
	// Indication of MPS service request.
	MpsId *string `json:"mpsId,omitempty" yaml:"mpsId,omitempty"`
	// Indication of MCS service request.
	McsId              *string                         `json:"mcsId,omitempty" yaml:"mcsId,omitempty"`
	PreemptControlInfo *PreemptionControlInformationRm `json:"preemptControlInfo,omitempty" yaml:"preemptControlInfo,omitempty"`
	// indicating a time in seconds with OpenAPI defined 'nullable: true' property.
	QosDuration openapi.NullableInt32 `json:"qosDuration" yaml:"qosDuration,omitempty"`
	// indicating a time in seconds with OpenAPI defined 'nullable: true' property.
	QosInactInt   openapi.NullableInt32 `json:"qosInactInt" yaml:"qosInactInt,omitempty"`
	ResPrio       *ReservPriority       `json:"resPrio,omitempty" yaml:"resPrio,omitempty"`
	ServInfStatus *ServiceInfoStatus    `json:"servInfStatus,omitempty" yaml:"servInfStatus,omitempty"`
	SipForkInd    *SipForkingIndication `json:"sipForkInd,omitempty" yaml:"sipForkInd,omitempty"`
	// Contains an identity of a sponsor.
	SponId              *string                    `json:"sponId,omitempty" yaml:"sponId,omitempty"`
	SponStatus          *SponsoringStatus          `json:"sponStatus,omitempty" yaml:"sponStatus,omitempty"`
...
func (o *AppSessionContextUpdateData) GetAspId() string {
	if o == nil || openapi.IsNil(o.AspId) {
		var ret string
		return ret
	}
	return *o.AspId
...
func (o *AppSessionContextUpdateData) GetEvSubsc() EventsSubscReqDataRm {
	if o == nil || openapi.IsNil(o.EvSubsc.Get()) {
...
func (o *AppSessionContextUpdateData) GetMcpttId() string {
	if o == nil || openapi.IsNil(o.McpttId) {
		var ret string
		return ret
	}
	return *o.McpttId
...
func (o *AppSessionContextUpdateData) GetMcVideoId() string {
	if o == nil || openapi.IsNil(o.McVideoId) {
		var ret string
		return ret
	}
	return *o.McVideoId
...
func (o *AppSessionContextUpdateData) GetMedComponents() map[string]MediaComponentRm {
	if o == nil || openapi.IsNil(o.MedComponents) {
...
func (o *AppSessionContextUpdateData) GetMpsAction() MpsAction {
	if o == nil || openapi.IsNil(o.MpsAction) {
		var ret MpsAction
		return ret
	}
	return *o.MpsAction
...
func (o *AppSessionContextUpdateData) GetMpsId() string {
	if o == nil || openapi.IsNil(o.MpsId) {
		var ret string
		return ret
	}
	return *o.MpsId
...
func (o *AppSessionContextUpdateData) GetMcsId() string {
	if o == nil || openapi.IsNil(o.McsId) {
		var ret string
		return ret
	}
	return *o.McsId
...
func (o *AppSessionContextUpdateData) GetPreemptControlInfo() PreemptionControlInformationRm {
	if o == nil || openapi.IsNil(o.PreemptControlInfo) {
...
func (o *AppSessionContextUpdateData) GetQosDuration() int32 {
	if o == nil || openapi.IsNil(o.QosDuration.Get()) {
		var ret int32
		return ret
	}
...
// SetQosDuration gets a reference to the given openapi.NullableInt32 and assigns it to the QosDuration field.
...
func (o *AppSessionContextUpdateData) GetQosInactInt() int32 {
	if o == nil || openapi.IsNil(o.QosInactInt.Get()) {
		var ret int32
		return ret
	}
...
// SetQosInactInt gets a reference to the given openapi.NullableInt32 and assigns it to the QosInactInt field.
...
func (o *AppSessionContextUpdateData) GetServInfStatus() ServiceInfoStatus {
	if o == nil || openapi.IsNil(o.ServInfStatus) {
...
func (o *AppSessionContextUpdateData) GetSipForkInd() SipForkingIndication {
	if o == nil || openapi.IsNil(o.SipForkInd) {
...
func (o *AppSessionContextUpdateData) GetSponId() string {
	if o == nil || openapi.IsNil(o.SponId) {
		var ret string
		return ret
	}
	return *o.SponId
...
func (o *AppSessionContextUpdateData) GetSponStatus() SponsoringStatus {
	if o == nil || openapi.IsNil(o.SponStatus) {
...
func (o AppSessionContextUpdateData) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.McpttId) {
		toSerialize["mcpttId"] = o.McpttId
	}
	if !openapi.IsNil(o.McVideoId) {
		toSerialize["mcVideoId"] = o.McVideoId
	}
	if !openapi.IsNil(o.MedComponents) {
		toSerialize["medComponents"] = o.MedComponents
	}
	if !openapi.IsNil(o.MpsAction) {
		toSerialize["mpsAction"] = o.MpsAction
	}
	if !openapi.IsNil(o.MpsId) {
		toSerialize["mpsId"] = o.MpsId
	}
	if !openapi.IsNil(o.McsId) {
		toSerialize["mcsId"] = o.McsId
	}
	if !openapi.IsNil(o.PreemptControlInfo) {
	...
	if !openapi.IsNil(o.ServInfStatus) {
		toSerialize["servInfStatus"] = o.ServInfStatus
	}
	if !openapi.IsNil(o.SipForkInd) {
		toSerialize["sipForkInd"] = o.SipForkInd
	}
	if !openapi.IsNil(o.SponId) {
		toSerialize["sponId"] = o.SponId
	}
	if !openapi.IsNil(o.SponStatus) {
