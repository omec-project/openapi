...
type LCSMobileOriginatedSubscriptionDataAPI interface {
	...
	*/
	QueryLcsMoData(ctx context.Context, ueId string) ApiQueryLcsMoDataRequest

	// QueryLcsMoDataExecute executes the request
	//   @return LcsMoData
	QueryLcsMoDataExecute(r ApiQueryLcsMoDataRequest) (*models.LcsMoData, *http.Response, error)
}
...
type ApiQueryLcsMoDataRequest struct {
	ctx               context.Context
	ApiService        LCSMobileOriginatedSubscriptionDataAPI
	ueId              string
	fields            *[]string
...
func (r ApiQueryLcsMoDataRequest) Execute() (*models.LcsMoData, *http.Response, error) {
...
//
//	@return LcsMoData
func (a *LCSMobileOriginatedSubscriptionDataAPIService) QueryLcsMoDataExecute(r ApiQueryLcsMoDataRequest) (*models.LcsMoData, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    any
		formFiles           []formFile
		localVarReturnValue *models.LcsMoData
	)
