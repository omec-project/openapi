...
var _ openapi.MappedNullable = &AfRoutingRequirementRm{}
...
type AfRoutingRequirementRm struct {
	...
	SpVal         NullableSpatialValidityRm `json:"spVal" yaml:"spVal,omitempty"`
	...
	SimConnInd openapi.NullableBool `json:"simConnInd" yaml:"simConnInd,omitempty"`
...
func (o *AfRoutingRequirementRm) GetSpVal() SpatialValidityRm {
	if o == nil || openapi.IsNil(o.SpVal.Get()) {
...
func (o *AfRoutingRequirementRm) GetSimConnInd() bool {
	if o == nil || openapi.IsNil(o.SimConnInd.Get()) {
		var ret bool
		return ret
	}
...
// SetSimConnInd gets a reference to the given openapi.NullableBool and assigns it to the SimConnInd field.
...
func (o *AfRoutingRequirementRm) GetTfcCorreInfo() TrafficCorrelationInfo {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *AfRoutingRequirementRm) GetTfcCorreInfoOk() (*TrafficCorrelationInfo, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AfRoutingRequirementRm) HasTfcCorreInfo() bool {
