...
var _ openapi.MappedNullable = &RgAuthCtx{}
...
type RgAuthCtx struct {
	...
	AuthInd *bool   `json:"authInd,omitempty" yaml:"authInd,omitempty"`
}
...
func (o *RgAuthCtx) GetAuthInd() bool {
	if o == nil || openapi.IsNil(o.AuthInd) {
		var ret bool
		return ret
	}
	return *o.AuthInd
...
func (o RgAuthCtx) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["authResult"] = o.AuthResult
	if !openapi.IsNil(o.Supi) {
		toSerialize["supi"] = o.Supi
	}
	if !openapi.IsNil(o.AuthInd) {
