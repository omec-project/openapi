...
var _ openapi.MappedNullable = &RedundantPduSessionInformation{}

// RedundantPduSessionInformation Redundant PDU Session Information
type RedundantPduSessionInformation struct {
	Rsn              Rsn    `json:"rsn" yaml:"rsn"`
	PduSessionPairId *int32 `json:"pduSessionPairId,omitempty" yaml:"pduSessionPairId,omitempty"`
}
...
func (o *RedundantPduSessionInformation) GetPduSessionPairId() int32 {
	if o == nil || openapi.IsNil(o.PduSessionPairId) {
		var ret int32
		return ret
	}
...
func (o RedundantPduSessionInformation) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["rsn"] = o.Rsn
	if !openapi.IsNil(o.PduSessionPairId) {
