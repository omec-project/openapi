...
var _ openapi.MappedNullable = &LocContextData{}
...
type LocContextData struct {
	...
	AmfId              string               `json:"amfId" yaml:"amfId"`
	...
	LdrType LdrType `json:"ldrType" yaml:"ldrType"`
	// String providing an URI formatted according to RFC 3986.
	HgmlcCallBackURI string `json:"hgmlcCallBackURI" yaml:"hgmlcCallBackURI"`
	// LDR Reference.
	...
	EventReportMessage   EventReportMessage    `json:"eventReportMessage" yaml:"eventReportMessage"`
	EventReportingStatus *EventReportingStatus `json:"eventReportingStatus,omitempty" yaml:"eventReportingStatus,omitempty"`
	UeLocationInfo       *UELocationInfo       `json:"ueLocationInfo,omitempty" yaml:"ueLocationInfo,omitempty"`
...
func (o *LocContextData) GetEventReportingStatus() EventReportingStatus {
	if o == nil || openapi.IsNil(o.EventReportingStatus) {
...
func (o *LocContextData) GetUeLocationInfo() UELocationInfo {
	if o == nil || openapi.IsNil(o.UeLocationInfo) {
...
func (o *LocContextData) GetIndoorOutdoorInd() IndoorOutdoorInd {
...
// and a boolean to check if the value has been set.
func (o *LocContextData) GetIndoorOutdoorIndOk() (*IndoorOutdoorInd, bool) {
	if o == nil || openapi.IsNil(o.IndoorOutdoorInd) {
		return nil, false
	}
...
func (o *LocContextData) HasIndoorOutdoorInd() bool {
	if o != nil && !openapi.IsNil(o.IndoorOutdoorInd) {
		return true
	}
...
func (o *LocContextData) SetIndoorOutdoorInd(v IndoorOutdoorInd) {
	o.IndoorOutdoorInd = &v
}

// GetLosNlosMeasureInd returns the LosNlosMeasureInd field value if set, zero value otherwise.
func (o *LocContextData) GetLosNlosMeasureInd() LosNlosMeasureInd {
...
// and a boolean to check if the value has been set.
func (o *LocContextData) GetLosNlosMeasureIndOk() (*LosNlosMeasureInd, bool) {
	if o == nil || openapi.IsNil(o.LosNlosMeasureInd) {
		return nil, false
	}
...
func (o *LocContextData) HasLosNlosMeasureInd() bool {
	if o != nil && !openapi.IsNil(o.LosNlosMeasureInd) {
		return true
	}
...
func (o *LocContextData) SetLosNlosMeasureInd(v LosNlosMeasureInd) {
	o.LosNlosMeasureInd = &v
}

// GetUpCumEvtRptCriteria returns the UpCumEvtRptCriteria field value if set, zero value otherwise.
func (o *LocContextData) GetUpCumEvtRptCriteria() UpCumEvtRptCriteria {
...
// and a boolean to check if the value has been set.
func (o *LocContextData) GetUpCumEvtRptCriteriaOk() (*UpCumEvtRptCriteria, bool) {
	if o == nil || openapi.IsNil(o.UpCumEvtRptCriteria) {
		return nil, false
	}
...
func (o *LocContextData) HasUpCumEvtRptCriteria() bool {
	if o != nil && !openapi.IsNil(o.UpCumEvtRptCriteria) {
		return true
	}
...
func (o *LocContextData) SetUpCumEvtRptCriteria(v UpCumEvtRptCriteria) {
	o.UpCumEvtRptCriteria = &v
}

func (o LocContextData) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.EventReportingStatus) {
		toSerialize["eventReportingStatus"] = o.EventReportingStatus
	}
	if !openapi.IsNil(o.UeLocationInfo) {
