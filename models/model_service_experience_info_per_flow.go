...
var _ openapi.MappedNullable = &ServiceExperienceInfoPerFlow{}
...
type ServiceExperienceInfoPerFlow struct {
	SvcExprc  *SvcExperience `json:"svcExprc,omitempty" yaml:"svcExprc,omitempty"`
	TimeIntev *TimeWindow    `json:"timeIntev,omitempty" yaml:"timeIntev,omitempty"`
	...
	EthTrafficFilter *EthFlowDescription `json:"ethTrafficFilter,omitempty" yaml:"ethTrafficFilter,omitempty"`
}
...
func (o *ServiceExperienceInfoPerFlow) GetSvcExprc() SvcExperience {
	if o == nil || openapi.IsNil(o.SvcExprc) {
...
func (o *ServiceExperienceInfoPerFlow) GetTimeIntev() TimeWindow {
	if o == nil || openapi.IsNil(o.TimeIntev) {
		var ret TimeWindow
		return ret
	}
	return *o.TimeIntev
...
func (o ServiceExperienceInfoPerFlow) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.SvcExprc) {
		toSerialize["svcExprc"] = o.SvcExprc
	}
	if !openapi.IsNil(o.TimeIntev) {
