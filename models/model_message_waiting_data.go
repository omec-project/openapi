...
var _ openapi.MappedNullable = &MessageWaitingData{}

// MessageWaitingData Message Waiting Data list.
type MessageWaitingData struct {
	MwdList []SmscData `json:"mwdList,omitempty" yaml:"mwdList,omitempty"`
}
...
func (o *MessageWaitingData) GetMwdList() []SmscData {
	if o == nil || openapi.IsNil(o.MwdList) {
		var ret []SmscData
		return ret
	}
	return o.MwdList
...
func (o MessageWaitingData) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.MwdList) {
