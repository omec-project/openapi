...
var _ openapi.MappedNullable = &UpfInformation{}
...
type UpfInformation struct {
	...
	UpfAddr *AddrFqdn `json:"upfAddr,omitempty" yaml:"upfAddr,omitempty"`
}
...
func (o *UpfInformation) GetUpfAddr() AddrFqdn {
	if o == nil || openapi.IsNil(o.UpfAddr) {
		var ret AddrFqdn
		return ret
	}
	return *o.UpfAddr
...
func (o UpfInformation) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.UpfId) {
		toSerialize["upfId"] = o.UpfId
	}
	if !openapi.IsNil(o.UpfAddr) {
