...
var _ openapi.MappedNullable = &EcRestriction{}
...
type EcRestriction struct {
	...
	PlmnEcInfos []PlmnEcInfo `json:"plmnEcInfos,omitempty" yaml:"plmnEcInfos,omitempty"`
...
func (o *EcRestriction) GetPlmnEcInfos() []PlmnEcInfo {
	if o == nil || openapi.IsNil(o.PlmnEcInfos) {
		var ret []PlmnEcInfo
		return ret
	}
...
func (o EcRestriction) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["afInstanceId"] = o.AfInstanceId
	toSerialize["referenceId"] = o.ReferenceId
	if !openapi.IsNil(o.PlmnEcInfos) {
