...
var _ openapi.MappedNullable = &PerUeAttribute{}

// PerUeAttribute UE application data collected per UE.
type PerUeAttribute struct {
	UeDest *LocationArea5G `json:"ueDest,omitempty" yaml:"ueDest,omitempty"`
	Route  *string         `json:"route,omitempty" yaml:"route,omitempty"`
	// String representing a bit rate; the prefixes follow the standard symbols from The International System of Units, and represent x1000 multipliers, with the exception that prefix \"K\" is used to represent the standard symbol \"k\".
	AvgSpeed *string `json:"avgSpeed,omitempty" yaml:"avgSpeed,omitempty" validate:"regexp=^\\\\d+(\\\\.\\\\d+)? (bps|Kbps|Mbps|Gbps|Tbps)$"`
	// string with format 'date-time' as defined in OpenAPI.
	TimeOfArrival *time.Time `json:"timeOfArrival,omitempty" yaml:"timeOfArrival,omitempty"`
}
...
func (o *PerUeAttribute) GetUeDest() LocationArea5G {
	if o == nil || openapi.IsNil(o.UeDest) {
...
func (o *PerUeAttribute) GetRoute() string {
	if o == nil || openapi.IsNil(o.Route) {
		var ret string
		return ret
	}
	return *o.Route
...
func (o *PerUeAttribute) GetAvgSpeed() string {
	if o == nil || openapi.IsNil(o.AvgSpeed) {
		var ret string
		return ret
	}
	return *o.AvgSpeed
...
func (o *PerUeAttribute) GetTimeOfArrival() time.Time {
	if o == nil || openapi.IsNil(o.TimeOfArrival) {
		var ret time.Time
		return ret
	}
...
func (o PerUeAttribute) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.UeDest) {
		toSerialize["ueDest"] = o.UeDest
	}
	if !openapi.IsNil(o.Route) {
		toSerialize["route"] = o.Route
	}
	if !openapi.IsNil(o.AvgSpeed) {
		toSerialize["avgSpeed"] = o.AvgSpeed
	}
	if !openapi.IsNil(o.TimeOfArrival) {
