...
var _ openapi.MappedNullable = &CipherResponseData{}

// CipherResponseData Information within Ciphering Key Data Response.
type CipherResponseData struct {
	DataAvailability DataAvailability `json:"dataAvailability" yaml:"dataAvailability"`
}
...
func (o CipherResponseData) ToMap() (map[string]any, error) {
