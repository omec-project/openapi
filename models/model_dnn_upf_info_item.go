...
var _ openapi.MappedNullable = &DnnUpfInfoItem{}
...
type DnnUpfInfoItem struct {
	...
	NatedIpv4AddressRanges []Ipv4AddressRange `json:"natedIpv4AddressRanges,omitempty" yaml:"natedIpv4AddressRanges,omitempty"`
	NatedIpv6PrefixRanges  []Ipv6PrefixRange  `json:"natedIpv6PrefixRanges,omitempty" yaml:"natedIpv6PrefixRanges,omitempty"`
	Ipv4IndexList          []IpIndex          `json:"ipv4IndexList,omitempty" yaml:"ipv4IndexList,omitempty"`
	Ipv6IndexList          []IpIndex          `json:"ipv6IndexList,omitempty" yaml:"ipv6IndexList,omitempty"`
	...
	DnaiNwInstanceList   *map[string]string     `json:"dnaiNwInstanceList,omitempty" yaml:"dnaiNwInstanceList,omitempty"`
...
func (o *DnnUpfInfoItem) GetNatedIpv4AddressRanges() []Ipv4AddressRange {
	if o == nil || openapi.IsNil(o.NatedIpv4AddressRanges) {
		var ret []Ipv4AddressRange
		return ret
	}
...
func (o *DnnUpfInfoItem) GetNatedIpv6PrefixRanges() []Ipv6PrefixRange {
	if o == nil || openapi.IsNil(o.NatedIpv6PrefixRanges) {
		var ret []Ipv6PrefixRange
		return ret
	}
...
func (o *DnnUpfInfoItem) GetIpv4IndexList() []IpIndex {
	if o == nil || openapi.IsNil(o.Ipv4IndexList) {
		var ret []IpIndex
		return ret
	}
...
func (o *DnnUpfInfoItem) GetIpv6IndexList() []IpIndex {
	if o == nil || openapi.IsNil(o.Ipv6IndexList) {
		var ret []IpIndex
		return ret
	}
...
func (o *DnnUpfInfoItem) GetDnaiNwInstanceList() map[string]string {
	if o == nil || openapi.IsNil(o.DnaiNwInstanceList) {
...
func (o DnnUpfInfoItem) ToMap() (map[string]any, error) {
