...
var _ openapi.MappedNullable = &AllowedSnssai{}
...
type AllowedSnssai struct {
	AllowedSnssai      Snssai           `json:"allowedSnssai" yaml:"allowedSnssai"`
	NsiInformationList []NsiInformation `json:"nsiInformationList,omitempty" yaml:"nsiInformationList,omitempty"`
...
func (o *AllowedSnssai) GetNsiInformationList() []NsiInformation {
	if o == nil || openapi.IsNil(o.NsiInformationList) {
...
func (o AllowedSnssai) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["allowedSnssai"] = o.AllowedSnssai
	if !openapi.IsNil(o.NsiInformationList) {
