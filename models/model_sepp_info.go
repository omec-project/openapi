...
var _ openapi.MappedNullable = &SeppInfo{}

// SeppInfo Information of a SEPP Instance
type SeppInfo struct {
	SeppPrefix *string `json:"seppPrefix,omitempty" yaml:"seppPrefix,omitempty"`
	// Port numbers for HTTP and HTTPS. The key of the map shall be \"http\" or \"https\".
	SeppPorts      *map[string]int32 `json:"seppPorts,omitempty" yaml:"seppPorts,omitempty"`
	...
	N32Purposes []N32Purpose `json:"n32Purposes,omitempty" yaml:"n32Purposes,omitempty"`
}
...
func (o *SeppInfo) GetSeppPrefix() string {
	if o == nil || openapi.IsNil(o.SeppPrefix) {
		var ret string
		return ret
	}
	return *o.SeppPrefix
...
func (o *SeppInfo) GetSeppPorts() map[string]int32 {
	if o == nil || openapi.IsNil(o.SeppPorts) {
...
func (o *SeppInfo) GetN32Purposes() []N32Purpose {
	if o == nil || openapi.IsNil(o.N32Purposes) {
		var ret []N32Purpose
		return ret
	}
...
func (o SeppInfo) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.SeppPrefix) {
		toSerialize["seppPrefix"] = o.SeppPrefix
	}
	if !openapi.IsNil(o.SeppPorts) {
	...
	if !openapi.IsNil(o.N32Purposes) {
