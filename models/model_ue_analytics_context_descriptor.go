...
var _ openapi.MappedNullable = &UeAnalyticsContextDescriptor{}
...
type UeAnalyticsContextDescriptor struct {
	...
	AnaTypes []NwdafEvent `json:"anaTypes" yaml:"anaTypes"`
}
...
func (o UeAnalyticsContextDescriptor) ToMap() (map[string]any, error) {
