...
type EventExposureDataDocumentAPI interface {
	...
	*/
	QueryEEData(ctx context.Context, ueId string) ApiQueryEEDataRequest

	// QueryEEDataExecute executes the request
	//   @return EeProfileData
	QueryEEDataExecute(r ApiQueryEEDataRequest) (*models.EeProfileData, *http.Response, error)
}
...
type ApiQueryEEDataRequest struct {
	ctx               context.Context
	ApiService        EventExposureDataDocumentAPI
	ueId              string
	fields            *[]string
...
func (r ApiQueryEEDataRequest) Execute() (*models.EeProfileData, *http.Response, error) {
...
//
//	@return EeProfileData
func (a *EventExposureDataDocumentAPIService) QueryEEDataExecute(r ApiQueryEEDataRequest) (*models.EeProfileData, *http.Response, error) {
	var (
