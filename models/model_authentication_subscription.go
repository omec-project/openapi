...
var _ openapi.MappedNullable = &AuthenticationSubscription{}

// AuthenticationSubscription A UE's authentication data.
type AuthenticationSubscription struct {
	AuthenticationMethod          AuthMethod      `json:"authenticationMethod" yaml:"authenticationMethod"`
	EncPermanentKey               *string         `json:"encPermanentKey,omitempty" yaml:"encPermanentKey,omitempty"`
	ProtectionParameterId         *string         `json:"protectionParameterId,omitempty" yaml:"protectionParameterId,omitempty"`
	SequenceNumber                *SequenceNumber `json:"sequenceNumber,omitempty" yaml:"sequenceNumber,omitempty"`
	AuthenticationManagementField *string         `json:"authenticationManagementField,omitempty" yaml:"authenticationManagementField,omitempty" validate:"regexp=^[A-Fa-f0-9]{4}$"`
	AlgorithmId                   *string         `json:"algorithmId,omitempty" yaml:"algorithmId,omitempty"`
	EncOpcKey                     *string         `json:"encOpcKey,omitempty" yaml:"encOpcKey,omitempty"`
	EncTopcKey                    *string         `json:"encTopcKey,omitempty" yaml:"encTopcKey,omitempty"`
	VectorGenerationInHss         *bool           `json:"vectorGenerationInHss,omitempty" yaml:"vectorGenerationInHss,omitempty"`
	// Identifier of a group of NFs.
	HssGroupId          *string     `json:"hssGroupId,omitempty" yaml:"hssGroupId,omitempty"`
	N5gcAuthMethod      *AuthMethod `json:"n5gcAuthMethod,omitempty" yaml:"n5gcAuthMethod,omitempty"`
	RgAuthenticationInd *bool       `json:"rgAuthenticationInd,omitempty" yaml:"rgAuthenticationInd,omitempty"`
	...
	AkmaAllowed        *bool   `json:"akmaAllowed,omitempty" yaml:"akmaAllowed,omitempty"`
	RoutingId          *string `json:"routingId,omitempty" yaml:"routingId,omitempty" validate:"regexp=^[0-9]{1,4}$"`
	Var5gKeyHierarSupp *bool   `json:"5gKeyHierarSupp,omitempty" yaml:"5gKeyHierarSupp,omitempty"`
}
...
func NewAuthenticationSubscription(authenticationMethod AuthMethod) *AuthenticationSubscription {
	...
	var var5gKeyHierarSupp bool = true
	this.Var5gKeyHierarSupp = &var5gKeyHierarSupp
	return &this
}
...
func (o *AuthenticationSubscription) GetEncPermanentKey() string {
	if o == nil || openapi.IsNil(o.EncPermanentKey) {
		var ret string
		return ret
	}
...
func (o *AuthenticationSubscription) GetProtectionParameterId() string {
	if o == nil || openapi.IsNil(o.ProtectionParameterId) {
		var ret string
		return ret
	}
...
func (o *AuthenticationSubscription) GetSequenceNumber() SequenceNumber {
	if o == nil || openapi.IsNil(o.SequenceNumber) {
...
func (o *AuthenticationSubscription) GetAuthenticationManagementField() string {
	if o == nil || openapi.IsNil(o.AuthenticationManagementField) {
		var ret string
		return ret
	}
...
func (o *AuthenticationSubscription) GetAlgorithmId() string {
	if o == nil || openapi.IsNil(o.AlgorithmId) {
		var ret string
		return ret
	}
...
func (o *AuthenticationSubscription) GetEncOpcKey() string {
	if o == nil || openapi.IsNil(o.EncOpcKey) {
		var ret string
		return ret
	}
	return *o.EncOpcKey
...
func (o *AuthenticationSubscription) GetEncTopcKey() string {
	if o == nil || openapi.IsNil(o.EncTopcKey) {
		var ret string
		return ret
	}
	return *o.EncTopcKey
...
func (o *AuthenticationSubscription) GetVectorGenerationInHss() bool {
	if o == nil || openapi.IsNil(o.VectorGenerationInHss) {
		var ret bool
		return ret
	}
...
func (o *AuthenticationSubscription) GetN5gcAuthMethod() AuthMethod {
	if o == nil || openapi.IsNil(o.N5gcAuthMethod) {
		var ret AuthMethod
		return ret
	}
...
func (o *AuthenticationSubscription) GetRgAuthenticationInd() bool {
	if o == nil || openapi.IsNil(o.RgAuthenticationInd) {
		var ret bool
		return ret
	}
...
func (o *AuthenticationSubscription) GetAkmaAllowed() bool {
	if o == nil || openapi.IsNil(o.AkmaAllowed) {
		var ret bool
		return ret
	}
...
// GetVar5gKeyHierarSupp returns the Var5gKeyHierarSupp field value if set, zero value otherwise.
func (o *AuthenticationSubscription) GetVar5gKeyHierarSupp() bool {
	if o == nil || openapi.IsNil(o.Var5gKeyHierarSupp) {
		var ret bool
		return ret
	}
	return *o.Var5gKeyHierarSupp
}

// GetVar5gKeyHierarSuppOk returns a tuple with the Var5gKeyHierarSupp field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AuthenticationSubscription) GetVar5gKeyHierarSuppOk() (*bool, bool) {
	if o == nil || openapi.IsNil(o.Var5gKeyHierarSupp) {
		return nil, false
	}
	return o.Var5gKeyHierarSupp, true
}

// HasVar5gKeyHierarSupp returns a boolean if a field has been set.
func (o *AuthenticationSubscription) HasVar5gKeyHierarSupp() bool {
	if o != nil && !openapi.IsNil(o.Var5gKeyHierarSupp) {
		return true
	}
...
// SetVar5gKeyHierarSupp gets a reference to the given bool and assigns it to the Var5gKeyHierarSupp field.
func (o *AuthenticationSubscription) SetVar5gKeyHierarSupp(v bool) {
	o.Var5gKeyHierarSupp = &v
}

func (o AuthenticationSubscription) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["authenticationMethod"] = o.AuthenticationMethod
	if !openapi.IsNil(o.EncPermanentKey) {
		toSerialize["encPermanentKey"] = o.EncPermanentKey
	}
	if !openapi.IsNil(o.ProtectionParameterId) {
		toSerialize["protectionParameterId"] = o.ProtectionParameterId
	}
	if !openapi.IsNil(o.SequenceNumber) {
		toSerialize["sequenceNumber"] = o.SequenceNumber
	}
	if !openapi.IsNil(o.AuthenticationManagementField) {
		toSerialize["authenticationManagementField"] = o.AuthenticationManagementField
	}
	if !openapi.IsNil(o.AlgorithmId) {
		toSerialize["algorithmId"] = o.AlgorithmId
	}
	if !openapi.IsNil(o.EncOpcKey) {
		toSerialize["encOpcKey"] = o.EncOpcKey
	}
	if !openapi.IsNil(o.EncTopcKey) {
		toSerialize["encTopcKey"] = o.EncTopcKey
	}
	if !openapi.IsNil(o.VectorGenerationInHss) {
