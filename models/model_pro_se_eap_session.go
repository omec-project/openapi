...
var _ openapi.MappedNullable = &ProSeEapSession{}
...
type ProSeEapSession struct {
	...
	KnrProSe *string `json:"knrProSe,omitempty" yaml:"knrProSe,omitempty" validate:"regexp=[A-Fa-f0-9]{64}"`
	// A map(list of key-value pairs) where member serves as key
	Links      map[string]LinksValueSchema `json:"_links,omitempty" yaml:"_links,omitempty"`
	AuthResult *AuthResult                 `json:"authResult,omitempty" yaml:"authResult,omitempty"`
	...
	// contains an Nonce2
	Nonce2 openapi.NullableString `json:"nonce2" yaml:"nonce2,omitempty"`
	...
	Var5gPrukId *string `json:"5gPrukId,omitempty" yaml:"5gPrukId,omitempty" validate:"regexp=^rid[0-9]{1,4}\\\\.pid[0-9a-fA-F]+\\\\@prose-cp\\\\.5gc\\\\.mnc[0-9]{2,3}\\\\.mcc[0-9]{3}\\\\.3gppnetwork\\\\.org$"`
}
...
func NewProSeEapSession(eapPayload openapi.NullableString) *ProSeEapSession {
...
func (o *ProSeEapSession) GetKnrProSe() string {
	if o == nil || openapi.IsNil(o.KnrProSe) {
		var ret string
		return ret
	}
	return *o.KnrProSe
...
func (o *ProSeEapSession) GetLinks() map[string]LinksValueSchema {
	if o == nil || openapi.IsNil(o.Links) {
...
func (o *ProSeEapSession) GetAuthResult() AuthResult {
	if o == nil || openapi.IsNil(o.AuthResult) {
		var ret AuthResult
		return ret
	}
	return *o.AuthResult
...
func (o *ProSeEapSession) GetNonce2() string {
	if o == nil || openapi.IsNil(o.Nonce2.Get()) {
		var ret string
		return ret
	}
	return *o.Nonce2.Get()
...
// SetNonce2 gets a reference to the given openapi.NullableString and assigns it to the Nonce2 field.
...
func (o *ProSeEapSession) GetVar5gPrukId() string {
	if o == nil || openapi.IsNil(o.Var5gPrukId) {
		var ret string
		return ret
	}
...
func (o ProSeEapSession) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["eapPayload"] = o.EapPayload.Get()
	if !openapi.IsNil(o.KnrProSe) {
		toSerialize["knrProSe"] = o.KnrProSe
	}
	if !openapi.IsNil(o.Links) {
		toSerialize["_links"] = o.Links
	}
	if !openapi.IsNil(o.AuthResult) {
	...
	if !openapi.IsNil(o.Var5gPrukId) {
