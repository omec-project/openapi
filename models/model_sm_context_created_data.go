...
var _ openapi.MappedNullable = &SmContextCreatedData{}
...
func (o *SmContextCreatedData) GetUdmGroupId() string {
...
// and a boolean to check if the value has been set.
func (o *SmContextCreatedData) GetUdmGroupIdOk() (*string, bool) {
	if o == nil || openapi.IsNil(o.UdmGroupId) {
		return nil, false
	}
...
func (o *SmContextCreatedData) HasUdmGroupId() bool {
	if o != nil && !openapi.IsNil(o.UdmGroupId) {
		return true
	}
...
func (o *SmContextCreatedData) SetUdmGroupId(v string) {
	o.UdmGroupId = &v
}

// GetPcfGroupId returns the PcfGroupId field value if set, zero value otherwise.
func (o *SmContextCreatedData) GetPcfGroupId() string {
...
// and a boolean to check if the value has been set.
func (o *SmContextCreatedData) GetPcfGroupIdOk() (*string, bool) {
	if o == nil || openapi.IsNil(o.PcfGroupId) {
		return nil, false
	}
...
func (o *SmContextCreatedData) HasPcfGroupId() bool {
	if o != nil && !openapi.IsNil(o.PcfGroupId) {
		return true
	}
...
func (o *SmContextCreatedData) SetPcfGroupId(v string) {
	o.PcfGroupId = &v
}

func (o SmContextCreatedData) ToMap() (map[string]any, error) {
