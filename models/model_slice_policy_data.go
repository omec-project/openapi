...
var _ openapi.MappedNullable = &SlicePolicyData{}
...
type SlicePolicyData struct {
	...
	MbrUl *string `json:"mbrUl,omitempty" yaml:"mbrUl,omitempty" validate:"regexp=^\\\\d+(\\\\.\\\\d+)? (bps|Kbps|Mbps|Gbps|Tbps)$"`
	// String representing a bit rate; the prefixes follow the standard symbols from The International System of Units, and represent x1000 multipliers, with the exception that prefix \"K\" is used to represent the standard symbol \"k\".
	MbrDl *string `json:"mbrDl,omitempty" yaml:"mbrDl,omitempty" validate:"regexp=^\\\\d+(\\\\.\\\\d+)? (bps|Kbps|Mbps|Gbps|Tbps)$"`
	// String representing a bit rate; the prefixes follow the standard symbols from The International System of Units, and represent x1000 multipliers, with the exception that prefix \"K\" is used to represent the standard symbol \"k\".
	RemainMbrUl *string `json:"remainMbrUl,omitempty" yaml:"remainMbrUl,omitempty" validate:"regexp=^\\\\d+(\\\\.\\\\d+)? (bps|Kbps|Mbps|Gbps|Tbps)$"`
	// String representing a bit rate; the prefixes follow the standard symbols from The International System of Units, and represent x1000 multipliers, with the exception that prefix \"K\" is used to represent the standard symbol \"k\".
	RemainMbrDl *string `json:"remainMbrDl,omitempty" yaml:"remainMbrDl,omitempty" validate:"regexp=^\\\\d+(\\\\.\\\\d+)? (bps|Kbps|Mbps|Gbps|Tbps)$"`
...
func (o *SlicePolicyData) GetMbrUl() string {
	if o == nil || openapi.IsNil(o.MbrUl) {
		var ret string
		return ret
	}
	return *o.MbrUl
...
func (o *SlicePolicyData) GetMbrDl() string {
	if o == nil || openapi.IsNil(o.MbrDl) {
		var ret string
		return ret
	}
	return *o.MbrDl
...
func (o *SlicePolicyData) GetRemainMbrUl() string {
	if o == nil || openapi.IsNil(o.RemainMbrUl) {
		var ret string
		return ret
	}
...
func (o *SlicePolicyData) GetRemainMbrDl() string {
	if o == nil || openapi.IsNil(o.RemainMbrDl) {
		var ret string
		return ret
	}
...
func (o SlicePolicyData) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.MbrUl) {
		toSerialize["mbrUl"] = o.MbrUl
	}
	if !openapi.IsNil(o.MbrDl) {
		toSerialize["mbrDl"] = o.MbrDl
	}
	if !openapi.IsNil(o.RemainMbrUl) {
		toSerialize["remainMbrUl"] = o.RemainMbrUl
	}
	if !openapi.IsNil(o.RemainMbrDl) {
