...
var _ openapi.MappedNullable = &Trigger{}

// Trigger struct for Trigger
type Trigger struct {
	TriggerType     *TriggerType    `json:"triggerType,omitempty" yaml:"triggerType,omitempty"`
	TriggerCategory TriggerCategory `json:"triggerCategory" yaml:"triggerCategory"`
	// indicating a time in seconds.
	TimeLimit *int32 `json:"timeLimit,omitempty" yaml:"timeLimit,omitempty"`
	// Integer where the allowed values correspond to the value range of an unsigned 32-bit integer.
	VolumeLimit *int32 `json:"volumeLimit,omitempty" yaml:"volumeLimit,omitempty"`
	// Integer where the allowed values correspond to the value range of an unsigned 64-bit integer.
	VolumeLimit64 *int32 `json:"volumeLimit64,omitempty" yaml:"volumeLimit64,omitempty"`
	// Integer where the allowed values correspond to the value range of an unsigned 32-bit integer.
	EventLimit *int32 `json:"eventLimit,omitempty" yaml:"eventLimit,omitempty"`
	// Integer where the allowed values correspond to the value range of an unsigned 32-bit integer.
	MaxNumberOfccc *int32 `json:"maxNumberOfccc,omitempty" yaml:"maxNumberOfccc,omitempty"`
	// string with format 'date-time' as defined in OpenAPI.
	TariffTimeChange *time.Time `json:"tariffTimeChange,omitempty" yaml:"tariffTimeChange,omitempty"`
}
...
func (o *Trigger) GetTriggerType() TriggerType {
	if o == nil || openapi.IsNil(o.TriggerType) {
		var ret TriggerType
		return ret
	}
...
func (o *Trigger) GetTimeLimit() int32 {
	if o == nil || openapi.IsNil(o.TimeLimit) {
		var ret int32
		return ret
	}
	return *o.TimeLimit
...
func (o *Trigger) GetVolumeLimit() int32 {
	if o == nil || openapi.IsNil(o.VolumeLimit) {
		var ret int32
		return ret
	}
...
func (o *Trigger) GetVolumeLimit64() int32 {
	if o == nil || openapi.IsNil(o.VolumeLimit64) {
		var ret int32
		return ret
	}
...
func (o *Trigger) GetEventLimit() int32 {
	if o == nil || openapi.IsNil(o.EventLimit) {
		var ret int32
		return ret
	}
	return *o.EventLimit
...
func (o *Trigger) GetMaxNumberOfccc() int32 {
	if o == nil || openapi.IsNil(o.MaxNumberOfccc) {
		var ret int32
		return ret
	}
...
func (o *Trigger) GetTariffTimeChange() time.Time {
	if o == nil || openapi.IsNil(o.TariffTimeChange) {
		var ret time.Time
		return ret
	}
