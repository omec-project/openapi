...
var _ openapi.MappedNullable = &NfGroupListCond{}
...
type NfGroupListCond struct {
	...
	NfGroupIdList []string `json:"nfGroupIdList" yaml:"nfGroupIdList"`
}
...
func (o NfGroupListCond) ToMap() (map[string]any, error) {
