...
var _ openapi.MappedNullable = &SuciInfo{}

// SuciInfo SUCI information containing Routing Indicator and Home Network Public Key ID
type SuciInfo struct {
	RoutingInds  []string `json:"routingInds,omitempty" yaml:"routingInds,omitempty"`
	HNwPubKeyIds []int32  `json:"hNwPubKeyIds,omitempty" yaml:"hNwPubKeyIds,omitempty"`
}
...
func (o *SuciInfo) GetRoutingInds() []string {
	if o == nil || openapi.IsNil(o.RoutingInds) {
		var ret []string
		return ret
	}
...
func (o *SuciInfo) GetHNwPubKeyIds() []int32 {
	if o == nil || openapi.IsNil(o.HNwPubKeyIds) {
		var ret []int32
		return ret
	}
...
func (o SuciInfo) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.RoutingInds) {
		toSerialize["routingInds"] = o.RoutingInds
	}
	if !openapi.IsNil(o.HNwPubKeyIds) {
