...
var _ openapi.MappedNullable = &SessionRule{}

// SessionRule Contains session level policy information.
type SessionRule struct {
	AuthSessAmbr *Ambr                 `json:"authSessAmbr,omitempty" yaml:"authSessAmbr,omitempty"`
...
func (o *SessionRule) GetAuthSessAmbr() Ambr {
	if o == nil || openapi.IsNil(o.AuthSessAmbr) {
		var ret Ambr
		return ret
	}
...
func (o *SessionRule) GetAuthDefQos() AuthorizedDefaultQos {
	if o == nil || openapi.IsNil(o.AuthDefQos) {
...
func (o *SessionRule) GetRefUmData() string {
	if o == nil || openapi.IsNil(o.RefUmData.Get()) {
		var ret string
		return ret
	}
...
// SetRefUmData gets a reference to the given openapi.NullableString and assigns it to the RefUmData field.
...
func (o *SessionRule) GetRefUmN3gData() string {
	if o == nil || openapi.IsNil(o.RefUmN3gData.Get()) {
		var ret string
		return ret
	}
...
// SetRefUmN3gData gets a reference to the given openapi.NullableString and assigns it to the RefUmN3gData field.
...
func (o SessionRule) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.AuthSessAmbr) {
		toSerialize["authSessAmbr"] = o.AuthSessAmbr
	}
	if !openapi.IsNil(o.AuthDefQos) {
