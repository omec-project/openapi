...
var _ openapi.MappedNullable = &LteV2xAuth{}

// LteV2xAuth Contains LTE V2X services authorized information.
type LteV2xAuth struct {
	VehicleUeAuth    *UeAuth `json:"vehicleUeAuth,omitempty" yaml:"vehicleUeAuth,omitempty"`
	PedestrianUeAuth *UeAuth `json:"pedestrianUeAuth,omitempty" yaml:"pedestrianUeAuth,omitempty"`
}
...
func (o *LteV2xAuth) GetVehicleUeAuth() UeAuth {
	if o == nil || openapi.IsNil(o.VehicleUeAuth) {
		var ret UeAuth
		return ret
	}
...
func (o *LteV2xAuth) GetPedestrianUeAuth() UeAuth {
	if o == nil || openapi.IsNil(o.PedestrianUeAuth) {
		var ret UeAuth
		return ret
	}
...
func (o LteV2xAuth) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.VehicleUeAuth) {
		toSerialize["vehicleUeAuth"] = o.VehicleUeAuth
	}
	if !openapi.IsNil(o.PedestrianUeAuth) {
