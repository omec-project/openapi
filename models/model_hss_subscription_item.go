...
var _ openapi.MappedNullable = &HssSubscriptionItem{}
...
type HssSubscriptionItem struct {
	...
	HssInstanceId string `json:"hssInstanceId" yaml:"hssInstanceId"`
...
func (o HssSubscriptionItem) ToMap() (map[string]any, error) {
