...
var _ openapi.MappedNullable = &SmfRegistrationModification{}
...
type SmfRegistrationModification struct {
	...
	PgwFqdn  openapi.NullableAny `json:"pgwFqdn" yaml:"pgwFqdn,omitempty"`
}
...
// GetPgwFqdn returns the PgwFqdn field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *SmfRegistrationModification) GetPgwFqdn() any {
	if o == nil || openapi.IsNil(o.PgwFqdn.Get()) {
		var ret any
		return ret
	}
	return *o.PgwFqdn.Get()
}

// GetPgwFqdnOk returns a tuple with the PgwFqdn field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *SmfRegistrationModification) GetPgwFqdnOk() (*any, bool) {
	if o == nil {
		return nil, false
	}
	return o.PgwFqdn.Get(), o.PgwFqdn.IsSet()
}

// HasPgwFqdn returns a boolean if a field has been set.
func (o *SmfRegistrationModification) HasPgwFqdn() bool {
	if o != nil && o.PgwFqdn.IsSet() {
		return true
	}
...
// SetPgwFqdn gets a reference to the given openapi.NullableAny and assigns it to the PgwFqdn field.
func (o *SmfRegistrationModification) SetPgwFqdn(v any) {
	o.PgwFqdn.Set(&v)
}

// SetPgwFqdnNil sets the value for PgwFqdn to be an explicit nil
func (o *SmfRegistrationModification) SetPgwFqdnNil() {
	o.PgwFqdn.Set(nil)
}

// UnsetPgwFqdn ensures that no value is present for PgwFqdn, not even an explicit nil
func (o *SmfRegistrationModification) UnsetPgwFqdn() {
	o.PgwFqdn.Unset()
}

func (o SmfRegistrationModification) ToMap() (map[string]any, error) {
	...
	if o.PgwFqdn.IsSet() {
		toSerialize["pgwFqdn"] = o.PgwFqdn.Get()
	}
