...
var _ openapi.MappedNullable = &EnableGroupReachabilityReqData{}
...
type EnableGroupReachabilityReqData struct {
	UeInfoList []UeInfo `json:"ueInfoList" yaml:"ueInfoList"`
	Tmgi       Tmgi     `json:"tmgi" yaml:"tmgi"`
	// String providing an URI formatted according to RFC 3986.
	ReachabilityNotifyUri  *string              `json:"reachabilityNotifyUri,omitempty" yaml:"reachabilityNotifyUri,omitempty"`
	MbsServiceAreaInfoList []MbsServiceAreaInfo `json:"mbsServiceAreaInfoList,omitempty" yaml:"mbsServiceAreaInfoList,omitempty"`
...
func (o *EnableGroupReachabilityReqData) GetReachabilityNotifyUri() string {
	if o == nil || openapi.IsNil(o.ReachabilityNotifyUri) {
		var ret string
		return ret
	}
...
func (o *EnableGroupReachabilityReqData) GetMbsServiceAreaInfoList() []MbsServiceAreaInfo {
	if o == nil || openapi.IsNil(o.MbsServiceAreaInfoList) {
...
func (o EnableGroupReachabilityReqData) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["ueInfoList"] = o.UeInfoList
	toSerialize["tmgi"] = o.Tmgi
	if !openapi.IsNil(o.ReachabilityNotifyUri) {
		toSerialize["reachabilityNotifyUri"] = o.ReachabilityNotifyUri
	}
	if !openapi.IsNil(o.MbsServiceAreaInfoList) {
