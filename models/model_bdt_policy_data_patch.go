...
var _ openapi.MappedNullable = &BdtPolicyDataPatch{}
...
type BdtPolicyDataPatch struct {
	...
	SelTransPolicyId int32 `json:"selTransPolicyId" yaml:"selTransPolicyId"`
}
...
func (o BdtPolicyDataPatch) ToMap() (map[string]any, error) {
