...
var _ openapi.MappedNullable = &UeN1N2InfoSubscriptionCreateData{}
...
type UeN1N2InfoSubscriptionCreateData struct {
	...
	N2NotifyCallbackUri *string         `json:"n2NotifyCallbackUri,omitempty" yaml:"n2NotifyCallbackUri,omitempty"`
	N1MessageClass      *N1MessageClass `json:"n1MessageClass,omitempty" yaml:"n1MessageClass,omitempty"`
	// String providing an URI formatted according to RFC 3986.
	N1NotifyCallbackUri *string `json:"n1NotifyCallbackUri,omitempty" yaml:"n1NotifyCallbackUri,omitempty"`
...
func (o *UeN1N2InfoSubscriptionCreateData) GetN2NotifyCallbackUri() string {
	if o == nil || openapi.IsNil(o.N2NotifyCallbackUri) {
		var ret string
		return ret
	}
...
func (o *UeN1N2InfoSubscriptionCreateData) GetN1NotifyCallbackUri() string {
	if o == nil || openapi.IsNil(o.N1NotifyCallbackUri) {
		var ret string
		return ret
	}
...
func (o UeN1N2InfoSubscriptionCreateData) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.N2InformationClass) {
		toSerialize["n2InformationClass"] = o.N2InformationClass
	}
	if !openapi.IsNil(o.N2NotifyCallbackUri) {
	...
	if !openapi.IsNil(o.N1NotifyCallbackUri) {
