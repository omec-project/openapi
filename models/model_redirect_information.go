...
var _ openapi.MappedNullable = &RedirectInformation{}

// RedirectInformation Contains the redirect information.
type RedirectInformation struct {
	// Indicates the redirect is enable.
	RedirectEnabled     *bool                `json:"redirectEnabled,omitempty" yaml:"redirectEnabled,omitempty"`
	RedirectAddressType *RedirectAddressType `json:"redirectAddressType,omitempty" yaml:"redirectAddressType,omitempty"`
	...
	RedirectServerAddress *string `json:"redirectServerAddress,omitempty" yaml:"redirectServerAddress,omitempty"`
}
...
func (o *RedirectInformation) GetRedirectEnabled() bool {
	if o == nil || openapi.IsNil(o.RedirectEnabled) {
		var ret bool
		return ret
	}
...
func (o *RedirectInformation) GetRedirectAddressType() RedirectAddressType {
	if o == nil || openapi.IsNil(o.RedirectAddressType) {
...
func (o *RedirectInformation) GetRedirectServerAddress() string {
	if o == nil || openapi.IsNil(o.RedirectServerAddress) {
		var ret string
		return ret
	}
...
func (o RedirectInformation) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.RedirectEnabled) {
		toSerialize["redirectEnabled"] = o.RedirectEnabled
	}
	if !openapi.IsNil(o.RedirectAddressType) {
		toSerialize["redirectAddressType"] = o.RedirectAddressType
	}
	if !openapi.IsNil(o.RedirectServerAddress) {
