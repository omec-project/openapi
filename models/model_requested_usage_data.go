...
var _ openapi.MappedNullable = &RequestedUsageData{}
...
type RequestedUsageData struct {
	...
	RefUmIds []string `json:"refUmIds,omitempty" yaml:"refUmIds,omitempty"`
	...
	AllUmIds *bool `json:"allUmIds,omitempty" yaml:"allUmIds,omitempty"`
}
...
func (o *RequestedUsageData) GetRefUmIds() []string {
	if o == nil || openapi.IsNil(o.RefUmIds) {
		var ret []string
		return ret
	}
	return o.RefUmIds
...
func (o *RequestedUsageData) GetAllUmIds() bool {
	if o == nil || openapi.IsNil(o.AllUmIds) {
		var ret bool
		return ret
	}
	return *o.AllUmIds
...
func (o RequestedUsageData) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.RefUmIds) {
		toSerialize["refUmIds"] = o.RefUmIds
	}
	if !openapi.IsNil(o.AllUmIds) {
