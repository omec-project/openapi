...
var _ openapi.MappedNullable = &MonitoringConfiguration{}
...
type MonitoringConfiguration struct {
	...
	LocationReportingConfiguration *LocationReportingConfiguration `json:"locationReportingConfiguration,omitempty" yaml:"locationReportingConfiguration,omitempty"`
	AssociationType                *AssociationType                `json:"associationType,omitempty" yaml:"associationType,omitempty"`
	DatalinkReportCfg              *DatalinkReportingConfiguration `json:"datalinkReportCfg,omitempty" yaml:"datalinkReportCfg,omitempty"`
	LossConnectivityCfg            *LossConnectivityCfg            `json:"lossConnectivityCfg,omitempty" yaml:"lossConnectivityCfg,omitempty"`
	// indicating a time in seconds.
	MaximumLatency *int32 `json:"maximumLatency,omitempty" yaml:"maximumLatency,omitempty"`
	// indicating a time in seconds.
	MaximumResponseTime  *int32 `json:"maximumResponseTime,omitempty" yaml:"maximumResponseTime,omitempty"`
	SuggestedPacketNumDl *int32 `json:"suggestedPacketNumDl,omitempty" yaml:"suggestedPacketNumDl,omitempty"`
	...
	PduSessionStatusCfg   *PduSessionStatusCfg             `json:"pduSessionStatusCfg,omitempty" yaml:"pduSessionStatusCfg,omitempty"`
	ReachabilityForSmsCfg *ReachabilityForSmsConfiguration `json:"reachabilityForSmsCfg,omitempty" yaml:"reachabilityForSmsCfg,omitempty"`
	...
	ReachabilityForDataCfg *ReachabilityForDataConfiguration `json:"reachabilityForDataCfg,omitempty" yaml:"reachabilityForDataCfg,omitempty"`
	IdleStatusInd          *bool                             `json:"idleStatusInd,omitempty" yaml:"idleStatusInd,omitempty"`
	MonitoringSuspension   *MonitoringSuspension             `json:"monitoringSuspension,omitempty" yaml:"monitoringSuspension,omitempty"`
}
...
func NewMonitoringConfiguration(eventType EventTypeUdm) *MonitoringConfiguration {
...
func (o *MonitoringConfiguration) GetEventType() EventTypeUdm {
	if o == nil {
...
func (o *MonitoringConfiguration) GetEventTypeOk() (*EventTypeUdm, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *MonitoringConfiguration) SetEventType(v EventTypeUdm) {
	o.EventType = v
}
...
func (o *MonitoringConfiguration) GetLocationReportingConfiguration() LocationReportingConfiguration {
	if o == nil || openapi.IsNil(o.LocationReportingConfiguration) {
...
func (o *MonitoringConfiguration) GetAssociationType() AssociationType {
	if o == nil || openapi.IsNil(o.AssociationType) {
...
func (o *MonitoringConfiguration) GetDatalinkReportCfg() DatalinkReportingConfiguration {
	if o == nil || openapi.IsNil(o.DatalinkReportCfg) {
...
func (o *MonitoringConfiguration) GetLossConnectivityCfg() LossConnectivityCfg {
	if o == nil || openapi.IsNil(o.LossConnectivityCfg) {
...
func (o *MonitoringConfiguration) GetMaximumLatency() int32 {
	if o == nil || openapi.IsNil(o.MaximumLatency) {
		var ret int32
		return ret
	}
...
func (o *MonitoringConfiguration) GetMaximumResponseTime() int32 {
	if o == nil || openapi.IsNil(o.MaximumResponseTime) {
		var ret int32
		return ret
	}
...
func (o *MonitoringConfiguration) GetSuggestedPacketNumDl() int32 {
	if o == nil || openapi.IsNil(o.SuggestedPacketNumDl) {
		var ret int32
		return ret
	}
...
func (o *MonitoringConfiguration) GetPduSessionStatusCfg() PduSessionStatusCfg {
	if o == nil || openapi.IsNil(o.PduSessionStatusCfg) {
...
func (o *MonitoringConfiguration) GetReachabilityForSmsCfg() ReachabilityForSmsConfiguration {
	if o == nil || openapi.IsNil(o.ReachabilityForSmsCfg) {
...
func (o *MonitoringConfiguration) GetReachabilityForDataCfg() ReachabilityForDataConfiguration {
	if o == nil || openapi.IsNil(o.ReachabilityForDataCfg) {
...
// GetMonitoringSuspension returns the MonitoringSuspension field value if set, zero value otherwise.
func (o *MonitoringConfiguration) GetMonitoringSuspension() MonitoringSuspension {
	if o == nil || openapi.IsNil(o.MonitoringSuspension) {
		var ret MonitoringSuspension
		return ret
	}
	return *o.MonitoringSuspension
}

// GetMonitoringSuspensionOk returns a tuple with the MonitoringSuspension field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MonitoringConfiguration) GetMonitoringSuspensionOk() (*MonitoringSuspension, bool) {
	if o == nil || openapi.IsNil(o.MonitoringSuspension) {
		return nil, false
	}
	return o.MonitoringSuspension, true
}
...
func (o MonitoringConfiguration) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.PduSessionStatusCfg) {
		toSerialize["pduSessionStatusCfg"] = o.PduSessionStatusCfg
	}
	if !openapi.IsNil(o.ReachabilityForSmsCfg) {
	...
	if !openapi.IsNil(o.ReachabilityForDataCfg) {
	...
	if !openapi.IsNil(o.MonitoringSuspension) {
		toSerialize["monitoringSuspension"] = o.MonitoringSuspension
	}
