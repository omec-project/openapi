...
var _ openapi.MappedNullable = &LocalOrigin{}

// LocalOrigin Indicates a Local origin in a reference system
type LocalOrigin struct {
	CoordinateId *string                  `json:"coordinateId,omitempty" yaml:"coordinateId,omitempty"`
...
func (o LocalOrigin) ToMap() (map[string]any, error) {
