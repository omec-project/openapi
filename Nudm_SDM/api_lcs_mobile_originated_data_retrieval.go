...
type LCSMobileOriginatedDataRetrievalAPI interface {
	...
	*/
	...
	//   @return LcsMoData
	GetLcsMoDataExecute(r ApiGetLcsMoDataRequest) (*models.LcsMoData, *http.Response, error)
}
...
func (r ApiGetLcsMoDataRequest) Execute() (*models.LcsMoData, *http.Response, error) {
...
//
//	@return LcsMoData
func (a *LCSMobileOriginatedDataRetrievalAPIService) GetLcsMoDataExecute(r ApiGetLcsMoDataRequest) (*models.LcsMoData, *http.Response, error) {
	var (
