...
var _ openapi.MappedNullable = &ModifyPduSession400Response{}

// ModifyPduSession400Response struct for ModifyPduSession400Response
type ModifyPduSession400Response struct {
	JsonData                    *VsmfUpdateError `json:"jsonData,omitempty" yaml:"jsonData,omitempty" multipart:"contentType:application/json,ref:{jsonData}"`
	...
	BinaryDataN4InformationExt3 **os.File        `json:"binaryDataN4InformationExt3,omitempty" yaml:"binaryDataN4InformationExt3,omitempty" multipart:"contentType:application/vnd.3gpp.pfcp,ref:{binaryDataN4InformationExt3}"`
}
...
func (o *ModifyPduSession400Response) GetBinaryDataN4InformationExt3() *os.File {
	if o == nil || openapi.IsNil(o.BinaryDataN4InformationExt3) {
		var ret *os.File
		return ret
	}
...
func (o ModifyPduSession400Response) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.BinaryDataN4InformationExt3) {
