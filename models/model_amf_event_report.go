...
var _ openapi.MappedNullable = &AmfEventReport{}
...
type AmfEventReport struct {
	...
	State AmfEventState `json:"state" yaml:"state"`
	...
	Location           *UserLocation `json:"location,omitempty" yaml:"location,omitempty"`
	AdditionalLocation *UserLocation `json:"additionalLocation,omitempty" yaml:"additionalLocation,omitempty"`
	...
	RmInfoList          []RmInfo                  `json:"rmInfoList,omitempty" yaml:"rmInfoList,omitempty"`
	CmInfoList          []CmInfo                  `json:"cmInfoList,omitempty" yaml:"cmInfoList,omitempty"`
	Reachability        *UeReachability           `json:"reachability,omitempty" yaml:"reachability,omitempty"`
	CommFailure         *CommunicationFailure     `json:"commFailure,omitempty" yaml:"commFailure,omitempty"`
	LossOfConnectReason *LossOfConnectivityReason `json:"lossOfConnectReason,omitempty" yaml:"lossOfConnectReason,omitempty"`
	NumberOfUes         *int32                    `json:"numberOfUes,omitempty" yaml:"numberOfUes,omitempty"`
	Var5gsUserStateList []FiveGsUserStateInfo     `json:"5gsUserStateList,omitempty" yaml:"5gsUserStateList,omitempty"`
	TypeCode            *string                   `json:"typeCode,omitempty" yaml:"typeCode,omitempty" validate:"regexp=^imeitac-[0-9]{8}$"`
	RegistrationNumber  *int32                    `json:"registrationNumber,omitempty" yaml:"registrationNumber,omitempty"`
	// string with format 'date-time' as defined in OpenAPI.
	MaxAvailabilityTime       *time.Time                        `json:"maxAvailabilityTime,omitempty" yaml:"maxAvailabilityTime,omitempty"`
	UeIdExt                   []UEIdExt                         `json:"ueIdExt,omitempty" yaml:"ueIdExt,omitempty"`
	SnssaiTaiList             []SnssaiTaiMapping                `json:"snssaiTaiList,omitempty" yaml:"snssaiTaiList,omitempty"`
	IdleStatusIndication      *IdleStatusIndication             `json:"idleStatusIndication,omitempty" yaml:"idleStatusIndication,omitempty"`
	UeAccessBehaviorTrends    []UeAccessBehaviorReportItem      `json:"ueAccessBehaviorTrends,omitempty" yaml:"ueAccessBehaviorTrends,omitempty"`
	UeLocationTrends          []UeLocationTrendsReportItem      `json:"ueLocationTrends,omitempty" yaml:"ueLocationTrends,omitempty"`
	MmTransLocationReportList []MmTransactionLocationReportItem `json:"mmTransLocationReportList,omitempty" yaml:"mmTransLocationReportList,omitempty"`
	MmTransSliceReportList    []MmTransactionSliceReportItem    `json:"mmTransSliceReportList,omitempty" yaml:"mmTransSliceReportList,omitempty"`
	TermReason                *SubTerminationReason             `json:"termReason,omitempty" yaml:"termReason,omitempty"`
	// indicating a time in seconds.
	UnavailabilityPeriod *int32 `json:"unavailabilityPeriod,omitempty" yaml:"unavailabilityPeriod,omitempty"`
}
...
func (o *AmfEventReport) GetLocation() UserLocation {
	if o == nil || openapi.IsNil(o.Location) {
...
func (o *AmfEventReport) GetAdditionalLocation() UserLocation {
	if o == nil || openapi.IsNil(o.AdditionalLocation) {
		var ret UserLocation
		return ret
	}
...
func (o *AmfEventReport) GetRmInfoList() []RmInfo {
	if o == nil || openapi.IsNil(o.RmInfoList) {
		var ret []RmInfo
		return ret
	}
	return o.RmInfoList
...
func (o *AmfEventReport) GetCmInfoList() []CmInfo {
	if o == nil || openapi.IsNil(o.CmInfoList) {
		var ret []CmInfo
		return ret
	}
	return o.CmInfoList
...
func (o *AmfEventReport) GetReachability() UeReachability {
	if o == nil || openapi.IsNil(o.Reachability) {
...
func (o *AmfEventReport) GetLossOfConnectReason() LossOfConnectivityReason {
	if o == nil || openapi.IsNil(o.LossOfConnectReason) {
...
func (o *AmfEventReport) GetVar5gsUserStateList() []FiveGsUserStateInfo {
	if o == nil || openapi.IsNil(o.Var5gsUserStateList) {
		var ret []FiveGsUserStateInfo
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *AmfEventReport) GetVar5gsUserStateListOk() ([]FiveGsUserStateInfo, bool) {
	if o == nil || openapi.IsNil(o.Var5gsUserStateList) {
		return nil, false
	}
...
// SetVar5gsUserStateList gets a reference to the given []FiveGsUserStateInfo and assigns it to the Var5gsUserStateList field.
func (o *AmfEventReport) SetVar5gsUserStateList(v []FiveGsUserStateInfo) {
...
func (o *AmfEventReport) GetTypeCode() string {
	if o == nil || openapi.IsNil(o.TypeCode) {
		var ret string
		return ret
	}
	return *o.TypeCode
...
func (o *AmfEventReport) GetRegistrationNumber() int32 {
	if o == nil || openapi.IsNil(o.RegistrationNumber) {
		var ret int32
		return ret
	}
...
func (o *AmfEventReport) GetMaxAvailabilityTime() time.Time {
	if o == nil || openapi.IsNil(o.MaxAvailabilityTime) {
		var ret time.Time
		return ret
	}
...
func (o *AmfEventReport) GetUeIdExt() []UEIdExt {
	if o == nil || openapi.IsNil(o.UeIdExt) {
		var ret []UEIdExt
		return ret
	}
	return o.UeIdExt
...
func (o *AmfEventReport) GetSnssaiTaiList() []SnssaiTaiMapping {
	if o == nil || openapi.IsNil(o.SnssaiTaiList) {
...
func (o *AmfEventReport) GetIdleStatusIndication() IdleStatusIndication {
	if o == nil || openapi.IsNil(o.IdleStatusIndication) {
...
func (o *AmfEventReport) GetUeAccessBehaviorTrends() []UeAccessBehaviorReportItem {
	if o == nil || openapi.IsNil(o.UeAccessBehaviorTrends) {
...
func (o *AmfEventReport) GetUeLocationTrends() []UeLocationTrendsReportItem {
	if o == nil || openapi.IsNil(o.UeLocationTrends) {
...
func (o *AmfEventReport) GetMmTransLocationReportList() []MmTransactionLocationReportItem {
	if o == nil || openapi.IsNil(o.MmTransLocationReportList) {
...
func (o *AmfEventReport) GetMmTransSliceReportList() []MmTransactionSliceReportItem {
	if o == nil || openapi.IsNil(o.MmTransSliceReportList) {
...
func (o *AmfEventReport) GetTermReason() SubTerminationReason {
	if o == nil || openapi.IsNil(o.TermReason) {
...
// GetUnavailabilityPeriod returns the UnavailabilityPeriod field value if set, zero value otherwise.
func (o *AmfEventReport) GetUnavailabilityPeriod() int32 {
	if o == nil || openapi.IsNil(o.UnavailabilityPeriod) {
		var ret int32
		return ret
	}
	return *o.UnavailabilityPeriod
}

// GetUnavailabilityPeriodOk returns a tuple with the UnavailabilityPeriod field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AmfEventReport) GetUnavailabilityPeriodOk() (*int32, bool) {
	if o == nil || openapi.IsNil(o.UnavailabilityPeriod) {
		return nil, false
	}
	return o.UnavailabilityPeriod, true
}

// HasUnavailabilityPeriod returns a boolean if a field has been set.
func (o *AmfEventReport) HasUnavailabilityPeriod() bool {
	if o != nil && !openapi.IsNil(o.UnavailabilityPeriod) {
		return true
	}
...
// SetUnavailabilityPeriod gets a reference to the given int32 and assigns it to the UnavailabilityPeriod field.
func (o *AmfEventReport) SetUnavailabilityPeriod(v int32) {
	o.UnavailabilityPeriod = &v
}

func (o AmfEventReport) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.Location) {
		toSerialize["location"] = o.Location
	}
	if !openapi.IsNil(o.AdditionalLocation) {
