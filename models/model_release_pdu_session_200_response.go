...
var _ openapi.MappedNullable = &ReleasePduSession200Response{}

// ReleasePduSession200Response struct for ReleasePduSession200Response
type ReleasePduSession200Response struct {
	JsonData                    *ReleasedData `json:"jsonData,omitempty" yaml:"jsonData,omitempty" multipart:"contentType:application/json,ref:{jsonData}"`
...
func (o ReleasePduSession200Response) ToMap() (map[string]any, error) {
