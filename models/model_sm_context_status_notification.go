...
type SmContextStatusNotification struct {
	...
	DdnFailureStatus                  *bool                `json:"ddnFailureStatus,omitempty" yaml:"ddnFailureStatus,omitempty"`
	NotifyCorrelationIdsForddnFailure []string             `json:"notifyCorrelationIdsForddnFailure,omitempty" yaml:"notifyCorrelationIdsForddnFailure,omitempty"`
	// String uniquely identifying a NF instance. The format of the NF Instance ID shall be a  Universally Unique Identifier (UUID) version 4, as described in IETF RFC 4122.
	NewIntermediateSmfId *string `json:"newIntermediateSmfId,omitempty" yaml:"newIntermediateSmfId,omitempty"`
	// String uniquely identifying a NF instance. The format of the NF Instance ID shall be a  Universally Unique Identifier (UUID) version 4, as described in IETF RFC 4122.
	...
	NewSmfSetId *string `json:"newSmfSetId,omitempty" yaml:"newSmfSetId,omitempty"`
	// String uniquely identifying a NF instance. The format of the NF Instance ID shall be a  Universally Unique Identifier (UUID) version 4, as described in IETF RFC 4122.
	...
	// String providing an URI formatted according to RFC 3986.
	AltAnchorSmfUri *string `json:"altAnchorSmfUri,omitempty" yaml:"altAnchorSmfUri,omitempty"`
	// String uniquely identifying a NF instance. The format of the NF Instance ID shall be a  Universally Unique Identifier (UUID) version 4, as described in IETF RFC 4122.
	AltAnchorSmfId *string         `json:"altAnchorSmfId,omitempty" yaml:"altAnchorSmfId,omitempty"`
...
func (o *SmContextStatusNotification) GetDdnFailureStatus() bool {
	if o == nil || openapi.IsNil(o.DdnFailureStatus) {
		var ret bool
		return ret
	}
...
func (o *SmContextStatusNotification) GetNotifyCorrelationIdsForddnFailure() []string {
	if o == nil || openapi.IsNil(o.NotifyCorrelationIdsForddnFailure) {
		var ret []string
		return ret
	}
...
func (o *SmContextStatusNotification) GetNewIntermediateSmfId() string {
	if o == nil || openapi.IsNil(o.NewIntermediateSmfId) {
		var ret string
		return ret
	}
...
func (o *SmContextStatusNotification) GetNewSmfSetId() string {
	if o == nil || openapi.IsNil(o.NewSmfSetId) {
		var ret string
		return ret
	}
...
func (o *SmContextStatusNotification) GetAltAnchorSmfUri() string {
	if o == nil || openapi.IsNil(o.AltAnchorSmfUri) {
		var ret string
		return ret
	}
...
func (o *SmContextStatusNotification) GetAltAnchorSmfId() string {
	if o == nil || openapi.IsNil(o.AltAnchorSmfId) {
		var ret string
		return ret
	}
...
func (o *SmContextStatusNotification) GetTargetDnaiInfo() TargetDnaiInfo {
	if o == nil || openapi.IsNil(o.TargetDnaiInfo) {
...
func (o *SmContextStatusNotification) GetTargetDnai() string {
...
// and a boolean to check if the value has been set.
func (o *SmContextStatusNotification) GetTargetDnaiOk() (*string, bool) {
	if o == nil || openapi.IsNil(o.TargetDnai) {
		return nil, false
	}
...
func (o *SmContextStatusNotification) HasTargetDnai() bool {
	if o != nil && !openapi.IsNil(o.TargetDnai) {
		return true
	}
...
func (o *SmContextStatusNotification) SetTargetDnai(v string) {
	o.TargetDnai = &v
}

func (o SmContextStatusNotification) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.AltAnchorSmfUri) {
		toSerialize["altAnchorSmfUri"] = o.AltAnchorSmfUri
	}
	if !openapi.IsNil(o.AltAnchorSmfId) {
		toSerialize["altAnchorSmfId"] = o.AltAnchorSmfId
	}
	if !openapi.IsNil(o.TargetDnaiInfo) {
