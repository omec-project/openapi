...
var _ openapi.MappedNullable = &ApplicationDataSubs{}
...
type ApplicationDataSubs struct {
	...
	DataFilters     []DataFilter `json:"dataFilters,omitempty" yaml:"dataFilters,omitempty"`
	...
	AmInfluEntries []AmInfluData `json:"amInfluEntries,omitempty" yaml:"amInfluEntries,omitempty"`
	...
	ImmReports []ApplicationDataChangeNotif `json:"immReports,omitempty" yaml:"immReports,omitempty"`
}
...
func (o *ApplicationDataSubs) GetDataFilters() []DataFilter {
	if o == nil || openapi.IsNil(o.DataFilters) {
		var ret []DataFilter
		return ret
	}
...
func (o *ApplicationDataSubs) GetAmInfluEntries() []AmInfluData {
	if o == nil || openapi.IsNil(o.AmInfluEntries) {
		var ret []AmInfluData
		return ret
	}
...
func (o *ApplicationDataSubs) GetImmReports() []ApplicationDataChangeNotif {
	if o == nil || openapi.IsNil(o.ImmReports) {
		var ret []ApplicationDataChangeNotif
		return ret
	}
	return o.ImmReports
}
...
// and a boolean to check if the value has been set.
func (o *ApplicationDataSubs) GetImmReportsOk() ([]ApplicationDataChangeNotif, bool) {
	if o == nil || openapi.IsNil(o.ImmReports) {
		return nil, false
	}
...
func (o *ApplicationDataSubs) HasImmReports() bool {
	if o != nil && !openapi.IsNil(o.ImmReports) {
		return true
	}
...
// SetImmReports gets a reference to the given []ApplicationDataChangeNotif and assigns it to the ImmReports field.
func (o *ApplicationDataSubs) SetImmReports(v []ApplicationDataChangeNotif) {
	o.ImmReports = v
}

func (o ApplicationDataSubs) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["notificationUri"] = o.NotificationUri
	if !openapi.IsNil(o.DataFilters) {
	...
	if !openapi.IsNil(o.AmInfluEntries) {
