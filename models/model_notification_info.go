...
var _ openapi.MappedNullable = &NotificationInfo{}
...
type NotificationInfo struct {
	...
	UpBufferInd *bool  `json:"upBufferInd,omitempty" yaml:"upBufferInd,omitempty"`
}
...
func (o *NotificationInfo) GetUpBufferInd() bool {
	if o == nil || openapi.IsNil(o.UpBufferInd) {
		var ret bool
		return ret
	}
...
func (o NotificationInfo) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["notifId"] = o.NotifId
	toSerialize["notifUri"] = o.NotifUri
	if !openapi.IsNil(o.UpBufferInd) {
