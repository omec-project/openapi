...
var _ openapi.MappedNullable = &SliceInfoForPDUSession{}
...
type SliceInfoForPDUSession struct {
	...
	RoamingIndication RoamingIndication `json:"roamingIndication" yaml:"roamingIndication"`
	HomeSnssai        *Snssai           `json:"homeSnssai,omitempty" yaml:"homeSnssai,omitempty"`
}
...
func (o *SliceInfoForPDUSession) GetHomeSnssai() Snssai {
	if o == nil || openapi.IsNil(o.HomeSnssai) {
		var ret Snssai
		return ret
	}
	return *o.HomeSnssai
...
func (o SliceInfoForPDUSession) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["sNssai"] = o.SNssai
	toSerialize["roamingIndication"] = o.RoamingIndication
	if !openapi.IsNil(o.HomeSnssai) {
