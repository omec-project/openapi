...
var _ openapi.MappedNullable = &EeGroupProfileData{}
...
func (o *EeGroupProfileData) GetRestrictedEventTypes() []EventTypeUdm {
...
func (o *EeGroupProfileData) GetRestrictedEventTypesOk() ([]EventTypeUdm, bool) {
	if o == nil || openapi.IsNil(o.RestrictedEventTypes) {
		return nil, false
	}
...
func (o *EeGroupProfileData) SetRestrictedEventTypes(v []EventTypeUdm) {
...
func (o EeGroupProfileData) ToMap() (map[string]any, error) {
