...
var _ openapi.MappedNullable = &EventsSubscReqData{}
...
type EventsSubscReqData struct {
	...
	QosMon          *QosMonitoringInformation         `json:"qosMon,omitempty" yaml:"qosMon,omitempty"`
	QosMonDatRate   *QosMonitoringInformation         `json:"qosMonDatRate,omitempty" yaml:"qosMonDatRate,omitempty"`
	PdvReqMonParams []RequestedQosMonitoringParameter `json:"pdvReqMonParams,omitempty" yaml:"pdvReqMonParams,omitempty"`
	PdvMon          *QosMonitoringInformation         `json:"pdvMon,omitempty" yaml:"pdvMon,omitempty"`
	CongestMon      *QosMonitoringInformation         `json:"congestMon,omitempty" yaml:"congestMon,omitempty"`
	RttMon          *QosMonitoringInformation         `json:"rttMon,omitempty" yaml:"rttMon,omitempty"`
	ReqAnis         []RequiredAccessInfo              `json:"reqAnis,omitempty" yaml:"reqAnis,omitempty"`
	UsgThres        *UsageThreshold                   `json:"usgThres,omitempty" yaml:"usgThres,omitempty"`
	NotifCorreId    *string                           `json:"notifCorreId,omitempty" yaml:"notifCorreId,omitempty"`
	AfAppIds        []string                          `json:"afAppIds,omitempty" yaml:"afAppIds,omitempty"`
	...
	AvrgWndw *int32 `json:"avrgWndw,omitempty" yaml:"avrgWndw,omitempty"`
}
...
func (o *EventsSubscReqData) GetQosMon() QosMonitoringInformation {
	if o == nil || openapi.IsNil(o.QosMon) {
...
func (o *EventsSubscReqData) GetQosMonDatRate() QosMonitoringInformation {
	if o == nil || openapi.IsNil(o.QosMonDatRate) {
		var ret QosMonitoringInformation
		return ret
	}
...
func (o *EventsSubscReqData) GetPdvMon() QosMonitoringInformation {
	if o == nil || openapi.IsNil(o.PdvMon) {
		var ret QosMonitoringInformation
		return ret
	}
	return *o.PdvMon
...
func (o *EventsSubscReqData) GetCongestMon() QosMonitoringInformation {
	if o == nil || openapi.IsNil(o.CongestMon) {
		var ret QosMonitoringInformation
		return ret
	}
	return *o.CongestMon
...
func (o *EventsSubscReqData) GetRttMon() QosMonitoringInformation {
	if o == nil || openapi.IsNil(o.RttMon) {
		var ret QosMonitoringInformation
		return ret
	}
	return *o.RttMon
...
func (o *EventsSubscReqData) GetUsgThres() UsageThreshold {
	if o == nil || openapi.IsNil(o.UsgThres) {
...
func (o *EventsSubscReqData) GetAfAppIds() []string {
	if o == nil || openapi.IsNil(o.AfAppIds) {
		var ret []string
		return ret
	}
	return o.AfAppIds
...
func (o *EventsSubscReqData) GetAvrgWndw() int32 {
	if o == nil || openapi.IsNil(o.AvrgWndw) {
		var ret int32
		return ret
	}
	return *o.AvrgWndw
...
func (o EventsSubscReqData) ToMap() (map[string]any, error) {
