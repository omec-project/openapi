...
var _ openapi.MappedNullable = &PduSessionEventNotification{}
...
func (o *PduSessionEventNotification) GetUeIpv6() string {
...
// and a boolean to check if the value has been set.
func (o *PduSessionEventNotification) GetUeIpv6Ok() (*string, bool) {
	if o == nil || openapi.IsNil(o.UeIpv6) {
		return nil, false
	}
...
func (o *PduSessionEventNotification) SetUeIpv6(v string) {
	o.UeIpv6 = &v
}
...
func (o *PduSessionEventNotification) GetStatus() PduSessionStatusPcf {
	if o == nil || openapi.IsNil(o.Status) {
		var ret PduSessionStatusPcf
		return ret
	}
	return *o.Status
}
...
// and a boolean to check if the value has been set.
func (o *PduSessionEventNotification) GetStatusOk() (*PduSessionStatusPcf, bool) {
	if o == nil || openapi.IsNil(o.Status) {
		return nil, false
	}
...
// SetStatus gets a reference to the given PduSessionStatusPcf and assigns it to the Status field.
func (o *PduSessionEventNotification) SetStatus(v PduSessionStatusPcf) {
	o.Status = &v
}
...
func (o PduSessionEventNotification) ToMap() (map[string]any, error) {
