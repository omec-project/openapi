...
var _ openapi.MappedNullable = &ChargingData{}
...
type ChargingData struct {
	...
	ReportingLevel NullableReportingLevel `json:"reportingLevel" yaml:"reportingLevel,omitempty"`
	// Integer where the allowed values correspond to the value range of an unsigned 32-bit integer.
	ServiceId *int32 `json:"serviceId,omitempty" yaml:"serviceId,omitempty"`
	...
	AppSvcProvId *string `json:"appSvcProvId,omitempty" yaml:"appSvcProvId,omitempty"`
	// Integer where the allowed values correspond to the value range of an unsigned 32-bit integer.
	// Deprecated
	AfChargingIdentifier *int32 `json:"afChargingIdentifier,omitempty" yaml:"afChargingIdentifier,omitempty"`
	// Application provided charging identifier allowing correlation of charging information.
	AfChargId *string `json:"afChargId,omitempty" yaml:"afChargId,omitempty"`
}
...
// GetMeteringMethod returns the MeteringMethod field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ChargingData) GetMeteringMethod() MeteringMethod {
	if o == nil || openapi.IsNil(o.MeteringMethod.Get()) {
		var ret MeteringMethod
		return ret
	}
	return *o.MeteringMethod.Get()
}
...
// SetMeteringMethod gets a reference to the given NullableMeteringMethod and assigns it to the MeteringMethod field.
func (o *ChargingData) SetMeteringMethod(v MeteringMethod) {
	o.MeteringMethod.Set(&v)
}

// SetMeteringMethodNil sets the value for MeteringMethod to be an explicit nil
func (o *ChargingData) SetMeteringMethodNil() {
	o.MeteringMethod.Set(nil)
}

// UnsetMeteringMethod ensures that no value is present for MeteringMethod, not even an explicit nil
func (o *ChargingData) UnsetMeteringMethod() {
	o.MeteringMethod.Unset()
}
...
func (o *ChargingData) GetSdfHandl() bool {
	if o == nil || openapi.IsNil(o.SdfHandl) {
		var ret bool
		return ret
	}
	return *o.SdfHandl
...
func (o *ChargingData) GetRatingGroup() int32 {
	if o == nil || openapi.IsNil(o.RatingGroup) {
		var ret int32
		return ret
	}
...
// GetReportingLevel returns the ReportingLevel field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ChargingData) GetReportingLevel() ReportingLevel {
	if o == nil || openapi.IsNil(o.ReportingLevel.Get()) {
		var ret ReportingLevel
		return ret
	}
	return *o.ReportingLevel.Get()
}
...
// SetReportingLevel gets a reference to the given NullableReportingLevel and assigns it to the ReportingLevel field.
func (o *ChargingData) SetReportingLevel(v ReportingLevel) {
	o.ReportingLevel.Set(&v)
}

// SetReportingLevelNil sets the value for ReportingLevel to be an explicit nil
func (o *ChargingData) SetReportingLevelNil() {
	o.ReportingLevel.Set(nil)
}

// UnsetReportingLevel ensures that no value is present for ReportingLevel, not even an explicit nil
func (o *ChargingData) UnsetReportingLevel() {
	o.ReportingLevel.Unset()
}

// GetServiceId returns the ServiceId field value if set, zero value otherwise.
func (o *ChargingData) GetServiceId() int32 {
	if o == nil || openapi.IsNil(o.ServiceId) {
		var ret int32
		return ret
	}
	return *o.ServiceId
...
func (o *ChargingData) GetAppSvcProvId() string {
	if o == nil || openapi.IsNil(o.AppSvcProvId) {
		var ret string
		return ret
	}
...
func (o *ChargingData) GetAfChargingIdentifier() int32 {
	if o == nil || openapi.IsNil(o.AfChargingIdentifier) {
		var ret int32
		return ret
	}
...
func (o *ChargingData) GetAfChargId() string {
	if o == nil || openapi.IsNil(o.AfChargId) {
		var ret string
		return ret
	}
	return *o.AfChargId
...
func (o ChargingData) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["chgId"] = o.ChgId
	if o.MeteringMethod.IsSet() {
		toSerialize["meteringMethod"] = o.MeteringMethod.Get()
	}
	...
	if !openapi.IsNil(o.SdfHandl) {
		toSerialize["sdfHandl"] = o.SdfHandl
	}
	if !openapi.IsNil(o.RatingGroup) {
		toSerialize["ratingGroup"] = o.RatingGroup
	}
	if o.ReportingLevel.IsSet() {
		toSerialize["reportingLevel"] = o.ReportingLevel.Get()
	}
	if !openapi.IsNil(o.ServiceId) {
		toSerialize["serviceId"] = o.ServiceId
	}
	if !openapi.IsNil(o.SponsorId) {
		toSerialize["sponsorId"] = o.SponsorId
	}
	if !openapi.IsNil(o.AppSvcProvId) {
		toSerialize["appSvcProvId"] = o.AppSvcProvId
	}
	if !openapi.IsNil(o.AfChargingIdentifier) {
		toSerialize["afChargingIdentifier"] = o.AfChargingIdentifier
	}
	if !openapi.IsNil(o.AfChargId) {
