...
var _ openapi.MappedNullable = &ResourceUsage{}
...
type ResourceUsage struct {
	...
	CpuUsage *int32 `json:"cpuUsage,omitempty" yaml:"cpuUsage,omitempty"`
	// Unsigned Integer, i.e. only value 0 and integers above 0 are permissible.
	MemoryUsage *int32 `json:"memoryUsage,omitempty" yaml:"memoryUsage,omitempty"`
	// Unsigned Integer, i.e. only value 0 and integers above 0 are permissible.
	StorageUsage *int32 `json:"storageUsage,omitempty" yaml:"storageUsage,omitempty"`
}
...
func (o *ResourceUsage) GetCpuUsage() int32 {
	if o == nil || openapi.IsNil(o.CpuUsage) {
		var ret int32
		return ret
	}
	return *o.CpuUsage
...
func (o *ResourceUsage) GetMemoryUsage() int32 {
	if o == nil || openapi.IsNil(o.MemoryUsage) {
		var ret int32
		return ret
	}
...
func (o *ResourceUsage) GetStorageUsage() int32 {
	if o == nil || openapi.IsNil(o.StorageUsage) {
		var ret int32
		return ret
	}
...
func (o ResourceUsage) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.CpuUsage) {
		toSerialize["cpuUsage"] = o.CpuUsage
	}
	if !openapi.IsNil(o.MemoryUsage) {
		toSerialize["memoryUsage"] = o.MemoryUsage
	}
	if !openapi.IsNil(o.StorageUsage) {
