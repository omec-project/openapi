...
var _ openapi.MappedNullable = &CollocatedNfInstance{}
...
type CollocatedNfInstance struct {
	...
	NfType       CollocatedNfType `json:"nfType" yaml:"nfType"`
}
...
func (o CollocatedNfInstance) ToMap() (map[string]any, error) {
