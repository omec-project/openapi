...
type EnhancedCoverageRestrictionDataRetrievalAPI interface {
	...
	*/
	GetEcrData(ctx context.Context, supi string) ApiGetEcrDataRequest

	// GetEcrDataExecute executes the request
	//   @return EnhancedCoverageRestrictionData
	GetEcrDataExecute(r ApiGetEcrDataRequest) (*models.EnhancedCoverageRestrictionData, *http.Response, error)
}
...
type ApiGetEcrDataRequest struct {
	ctx               context.Context
	ApiService        EnhancedCoverageRestrictionDataRetrievalAPI
	supi              string
...
func (r ApiGetEcrDataRequest) Execute() (*models.EnhancedCoverageRestrictionData, *http.Response, error) {
...
//
//	@return EnhancedCoverageRestrictionData
func (a *EnhancedCoverageRestrictionDataRetrievalAPIService) GetEcrDataExecute(r ApiGetEcrDataRequest) (*models.EnhancedCoverageRestrictionData, *http.Response, error) {
	var (
