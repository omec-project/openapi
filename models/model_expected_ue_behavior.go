...
var _ openapi.MappedNullable = &ExpectedUeBehavior{}
...
type ExpectedUeBehavior struct {
	ExpMoveTrajectory []UserLocation `json:"expMoveTrajectory" yaml:"expMoveTrajectory"`
	// string with format 'date-time' as defined in OpenAPI.
	ValidityTime time.Time `json:"validityTime" yaml:"validityTime"`
}
...
func (o ExpectedUeBehavior) ToMap() (map[string]any, error) {
