...
var _ openapi.MappedNullable = &ExemptionInd{}

// ExemptionInd Exemption Indication
type ExemptionInd struct {
	DnnCongestion        *bool `json:"dnnCongestion,omitempty" yaml:"dnnCongestion,omitempty"`
	SnssaiOnlyCongestion *bool `json:"snssaiOnlyCongestion,omitempty" yaml:"snssaiOnlyCongestion,omitempty"`
	SnssaiDnnCongestion  *bool `json:"snssaiDnnCongestion,omitempty" yaml:"snssaiDnnCongestion,omitempty"`
}
...
func (o *ExemptionInd) GetDnnCongestion() bool {
	if o == nil || openapi.IsNil(o.DnnCongestion) {
		var ret bool
		return ret
	}
...
func (o *ExemptionInd) GetSnssaiOnlyCongestion() bool {
	if o == nil || openapi.IsNil(o.SnssaiOnlyCongestion) {
		var ret bool
		return ret
	}
...
func (o *ExemptionInd) GetSnssaiDnnCongestion() bool {
	if o == nil || openapi.IsNil(o.SnssaiDnnCongestion) {
		var ret bool
		return ret
	}
...
func (o ExemptionInd) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.DnnCongestion) {
		toSerialize["dnnCongestion"] = o.DnnCongestion
	}
	if !openapi.IsNil(o.SnssaiOnlyCongestion) {
		toSerialize["snssaiOnlyCongestion"] = o.SnssaiOnlyCongestion
	}
	if !openapi.IsNil(o.SnssaiDnnCongestion) {
