...
var _ openapi.MappedNullable = &SliceLoadLevelInformation{}
...
type SliceLoadLevelInformation struct {
	...
	Snssais []Snssai `json:"snssais" yaml:"snssais"`
}
...
func (o SliceLoadLevelInformation) ToMap() (map[string]any, error) {
