...
var _ openapi.MappedNullable = &ProSeAuthenticationInfo{}
...
type ProSeAuthenticationInfo struct {
	...
	SupiOrSuci *string `json:"supiOrSuci,omitempty" yaml:"supiOrSuci,omitempty" validate:"regexp=^(imsi-[0-9]{5,15}|nai-.+|gli-.+|gci-.+|suci-(0-[0-9]{3}-[0-9]{2,3}|[1-7]-.+)-[0-9]{1,4}-(0-0-.*|[a-fA-F1-9]-([1-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])-[a-fA-F0-9]+)|.+)$"`
	...
	RelayServiceCode int32 `json:"relayServiceCode" yaml:"relayServiceCode"`
	// contains an Nonce1
	Nonce1             openapi.NullableString `json:"nonce1" yaml:"nonce1"`
...
func NewProSeAuthenticationInfo(relayServiceCode int32, nonce1 openapi.NullableString, servingNetworkName string) *ProSeAuthenticationInfo {
...
func (o *ProSeAuthenticationInfo) GetSupiOrSuci() string {
	if o == nil || openapi.IsNil(o.SupiOrSuci) {
		var ret string
		return ret
	}
	return *o.SupiOrSuci
...
func (o ProSeAuthenticationInfo) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.SupiOrSuci) {
