...
type AMFRegistrationForNon3GPPAccessAPI interface {
	...
	*/
	...
	Non3GppRegistrationExecute(r ApiNon3GppRegistrationRequest) (*models.AmfNon3GppAccessRegistration, *http.Response, error)
}
...
func (r ApiNon3GppRegistrationRequest) AmfNon3GppAccessRegistration(amfNon3GppAccessRegistration models.AmfNon3GppAccessRegistration) ApiNon3GppRegistrationRequest {
	r.amfNon3GppAccessRegistration = &amfNon3GppAccessRegistration
	return r
}

func (r ApiNon3GppRegistrationRequest) Execute() (*models.AmfNon3GppAccessRegistration, *http.Response, error) {
...
//
//	@return AmfNon3GppAccessRegistration
func (a *AMFRegistrationForNon3GPPAccessAPIService) Non3GppRegistrationExecute(r ApiNon3GppRegistrationRequest) (*models.AmfNon3GppAccessRegistration, *http.Response, error) {
	var (
