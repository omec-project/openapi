...
var _ openapi.MappedNullable = &NFService{}
...
type NFService struct {
	...
	ServiceName       ServiceName        `json:"serviceName" yaml:"serviceName"`
	Versions          []NFServiceVersion `json:"versions" yaml:"versions"`
	...
	AllowedOperationsPerNfType *map[string][]string `json:"allowedOperationsPerNfType,omitempty" yaml:"allowedOperationsPerNfType,omitempty"`
	// A map (list of key-value pairs) where NF Instance Id serves as key
	AllowedOperationsPerNfInstance          *map[string][]string `json:"allowedOperationsPerNfInstance,omitempty" yaml:"allowedOperationsPerNfInstance,omitempty"`
	AllowedOperationsPerNfInstanceOverrides *bool                `json:"allowedOperationsPerNfInstanceOverrides,omitempty" yaml:"allowedOperationsPerNfInstanceOverrides,omitempty"`
	// A map (list of key-value pairs) where a valid JSON pointer Id serves as key
	AllowedScopesRuleSet *map[string]RuleSet `json:"allowedScopesRuleSet,omitempty" yaml:"allowedScopesRuleSet,omitempty"`
	...
	NfServiceSetIdList []string     `json:"nfServiceSetIdList,omitempty" yaml:"nfServiceSetIdList,omitempty"`
	...
	Oauth2Required                  *bool                               `json:"oauth2Required,omitempty" yaml:"oauth2Required,omitempty"`
	PerPlmnOauth2ReqList            *PlmnOauth2                         `json:"perPlmnOauth2ReqList,omitempty" yaml:"perPlmnOauth2ReqList,omitempty"`
	...
	SharedServiceDataId             *string                             `json:"sharedServiceDataId,omitempty" yaml:"sharedServiceDataId,omitempty"`
}
...
func (o *NFService) GetIpEndPoints() []IpEndPoint {
	if o == nil || openapi.IsNil(o.IpEndPoints) {
		var ret []IpEndPoint
		return ret
	}
...
func (o *NFService) GetApiPrefix() string {
	if o == nil || openapi.IsNil(o.ApiPrefix) {
		var ret string
		return ret
	}
	return *o.ApiPrefix
...
func (o *NFService) GetCallbackUriPrefixList() []CallbackUriPrefixItem {
	if o == nil || openapi.IsNil(o.CallbackUriPrefixList) {
...
func (o *NFService) GetAllowedOperationsPerNfType() map[string][]string {
	if o == nil || openapi.IsNil(o.AllowedOperationsPerNfType) {
...
func (o *NFService) GetAllowedOperationsPerNfInstance() map[string][]string {
	if o == nil || openapi.IsNil(o.AllowedOperationsPerNfInstance) {
		var ret map[string][]string
		return ret
	}
...
func (o *NFService) GetAllowedOperationsPerNfInstanceOverrides() bool {
	if o == nil || openapi.IsNil(o.AllowedOperationsPerNfInstanceOverrides) {
		var ret bool
		return ret
	}
...
func (o *NFService) GetAllowedScopesRuleSet() map[string]RuleSet {
	if o == nil || openapi.IsNil(o.AllowedScopesRuleSet) {
...
func (o *NFService) GetNfServiceSetIdList() []string {
	if o == nil || openapi.IsNil(o.NfServiceSetIdList) {
		var ret []string
		return ret
	}
...
func (o *NFService) GetSNssais() []Snssai {
...
// and a boolean to check if the value has been set.
func (o *NFService) GetSNssaisOk() ([]Snssai, bool) {
	if o == nil || openapi.IsNil(o.SNssais) {
		return nil, false
	}
...
func (o *NFService) SetSNssais(v []Snssai) {
	o.SNssais = v
}
...
func (o *NFService) GetOauth2Required() bool {
	if o == nil || openapi.IsNil(o.Oauth2Required) {
		var ret bool
		return ret
	}
...
func (o *NFService) GetPerPlmnOauth2ReqList() PlmnOauth2 {
	if o == nil || openapi.IsNil(o.PerPlmnOauth2ReqList) {
		var ret PlmnOauth2
		return ret
	}
...
func (o *NFService) GetSharedServiceDataId() string {
	if o == nil || openapi.IsNil(o.SharedServiceDataId) {
		var ret string
		return ret
	}
...
func (o NFService) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.IpEndPoints) {
		toSerialize["ipEndPoints"] = o.IpEndPoints
	}
	if !openapi.IsNil(o.ApiPrefix) {
		toSerialize["apiPrefix"] = o.ApiPrefix
	}
	if !openapi.IsNil(o.CallbackUriPrefixList) {
	...
	if !openapi.IsNil(o.NfServiceSetIdList) {
	...
	if !openapi.IsNil(o.Oauth2Required) {
		toSerialize["oauth2Required"] = o.Oauth2Required
	}
	if !openapi.IsNil(o.PerPlmnOauth2ReqList) {
	...
	if !openapi.IsNil(o.SharedServiceDataId) {
