...
var _ openapi.MappedNullable = &NFServiceVersion{}

// NFServiceVersion Contains the version details of an NF service
type NFServiceVersion struct {
	ApiVersionInUri string `json:"apiVersionInUri" yaml:"apiVersionInUri"`
	ApiFullVersion  string `json:"apiFullVersion" yaml:"apiFullVersion"`
...
func (o NFServiceVersion) ToMap() (map[string]any, error) {
