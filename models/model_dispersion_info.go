...
var _ openapi.MappedNullable = &DispersionInfo{}
...
type DispersionInfo struct {
	...
	DisperCollects []DispersionCollection `json:"disperCollects" yaml:"disperCollects"`
...
func (o DispersionInfo) ToMap() (map[string]any, error) {
