...
var _ openapi.MappedNullable = &DownlinkDataNotificationControl{}
...
type DownlinkDataNotificationControl struct {
	NotifCtrlInds []NotificationControlIndication `json:"notifCtrlInds,omitempty" yaml:"notifCtrlInds,omitempty"`
...
func (o *DownlinkDataNotificationControl) GetNotifCtrlInds() []NotificationControlIndication {
	if o == nil || openapi.IsNil(o.NotifCtrlInds) {
...
func (o DownlinkDataNotificationControl) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.NotifCtrlInds) {
