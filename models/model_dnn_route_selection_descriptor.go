...
var _ openapi.MappedNullable = &DnnRouteSelectionDescriptor{}
...
type DnnRouteSelectionDescriptor struct {
	...
	SscModes     []SscMode        `json:"sscModes,omitempty" yaml:"sscModes,omitempty"`
	PduSessTypes []PduSessionType `json:"pduSessTypes,omitempty" yaml:"pduSessTypes,omitempty"`
	...
	AtsssInfo *bool `json:"atsssInfo,omitempty" yaml:"atsssInfo,omitempty"`
	// Indicates whether LBO for the DNN and S-NSSAI is allowed when roaming.
	LboRoamAllowed *bool `json:"lboRoamAllowed,omitempty" yaml:"lboRoamAllowed,omitempty"`
}
...
func (o *DnnRouteSelectionDescriptor) GetSscModes() []SscMode {
	if o == nil || openapi.IsNil(o.SscModes) {
		var ret []SscMode
		return ret
	}
	return o.SscModes
...
func (o *DnnRouteSelectionDescriptor) GetPduSessTypes() []PduSessionType {
	if o == nil || openapi.IsNil(o.PduSessTypes) {
...
func (o *DnnRouteSelectionDescriptor) GetAtsssInfo() bool {
	if o == nil || openapi.IsNil(o.AtsssInfo) {
		var ret bool
		return ret
	}
	return *o.AtsssInfo
...
// GetLboRoamAllowed returns the LboRoamAllowed field value if set, zero value otherwise.
func (o *DnnRouteSelectionDescriptor) GetLboRoamAllowed() bool {
	if o == nil || openapi.IsNil(o.LboRoamAllowed) {
		var ret bool
		return ret
	}
	return *o.LboRoamAllowed
}

// GetLboRoamAllowedOk returns a tuple with the LboRoamAllowed field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DnnRouteSelectionDescriptor) GetLboRoamAllowedOk() (*bool, bool) {
	if o == nil || openapi.IsNil(o.LboRoamAllowed) {
		return nil, false
	}
	return o.LboRoamAllowed, true
}

// HasLboRoamAllowed returns a boolean if a field has been set.
func (o *DnnRouteSelectionDescriptor) HasLboRoamAllowed() bool {
	if o != nil && !openapi.IsNil(o.LboRoamAllowed) {
		return true
	}
...
// SetLboRoamAllowed gets a reference to the given bool and assigns it to the LboRoamAllowed field.
func (o *DnnRouteSelectionDescriptor) SetLboRoamAllowed(v bool) {
	o.LboRoamAllowed = &v
}

func (o DnnRouteSelectionDescriptor) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["dnn"] = o.Dnn
	if !openapi.IsNil(o.SscModes) {
		toSerialize["sscModes"] = o.SscModes
	}
	if !openapi.IsNil(o.PduSessTypes) {
		toSerialize["pduSessTypes"] = o.PduSessTypes
	}
	if !openapi.IsNil(o.AtsssInfo) {
		toSerialize["atsssInfo"] = o.AtsssInfo
	}
	if !openapi.IsNil(o.LboRoamAllowed) {
		toSerialize["lboRoamAllowed"] = o.LboRoamAllowed
	}
