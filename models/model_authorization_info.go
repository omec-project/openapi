...
var _ openapi.MappedNullable = &AuthorizationInfo{}
...
type AuthorizationInfo struct {
	...
	MtcProviderInformation string `json:"mtcProviderInformation" yaml:"mtcProviderInformation"`
	// String providing an URI formatted according to RFC 3986.
	AuthUpdateCallbackUri string  `json:"authUpdateCallbackUri" yaml:"authUpdateCallbackUri"`
...
func (o AuthorizationInfo) ToMap() (map[string]any, error) {
