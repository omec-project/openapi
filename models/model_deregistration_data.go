...
var _ openapi.MappedNullable = &DeregistrationData{}

// DeregistrationData This datatype is supported by the POST HTTP method, and it includes the deregistration data.
...
func (o *DeregistrationData) GetNewSmfInstanceId() string {
	if o == nil || openapi.IsNil(o.NewSmfInstanceId) {
		var ret string
		return ret
	}
...
func (o DeregistrationData) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.NewSmfInstanceId) {
