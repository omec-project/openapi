...
var _ openapi.MappedNullable = &NwdafInfo{}

// NwdafInfo Information of a NWDAF NF Instance
type NwdafInfo struct {
	EventIds        []EventId        `json:"eventIds,omitempty" yaml:"eventIds,omitempty"`
	...
	NwdafCapability *NwdafCapability `json:"nwdafCapability,omitempty" yaml:"nwdafCapability,omitempty"`
	// indicating a time in seconds.
	AnalyticsDelay     *int32            `json:"analyticsDelay,omitempty" yaml:"analyticsDelay,omitempty"`
	...
	MlAnalyticsList    []MlAnalyticsInfo `json:"mlAnalyticsList,omitempty" yaml:"mlAnalyticsList,omitempty"`
}
...
func (o *NwdafInfo) GetEventIds() []EventId {
	if o == nil || openapi.IsNil(o.EventIds) {
		var ret []EventId
		return ret
	}
	return o.EventIds
...
func (o *NwdafInfo) GetNwdafEvents() []NwdafEvent {
	if o == nil || openapi.IsNil(o.NwdafEvents) {
		var ret []NwdafEvent
		return ret
	}
...
func (o *NwdafInfo) GetNwdafCapability() NwdafCapability {
	if o == nil || openapi.IsNil(o.NwdafCapability) {
...
func (o *NwdafInfo) GetAnalyticsDelay() int32 {
	if o == nil || openapi.IsNil(o.AnalyticsDelay) {
		var ret int32
		return ret
	}
...
func (o *NwdafInfo) GetMlAnalyticsList() []MlAnalyticsInfo {
	if o == nil || openapi.IsNil(o.MlAnalyticsList) {
...
func (o NwdafInfo) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.EventIds) {
		toSerialize["eventIds"] = o.EventIds
	}
	if !openapi.IsNil(o.NwdafEvents) {
	...
	if !openapi.IsNil(o.NwdafCapability) {
		toSerialize["nwdafCapability"] = o.NwdafCapability
	}
	if !openapi.IsNil(o.AnalyticsDelay) {
	...
	if !openapi.IsNil(o.MlAnalyticsList) {
