...
type SMSFDeregistrationFor3GPPAccessAPI interface {
	...
	*/
	Call3GppSmsfDeregistration(ctx context.Context, ueId string) ApiCall3GppSmsfDeregistrationRequest

	// Call3GppSmsfDeregistrationExecute executes the request
	Call3GppSmsfDeregistrationExecute(r ApiCall3GppSmsfDeregistrationRequest) (*http.Response, error)
}
...
type ApiCall3GppSmsfDeregistrationRequest struct {
	ctx        context.Context
	ApiService SMSFDeregistrationFor3GPPAccessAPI
	ueId       string
	smsfSetId  *string
	ifMatch    *string
}
