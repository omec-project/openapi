...
var _ openapi.MappedNullable = &PfdChangeNotification{}
...
func (o *PfdChangeNotification) GetRemovalFlag() bool {
	if o == nil || openapi.IsNil(o.RemovalFlag) {
		var ret bool
		return ret
	}
...
func (o PfdChangeNotification) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["applicationId"] = o.ApplicationId
	if !openapi.IsNil(o.RemovalFlag) {
