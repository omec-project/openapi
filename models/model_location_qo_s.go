...
var _ openapi.MappedNullable = &LocationQoS{}
...
type LocationQoS struct {
	...
	MinorLocQoses     []MinorLocationQoS `json:"minorLocQoses,omitempty" yaml:"minorLocQoses,omitempty"`
...
func (o *LocationQoS) GetMinorLocQoses() []MinorLocationQoS {
	if o == nil || openapi.IsNil(o.MinorLocQoses) {
...
func (o LocationQoS) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.MinorLocQoses) {
