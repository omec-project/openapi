...
var _ openapi.MappedNullable = &DispersionArea{}
...
type DispersionArea struct {
	...
	N3gaInd  *bool  `json:"n3gaInd,omitempty" yaml:"n3gaInd,omitempty"`
}
...
func (o *DispersionArea) GetN3gaInd() bool {
	if o == nil || openapi.IsNil(o.N3gaInd) {
		var ret bool
		return ret
	}
	return *o.N3gaInd
...
func (o DispersionArea) ToMap() (map[string]any, error) {
