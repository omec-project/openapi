...
var _ openapi.MappedNullable = &SmPolicyData{}
...
type SmPolicyData struct {
	...
	SmPolicySnssaiData map[string]SmPolicySnssaiData `json:"smPolicySnssaiData" yaml:"smPolicySnssaiData"`
	...
	UmDataLimits *map[string]UsageMonDataLimit `json:"umDataLimits,omitempty" yaml:"umDataLimits,omitempty"`
...
func (o *SmPolicyData) GetUmDataLimits() map[string]UsageMonDataLimit {
	if o == nil || openapi.IsNil(o.UmDataLimits) {
...
func (o SmPolicyData) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["smPolicySnssaiData"] = o.SmPolicySnssaiData
	if !openapi.IsNil(o.UmDataLimits) {
