...
var _ openapi.MappedNullable = &CivicAddress{}

// CivicAddress Indicates a Civic address.
type CivicAddress struct {
	Country    *string `json:"country,omitempty" yaml:"country,omitempty"`
	A1         *string `json:"A1,omitempty" yaml:"A1,omitempty"`
	A2         *string `json:"A2,omitempty" yaml:"A2,omitempty"`
	A3         *string `json:"A3,omitempty" yaml:"A3,omitempty"`
	A4         *string `json:"A4,omitempty" yaml:"A4,omitempty"`
	A5         *string `json:"A5,omitempty" yaml:"A5,omitempty"`
	A6         *string `json:"A6,omitempty" yaml:"A6,omitempty"`
	PRD        *string `json:"PRD,omitempty" yaml:"PRD,omitempty"`
	POD        *string `json:"POD,omitempty" yaml:"POD,omitempty"`
	STS        *string `json:"STS,omitempty" yaml:"STS,omitempty"`
	HNO        *string `json:"HNO,omitempty" yaml:"HNO,omitempty"`
	HNS        *string `json:"HNS,omitempty" yaml:"HNS,omitempty"`
	LMK        *string `json:"LMK,omitempty" yaml:"LMK,omitempty"`
	LOC        *string `json:"LOC,omitempty" yaml:"LOC,omitempty"`
	NAM        *string `json:"NAM,omitempty" yaml:"NAM,omitempty"`
	PC         *string `json:"PC,omitempty" yaml:"PC,omitempty"`
	BLD        *string `json:"BLD,omitempty" yaml:"BLD,omitempty"`
	UNIT       *string `json:"UNIT,omitempty" yaml:"UNIT,omitempty"`
	FLR        *string `json:"FLR,omitempty" yaml:"FLR,omitempty"`
	ROOM       *string `json:"ROOM,omitempty" yaml:"ROOM,omitempty"`
	PLC        *string `json:"PLC,omitempty" yaml:"PLC,omitempty"`
	PCN        *string `json:"PCN,omitempty" yaml:"PCN,omitempty"`
	POBOX      *string `json:"POBOX,omitempty" yaml:"POBOX,omitempty"`
	ADDCODE    *string `json:"ADDCODE,omitempty" yaml:"ADDCODE,omitempty"`
	SEAT       *string `json:"SEAT,omitempty" yaml:"SEAT,omitempty"`
	RD         *string `json:"RD,omitempty" yaml:"RD,omitempty"`
	RDSEC      *string `json:"RDSEC,omitempty" yaml:"RDSEC,omitempty"`
	RDBR       *string `json:"RDBR,omitempty" yaml:"RDBR,omitempty"`
	RDSUBBR    *string `json:"RDSUBBR,omitempty" yaml:"RDSUBBR,omitempty"`
	PRM        *string `json:"PRM,omitempty" yaml:"PRM,omitempty"`
	POM        *string `json:"POM,omitempty" yaml:"POM,omitempty"`
	UsageRules *string `json:"usageRules,omitempty" yaml:"usageRules,omitempty"`
	Method     *string `json:"method,omitempty" yaml:"method,omitempty"`
	ProvidedBy *string `json:"providedBy,omitempty" yaml:"providedBy,omitempty"`
}
...
func (o *CivicAddress) GetPOBOX() string {
	if o == nil || openapi.IsNil(o.POBOX) {
		var ret string
		return ret
	}
	return *o.POBOX
...
func (o *CivicAddress) GetADDCODE() string {
	if o == nil || openapi.IsNil(o.ADDCODE) {
		var ret string
		return ret
	}
	return *o.ADDCODE
...
func (o *CivicAddress) GetRDSEC() string {
	if o == nil || openapi.IsNil(o.RDSEC) {
		var ret string
		return ret
	}
	return *o.RDSEC
...
func (o *CivicAddress) GetRDSUBBR() string {
	if o == nil || openapi.IsNil(o.RDSUBBR) {
		var ret string
		return ret
	}
	return *o.RDSUBBR
...
func (o *CivicAddress) GetUsageRules() string {
	if o == nil || openapi.IsNil(o.UsageRules) {
		var ret string
		return ret
	}
	return *o.UsageRules
...
func (o *CivicAddress) GetMethod() string {
	if o == nil || openapi.IsNil(o.Method) {
		var ret string
		return ret
	}
	return *o.Method
...
func (o *CivicAddress) GetProvidedBy() string {
	if o == nil || openapi.IsNil(o.ProvidedBy) {
		var ret string
		return ret
	}
	return *o.ProvidedBy
...
func (o CivicAddress) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.Country) {
		toSerialize["country"] = o.Country
	}
	if !openapi.IsNil(o.A1) {
		toSerialize["A1"] = o.A1
	}
	if !openapi.IsNil(o.A2) {
		toSerialize["A2"] = o.A2
	}
	if !openapi.IsNil(o.A3) {
		toSerialize["A3"] = o.A3
	}
	if !openapi.IsNil(o.A4) {
		toSerialize["A4"] = o.A4
	}
	if !openapi.IsNil(o.A5) {
		toSerialize["A5"] = o.A5
	}
	if !openapi.IsNil(o.A6) {
		toSerialize["A6"] = o.A6
	}
	if !openapi.IsNil(o.PRD) {
		toSerialize["PRD"] = o.PRD
	}
	if !openapi.IsNil(o.POD) {
		toSerialize["POD"] = o.POD
	}
	if !openapi.IsNil(o.STS) {
		toSerialize["STS"] = o.STS
	}
	if !openapi.IsNil(o.HNO) {
		toSerialize["HNO"] = o.HNO
	}
	if !openapi.IsNil(o.HNS) {
		toSerialize["HNS"] = o.HNS
	}
	if !openapi.IsNil(o.LMK) {
		toSerialize["LMK"] = o.LMK
	}
	if !openapi.IsNil(o.LOC) {
		toSerialize["LOC"] = o.LOC
	}
	if !openapi.IsNil(o.NAM) {
		toSerialize["NAM"] = o.NAM
	}
	if !openapi.IsNil(o.PC) {
		toSerialize["PC"] = o.PC
	}
	if !openapi.IsNil(o.BLD) {
		toSerialize["BLD"] = o.BLD
	}
	if !openapi.IsNil(o.UNIT) {
		toSerialize["UNIT"] = o.UNIT
	}
	if !openapi.IsNil(o.FLR) {
		toSerialize["FLR"] = o.FLR
	}
	if !openapi.IsNil(o.ROOM) {
		toSerialize["ROOM"] = o.ROOM
	}
	if !openapi.IsNil(o.PLC) {
		toSerialize["PLC"] = o.PLC
	}
	if !openapi.IsNil(o.PCN) {
		toSerialize["PCN"] = o.PCN
	}
	if !openapi.IsNil(o.POBOX) {
		toSerialize["POBOX"] = o.POBOX
	}
	if !openapi.IsNil(o.ADDCODE) {
		toSerialize["ADDCODE"] = o.ADDCODE
	}
	if !openapi.IsNil(o.SEAT) {
		toSerialize["SEAT"] = o.SEAT
	}
	if !openapi.IsNil(o.RD) {
		toSerialize["RD"] = o.RD
	}
	if !openapi.IsNil(o.RDSEC) {
		toSerialize["RDSEC"] = o.RDSEC
	}
	if !openapi.IsNil(o.RDBR) {
		toSerialize["RDBR"] = o.RDBR
	}
	if !openapi.IsNil(o.RDSUBBR) {
		toSerialize["RDSUBBR"] = o.RDSUBBR
	}
	if !openapi.IsNil(o.PRM) {
		toSerialize["PRM"] = o.PRM
	}
	if !openapi.IsNil(o.POM) {
		toSerialize["POM"] = o.POM
	}
	if !openapi.IsNil(o.UsageRules) {
		toSerialize["usageRules"] = o.UsageRules
	}
	if !openapi.IsNil(o.Method) {
		toSerialize["method"] = o.Method
	}
	if !openapi.IsNil(o.ProvidedBy) {
