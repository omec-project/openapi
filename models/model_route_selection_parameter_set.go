...
var _ openapi.MappedNullable = &RouteSelectionParameterSet{}
...
type RouteSelectionParameterSet struct {
	...
	SpatialValidityAreas []GeographicalArea `json:"spatialValidityAreas,omitempty" yaml:"spatialValidityAreas,omitempty"`
	...
	SpatialValidityTais []Tai           `json:"spatialValidityTais,omitempty" yaml:"spatialValidityTais,omitempty"`
...
func (o *RouteSelectionParameterSet) GetSpatialValidityAreas() []GeographicalArea {
	if o == nil || openapi.IsNil(o.SpatialValidityAreas) {
...
func (o *RouteSelectionParameterSet) GetSpatialValidityTais() []Tai {
	if o == nil || openapi.IsNil(o.SpatialValidityTais) {
		var ret []Tai
		return ret
	}
...
func (o *RouteSelectionParameterSet) GetPduSessType() PduSessionType {
...
// and a boolean to check if the value has been set.
func (o *RouteSelectionParameterSet) GetPduSessTypeOk() (*PduSessionType, bool) {
	if o == nil || openapi.IsNil(o.PduSessType) {
		return nil, false
	}
...
func (o *RouteSelectionParameterSet) HasPduSessType() bool {
	if o != nil && !openapi.IsNil(o.PduSessType) {
		return true
	}
...
func (o *RouteSelectionParameterSet) SetPduSessType(v PduSessionType) {
	o.PduSessType = &v
}

func (o RouteSelectionParameterSet) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.SpatialValidityAreas) {
		toSerialize["spatialValidityAreas"] = o.SpatialValidityAreas
	}
	if !openapi.IsNil(o.SpatialValidityTais) {
