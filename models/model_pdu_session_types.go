...
var _ openapi.MappedNullable = &PduSessionTypes{}

// PduSessionTypes struct for PduSessionTypes
type PduSessionTypes struct {
	DefaultSessionType  *PduSessionType  `json:"defaultSessionType,omitempty" yaml:"defaultSessionType,omitempty"`
	AllowedSessionTypes []PduSessionType `json:"allowedSessionTypes,omitempty" yaml:"allowedSessionTypes,omitempty"`
}
...
func (o *PduSessionTypes) GetDefaultSessionType() PduSessionType {
	if o == nil || openapi.IsNil(o.DefaultSessionType) {
...
func (o *PduSessionTypes) GetAllowedSessionTypes() []PduSessionType {
	if o == nil || openapi.IsNil(o.AllowedSessionTypes) {
		var ret []PduSessionType
		return ret
	}
...
func (o PduSessionTypes) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.DefaultSessionType) {
		toSerialize["defaultSessionType"] = o.DefaultSessionType
	}
	if !openapi.IsNil(o.AllowedSessionTypes) {
