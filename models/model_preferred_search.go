...
var _ openapi.MappedNullable = &PreferredSearch{}
...
type PreferredSearch struct {
	PreferredTaiMatchInd               *bool `json:"preferredTaiMatchInd,omitempty" yaml:"preferredTaiMatchInd,omitempty"`
	PreferredFullPlmnMatchInd          *bool `json:"preferredFullPlmnMatchInd,omitempty" yaml:"preferredFullPlmnMatchInd,omitempty"`
	PreferredApiVersionsMatchInd       *bool `json:"preferredApiVersionsMatchInd,omitempty" yaml:"preferredApiVersionsMatchInd,omitempty"`
	OtherApiVersionsInd                *bool `json:"otherApiVersionsInd,omitempty" yaml:"otherApiVersionsInd,omitempty"`
	PreferredLocalityMatchInd          *bool `json:"preferredLocalityMatchInd,omitempty" yaml:"preferredLocalityMatchInd,omitempty"`
	OtherLocalityInd                   *bool `json:"otherLocalityInd,omitempty" yaml:"otherLocalityInd,omitempty"`
	PreferredVendorSpecificFeaturesInd *bool `json:"preferredVendorSpecificFeaturesInd,omitempty" yaml:"preferredVendorSpecificFeaturesInd,omitempty"`
	PreferredCollocatedNfTypeInd       *bool `json:"preferredCollocatedNfTypeInd,omitempty" yaml:"preferredCollocatedNfTypeInd,omitempty"`
	PreferredPgwMatchInd               *bool `json:"preferredPgwMatchInd,omitempty" yaml:"preferredPgwMatchInd,omitempty"`
	PreferredAnalyticsDelaysInd        *bool `json:"preferredAnalyticsDelaysInd,omitempty" yaml:"preferredAnalyticsDelaysInd,omitempty"`
	PreferredFeaturesMatchInd          *bool `json:"preferredFeaturesMatchInd,omitempty" yaml:"preferredFeaturesMatchInd,omitempty"`
	NoPreferredFeaturesInd             *bool `json:"noPreferredFeaturesInd,omitempty" yaml:"noPreferredFeaturesInd,omitempty"`
}
...
func (o *PreferredSearch) GetPreferredTaiMatchInd() bool {
	if o == nil || openapi.IsNil(o.PreferredTaiMatchInd) {
		var ret bool
		return ret
	}
...
func (o *PreferredSearch) GetPreferredFullPlmnMatchInd() bool {
	if o == nil || openapi.IsNil(o.PreferredFullPlmnMatchInd) {
		var ret bool
		return ret
	}
...
func (o *PreferredSearch) GetPreferredApiVersionsMatchInd() bool {
	if o == nil || openapi.IsNil(o.PreferredApiVersionsMatchInd) {
		var ret bool
		return ret
	}
...
func (o *PreferredSearch) GetOtherApiVersionsInd() bool {
	if o == nil || openapi.IsNil(o.OtherApiVersionsInd) {
		var ret bool
		return ret
	}
...
func (o *PreferredSearch) GetPreferredLocalityMatchInd() bool {
	if o == nil || openapi.IsNil(o.PreferredLocalityMatchInd) {
		var ret bool
		return ret
	}
...
func (o *PreferredSearch) GetOtherLocalityInd() bool {
	if o == nil || openapi.IsNil(o.OtherLocalityInd) {
		var ret bool
		return ret
	}
...
func (o *PreferredSearch) GetPreferredVendorSpecificFeaturesInd() bool {
	if o == nil || openapi.IsNil(o.PreferredVendorSpecificFeaturesInd) {
		var ret bool
		return ret
	}
...
func (o *PreferredSearch) GetPreferredCollocatedNfTypeInd() bool {
	if o == nil || openapi.IsNil(o.PreferredCollocatedNfTypeInd) {
		var ret bool
		return ret
	}
...
func (o *PreferredSearch) GetPreferredPgwMatchInd() bool {
	if o == nil || openapi.IsNil(o.PreferredPgwMatchInd) {
		var ret bool
		return ret
	}
...
func (o *PreferredSearch) GetPreferredAnalyticsDelaysInd() bool {
	if o == nil || openapi.IsNil(o.PreferredAnalyticsDelaysInd) {
		var ret bool
		return ret
	}
...
func (o *PreferredSearch) GetPreferredFeaturesMatchInd() bool {
	if o == nil || openapi.IsNil(o.PreferredFeaturesMatchInd) {
		var ret bool
		return ret
	}
...
func (o *PreferredSearch) GetNoPreferredFeaturesInd() bool {
	if o == nil || openapi.IsNil(o.NoPreferredFeaturesInd) {
		var ret bool
		return ret
	}
