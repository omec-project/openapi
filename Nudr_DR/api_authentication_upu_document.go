...
type AuthenticationUPUDocumentAPI interface {
	...
	*/
	CreateAuthenticationUPU(ctx context.Context, ueId string) ApiCreateAuthenticationUPURequest

	// CreateAuthenticationUPUExecute executes the request
	CreateAuthenticationUPUExecute(r ApiCreateAuthenticationUPURequest) (*http.Response, error)
	...
	*/
	QueryAuthUPU(ctx context.Context, ueId string) ApiQueryAuthUPURequest

	// QueryAuthUPUExecute executes the request
	//   @return UpuDataUdr
	QueryAuthUPUExecute(r ApiQueryAuthUPURequest) (*models.UpuDataUdr, *http.Response, error)
}
...
type ApiCreateAuthenticationUPURequest struct {
	ctx               context.Context
	ApiService        AuthenticationUPUDocumentAPI
	ueId              string
	upuDataUdr        *models.UpuDataUdr
	supportedFeatures *string
}

func (r ApiCreateAuthenticationUPURequest) UpuDataUdr(upuDataUdr models.UpuDataUdr) ApiCreateAuthenticationUPURequest {
	r.upuDataUdr = &upuDataUdr
	return r
}
...
func (a *AuthenticationUPUDocumentAPIService) CreateAuthenticationUPUExecute(r ApiCreateAuthenticationUPURequest) (*http.Response, error) {
	...
	if r.upuDataUdr == nil {
		return nil, openapi.ReportError("upuDataUdr is required and must be specified")
	}
...
func (r ApiQueryAuthUPURequest) Execute() (*models.UpuDataUdr, *http.Response, error) {
...
//
//	@return UpuDataUdr
func (a *AuthenticationUPUDocumentAPIService) QueryAuthUPUExecute(r ApiQueryAuthUPURequest) (*models.UpuDataUdr, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    any
		formFiles           []formFile
		localVarReturnValue *models.UpuDataUdr
	)
