...
var _ openapi.MappedNullable = &AuthenticationInfo{}
...
type AuthenticationInfo struct {
	...
	SupiOrSuci            string                 `json:"supiOrSuci" yaml:"supiOrSuci" validate:"regexp=^(imsi-[0-9]{5,15}|nai-.+|gli-.+|gci-.+|suci-(0-[0-9]{3}-[0-9]{2,3}|[1-7]-.+)-[0-9]{1,4}-(0-0-.*|[a-fA-F1-9]-([1-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])-[a-fA-F0-9]+)|.+)$"`
	ServingNetworkName    string                 `json:"servingNetworkName" yaml:"servingNetworkName" validate:"regexp=^(5G:mnc[0-9]{3}[.]mcc[0-9]{3}[.]3gppnetwork[.]org(:[A-F0-9]{11})?)|5G:NSWO$"`
	ResynchronizationInfo *ResynchronizationInfo `json:"resynchronizationInfo,omitempty" yaml:"resynchronizationInfo,omitempty"`
	...
	N5gcInd          *bool    `json:"n5gcInd,omitempty" yaml:"n5gcInd,omitempty"`
	...
	NswoInd            *bool   `json:"nswoInd,omitempty" yaml:"nswoInd,omitempty"`
	...
	Aun3Ind            *bool   `json:"aun3Ind,omitempty" yaml:"aun3Ind,omitempty"`
}
...
func NewAuthenticationInfo(supiOrSuci string, servingNetworkName string) *AuthenticationInfo {
	...
	var aun3Ind bool = false
	this.Aun3Ind = &aun3Ind
	return &this
}
...
func (o *AuthenticationInfo) GetResynchronizationInfo() ResynchronizationInfo {
	if o == nil || openapi.IsNil(o.ResynchronizationInfo) {
...
func (o *AuthenticationInfo) GetN5gcInd() bool {
	if o == nil || openapi.IsNil(o.N5gcInd) {
		var ret bool
		return ret
	}
	return *o.N5gcInd
...
func (o *AuthenticationInfo) GetNswoInd() bool {
	if o == nil || openapi.IsNil(o.NswoInd) {
		var ret bool
		return ret
	}
	return *o.NswoInd
...
// GetAun3Ind returns the Aun3Ind field value if set, zero value otherwise.
func (o *AuthenticationInfo) GetAun3Ind() bool {
	if o == nil || openapi.IsNil(o.Aun3Ind) {
		var ret bool
		return ret
	}
	return *o.Aun3Ind
...
// GetAun3IndOk returns a tuple with the Aun3Ind field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AuthenticationInfo) GetAun3IndOk() (*bool, bool) {
	if o == nil || openapi.IsNil(o.Aun3Ind) {
		return nil, false
	}
	return o.Aun3Ind, true
}

// HasAun3Ind returns a boolean if a field has been set.
func (o *AuthenticationInfo) HasAun3Ind() bool {
	if o != nil && !openapi.IsNil(o.Aun3Ind) {
		return true
	}
...
// SetAun3Ind gets a reference to the given bool and assigns it to the Aun3Ind field.
func (o *AuthenticationInfo) SetAun3Ind(v bool) {
	o.Aun3Ind = &v
}

func (o AuthenticationInfo) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["supiOrSuci"] = o.SupiOrSuci
	toSerialize["servingNetworkName"] = o.ServingNetworkName
	if !openapi.IsNil(o.ResynchronizationInfo) {
	...
	if !openapi.IsNil(o.Aun3Ind) {
		toSerialize["aun3Ind"] = o.Aun3Ind
	}
