...
var _ openapi.MappedNullable = &DnPerf{}

// DnPerf Represents DN performance for the application.
type DnPerf struct {
	AppServerInsAddr *AddrFqdn       `json:"appServerInsAddr,omitempty" yaml:"appServerInsAddr,omitempty"`
	...
	PerfData         PerfData         `json:"perfData" yaml:"perfData"`
	SpatialValidCon  *NetworkAreaInfo `json:"spatialValidCon,omitempty" yaml:"spatialValidCon,omitempty"`
	TemporalValidCon *TimeWindow      `json:"temporalValidCon,omitempty" yaml:"temporalValidCon,omitempty"`
}
...
func (o *DnPerf) GetAppServerInsAddr() AddrFqdn {
	if o == nil || openapi.IsNil(o.AppServerInsAddr) {
		var ret AddrFqdn
		return ret
	}
...
func (o *DnPerf) GetTemporalValidCon() TimeWindow {
	if o == nil || openapi.IsNil(o.TemporalValidCon) {
		var ret TimeWindow
		return ret
	}
...
func (o DnPerf) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.AppServerInsAddr) {
	...
	if !openapi.IsNil(o.TemporalValidCon) {
