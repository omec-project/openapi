...
var _ openapi.MappedNullable = &N1N2MsgTxfrErrDetail{}
...
type N1N2MsgTxfrErrDetail struct {
	...
	HighestPrioArp *Arp   `json:"highestPrioArp,omitempty" yaml:"highestPrioArp,omitempty"`
...
func (o *N1N2MsgTxfrErrDetail) GetHighestPrioArp() Arp {
	if o == nil || openapi.IsNil(o.HighestPrioArp) {
		var ret Arp
		return ret
	}
...
func (o N1N2MsgTxfrErrDetail) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.RetryAfter) {
		toSerialize["retryAfter"] = o.RetryAfter
	}
	if !openapi.IsNil(o.HighestPrioArp) {
