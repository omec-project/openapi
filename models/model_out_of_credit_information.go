...
var _ openapi.MappedNullable = &OutOfCreditInformation{}
...
type OutOfCreditInformation struct {
	FinUnitAct FinalUnitAction `json:"finUnitAct" yaml:"finUnitAct"`
...
func (o OutOfCreditInformation) ToMap() (map[string]any, error) {
