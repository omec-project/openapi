...
var _ openapi.MappedNullable = &FqdnPatternMatchingRule{}
...
func (o *FqdnPatternMatchingRule) GetRegex() string {
	if o == nil || openapi.IsNil(o.Regex) {
		var ret string
		return ret
	}
	return *o.Regex
...
func (o *FqdnPatternMatchingRule) GetStringMatchingRule() StringMatchingRule {
	if o == nil || openapi.IsNil(o.StringMatchingRule) {
...
func (o FqdnPatternMatchingRule) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.Regex) {
		toSerialize["regex"] = o.Regex
	}
	if !openapi.IsNil(o.StringMatchingRule) {
