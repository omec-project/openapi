...
var _ openapi.MappedNullable = &Lpi{}

// Lpi struct for Lpi
type Lpi struct {
	LocationPrivacyInd LocationPrivacyInd `json:"locationPrivacyInd" yaml:"locationPrivacyInd"`
...
func (o Lpi) ToMap() (map[string]any, error) {
