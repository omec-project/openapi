...
var _ openapi.MappedNullable = &CreateUEContextRequest{}

// CreateUEContextRequest struct for CreateUEContextRequest
type CreateUEContextRequest struct {
	JsonData                     *UeContextCreateData `json:"jsonData,omitempty" yaml:"jsonData,omitempty" multipart:"contentType:application/json,ref:{jsonData}"`
	...
	BinaryDataN2InformationExt17 **os.File            `json:"binaryDataN2InformationExt17,omitempty" yaml:"binaryDataN2InformationExt17,omitempty" multipart:"contentType:application/vnd.3gpp.ngap,ref:{binaryDataN2InformationExt17}"`
}
...
func (o *CreateUEContextRequest) GetBinaryDataN2InformationExt17() *os.File {
	if o == nil || openapi.IsNil(o.BinaryDataN2InformationExt17) {
		var ret *os.File
		return ret
	}
...
func (o CreateUEContextRequest) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.BinaryDataN2InformationExt17) {
