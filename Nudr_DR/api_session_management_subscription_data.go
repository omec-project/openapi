...
type SessionManagementSubscriptionDataAPI interface {
	...
	*/
	QuerySmData(ctx context.Context, ueId string, servingPlmnId string) ApiQuerySmDataRequest

	// QuerySmDataExecute executes the request
	//   @return SmSubsData
	QuerySmDataExecute(r ApiQuerySmDataRequest) (*models.SmSubsData, *http.Response, error)
}
...
type ApiQuerySmDataRequest struct {
	ctx               context.Context
	ApiService        SessionManagementSubscriptionDataAPI
	ueId              string
...
// single NSSAI
func (r ApiQuerySmDataRequest) SingleNssai(singleNssai models.Snssai) ApiQuerySmDataRequest {
...
func (r ApiQuerySmDataRequest) Execute() (*models.SmSubsData, *http.Response, error) {
...
//
//	@return SmSubsData
func (a *SessionManagementSubscriptionDataAPIService) QuerySmDataExecute(r ApiQuerySmDataRequest) (*models.SmSubsData, *http.Response, error) {
	var (
