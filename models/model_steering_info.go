...
var _ openapi.MappedNullable = &SteeringInfo{}
...
type SteeringInfo struct {
	...
	AccessTechList []AccessTech `json:"accessTechList,omitempty" yaml:"accessTechList,omitempty"`
}
...
func (o *SteeringInfo) GetAccessTechList() []AccessTech {
	if o == nil || openapi.IsNil(o.AccessTechList) {
		var ret []AccessTech
		return ret
	}
...
func (o SteeringInfo) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["plmnId"] = o.PlmnId
	if !openapi.IsNil(o.AccessTechList) {
