...
type LocationContextTransferAPI interface {
	...
	*/
	LocationContextTransfer(ctx context.Context) ApiLocationContextTransferRequest

	// LocationContextTransferExecute executes the request
	LocationContextTransferExecute(r ApiLocationContextTransferRequest) (*http.Response, error)
}
...
type ApiLocationContextTransferRequest struct {
	ctx            context.Context
	ApiService     LocationContextTransferAPI
	locContextData *models.LocContextData
}

func (r ApiLocationContextTransferRequest) LocContextData(locContextData models.LocContextData) ApiLocationContextTransferRequest {
...
func (a *LocationContextTransferAPIService) LocationContextTransferExecute(r ApiLocationContextTransferRequest) (*http.Response, error) {
	...
	if r.locContextData == nil {
		return nil, openapi.ReportError("locContextData is required and must be specified")
	}
