...
var _ openapi.MappedNullable = &N2SmInformation{}
...
type N2SmInformation struct {
	...
	N2InfoContent  *N2InfoContent `json:"n2InfoContent,omitempty" yaml:"n2InfoContent,omitempty"`
	SNssai         *Snssai        `json:"sNssai,omitempty" yaml:"sNssai,omitempty"`
	HomePlmnSnssai *Snssai        `json:"homePlmnSnssai,omitempty" yaml:"homePlmnSnssai,omitempty"`
	IwkSnssai      *Snssai        `json:"iwkSnssai,omitempty" yaml:"iwkSnssai,omitempty"`
	SubjectToHo    *bool          `json:"subjectToHo,omitempty" yaml:"subjectToHo,omitempty"`
}
...
func (o *N2SmInformation) GetN2InfoContent() N2InfoContent {
	if o == nil || openapi.IsNil(o.N2InfoContent) {
...
func (o *N2SmInformation) GetHomePlmnSnssai() Snssai {
	if o == nil || openapi.IsNil(o.HomePlmnSnssai) {
		var ret Snssai
		return ret
	}
...
func (o *N2SmInformation) GetIwkSnssai() Snssai {
	if o == nil || openapi.IsNil(o.IwkSnssai) {
		var ret Snssai
		return ret
	}
	return *o.IwkSnssai
...
func (o *N2SmInformation) GetSubjectToHo() bool {
	if o == nil || openapi.IsNil(o.SubjectToHo) {
		var ret bool
		return ret
	}
