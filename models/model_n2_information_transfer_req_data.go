...
var _ openapi.MappedNullable = &N2InformationTransferReqData{}
...
type N2InformationTransferReqData struct {
	...
	RatSelector       *RatSelector      `json:"ratSelector,omitempty" yaml:"ratSelector,omitempty"`
	GlobalRanNodeList []GlobalRanNodeId `json:"globalRanNodeList,omitempty" yaml:"globalRanNodeList,omitempty"`
	N2Information     N2InfoContainer   `json:"n2Information" yaml:"n2Information"`
...
func (o *N2InformationTransferReqData) GetRatSelector() RatSelector {
	if o == nil || openapi.IsNil(o.RatSelector) {
		var ret RatSelector
		return ret
	}
...
func (o N2InformationTransferReqData) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.TaiList) {
		toSerialize["taiList"] = o.TaiList
	}
	if !openapi.IsNil(o.RatSelector) {
