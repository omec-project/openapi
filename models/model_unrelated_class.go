...
var _ openapi.MappedNullable = &UnrelatedClass{}

// UnrelatedClass struct for UnrelatedClass
type UnrelatedClass struct {
	DefaultUnrelatedClass       DefaultUnrelatedClass       `json:"defaultUnrelatedClass" yaml:"defaultUnrelatedClass"`
	ExternalUnrelatedClass      *ExternalUnrelatedClass     `json:"externalUnrelatedClass,omitempty" yaml:"externalUnrelatedClass,omitempty"`
	ServiceTypeUnrelatedClasses []ServiceTypeUnrelatedClass `json:"serviceTypeUnrelatedClasses,omitempty" yaml:"serviceTypeUnrelatedClasses,omitempty"`
}
...
func (o *UnrelatedClass) GetExternalUnrelatedClass() ExternalUnrelatedClass {
	if o == nil || openapi.IsNil(o.ExternalUnrelatedClass) {
...
func (o *UnrelatedClass) GetServiceTypeUnrelatedClasses() []ServiceTypeUnrelatedClass {
	if o == nil || openapi.IsNil(o.ServiceTypeUnrelatedClasses) {
...
func (o UnrelatedClass) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["defaultUnrelatedClass"] = o.DefaultUnrelatedClass
	if !openapi.IsNil(o.ExternalUnrelatedClass) {
		toSerialize["externalUnrelatedClass"] = o.ExternalUnrelatedClass
	}
	if !openapi.IsNil(o.ServiceTypeUnrelatedClasses) {
