...
var _ openapi.MappedNullable = &AccuUsageReport{}
...
type AccuUsageReport struct {
	...
	RefUmIds string `json:"refUmIds" yaml:"refUmIds"`
	// Unsigned integer identifying a volume in units of bytes.
	VolUsage *int64 `json:"volUsage,omitempty" yaml:"volUsage,omitempty"`
	// Unsigned integer identifying a volume in units of bytes.
	VolUsageUplink *int64 `json:"volUsageUplink,omitempty" yaml:"volUsageUplink,omitempty"`
	// Unsigned integer identifying a volume in units of bytes.
	VolUsageDownlink *int64 `json:"volUsageDownlink,omitempty" yaml:"volUsageDownlink,omitempty"`
	// indicating a time in seconds.
	TimeUsage *int32 `json:"timeUsage,omitempty" yaml:"timeUsage,omitempty"`
	// Unsigned integer identifying a volume in units of bytes.
	NextVolUsage *int64 `json:"nextVolUsage,omitempty" yaml:"nextVolUsage,omitempty"`
	// Unsigned integer identifying a volume in units of bytes.
	NextVolUsageUplink *int64 `json:"nextVolUsageUplink,omitempty" yaml:"nextVolUsageUplink,omitempty"`
	// Unsigned integer identifying a volume in units of bytes.
	NextVolUsageDownlink *int64 `json:"nextVolUsageDownlink,omitempty" yaml:"nextVolUsageDownlink,omitempty"`
	// indicating a time in seconds.
	NextTimeUsage *int32 `json:"nextTimeUsage,omitempty" yaml:"nextTimeUsage,omitempty"`
}
...
func (o *AccuUsageReport) GetVolUsage() int64 {
	if o == nil || openapi.IsNil(o.VolUsage) {
		var ret int64
		return ret
	}
	return *o.VolUsage
...
func (o *AccuUsageReport) GetVolUsageUplink() int64 {
	if o == nil || openapi.IsNil(o.VolUsageUplink) {
		var ret int64
		return ret
	}
...
func (o *AccuUsageReport) GetVolUsageDownlink() int64 {
	if o == nil || openapi.IsNil(o.VolUsageDownlink) {
		var ret int64
		return ret
	}
...
func (o *AccuUsageReport) GetTimeUsage() int32 {
	if o == nil || openapi.IsNil(o.TimeUsage) {
		var ret int32
		return ret
	}
	return *o.TimeUsage
...
func (o *AccuUsageReport) GetNextVolUsage() int64 {
	if o == nil || openapi.IsNil(o.NextVolUsage) {
		var ret int64
		return ret
	}
...
func (o *AccuUsageReport) GetNextVolUsageUplink() int64 {
	if o == nil || openapi.IsNil(o.NextVolUsageUplink) {
		var ret int64
		return ret
	}
...
func (o *AccuUsageReport) GetNextVolUsageDownlink() int64 {
	if o == nil || openapi.IsNil(o.NextVolUsageDownlink) {
		var ret int64
		return ret
	}
...
func (o *AccuUsageReport) GetNextTimeUsage() int32 {
	if o == nil || openapi.IsNil(o.NextTimeUsage) {
		var ret int32
		return ret
	}
