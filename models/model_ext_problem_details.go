...
var _ openapi.MappedNullable = &ExtProblemDetails{}
...
func (o *ExtProblemDetails) GetNoProfileMatchInfo() NoProfileMatchInfo {
...
// and a boolean to check if the value has been set.
func (o *ExtProblemDetails) GetNoProfileMatchInfoOk() (*NoProfileMatchInfo, bool) {
	if o == nil || openapi.IsNil(o.NoProfileMatchInfo) {
		return nil, false
	}
...
func (o *ExtProblemDetails) HasNoProfileMatchInfo() bool {
	if o != nil && !openapi.IsNil(o.NoProfileMatchInfo) {
		return true
	}
...
func (o *ExtProblemDetails) SetNoProfileMatchInfo(v NoProfileMatchInfo) {
...
func (o ExtProblemDetails) ToMap() (map[string]any, error) {
