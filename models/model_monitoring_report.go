...
var _ openapi.MappedNullable = &MonitoringReport{}
...
type MonitoringReport struct {
	...
	ReachabilityReport *ReachabilityReport `json:"reachabilityReport,omitempty" yaml:"reachabilityReport,omitempty"`
}
...
func NewMonitoringReport(referenceId int32, eventType EventTypeUdm, timeStamp time.Time) *MonitoringReport {
...
func (o *MonitoringReport) GetEventType() EventTypeUdm {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *MonitoringReport) GetEventTypeOk() (*EventTypeUdm, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *MonitoringReport) SetEventType(v EventTypeUdm) {
	o.EventType = v
}
...
func (o *MonitoringReport) GetReachabilityForSmsReport() ReachabilityForSmsReport {
	if o == nil || openapi.IsNil(o.ReachabilityForSmsReport) {
...
func (o *MonitoringReport) GetReachabilityReport() ReachabilityReport {
	if o == nil || openapi.IsNil(o.ReachabilityReport) {
...
func (o MonitoringReport) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.ReachabilityForSmsReport) {
	...
	if !openapi.IsNil(o.ReachabilityReport) {
