...
type RetrievalOfIndividualSharedDataAPI interface {
...
type ApiGetIndividualSharedDataRequest struct {
	ctx             context.Context
	ApiService      RetrievalOfIndividualSharedDataAPI
	sharedDataId    string
	ifNoneMatch     *string
...
//
//	@return SharedDataUdm1
func (a *RetrievalOfIndividualSharedDataAPIService) GetIndividualSharedDataExecute(r ApiGetIndividualSharedDataRequest) (*models.SharedDataUdm, *http.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/subscription-data/shared-data/{sharedDataId}"
