...
var _ openapi.MappedNullable = &EpsPdnCnxInfo{}

// EpsPdnCnxInfo EPS PDN Connection Information from H-SMF to V-SMF, or from SMF to I-SMF
type EpsPdnCnxInfo struct {
	// string with format 'bytes' as defined in OpenAPI
	PgwS8cFteid string `json:"pgwS8cFteid" yaml:"pgwS8cFteid"`
	// string with format 'bytes' as defined in OpenAPI
	PgwNodeName *string `json:"pgwNodeName,omitempty" yaml:"pgwNodeName,omitempty"`
	// string with format 'bytes' as defined in OpenAPI
	PgwChangeInfo *string `json:"pgwChangeInfo,omitempty" yaml:"pgwChangeInfo,omitempty"`
	// EPS Bearer Identifier
	LinkedBearerId *int32 `json:"linkedBearerId,omitempty" yaml:"linkedBearerId,omitempty"`
}
...
func (o *EpsPdnCnxInfo) GetPgwNodeName() string {
	if o == nil || openapi.IsNil(o.PgwNodeName) {
		var ret string
		return ret
	}
...
func (o *EpsPdnCnxInfo) GetPgwChangeInfo() string {
	if o == nil || openapi.IsNil(o.PgwChangeInfo) {
		var ret string
		return ret
	}
...
func (o *EpsPdnCnxInfo) GetLinkedBearerId() int32 {
	if o == nil || openapi.IsNil(o.LinkedBearerId) {
		var ret int32
		return ret
	}
...
func (o EpsPdnCnxInfo) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["pgwS8cFteid"] = o.PgwS8cFteid
	if !openapi.IsNil(o.PgwNodeName) {
		toSerialize["pgwNodeName"] = o.PgwNodeName
	}
	if !openapi.IsNil(o.PgwChangeInfo) {
		toSerialize["pgwChangeInfo"] = o.PgwChangeInfo
	}
	if !openapi.IsNil(o.LinkedBearerId) {
