...
var _ openapi.MappedNullable = &AuthEvent{}
...
type AuthEvent struct {
	...
	AuthRemovalInd     *bool     `json:"authRemovalInd,omitempty" yaml:"authRemovalInd,omitempty"`
	...
	NfSetId  *string  `json:"nfSetId,omitempty" yaml:"nfSetId,omitempty"`
...
func (o *AuthEvent) GetAuthRemovalInd() bool {
	if o == nil || openapi.IsNil(o.AuthRemovalInd) {
		var ret bool
		return ret
	}
...
func (o AuthEvent) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.AuthRemovalInd) {
