...
var _ openapi.MappedNullable = &FrameRouteInfo{}
...
func (o *FrameRouteInfo) GetIpv4Mask() string {
	if o == nil || openapi.IsNil(o.Ipv4Mask) {
		var ret string
		return ret
	}
	return *o.Ipv4Mask
...
func (o *FrameRouteInfo) GetIpv6Prefix() string {
...
// and a boolean to check if the value has been set.
func (o *FrameRouteInfo) GetIpv6PrefixOk() (*string, bool) {
	if o == nil || openapi.IsNil(o.Ipv6Prefix) {
		return nil, false
	}
...
func (o *FrameRouteInfo) SetIpv6Prefix(v string) {
	o.Ipv6Prefix = &v
}

func (o FrameRouteInfo) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.Ipv4Mask) {
