...
var _ openapi.MappedNullable = &DispersionCollection{}

// DispersionCollection struct for DispersionCollection
type DispersionCollection struct {
	...
	AppVolumes []ApplicationVolume `json:"appVolumes,omitempty" yaml:"appVolumes,omitempty"`
	// Unsigned Integer, i.e. only value 0 and integers above 0 are permissible.
	DisperAmount *int32           `json:"disperAmount,omitempty" yaml:"disperAmount,omitempty"`
	DisperClass  *DispersionClass `json:"disperClass,omitempty" yaml:"disperClass,omitempty"`
	// Integer where the allowed values correspond to 1, 2, 3 only.
	UsageRank *int32 `json:"usageRank,omitempty" yaml:"usageRank,omitempty"`
	// Unsigned integer indicating Sampling Ratio (see clauses 4.15.1 of 3GPP TS 23.502), expressed in percent.
	PercentileRank *int32 `json:"percentileRank,omitempty" yaml:"percentileRank,omitempty"`
	// Unsigned integer indicating Sampling Ratio (see clauses 4.15.1 of 3GPP TS 23.502), expressed in percent.
	UeRatio *int32 `json:"ueRatio,omitempty" yaml:"ueRatio,omitempty"`
	// Unsigned Integer, i.e. only value 0 and integers above 0 are permissible.
...
func (o *DispersionCollection) GetAppVolumes() []ApplicationVolume {
	if o == nil || openapi.IsNil(o.AppVolumes) {
...
func (o *DispersionCollection) GetDisperAmount() int32 {
	if o == nil || openapi.IsNil(o.DisperAmount) {
		var ret int32
		return ret
	}
...
func (o *DispersionCollection) GetDisperClass() DispersionClass {
	if o == nil || openapi.IsNil(o.DisperClass) {
...
func (o *DispersionCollection) GetUsageRank() int32 {
	if o == nil || openapi.IsNil(o.UsageRank) {
		var ret int32
		return ret
	}
	return *o.UsageRank
...
func (o *DispersionCollection) GetPercentileRank() int32 {
	if o == nil || openapi.IsNil(o.PercentileRank) {
		var ret int32
		return ret
	}
...
func (o *DispersionCollection) GetUeRatio() int32 {
	if o == nil || openapi.IsNil(o.UeRatio) {
		var ret int32
		return ret
	}
	return *o.UeRatio
...
func (o DispersionCollection) ToMap() (map[string]any, error) {
