...
type RetrieveTheRoamingInformationOfThe5GCEPCDomainsDocumentAPI interface {
	...
	*/
	...
	QueryPeiInformationExecute(r ApiQueryPeiInformationRequest) (*models.PeiUpdateInfo, *http.Response, error)
}
...
func (r ApiQueryPeiInformationRequest) Execute() (*models.PeiUpdateInfo, *http.Response, error) {
...
//
//	@return PeiUpdateInfo
func (a *RetrieveTheRoamingInformationOfThe5GCEPCDomainsDocumentAPIService) QueryPeiInformationExecute(r ApiQueryPeiInformationRequest) (*models.PeiUpdateInfo, *http.Response, error) {
	var (
