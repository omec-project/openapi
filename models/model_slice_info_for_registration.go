...
var _ openapi.MappedNullable = &SliceInfoForRegistration{}
...
type SliceInfoForRegistration struct {
	SubscribedNssai            []SubscribedSnssai `json:"subscribedNssai,omitempty" yaml:"subscribedNssai,omitempty"`
	AllowedNssaiCurrentAccess  *AllowedNssai      `json:"allowedNssaiCurrentAccess,omitempty" yaml:"allowedNssaiCurrentAccess,omitempty"`
	AllowedNssaiOtherAccess    *AllowedNssai      `json:"allowedNssaiOtherAccess,omitempty" yaml:"allowedNssaiOtherAccess,omitempty"`
	SNssaiForMapping           []Snssai           `json:"sNssaiForMapping,omitempty" yaml:"sNssaiForMapping,omitempty"`
	RequestedNssai             []Snssai           `json:"requestedNssai,omitempty" yaml:"requestedNssai,omitempty"`
	DefaultConfiguredSnssaiInd *bool              `json:"defaultConfiguredSnssaiInd,omitempty" yaml:"defaultConfiguredSnssaiInd,omitempty"`
	MappingOfNssai             []MappingOfSnssai  `json:"mappingOfNssai,omitempty" yaml:"mappingOfNssai,omitempty"`
	RequestMapping             *bool              `json:"requestMapping,omitempty" yaml:"requestMapping,omitempty"`
	UeSupNssrgInd              *bool              `json:"ueSupNssrgInd,omitempty" yaml:"ueSupNssrgInd,omitempty"`
	SuppressNssrgInd           *bool              `json:"suppressNssrgInd,omitempty" yaml:"suppressNssrgInd,omitempty"`
	NsagSupported              *bool              `json:"nsagSupported,omitempty" yaml:"nsagSupported,omitempty"`
}
...
func (o *SliceInfoForRegistration) GetSubscribedNssai() []SubscribedSnssai {
	if o == nil || openapi.IsNil(o.SubscribedNssai) {
...
func (o *SliceInfoForRegistration) GetAllowedNssaiCurrentAccess() AllowedNssai {
	if o == nil || openapi.IsNil(o.AllowedNssaiCurrentAccess) {
...
func (o *SliceInfoForRegistration) GetAllowedNssaiOtherAccess() AllowedNssai {
	if o == nil || openapi.IsNil(o.AllowedNssaiOtherAccess) {
		var ret AllowedNssai
		return ret
	}
...
func (o *SliceInfoForRegistration) GetSNssaiForMapping() []Snssai {
	if o == nil || openapi.IsNil(o.SNssaiForMapping) {
		var ret []Snssai
		return ret
	}
...
func (o *SliceInfoForRegistration) GetRequestedNssai() []Snssai {
	if o == nil || openapi.IsNil(o.RequestedNssai) {
		var ret []Snssai
		return ret
	}
...
func (o *SliceInfoForRegistration) GetDefaultConfiguredSnssaiInd() bool {
	if o == nil || openapi.IsNil(o.DefaultConfiguredSnssaiInd) {
		var ret bool
		return ret
	}
...
func (o *SliceInfoForRegistration) GetMappingOfNssai() []MappingOfSnssai {
	if o == nil || openapi.IsNil(o.MappingOfNssai) {
...
func (o *SliceInfoForRegistration) GetRequestMapping() bool {
	if o == nil || openapi.IsNil(o.RequestMapping) {
		var ret bool
		return ret
	}
...
func (o *SliceInfoForRegistration) GetUeSupNssrgInd() bool {
	if o == nil || openapi.IsNil(o.UeSupNssrgInd) {
		var ret bool
		return ret
	}
...
func (o *SliceInfoForRegistration) GetNsagSupported() bool {
	if o == nil || openapi.IsNil(o.NsagSupported) {
		var ret bool
		return ret
	}
...
func (o SliceInfoForRegistration) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.NsagSupported) {
