...
var _ openapi.MappedNullable = &GbaAuthenticationInfoResult{}

// GbaAuthenticationInfoResult struct for GbaAuthenticationInfoResult
type GbaAuthenticationInfoResult struct {
	Var3gAkaAv *ThreeGAkaAv `json:"3gAkaAv,omitempty" yaml:"3gAkaAv,omitempty"`
...
func (o *GbaAuthenticationInfoResult) GetVar3gAkaAv() ThreeGAkaAv {
	if o == nil || openapi.IsNil(o.Var3gAkaAv) {
		var ret ThreeGAkaAv
		return ret
	}
	return *o.Var3gAkaAv
...
func (o *GbaAuthenticationInfoResult) GetVar3gAkaAvOk() (*ThreeGAkaAv, bool) {
	if o == nil || openapi.IsNil(o.Var3gAkaAv) {
		return nil, false
	}
...
// SetVar3gAkaAv gets a reference to the given ThreeGAkaAv and assigns it to the Var3gAkaAv field.
func (o *GbaAuthenticationInfoResult) SetVar3gAkaAv(v ThreeGAkaAv) {
	o.Var3gAkaAv = &v
}
...
func (o GbaAuthenticationInfoResult) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.Var3gAkaAv) {
