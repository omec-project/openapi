...
var _ openapi.MappedNullable = &FailureEventInfo{}
...
type FailureEventInfo struct {
	...
	FailureCode NwdafFailureCode `json:"failureCode" yaml:"failureCode"`
}
...
func (o FailureEventInfo) ToMap() (map[string]any, error) {
