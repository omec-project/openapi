...
var _ openapi.MappedNullable = &AdditionalMeasurement{}

// AdditionalMeasurement Represents additional measurement information.
type AdditionalMeasurement struct {
	UnexpLoc      *NetworkAreaInfo          `json:"unexpLoc,omitempty" yaml:"unexpLoc,omitempty"`
	UnexpFlowTeps []IpEthFlowDescription    `json:"unexpFlowTeps,omitempty" yaml:"unexpFlowTeps,omitempty"`
	UnexpWakes    []time.Time               `json:"unexpWakes,omitempty" yaml:"unexpWakes,omitempty"`
	DdosAttack    *AddressList              `json:"ddosAttack,omitempty" yaml:"ddosAttack,omitempty"`
	WrgDest       *AddressList              `json:"wrgDest,omitempty" yaml:"wrgDest,omitempty"`
	Circums       []CircumstanceDescription `json:"circums,omitempty" yaml:"circums,omitempty"`
}
...
func (o *AdditionalMeasurement) GetUnexpLoc() NetworkAreaInfo {
	if o == nil || openapi.IsNil(o.UnexpLoc) {
...
func (o *AdditionalMeasurement) GetUnexpFlowTeps() []IpEthFlowDescription {
	if o == nil || openapi.IsNil(o.UnexpFlowTeps) {
...
func (o *AdditionalMeasurement) GetUnexpWakes() []time.Time {
	if o == nil || openapi.IsNil(o.UnexpWakes) {
		var ret []time.Time
		return ret
	}
	return o.UnexpWakes
...
func (o *AdditionalMeasurement) GetDdosAttack() AddressList {
	if o == nil || openapi.IsNil(o.DdosAttack) {
		var ret AddressList
		return ret
	}
	return *o.DdosAttack
...
func (o *AdditionalMeasurement) GetWrgDest() AddressList {
	if o == nil || openapi.IsNil(o.WrgDest) {
		var ret AddressList
		return ret
	}
	return *o.WrgDest
...
func (o *AdditionalMeasurement) GetCircums() []CircumstanceDescription {
	if o == nil || openapi.IsNil(o.Circums) {
...
func (o AdditionalMeasurement) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.UnexpLoc) {
		toSerialize["unexpLoc"] = o.UnexpLoc
	}
	if !openapi.IsNil(o.UnexpFlowTeps) {
		toSerialize["unexpFlowTeps"] = o.UnexpFlowTeps
	}
	if !openapi.IsNil(o.UnexpWakes) {
		toSerialize["unexpWakes"] = o.UnexpWakes
	}
	if !openapi.IsNil(o.DdosAttack) {
		toSerialize["ddosAttack"] = o.DdosAttack
	}
	if !openapi.IsNil(o.WrgDest) {
		toSerialize["wrgDest"] = o.WrgDest
	}
	if !openapi.IsNil(o.Circums) {
