...
var _ openapi.MappedNullable = &UriList{}
...
type UriList struct {
	...
	TotalItemCount *int32                      `json:"totalItemCount,omitempty" yaml:"totalItemCount,omitempty"`
}
...
func (o *UriList) GetTotalItemCount() int32 {
	if o == nil || openapi.IsNil(o.TotalItemCount) {
		var ret int32
		return ret
	}
...
func (o UriList) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.Links) {
		toSerialize["_links"] = o.Links
	}
	if !openapi.IsNil(o.TotalItemCount) {
