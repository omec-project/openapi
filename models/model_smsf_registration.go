...
var _ openapi.MappedNullable = &SmsfRegistration{}
...
type SmsfRegistration struct {
	...
	SmsfMAPAddress      *string                     `json:"smsfMAPAddress,omitempty" yaml:"smsfMAPAddress,omitempty" validate:"regexp=^[0-9]{1,15}$"`
	SmsfDiameterAddress *NetworkNodeDiameterAddress `json:"smsfDiameterAddress,omitempty" yaml:"smsfDiameterAddress,omitempty"`
	...
	SmsfSbiSupInd              *bool    `json:"smsfSbiSupInd,omitempty" yaml:"smsfSbiSupInd,omitempty"`
...
func (o *SmsfRegistration) GetSmsfMAPAddress() string {
	if o == nil || openapi.IsNil(o.SmsfMAPAddress) {
		var ret string
		return ret
	}
...
func (o *SmsfRegistration) GetSmsfDiameterAddress() NetworkNodeDiameterAddress {
	if o == nil || openapi.IsNil(o.SmsfDiameterAddress) {
...
func (o *SmsfRegistration) GetSmsfSbiSupInd() bool {
	if o == nil || openapi.IsNil(o.SmsfSbiSupInd) {
		var ret bool
		return ret
	}
...
func (o SmsfRegistration) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.SmsfMAPAddress) {
		toSerialize["smsfMAPAddress"] = o.SmsfMAPAddress
	}
	if !openapi.IsNil(o.SmsfDiameterAddress) {
	...
	if !openapi.IsNil(o.SmsfSbiSupInd) {
