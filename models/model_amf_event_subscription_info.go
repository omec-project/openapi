...
func (o *AmfEventSubscriptionInfo) GetOldSubId() string {
	if o == nil || openapi.IsNil(o.OldSubId) {
		var ret string
		return ret
	}
	return *o.OldSubId
...
func (o AmfEventSubscriptionInfo) ToMap() (map[string]any, error) {
