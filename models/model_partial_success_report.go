...
type PartialSuccessReport struct {
	...
	UeCampingRep    *UeCampingRep       `json:"ueCampingRep,omitempty" yaml:"ueCampingRep,omitempty"`
...
func (o *PartialSuccessReport) GetUeCampingRep() UeCampingRep {
	if o == nil || openapi.IsNil(o.UeCampingRep) {
...
func (o PartialSuccessReport) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.UeCampingRep) {
