...
var _ openapi.MappedNullable = &UeContextCreatedData{}
...
type UeContextCreatedData struct {
	...
	FailedSessionList  []N2SmInformation `json:"failedSessionList,omitempty" yaml:"failedSessionList,omitempty"`
...
func (o *UeContextCreatedData) GetFailedSessionList() []N2SmInformation {
	if o == nil || openapi.IsNil(o.FailedSessionList) {
		var ret []N2SmInformation
		return ret
	}
...
func (o UeContextCreatedData) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.FailedSessionList) {
