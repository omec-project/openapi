...
var _ openapi.MappedNullable = &TrafficInfluDataNotif{}
...
type TrafficInfluDataNotif struct {
	...
	TrafficInfluData *TrafficInfluData `json:"trafficInfluData,omitempty" yaml:"trafficInfluData,omitempty"`
}
...
func (o TrafficInfluDataNotif) ToMap() (map[string]any, error) {
