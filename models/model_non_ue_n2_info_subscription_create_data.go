...
var _ openapi.MappedNullable = &NonUeN2InfoSubscriptionCreateData{}
...
type NonUeN2InfoSubscriptionCreateData struct {
	GlobalRanNodeList  []GlobalRanNodeId  `json:"globalRanNodeList,omitempty" yaml:"globalRanNodeList,omitempty"`
	AnTypeList         []AccessType       `json:"anTypeList,omitempty" yaml:"anTypeList,omitempty"`
	N2InformationClass N2InformationClass `json:"n2InformationClass" yaml:"n2InformationClass"`
	// String providing an URI formatted according to RFC 3986.
	N2NotifyCallbackUri string `json:"n2NotifyCallbackUri" yaml:"n2NotifyCallbackUri"`
...
func (o *NonUeN2InfoSubscriptionCreateData) GetGlobalRanNodeList() []GlobalRanNodeId {
	if o == nil || openapi.IsNil(o.GlobalRanNodeList) {
...
func (o *NonUeN2InfoSubscriptionCreateData) GetAnTypeList() []AccessType {
	if o == nil || openapi.IsNil(o.AnTypeList) {
		var ret []AccessType
		return ret
	}
	return o.AnTypeList
...
func (o *NonUeN2InfoSubscriptionCreateData) GetNotifCorrelationId() string {
...
// and a boolean to check if the value has been set.
func (o *NonUeN2InfoSubscriptionCreateData) GetNotifCorrelationIdOk() (*string, bool) {
	if o == nil || openapi.IsNil(o.NotifCorrelationId) {
		return nil, false
	}
...
func (o *NonUeN2InfoSubscriptionCreateData) HasNotifCorrelationId() bool {
	if o != nil && !openapi.IsNil(o.NotifCorrelationId) {
		return true
	}
...
func (o *NonUeN2InfoSubscriptionCreateData) SetNotifCorrelationId(v string) {
	o.NotifCorrelationId = &v
}

func (o NonUeN2InfoSubscriptionCreateData) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.GlobalRanNodeList) {
		toSerialize["globalRanNodeList"] = o.GlobalRanNodeList
	}
	if !openapi.IsNil(o.AnTypeList) {
