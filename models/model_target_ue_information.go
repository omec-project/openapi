...
var _ openapi.MappedNullable = &TargetUeInformation{}
...
type TargetUeInformation struct {
	...
	IntGroupIds []string `json:"intGroupIds,omitempty" yaml:"intGroupIds,omitempty"`
}
...
func (o *TargetUeInformation) GetIntGroupIds() []string {
	if o == nil || openapi.IsNil(o.IntGroupIds) {
		var ret []string
		return ret
	}
...
func (o TargetUeInformation) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.IntGroupIds) {
