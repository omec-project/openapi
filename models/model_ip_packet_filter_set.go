...
var _ openapi.MappedNullable = &IpPacketFilterSet{}
...
type IpPacketFilterSet struct {
	...
	SrcPort   *int32  `json:"srcPort,omitempty" yaml:"srcPort,omitempty"`
	DstPort   *int32  `json:"dstPort,omitempty" yaml:"dstPort,omitempty"`
	ToSTc     *string `json:"toSTc,omitempty" yaml:"toSTc,omitempty"`
	FlowLabel *int32  `json:"flowLabel,omitempty" yaml:"flowLabel,omitempty"`
	Spi       *int32  `json:"spi,omitempty" yaml:"spi,omitempty"`
...
func (o *IpPacketFilterSet) GetSrcIp() string {
	if o == nil || openapi.IsNil(o.SrcIp) {
		var ret string
		return ret
	}
	return *o.SrcIp
...
func (o *IpPacketFilterSet) GetDstIp() string {
	if o == nil || openapi.IsNil(o.DstIp) {
		var ret string
		return ret
	}
	return *o.DstIp
...
func (o *IpPacketFilterSet) GetSrcPort() int32 {
	if o == nil || openapi.IsNil(o.SrcPort) {
		var ret int32
		return ret
	}
	return *o.SrcPort
...
func (o *IpPacketFilterSet) GetDstPort() int32 {
	if o == nil || openapi.IsNil(o.DstPort) {
		var ret int32
		return ret
	}
	return *o.DstPort
...
func (o IpPacketFilterSet) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.SrcIp) {
		toSerialize["srcIp"] = o.SrcIp
	}
	if !openapi.IsNil(o.DstIp) {
		toSerialize["dstIp"] = o.DstIp
	}
	if !openapi.IsNil(o.Protocol) {
		toSerialize["protocol"] = o.Protocol
	}
	if !openapi.IsNil(o.SrcPort) {
		toSerialize["srcPort"] = o.SrcPort
	}
	if !openapi.IsNil(o.DstPort) {
