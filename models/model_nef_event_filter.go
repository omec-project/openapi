...
var _ openapi.MappedNullable = &NefEventFilter{}

// NefEventFilter Represents event filter information for an event.
type NefEventFilter struct {
	TgtUe     TargetUeIdentification      `json:"tgtUe" yaml:"tgtUe"`
	...
	CollAttrs []CollectiveBehaviourFilter `json:"collAttrs,omitempty" yaml:"collAttrs,omitempty"`
}
...
func (o NefEventFilter) ToMap() (map[string]any, error) {
