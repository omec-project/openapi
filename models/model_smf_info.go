...
var _ openapi.MappedNullable = &SmfInfo{}

// SmfInfo Information of an SMF NF Instance
type SmfInfo struct {
	SNssaiSmfInfoList []SnssaiSmfInfoItem `json:"sNssaiSmfInfoList" yaml:"sNssaiSmfInfoList"`
	...
	VsmfSupportInd *bool        `json:"vsmfSupportInd,omitempty" yaml:"vsmfSupportInd,omitempty"`
	PgwFqdnList    []string     `json:"pgwFqdnList,omitempty" yaml:"pgwFqdnList,omitempty"`
	// Deprecated
	SmfOnboardingCapability *bool `json:"smfOnboardingCapability,omitempty" yaml:"smfOnboardingCapability,omitempty"`
	IsmfSupportInd          *bool `json:"ismfSupportInd,omitempty" yaml:"ismfSupportInd,omitempty"`
	SmfUPRPCapability       *bool `json:"smfUPRPCapability,omitempty" yaml:"smfUPRPCapability,omitempty"`
}
...
func (o *SmfInfo) GetPgwIpAddrList() []IpAddr {
	if o == nil || openapi.IsNil(o.PgwIpAddrList) {
		var ret []IpAddr
		return ret
	}
...
func (o *SmfInfo) GetVsmfSupportInd() bool {
	if o == nil || openapi.IsNil(o.VsmfSupportInd) {
		var ret bool
		return ret
	}
...
func (o *SmfInfo) GetPgwFqdnList() []string {
	if o == nil || openapi.IsNil(o.PgwFqdnList) {
		var ret []string
		return ret
	}
...
func (o *SmfInfo) GetSmfOnboardingCapability() bool {
	if o == nil || openapi.IsNil(o.SmfOnboardingCapability) {
		var ret bool
		return ret
	}
...
func (o *SmfInfo) GetIsmfSupportInd() bool {
	if o == nil || openapi.IsNil(o.IsmfSupportInd) {
		var ret bool
		return ret
	}
...
func (o *SmfInfo) GetSmfUPRPCapability() bool {
	if o == nil || openapi.IsNil(o.SmfUPRPCapability) {
		var ret bool
		return ret
	}
...
func (o SmfInfo) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.PgwIpAddrList) {
