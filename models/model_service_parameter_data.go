...
var _ openapi.MappedNullable = &ServiceParameterData{}
...
type ServiceParameterData struct {
	...
	UeIpv4 *string `json:"ueIpv4,omitempty" yaml:"ueIpv4,omitempty"`
	...
	UeIpv6 *string `json:"ueIpv6,omitempty" yaml:"ueIpv6,omitempty"`
	...
	RoamUeNetDescs []NetworkDescription `json:"roamUeNetDescs,omitempty" yaml:"roamUeNetDescs,omitempty"`
	// Represents configuration parameters for V2X communications over PC5 reference point.
	ParamOverPc5 *string `json:"paramOverPc5,omitempty" yaml:"paramOverPc5,omitempty"`
	// Represents configuration parameters for V2X communications over Uu reference point.
	ParamOverUu *string `json:"paramOverUu,omitempty" yaml:"paramOverUu,omitempty"`
	// Represents configuration parameters for A2X communications over PC5 reference point.
	A2xParamsPc5 *string `json:"a2xParamsPc5,omitempty" yaml:"a2xParamsPc5,omitempty"`
	// Represents the service parameters for 5G ProSe direct discovery.
	ParamForProSeDd *string `json:"paramForProSeDd,omitempty" yaml:"paramForProSeDd,omitempty"`
	// Represents the service parameters for 5G ProSe direct communications.
	ParamForProSeDc *string `json:"paramForProSeDc,omitempty" yaml:"paramForProSeDc,omitempty"`
	// Represents the service parameters for 5G ProSe UE-to-network relay UE.
	ParamForProSeU2NRelUe *string `json:"paramForProSeU2NRelUe,omitempty" yaml:"paramForProSeU2NRelUe,omitempty"`
	// Represents the service parameters for 5G ProSe Remote UE.
	ParamForProSeRemUe *string `json:"paramForProSeRemUe,omitempty" yaml:"paramForProSeRemUe,omitempty"`
	// Represents the service parameters for 5G ProSe UE-to-UE relay UE.
	ParamForProSeU2URelUe *string `json:"paramForProSeU2URelUe,omitempty" yaml:"paramForProSeU2URelUe,omitempty"`
	// Represents the service parameters for 5G ProSe End UE.
	ParamForProSeEndUe *string `json:"paramForProSeEndUe,omitempty" yaml:"paramForProSeEndUe,omitempty"`
	// Contains the service parameter used to guide the URSP and/or VPLMN specific URSP.
	...
	PolicDelivNotifCorreId *string `json:"policDelivNotifCorreId,omitempty" yaml:"policDelivNotifCorreId,omitempty"`
	...
	ParamForRangingSlPos *string      `json:"paramForRangingSlPos,omitempty" yaml:"paramForRangingSlPos,omitempty"`
	MappingInfo          *MappingInfo `json:"mappingInfo,omitempty" yaml:"mappingInfo,omitempty"`
}
...
func (o *ServiceParameterData) GetUeIpv4() string {
	if o == nil || openapi.IsNil(o.UeIpv4) {
		var ret string
		return ret
	}
	return *o.UeIpv4
...
func (o *ServiceParameterData) GetUeIpv6() string {
	if o == nil || openapi.IsNil(o.UeIpv6) {
		var ret string
		return ret
	}
	return *o.UeIpv6
...
// GetRoamUeNetDescs returns the RoamUeNetDescs field value if set, zero value otherwise.
func (o *ServiceParameterData) GetRoamUeNetDescs() []NetworkDescription {
	if o == nil || openapi.IsNil(o.RoamUeNetDescs) {
		var ret []NetworkDescription
		return ret
	}
	return o.RoamUeNetDescs
}

// GetRoamUeNetDescsOk returns a tuple with the RoamUeNetDescs field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ServiceParameterData) GetRoamUeNetDescsOk() ([]NetworkDescription, bool) {
	if o == nil || openapi.IsNil(o.RoamUeNetDescs) {
		return nil, false
	}
	return o.RoamUeNetDescs, true
}

// HasRoamUeNetDescs returns a boolean if a field has been set.
func (o *ServiceParameterData) HasRoamUeNetDescs() bool {
	if o != nil && !openapi.IsNil(o.RoamUeNetDescs) {
		return true
	}
...
// SetRoamUeNetDescs gets a reference to the given []NetworkDescription and assigns it to the RoamUeNetDescs field.
func (o *ServiceParameterData) SetRoamUeNetDescs(v []NetworkDescription) {
	o.RoamUeNetDescs = v
}
...
func (o *ServiceParameterData) GetParamOverPc5() string {
	if o == nil || openapi.IsNil(o.ParamOverPc5) {
		var ret string
		return ret
	}
...
func (o *ServiceParameterData) GetParamOverUu() string {
	if o == nil || openapi.IsNil(o.ParamOverUu) {
		var ret string
		return ret
	}
...
// GetA2xParamsPc5 returns the A2xParamsPc5 field value if set, zero value otherwise.
func (o *ServiceParameterData) GetA2xParamsPc5() string {
	if o == nil || openapi.IsNil(o.A2xParamsPc5) {
		var ret string
		return ret
	}
	return *o.A2xParamsPc5
}

// GetA2xParamsPc5Ok returns a tuple with the A2xParamsPc5 field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ServiceParameterData) GetA2xParamsPc5Ok() (*string, bool) {
	if o == nil || openapi.IsNil(o.A2xParamsPc5) {
		return nil, false
	}
	return o.A2xParamsPc5, true
}

// HasA2xParamsPc5 returns a boolean if a field has been set.
func (o *ServiceParameterData) HasA2xParamsPc5() bool {
	if o != nil && !openapi.IsNil(o.A2xParamsPc5) {
		return true
	}
...
// SetA2xParamsPc5 gets a reference to the given string and assigns it to the A2xParamsPc5 field.
func (o *ServiceParameterData) SetA2xParamsPc5(v string) {
	o.A2xParamsPc5 = &v
}
...
func (o *ServiceParameterData) GetParamForProSeDd() string {
	if o == nil || openapi.IsNil(o.ParamForProSeDd) {
		var ret string
		return ret
	}
...
func (o *ServiceParameterData) GetParamForProSeDc() string {
	if o == nil || openapi.IsNil(o.ParamForProSeDc) {
		var ret string
		return ret
	}
...
func (o *ServiceParameterData) GetParamForProSeU2NRelUe() string {
	if o == nil || openapi.IsNil(o.ParamForProSeU2NRelUe) {
		var ret string
		return ret
	}
...
func (o *ServiceParameterData) GetParamForProSeRemUe() string {
	if o == nil || openapi.IsNil(o.ParamForProSeRemUe) {
		var ret string
		return ret
	}
...
// GetParamForProSeU2URelUe returns the ParamForProSeU2URelUe field value if set, zero value otherwise.
func (o *ServiceParameterData) GetParamForProSeU2URelUe() string {
	if o == nil || openapi.IsNil(o.ParamForProSeU2URelUe) {
		var ret string
		return ret
	}
	return *o.ParamForProSeU2URelUe
}

// GetParamForProSeU2URelUeOk returns a tuple with the ParamForProSeU2URelUe field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ServiceParameterData) GetParamForProSeU2URelUeOk() (*string, bool) {
	if o == nil || openapi.IsNil(o.ParamForProSeU2URelUe) {
		return nil, false
	}
	return o.ParamForProSeU2URelUe, true
}

// HasParamForProSeU2URelUe returns a boolean if a field has been set.
func (o *ServiceParameterData) HasParamForProSeU2URelUe() bool {
	if o != nil && !openapi.IsNil(o.ParamForProSeU2URelUe) {
		return true
	}
...
// SetParamForProSeU2URelUe gets a reference to the given string and assigns it to the ParamForProSeU2URelUe field.
func (o *ServiceParameterData) SetParamForProSeU2URelUe(v string) {
	o.ParamForProSeU2URelUe = &v
}

// GetParamForProSeEndUe returns the ParamForProSeEndUe field value if set, zero value otherwise.
func (o *ServiceParameterData) GetParamForProSeEndUe() string {
	if o == nil || openapi.IsNil(o.ParamForProSeEndUe) {
		var ret string
		return ret
	}
	return *o.ParamForProSeEndUe
}

// GetParamForProSeEndUeOk returns a tuple with the ParamForProSeEndUe field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ServiceParameterData) GetParamForProSeEndUeOk() (*string, bool) {
	if o == nil || openapi.IsNil(o.ParamForProSeEndUe) {
		return nil, false
	}
	return o.ParamForProSeEndUe, true
}

// HasParamForProSeEndUe returns a boolean if a field has been set.
func (o *ServiceParameterData) HasParamForProSeEndUe() bool {
	if o != nil && !openapi.IsNil(o.ParamForProSeEndUe) {
		return true
	}
...
// SetParamForProSeEndUe gets a reference to the given string and assigns it to the ParamForProSeEndUe field.
func (o *ServiceParameterData) SetParamForProSeEndUe(v string) {
	o.ParamForProSeEndUe = &v
}
...
// GetTnaps returns the Tnaps field value if set, zero value otherwise.
func (o *ServiceParameterData) GetTnaps() []TnapId {
...
// and a boolean to check if the value has been set.
func (o *ServiceParameterData) GetTnapsOk() ([]TnapId, bool) {
	if o == nil || openapi.IsNil(o.Tnaps) {
		return nil, false
	}
	return o.Tnaps, true
...
func (o *ServiceParameterData) HasTnaps() bool {
	if o != nil && !openapi.IsNil(o.Tnaps) {
		return true
	}
...
func (o *ServiceParameterData) SetTnaps(v []TnapId) {
	o.Tnaps = v
}
...
func (o *ServiceParameterData) GetPolicDelivNotifCorreId() string {
	if o == nil || openapi.IsNil(o.PolicDelivNotifCorreId) {
		var ret string
		return ret
	}
...
// GetParamForRangingSlPos returns the ParamForRangingSlPos field value if set, zero value otherwise.
func (o *ServiceParameterData) GetParamForRangingSlPos() string {
	if o == nil || openapi.IsNil(o.ParamForRangingSlPos) {
		var ret string
		return ret
	}
	return *o.ParamForRangingSlPos
}

// GetParamForRangingSlPosOk returns a tuple with the ParamForRangingSlPos field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ServiceParameterData) GetParamForRangingSlPosOk() (*string, bool) {
	if o == nil || openapi.IsNil(o.ParamForRangingSlPos) {
		return nil, false
	}
	return o.ParamForRangingSlPos, true
}

// HasParamForRangingSlPos returns a boolean if a field has been set.
func (o *ServiceParameterData) HasParamForRangingSlPos() bool {
	if o != nil && !openapi.IsNil(o.ParamForRangingSlPos) {
		return true
	}
...
// SetParamForRangingSlPos gets a reference to the given string and assigns it to the ParamForRangingSlPos field.
func (o *ServiceParameterData) SetParamForRangingSlPos(v string) {
	o.ParamForRangingSlPos = &v
}

// GetMappingInfo returns the MappingInfo field value if set, zero value otherwise.
func (o *ServiceParameterData) GetMappingInfo() MappingInfo {
	if o == nil || openapi.IsNil(o.MappingInfo) {
		var ret MappingInfo
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ServiceParameterData) GetMappingInfoOk() (*MappingInfo, bool) {
	if o == nil || openapi.IsNil(o.MappingInfo) {
		return nil, false
	}
...
func (o *ServiceParameterData) HasMappingInfo() bool {
	if o != nil && !openapi.IsNil(o.MappingInfo) {
		return true
	}
...
// SetMappingInfo gets a reference to the given MappingInfo and assigns it to the MappingInfo field.
func (o *ServiceParameterData) SetMappingInfo(v MappingInfo) {
	o.MappingInfo = &v
}

func (o ServiceParameterData) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.UeIpv4) {
		toSerialize["ueIpv4"] = o.UeIpv4
	}
	if !openapi.IsNil(o.UeIpv6) {
	...
	if !openapi.IsNil(o.RoamUeNetDescs) {
		toSerialize["roamUeNetDescs"] = o.RoamUeNetDescs
	}
	if !openapi.IsNil(o.ParamOverPc5) {
		toSerialize["paramOverPc5"] = o.ParamOverPc5
	}
	if !openapi.IsNil(o.ParamOverUu) {
		toSerialize["paramOverUu"] = o.ParamOverUu
	}
	if !openapi.IsNil(o.A2xParamsPc5) {
		toSerialize["a2xParamsPc5"] = o.A2xParamsPc5
	}
	if !openapi.IsNil(o.ParamForProSeDd) {
		toSerialize["paramForProSeDd"] = o.ParamForProSeDd
	}
	if !openapi.IsNil(o.ParamForProSeDc) {
		toSerialize["paramForProSeDc"] = o.ParamForProSeDc
	}
	if !openapi.IsNil(o.ParamForProSeU2NRelUe) {
		toSerialize["paramForProSeU2NRelUe"] = o.ParamForProSeU2NRelUe
	}
	if !openapi.IsNil(o.ParamForProSeRemUe) {
		toSerialize["paramForProSeRemUe"] = o.ParamForProSeRemUe
	}
	if !openapi.IsNil(o.ParamForProSeU2URelUe) {
		toSerialize["paramForProSeU2URelUe"] = o.ParamForProSeU2URelUe
	}
	if !openapi.IsNil(o.ParamForProSeEndUe) {
		toSerialize["paramForProSeEndUe"] = o.ParamForProSeEndUe
	}
	if !openapi.IsNil(o.UrspGuidance) {
		toSerialize["urspGuidance"] = o.UrspGuidance
	}
	if !openapi.IsNil(o.Tnaps) {
		toSerialize["tnaps"] = o.Tnaps
	}
	if !openapi.IsNil(o.DeliveryEvents) {
		toSerialize["deliveryEvents"] = o.DeliveryEvents
	}
	if !openapi.IsNil(o.PolicDelivNotifCorreId) {
	...
	if !openapi.IsNil(o.ParamForRangingSlPos) {
		toSerialize["paramForRangingSlPos"] = o.ParamForRangingSlPos
	}
	if !openapi.IsNil(o.MappingInfo) {
		toSerialize["mappingInfo"] = o.MappingInfo
	}
