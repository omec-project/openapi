...
var _ openapi.MappedNullable = &PolicyControl{}

// PolicyControl struct for PolicyControl
type PolicyControl struct {
	PlmnId               PlmnId    `json:"plmnId" yaml:"plmnId"`
	Snssai               Snssai    `json:"snssai" yaml:"snssai"`
	Dnns                 []string  `json:"dnns" yaml:"dnns"`
	PccRules             []PccRule `json:"pccRules" yaml:"pccRules"`
...
func (o *PolicyControl) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varPolicyControl)
	...
	*o = PolicyControl(varPolicyControl)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "dnns")
		delete(additionalProperties, "pccRules")
