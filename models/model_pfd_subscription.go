...
var _ openapi.MappedNullable = &PfdSubscription{}
...
type PfdSubscription struct {
	...
	NotifyUri string `json:"notifyUri" yaml:"notifyUri"`
	...
	SupportedFeatures string `json:"supportedFeatures" yaml:"supportedFeatures" validate:"regexp=^[A-Fa-f0-9]*$"`
}
...
func (o *PfdSubscription) GetApplicationIds() []string {
	if o == nil || openapi.IsNil(o.ApplicationIds) {
		var ret []string
		return ret
	}
...
func (o PfdSubscription) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.ApplicationIds) {
