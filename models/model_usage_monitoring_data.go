...
var _ openapi.MappedNullable = &UsageMonitoringData{}
...
type UsageMonitoringData struct {
	...
	UmId string `json:"umId" yaml:"umId"`
	// Unsigned integer identifying a volume in units of bytes with \"nullable=true\" property.
	VolumeThreshold openapi.NullableInt64 `json:"volumeThreshold" yaml:"volumeThreshold,omitempty"`
	// Unsigned integer identifying a volume in units of bytes with \"nullable=true\" property.
	VolumeThresholdUplink openapi.NullableInt64 `json:"volumeThresholdUplink" yaml:"volumeThresholdUplink,omitempty"`
	// Unsigned integer identifying a volume in units of bytes with \"nullable=true\" property.
	VolumeThresholdDownlink openapi.NullableInt64 `json:"volumeThresholdDownlink" yaml:"volumeThresholdDownlink,omitempty"`
	// indicating a time in seconds with OpenAPI defined 'nullable: true' property.
	TimeThreshold openapi.NullableInt32 `json:"timeThreshold" yaml:"timeThreshold,omitempty"`
	// string with format 'date-time' as defined in OpenAPI with 'nullable:true' property.
	MonitoringTime openapi.NullableTime `json:"monitoringTime" yaml:"monitoringTime,omitempty"`
	// Unsigned integer identifying a volume in units of bytes with \"nullable=true\" property.
	NextVolThreshold openapi.NullableInt64 `json:"nextVolThreshold" yaml:"nextVolThreshold,omitempty"`
	// Unsigned integer identifying a volume in units of bytes with \"nullable=true\" property.
	NextVolThresholdUplink openapi.NullableInt64 `json:"nextVolThresholdUplink" yaml:"nextVolThresholdUplink,omitempty"`
	// Unsigned integer identifying a volume in units of bytes with \"nullable=true\" property.
	NextVolThresholdDownlink openapi.NullableInt64 `json:"nextVolThresholdDownlink" yaml:"nextVolThresholdDownlink,omitempty"`
	// indicating a time in seconds with OpenAPI defined 'nullable: true' property.
	NextTimeThreshold openapi.NullableInt32 `json:"nextTimeThreshold" yaml:"nextTimeThreshold,omitempty"`
	// indicating a time in seconds with OpenAPI defined 'nullable: true' property.
	InactivityTime openapi.NullableInt32 `json:"inactivityTime" yaml:"inactivityTime,omitempty"`
	...
	ExUsagePccRuleIds []string `json:"exUsagePccRuleIds,omitempty" yaml:"exUsagePccRuleIds,omitempty"`
}
...
func (o *UsageMonitoringData) GetVolumeThreshold() int64 {
	if o == nil || openapi.IsNil(o.VolumeThreshold.Get()) {
		var ret int64
		return ret
	}
...
// SetVolumeThreshold gets a reference to the given openapi.NullableInt64 and assigns it to the VolumeThreshold field.
...
func (o *UsageMonitoringData) GetVolumeThresholdUplink() int64 {
	if o == nil || openapi.IsNil(o.VolumeThresholdUplink.Get()) {
		var ret int64
		return ret
	}
...
// SetVolumeThresholdUplink gets a reference to the given openapi.NullableInt64 and assigns it to the VolumeThresholdUplink field.
...
func (o *UsageMonitoringData) GetVolumeThresholdDownlink() int64 {
	if o == nil || openapi.IsNil(o.VolumeThresholdDownlink.Get()) {
		var ret int64
		return ret
	}
...
// SetVolumeThresholdDownlink gets a reference to the given openapi.NullableInt64 and assigns it to the VolumeThresholdDownlink field.
...
func (o *UsageMonitoringData) GetTimeThreshold() int32 {
	if o == nil || openapi.IsNil(o.TimeThreshold.Get()) {
		var ret int32
		return ret
	}
...
// SetTimeThreshold gets a reference to the given openapi.NullableInt32 and assigns it to the TimeThreshold field.
...
func (o *UsageMonitoringData) GetMonitoringTime() time.Time {
	if o == nil || openapi.IsNil(o.MonitoringTime.Get()) {
		var ret time.Time
		return ret
	}
...
// SetMonitoringTime gets a reference to the given openapi.NullableTime and assigns it to the MonitoringTime field.
...
func (o *UsageMonitoringData) GetNextVolThreshold() int64 {
	if o == nil || openapi.IsNil(o.NextVolThreshold.Get()) {
		var ret int64
		return ret
	}
...
// SetNextVolThreshold gets a reference to the given openapi.NullableInt64 and assigns it to the NextVolThreshold field.
...
func (o *UsageMonitoringData) GetNextVolThresholdUplink() int64 {
	if o == nil || openapi.IsNil(o.NextVolThresholdUplink.Get()) {
		var ret int64
		return ret
	}
...
// SetNextVolThresholdUplink gets a reference to the given openapi.NullableInt64 and assigns it to the NextVolThresholdUplink field.
...
func (o *UsageMonitoringData) GetNextVolThresholdDownlink() int64 {
	if o == nil || openapi.IsNil(o.NextVolThresholdDownlink.Get()) {
		var ret int64
		return ret
	}
...
// SetNextVolThresholdDownlink gets a reference to the given openapi.NullableInt64 and assigns it to the NextVolThresholdDownlink field.
...
func (o *UsageMonitoringData) GetNextTimeThreshold() int32 {
	if o == nil || openapi.IsNil(o.NextTimeThreshold.Get()) {
		var ret int32
		return ret
	}
...
// SetNextTimeThreshold gets a reference to the given openapi.NullableInt32 and assigns it to the NextTimeThreshold field.
...
func (o *UsageMonitoringData) GetInactivityTime() int32 {
	if o == nil || openapi.IsNil(o.InactivityTime.Get()) {
		var ret int32
		return ret
	}
...
// SetInactivityTime gets a reference to the given openapi.NullableInt32 and assigns it to the InactivityTime field.
...
func (o *UsageMonitoringData) GetExUsagePccRuleIdsOk() ([]string, bool) {
	if o == nil || openapi.IsNil(o.ExUsagePccRuleIds) {
		return nil, false
	}
...
func (o UsageMonitoringData) ToMap() (map[string]any, error) {
