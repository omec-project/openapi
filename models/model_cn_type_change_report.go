...
var _ openapi.MappedNullable = &CnTypeChangeReport{}

// CnTypeChangeReport struct for CnTypeChangeReport
type CnTypeChangeReport struct {
	NewCnType CnType  `json:"newCnType" yaml:"newCnType"`
	OldCnType *CnType `json:"oldCnType,omitempty" yaml:"oldCnType,omitempty"`
}
...
func (o *CnTypeChangeReport) GetOldCnType() CnType {
	if o == nil || openapi.IsNil(o.OldCnType) {
		var ret CnType
		return ret
	}
	return *o.OldCnType
...
func (o CnTypeChangeReport) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["newCnType"] = o.NewCnType
	if !openapi.IsNil(o.OldCnType) {
