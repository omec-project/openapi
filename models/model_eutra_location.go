...
var _ openapi.MappedNullable = &EutraLocation{}

// EutraLocation Contains the E-UTRA user location.
type EutraLocation struct {
	Tai       Tai   `json:"tai" yaml:"tai"`
	IgnoreTai *bool `json:"ignoreTai,omitempty" yaml:"ignoreTai,omitempty"`
	Ecgi      Ecgi  `json:"ecgi" yaml:"ecgi"`
	...
	IgnoreEcgi *bool `json:"ignoreEcgi,omitempty" yaml:"ignoreEcgi,omitempty"`
	// The value represents the elapsed time in minutes since the last network contact of the mobile station.  Value \"0\" indicates that the location information was obtained after a successful paging procedure for Active Location Retrieval when the UE is in idle mode or after a successful NG-RAN location reporting procedure with the eNB when the UE is in connected mode.  Any other value than \"0\" indicates that the location information is the last known one.  See 3GPP TS 29.002 clause 17.7.8.
	AgeOfLocationInformation *int32 `json:"ageOfLocationInformation,omitempty" yaml:"ageOfLocationInformation,omitempty"`
	// string with format 'date-time' as defined in OpenAPI.
	UeLocationTimestamp *time.Time `json:"ueLocationTimestamp,omitempty" yaml:"ueLocationTimestamp,omitempty"`
	// Refer to geographical Information. See 3GPP TS 23.032 clause 7.3.2. Only the description of an ellipsoid point with uncertainty circle is allowed to be used.
	GeographicalInformation *string `json:"geographicalInformation,omitempty" yaml:"geographicalInformation,omitempty" validate:"regexp=^[0-9A-F]{16}$"`
	...
	GeodeticInformation *string                 `json:"geodeticInformation,omitempty" yaml:"geodeticInformation,omitempty" validate:"regexp=^[0-9A-F]{20}$"`
	GlobalNgenbId       NullableGlobalRanNodeId `json:"globalNgenbId" yaml:"globalNgenbId,omitempty"`
	GlobalENbId         NullableGlobalRanNodeId `json:"globalENbId" yaml:"globalENbId,omitempty"`
}
...
func (o *EutraLocation) GetIgnoreTai() bool {
	if o == nil || openapi.IsNil(o.IgnoreTai) {
		var ret bool
		return ret
	}
	return *o.IgnoreTai
...
func (o *EutraLocation) GetIgnoreEcgi() bool {
	if o == nil || openapi.IsNil(o.IgnoreEcgi) {
		var ret bool
		return ret
	}
	return *o.IgnoreEcgi
...
func (o *EutraLocation) GetAgeOfLocationInformation() int32 {
	if o == nil || openapi.IsNil(o.AgeOfLocationInformation) {
		var ret int32
		return ret
	}
...
func (o *EutraLocation) GetUeLocationTimestamp() time.Time {
	if o == nil || openapi.IsNil(o.UeLocationTimestamp) {
		var ret time.Time
		return ret
	}
...
func (o *EutraLocation) GetGeographicalInformation() string {
	if o == nil || openapi.IsNil(o.GeographicalInformation) {
		var ret string
		return ret
	}
...
func (o *EutraLocation) GetGeodeticInformation() string {
	if o == nil || openapi.IsNil(o.GeodeticInformation) {
		var ret string
		return ret
	}
...
func (o *EutraLocation) GetGlobalNgenbId() GlobalRanNodeId {
	if o == nil || openapi.IsNil(o.GlobalNgenbId.Get()) {
...
func (o *EutraLocation) GetGlobalENbId() GlobalRanNodeId {
	if o == nil || openapi.IsNil(o.GlobalENbId.Get()) {
		var ret GlobalRanNodeId
		return ret
	}
