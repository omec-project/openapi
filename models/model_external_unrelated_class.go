...
var _ openapi.MappedNullable = &ExternalUnrelatedClass{}

// ExternalUnrelatedClass struct for ExternalUnrelatedClass
type ExternalUnrelatedClass struct {
	LcsClientExternals      []LcsClientExternal      `json:"lcsClientExternals,omitempty" yaml:"lcsClientExternals,omitempty"`
	AfExternals             []AfExternal             `json:"afExternals,omitempty" yaml:"afExternals,omitempty"`
	LcsClientGroupExternals []LcsClientGroupExternal `json:"lcsClientGroupExternals,omitempty" yaml:"lcsClientGroupExternals,omitempty"`
}
...
func (o *ExternalUnrelatedClass) GetLcsClientExternals() []LcsClientExternal {
	if o == nil || openapi.IsNil(o.LcsClientExternals) {
...
func (o *ExternalUnrelatedClass) GetAfExternals() []AfExternal {
	if o == nil || openapi.IsNil(o.AfExternals) {
		var ret []AfExternal
		return ret
	}
...
func (o *ExternalUnrelatedClass) GetLcsClientGroupExternals() []LcsClientGroupExternal {
	if o == nil || openapi.IsNil(o.LcsClientGroupExternals) {
...
func (o ExternalUnrelatedClass) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.LcsClientExternals) {
		toSerialize["lcsClientExternals"] = o.LcsClientExternals
	}
	if !openapi.IsNil(o.AfExternals) {
		toSerialize["afExternals"] = o.AfExternals
	}
	if !openapi.IsNil(o.LcsClientGroupExternals) {
