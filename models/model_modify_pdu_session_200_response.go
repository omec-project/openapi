...
var _ openapi.MappedNullable = &ModifyPduSession200Response{}

// ModifyPduSession200Response struct for ModifyPduSession200Response
type ModifyPduSession200Response struct {
	JsonData                    *VsmfUpdatedData `json:"jsonData,omitempty" yaml:"jsonData,omitempty" multipart:"contentType:application/json,ref:{jsonData}"`
...
func (o ModifyPduSession200Response) ToMap() (map[string]any, error) {
