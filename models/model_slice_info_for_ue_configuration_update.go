...
var _ openapi.MappedNullable = &SliceInfoForUEConfigurationUpdate{}
...
type SliceInfoForUEConfigurationUpdate struct {
	...
	RejectedNssaiRa            []Snssai           `json:"rejectedNssaiRa,omitempty" yaml:"rejectedNssaiRa,omitempty"`
...
func (o *SliceInfoForUEConfigurationUpdate) GetRejectedNssaiRa() []Snssai {
	if o == nil || openapi.IsNil(o.RejectedNssaiRa) {
		var ret []Snssai
		return ret
	}
...
func (o SliceInfoForUEConfigurationUpdate) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.RejectedNssaiRa) {
