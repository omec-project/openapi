...
var _ openapi.MappedNullable = &UeConnectivityState{}
...
type UeConnectivityState struct {
	...
	Connectivitystate *CmState   `json:"connectivitystate,omitempty" yaml:"connectivitystate,omitempty"`
}
...
func (o *UeConnectivityState) GetConnectivitystate() CmState {
	if o == nil || openapi.IsNil(o.Connectivitystate) {
		var ret CmState
		return ret
	}
...
func (o UeConnectivityState) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["accessType"] = o.AccessType
	if !openapi.IsNil(o.Connectivitystate) {
