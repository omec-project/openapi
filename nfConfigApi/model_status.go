...
func (v *Status) UnmarshalJSON(src []byte) error {
	...
	return openapi.ReportError("%+v is not a valid Status", value)
}
...
func NewStatusFromValue(v string) (*Status, error) {
	...
	if ev.IsValid() {
		...
		return nil, openapi.ReportError("invalid value '%v' for Status: valid values are %v", v, AllowedStatusEnumValues)
	}
}
