...
var _ openapi.MappedNullable = &SmallDataRateStatusInfo{}
...
type SmallDataRateStatusInfo struct {
	...
	SmallDataRateStatus SmallDataRateStatus `json:"SmallDataRateStatus" yaml:"SmallDataRateStatus"`
}
...
func (o SmallDataRateStatusInfo) ToMap() (map[string]any, error) {
