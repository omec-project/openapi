...
var _ openapi.MappedNullable = &MmTransactionLocationReportItem{}
...
type MmTransactionLocationReportItem struct {
	...
	Transactions int32     `json:"transactions" yaml:"transactions"`
}
...
func (o MmTransactionLocationReportItem) ToMap() (map[string]any, error) {
