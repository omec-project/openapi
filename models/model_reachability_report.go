...
var _ openapi.MappedNullable = &ReachabilityReport{}

// ReachabilityReport struct for ReachabilityReport
type ReachabilityReport struct {
	// String uniquely identifying a NF instance. The format of the NF Instance ID shall be a  Universally Unique Identifier (UUID) version 4, as described in IETF RFC 4122.
	AmfInstanceId  *string         `json:"amfInstanceId,omitempty" yaml:"amfInstanceId,omitempty"`
...
func (o *ReachabilityReport) GetAmfInstanceId() string {
	if o == nil || openapi.IsNil(o.AmfInstanceId) {
		var ret string
		return ret
	}
...
func (o ReachabilityReport) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.AmfInstanceId) {
