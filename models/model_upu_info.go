...
var _ openapi.MappedNullable = &UpuInfo{}

// UpuInfo struct for UpuInfo
type UpuInfo struct {
	UpuDataList []UpuData `json:"upuDataList,omitempty" yaml:"upuDataList,omitempty"`
	UpuRegInd   *bool     `json:"upuRegInd,omitempty" yaml:"upuRegInd,omitempty"`
	// Contains the indication of whether the acknowledgement from UE is needed.
	UpuAckInd *bool `json:"upuAckInd,omitempty" yaml:"upuAckInd,omitempty"`
	// MAC value for protecting UPU procedure (UPU-MAC-IAUSF and UPU-MAC-IUE).
	UpuMacIausf *string `json:"upuMacIausf,omitempty" yaml:"upuMacIausf,omitempty" validate:"regexp=^[A-Fa-f0-9]{32}$"`
	// CounterUPU.
	CounterUpu *string `json:"counterUpu,omitempty" yaml:"counterUpu,omitempty" validate:"regexp=^[A-Fa-f0-9]{4}$"`
...
func (o *UpuInfo) GetUpuDataList() []UpuData {
	if o == nil || openapi.IsNil(o.UpuDataList) {
		var ret []UpuData
		return ret
	}
...
func (o *UpuInfo) GetUpuRegInd() bool {
	if o == nil || openapi.IsNil(o.UpuRegInd) {
		var ret bool
		return ret
	}
	return *o.UpuRegInd
...
func (o *UpuInfo) GetUpuAckInd() bool {
	if o == nil || openapi.IsNil(o.UpuAckInd) {
		var ret bool
		return ret
	}
	return *o.UpuAckInd
...
func (o *UpuInfo) GetUpuMacIausf() string {
	if o == nil || openapi.IsNil(o.UpuMacIausf) {
		var ret string
		return ret
	}
...
func (o *UpuInfo) GetCounterUpu() string {
	if o == nil || openapi.IsNil(o.CounterUpu) {
		var ret string
		return ret
	}
	return *o.CounterUpu
...
func (o UpuInfo) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.UpuDataList) {
		toSerialize["upuDataList"] = o.UpuDataList
	}
	if !openapi.IsNil(o.UpuRegInd) {
		toSerialize["upuRegInd"] = o.UpuRegInd
	}
	if !openapi.IsNil(o.UpuAckInd) {
		toSerialize["upuAckInd"] = o.UpuAckInd
	}
	if !openapi.IsNil(o.UpuMacIausf) {
		toSerialize["upuMacIausf"] = o.UpuMacIausf
	}
	if !openapi.IsNil(o.CounterUpu) {
