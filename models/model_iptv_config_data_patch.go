...
var _ openapi.MappedNullable = &IptvConfigDataPatch{}
...
type IptvConfigDataPatch struct {
	...
	MultiAccCtrls *map[string]MulticastAccessControlIptv `json:"multiAccCtrls,omitempty" yaml:"multiAccCtrls,omitempty"`
}
...
func (o *IptvConfigDataPatch) GetMultiAccCtrls() map[string]MulticastAccessControlIptv {
	if o == nil || openapi.IsNil(o.MultiAccCtrls) {
...
func (o *IptvConfigDataPatch) GetMultiAccCtrlsOk() (*map[string]MulticastAccessControlIptv, bool) {
	if o == nil || openapi.IsNil(o.MultiAccCtrls) {
		return nil, false
	}
...
// SetMultiAccCtrls gets a reference to the given map[string]MulticastAccessControlIptv and assigns it to the MultiAccCtrls field.
func (o *IptvConfigDataPatch) SetMultiAccCtrls(v map[string]MulticastAccessControlIptv) {
	o.MultiAccCtrls = &v
}

func (o IptvConfigDataPatch) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.MultiAccCtrls) {
