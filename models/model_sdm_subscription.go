...
var _ openapi.MappedNullable = &SdmSubscription{}
...
type SdmSubscription struct {
	...
	ImplicitUnsubscribe *bool  `json:"implicitUnsubscribe,omitempty" yaml:"implicitUnsubscribe,omitempty"`
	...
	AmfServiceName        *ServiceName `json:"amfServiceName,omitempty" yaml:"amfServiceName,omitempty"`
	...
	Report          *ImmediateReport `json:"report,omitempty" yaml:"report,omitempty"`
	...
	NfChangeFilter        *bool                        `json:"nfChangeFilter,omitempty" yaml:"nfChangeFilter,omitempty"`
	...
	UeConSmfDataSubFilter *UeContextInSmfDataSubFilter `json:"ueConSmfDataSubFilter,omitempty" yaml:"ueConSmfDataSubFilter,omitempty"`
	AdjacentPlmns         []PlmnId                     `json:"adjacentPlmns,omitempty" yaml:"adjacentPlmns,omitempty"`
...
func (o *SdmSubscription) GetImplicitUnsubscribe() bool {
	if o == nil || openapi.IsNil(o.ImplicitUnsubscribe) {
		var ret bool
		return ret
	}
...
func (o *SdmSubscription) GetAmfServiceName() ServiceName {
	if o == nil || openapi.IsNil(o.AmfServiceName) {
		var ret ServiceName
		return ret
	}
...
func (o *SdmSubscription) GetNfChangeFilter() bool {
	if o == nil || openapi.IsNil(o.NfChangeFilter) {
		var ret bool
		return ret
	}
...
func (o *SdmSubscription) GetUeConSmfDataSubFilter() UeContextInSmfDataSubFilter {
	if o == nil || openapi.IsNil(o.UeConSmfDataSubFilter) {
...
func (o *SdmSubscription) GetAdjacentPlmns() []PlmnId {
	if o == nil || openapi.IsNil(o.AdjacentPlmns) {
		var ret []PlmnId
		return ret
	}
...
func (o SdmSubscription) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["nfInstanceId"] = o.NfInstanceId
	if !openapi.IsNil(o.ImplicitUnsubscribe) {
	...
	if !openapi.IsNil(o.AmfServiceName) {
	...
	if !openapi.IsNil(o.NfChangeFilter) {
	...
	if !openapi.IsNil(o.UeConSmfDataSubFilter) {
		toSerialize["ueConSmfDataSubFilter"] = o.UeConSmfDataSubFilter
	}
	if !openapi.IsNil(o.AdjacentPlmns) {
