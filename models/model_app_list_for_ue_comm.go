...
var _ openapi.MappedNullable = &AppListForUeComm{}
...
type AppListForUeComm struct {
	...
	AppDur *int32 `json:"appDur,omitempty" yaml:"appDur,omitempty"`
	// Unsigned integer indicating Sampling Ratio (see clauses 4.15.1 of 3GPP TS 23.502), expressed in percent.
	OccurRatio      *int32           `json:"occurRatio,omitempty" yaml:"occurRatio,omitempty"`
	SpatialValidity *NetworkAreaInfo `json:"spatialValidity,omitempty" yaml:"spatialValidity,omitempty"`
}
...
func (o *AppListForUeComm) GetAppDur() int32 {
	if o == nil || openapi.IsNil(o.AppDur) {
		var ret int32
		return ret
	}
	return *o.AppDur
...
func (o *AppListForUeComm) GetOccurRatio() int32 {
	if o == nil || openapi.IsNil(o.OccurRatio) {
		var ret int32
		return ret
	}
	return *o.OccurRatio
...
func (o AppListForUeComm) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["appId"] = o.AppId
	if !openapi.IsNil(o.StartTime) {
		toSerialize["startTime"] = o.StartTime
	}
	if !openapi.IsNil(o.AppDur) {
		toSerialize["appDur"] = o.AppDur
	}
	if !openapi.IsNil(o.OccurRatio) {
