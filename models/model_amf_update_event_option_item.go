...
var _ openapi.MappedNullable = &AmfUpdateEventOptionItem{}
...
func (o *AmfUpdateEventOptionItem) GetMutingExcInstructions() MutingExceptionInstructions {
...
// and a boolean to check if the value has been set.
func (o *AmfUpdateEventOptionItem) GetMutingExcInstructionsOk() (*MutingExceptionInstructions, bool) {
	if o == nil || openapi.IsNil(o.MutingExcInstructions) {
		return nil, false
	}
...
func (o *AmfUpdateEventOptionItem) HasMutingExcInstructions() bool {
	if o != nil && !openapi.IsNil(o.MutingExcInstructions) {
		return true
	}
...
func (o *AmfUpdateEventOptionItem) SetMutingExcInstructions(v MutingExceptionInstructions) {
	o.MutingExcInstructions = &v
}

func (o AmfUpdateEventOptionItem) ToMap() (map[string]any, error) {
