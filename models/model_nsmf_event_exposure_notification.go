...
var _ openapi.MappedNullable = &NsmfEventExposureNotification{}
...
type NsmfEventExposureNotification struct {
	...
	EventNotifs []EventNotificationSmf `json:"eventNotifs" yaml:"eventNotifs"`
	// String providing an URI formatted according to RFC 3986.
	AckUri *string `json:"ackUri,omitempty" yaml:"ackUri,omitempty"`
}
...
func NewNsmfEventExposureNotification(notifId string, eventNotifs []EventNotificationSmf) *NsmfEventExposureNotification {
...
func (o *NsmfEventExposureNotification) GetEventNotifs() []EventNotificationSmf {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *NsmfEventExposureNotification) GetEventNotifsOk() ([]EventNotificationSmf, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NsmfEventExposureNotification) SetEventNotifs(v []EventNotificationSmf) {
	o.EventNotifs = v
}
...
func (o *NsmfEventExposureNotification) GetAckUri() string {
	if o == nil || openapi.IsNil(o.AckUri) {
		var ret string
		return ret
	}
	return *o.AckUri
...
func (o NsmfEventExposureNotification) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["notifId"] = o.NotifId
	toSerialize["eventNotifs"] = o.EventNotifs
	if !openapi.IsNil(o.AckUri) {
