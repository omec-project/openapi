...
var _ openapi.MappedNullable = &IdTranslationResult{}
...
type IdTranslationResult struct {
	...
	AdditionalSupis []string `json:"additionalSupis,omitempty" yaml:"additionalSupis,omitempty"`
	AdditionalGpsis []string `json:"additionalGpsis,omitempty" yaml:"additionalGpsis,omitempty"`
}
...
func (o *IdTranslationResult) GetAdditionalSupis() []string {
	if o == nil || openapi.IsNil(o.AdditionalSupis) {
		var ret []string
		return ret
	}
...
func (o *IdTranslationResult) GetAdditionalGpsis() []string {
	if o == nil || openapi.IsNil(o.AdditionalGpsis) {
		var ret []string
		return ret
	}
...
func (o IdTranslationResult) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.AdditionalSupis) {
		toSerialize["additionalSupis"] = o.AdditionalSupis
	}
	if !openapi.IsNil(o.AdditionalGpsis) {
