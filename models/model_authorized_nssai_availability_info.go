...
var _ openapi.MappedNullable = &AuthorizedNssaiAvailabilityInfo{}
...
type AuthorizedNssaiAvailabilityInfo struct {
	AuthorizedNssaiAvailabilityData []AuthorizedNssaiAvailabilityData `json:"authorizedNssaiAvailabilityData" yaml:"authorizedNssaiAvailabilityData"`
...
func (o AuthorizedNssaiAvailabilityInfo) ToMap() (map[string]any, error) {
