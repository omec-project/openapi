...
var _ openapi.MappedNullable = &BdtReqData{}
...
type BdtReqData struct {
	...
	DesTimeInt TimeWindow `json:"desTimeInt" yaml:"desTimeInt"`
	...
	NumOfUes int32          `json:"numOfUes" yaml:"numOfUes"`
	VolPerUe UsageThreshold `json:"volPerUe" yaml:"volPerUe"`
	...
	WarnNotifReq *bool `json:"warnNotifReq,omitempty" yaml:"warnNotifReq,omitempty"`
}
...
func (o *BdtReqData) GetWarnNotifReq() bool {
	if o == nil || openapi.IsNil(o.WarnNotifReq) {
		var ret bool
		return ret
	}
...
func (o BdtReqData) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.WarnNotifReq) {
