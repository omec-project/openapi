...
var _ openapi.MappedNullable = &AssignEbiError{}
...
type AssignEbiError struct {
	...
	FailureDetails AssignEbiFailed `json:"failureDetails" yaml:"failureDetails"`
}
...
func (o AssignEbiError) ToMap() (map[string]any, error) {
