...
var _ openapi.MappedNullable = &EnhancedCoverageRestrictionData{}

// EnhancedCoverageRestrictionData struct for EnhancedCoverageRestrictionData
type EnhancedCoverageRestrictionData struct {
	PlmnEcInfoList []PlmnEcInfo `json:"plmnEcInfoList,omitempty" yaml:"plmnEcInfoList,omitempty"`
}
...
func (o *EnhancedCoverageRestrictionData) GetPlmnEcInfoList() []PlmnEcInfo {
	if o == nil || openapi.IsNil(o.PlmnEcInfoList) {
		var ret []PlmnEcInfo
		return ret
	}
...
func (o EnhancedCoverageRestrictionData) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.PlmnEcInfoList) {
