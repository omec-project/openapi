...
var _ openapi.MappedNullable = &PpMaximumResponseTime{}

// PpMaximumResponseTime struct for PpMaximumResponseTime
type PpMaximumResponseTime struct {
	// indicating a time in seconds.
	MaximumResponseTime int32  `json:"maximumResponseTime" yaml:"maximumResponseTime"`
...
func (o PpMaximumResponseTime) ToMap() (map[string]any, error) {
