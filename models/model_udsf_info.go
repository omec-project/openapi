...
var _ openapi.MappedNullable = &UdsfInfo{}
...
type UdsfInfo struct {
	...
	StorageIdRanges *map[string][]IdentityRange `json:"storageIdRanges,omitempty" yaml:"storageIdRanges,omitempty"`
}
...
func (o *UdsfInfo) GetStorageIdRanges() map[string][]IdentityRange {
	if o == nil || openapi.IsNil(o.StorageIdRanges) {
...
func (o UdsfInfo) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.StorageIdRanges) {
