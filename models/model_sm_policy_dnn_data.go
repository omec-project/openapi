...
var _ openapi.MappedNullable = &SmPolicyDnnData{}
...
type SmPolicyDnnData struct {
	...
	// Contains the status of the requested policy counters for the PDU session. The key of the map is the attribute policyCounterId.
	...
	// A reference to the UsageMonDataLimit or UsageMonData instances for this DNN and SNSSAI that may also include the related monitoring key(s). The key of the map is the limit identifier.
	RefUmDataLimitIds *map[string]LimitIdToMonitoringKey `json:"refUmDataLimitIds,omitempty" yaml:"refUmDataLimitIds,omitempty"`
	...
	ImsSignallingPrio *bool                              `json:"imsSignallingPrio,omitempty" yaml:"imsSignallingPrio,omitempty"`
	MpsPriorityLevel  *int32                             `json:"mpsPriorityLevel,omitempty" yaml:"mpsPriorityLevel,omitempty"`
	McsPriorityLevel  *int32                             `json:"mcsPriorityLevel,omitempty" yaml:"mcsPriorityLevel,omitempty"`
...
func (o *SmPolicyDnnData) GetAllowedServices() []string {
	if o == nil || openapi.IsNil(o.AllowedServices) {
		var ret []string
		return ret
	}
...
func (o *SmPolicyDnnData) GetAdcSupport() bool {
	if o == nil || openapi.IsNil(o.AdcSupport) {
		var ret bool
		return ret
	}
	return *o.AdcSupport
...
func (o *SmPolicyDnnData) GetSpendLimInfo() map[string]PolicyCounterInfo {
...
// and a boolean to check if the value has been set.
func (o *SmPolicyDnnData) GetSpendLimInfoOk() (*map[string]PolicyCounterInfo, bool) {
	if o == nil || openapi.IsNil(o.SpendLimInfo) {
		return nil, false
	}
...
func (o *SmPolicyDnnData) HasSpendLimInfo() bool {
	if o != nil && !openapi.IsNil(o.SpendLimInfo) {
		return true
	}
...
func (o *SmPolicyDnnData) SetSpendLimInfo(v map[string]PolicyCounterInfo) {
	o.SpendLimInfo = &v
}
...
func (o *SmPolicyDnnData) GetRefUmDataLimitIds() map[string]LimitIdToMonitoringKey {
	if o == nil || openapi.IsNil(o.RefUmDataLimitIds) {
...
func (o *SmPolicyDnnData) GetImsSignallingPrio() bool {
	if o == nil || openapi.IsNil(o.ImsSignallingPrio) {
		var ret bool
		return ret
	}
...
func (o *SmPolicyDnnData) GetMpsPriorityLevel() int32 {
	if o == nil || openapi.IsNil(o.MpsPriorityLevel) {
		var ret int32
		return ret
	}
...
func (o *SmPolicyDnnData) GetMcsPriorityLevel() int32 {
	if o == nil || openapi.IsNil(o.McsPriorityLevel) {
		var ret int32
		return ret
	}
...
func (o *SmPolicyDnnData) GetLocRoutNotAllowed() bool {
	if o == nil || openapi.IsNil(o.LocRoutNotAllowed) {
		var ret bool
		return ret
	}
...
// GetSfcNotAllowed returns the SfcNotAllowed field value if set, zero value otherwise.
func (o *SmPolicyDnnData) GetSfcNotAllowed() bool {
	if o == nil || openapi.IsNil(o.SfcNotAllowed) {
		var ret bool
		return ret
	}
	return *o.SfcNotAllowed
}

// GetSfcNotAllowedOk returns a tuple with the SfcNotAllowed field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SmPolicyDnnData) GetSfcNotAllowedOk() (*bool, bool) {
	if o == nil || openapi.IsNil(o.SfcNotAllowed) {
		return nil, false
	}
	return o.SfcNotAllowed, true
}

// HasSfcNotAllowed returns a boolean if a field has been set.
func (o *SmPolicyDnnData) HasSfcNotAllowed() bool {
	if o != nil && !openapi.IsNil(o.SfcNotAllowed) {
		return true
	}
...
// SetSfcNotAllowed gets a reference to the given bool and assigns it to the SfcNotAllowed field.
func (o *SmPolicyDnnData) SetSfcNotAllowed(v bool) {
	o.SfcNotAllowed = &v
}

// GetTnaps returns the Tnaps field value if set, zero value otherwise.
func (o *SmPolicyDnnData) GetTnaps() []TnapId {
...
// and a boolean to check if the value has been set.
func (o *SmPolicyDnnData) GetTnapsOk() ([]TnapId, bool) {
	if o == nil || openapi.IsNil(o.Tnaps) {
		return nil, false
	}
	return o.Tnaps, true
...
func (o *SmPolicyDnnData) HasTnaps() bool {
	if o != nil && !openapi.IsNil(o.Tnaps) {
		return true
	}
...
func (o *SmPolicyDnnData) SetTnaps(v []TnapId) {
	o.Tnaps = v
}

func (o SmPolicyDnnData) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["dnn"] = o.Dnn
	if !openapi.IsNil(o.AllowedServices) {
	...
	if !openapi.IsNil(o.RefUmDataLimitIds) {
	...
	if !openapi.IsNil(o.ImsSignallingPrio) {
		toSerialize["imsSignallingPrio"] = o.ImsSignallingPrio
	}
	if !openapi.IsNil(o.MpsPriorityLevel) {
		toSerialize["mpsPriorityLevel"] = o.MpsPriorityLevel
	}
	if !openapi.IsNil(o.McsPriorityLevel) {
	...
	if !openapi.IsNil(o.LocRoutNotAllowed) {
		toSerialize["locRoutNotAllowed"] = o.LocRoutNotAllowed
	}
	if !openapi.IsNil(o.SfcNotAllowed) {
		toSerialize["sfcNotAllowed"] = o.SfcNotAllowed
	}
