...
var _ openapi.MappedNullable = &EcsServerAddr{}
...
type EcsServerAddr struct {
	EcsFqdnList      []string `json:"ecsFqdnList,omitempty" yaml:"ecsFqdnList,omitempty"`
	EcsIpAddressList []IpAddr `json:"ecsIpAddressList,omitempty" yaml:"ecsIpAddressList,omitempty"`
	EcsUriList       []string `json:"ecsUriList,omitempty" yaml:"ecsUriList,omitempty"`
	EcsProviderId    *string  `json:"ecsProviderId,omitempty" yaml:"ecsProviderId,omitempty"`
}
...
func (o *EcsServerAddr) GetEcsFqdnList() []string {
	if o == nil || openapi.IsNil(o.EcsFqdnList) {
		var ret []string
		return ret
	}
...
func (o *EcsServerAddr) GetEcsIpAddressList() []IpAddr {
	if o == nil || openapi.IsNil(o.EcsIpAddressList) {
		var ret []IpAddr
		return ret
	}
...
func (o *EcsServerAddr) GetEcsUriList() []string {
	if o == nil || openapi.IsNil(o.EcsUriList) {
		var ret []string
		return ret
	}
	return o.EcsUriList
...
func (o *EcsServerAddr) GetEcsProviderId() string {
	if o == nil || openapi.IsNil(o.EcsProviderId) {
		var ret string
		return ret
	}
...
func (o EcsServerAddr) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.EcsFqdnList) {
		toSerialize["ecsFqdnList"] = o.EcsFqdnList
	}
	if !openapi.IsNil(o.EcsIpAddressList) {
		toSerialize["ecsIpAddressList"] = o.EcsIpAddressList
	}
	if !openapi.IsNil(o.EcsUriList) {
		toSerialize["ecsUriList"] = o.EcsUriList
	}
	if !openapi.IsNil(o.EcsProviderId) {
