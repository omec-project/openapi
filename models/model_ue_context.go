...
var _ openapi.MappedNullable = &UeContext{}
...
type UeContext struct {
	...
	SupiUnauthInd *bool    `json:"supiUnauthInd,omitempty" yaml:"supiUnauthInd,omitempty"`
	...
	// Identifier of a group of NFs.
	AusfGroupId *string `json:"ausfGroupId,omitempty" yaml:"ausfGroupId,omitempty"`
	// Identifier of a group of NFs.
	...
	GroupList        []string `json:"groupList,omitempty" yaml:"groupList,omitempty"`
	// string with format 'bytes' as defined in OpenAPI
	DrxParameter *string `json:"drxParameter,omitempty" yaml:"drxParameter,omitempty"`
	// Unsigned integer representing the \"Subscriber Profile ID for RAT/Frequency Priority\"  as specified in 3GPP TS 36.413.
	SubRfsp *int32 `json:"subRfsp,omitempty" yaml:"subRfsp,omitempty"`
	// Unsigned integer representing the \"Subscriber Profile ID for RAT/Frequency Priority\"  as specified in 3GPP TS 36.413.
	PcfRfsp *int32 `json:"pcfRfsp,omitempty" yaml:"pcfRfsp,omitempty"`
	// Unsigned integer representing the \"Subscriber Profile ID for RAT/Frequency Priority\"  as specified in 3GPP TS 36.413.
	UsedRfsp  *int32 `json:"usedRfsp,omitempty" yaml:"usedRfsp,omitempty"`
	SubUeAmbr *Ambr  `json:"subUeAmbr,omitempty" yaml:"subUeAmbr,omitempty"`
	PcfUeAmbr *Ambr  `json:"pcfUeAmbr,omitempty" yaml:"pcfUeAmbr,omitempty"`
	// A map(list of key-value pairs) where Snssai serves as key.
	SubUeSliceMbrList *map[string]SliceMbr `json:"subUeSliceMbrList,omitempty" yaml:"subUeSliceMbrList,omitempty"`
	// String uniquely identifying a NF instance. The format of the NF Instance ID shall be a  Universally Unique Identifier (UUID) version 4, as described in IETF RFC 4122.
	SmsfId   *string   `json:"smsfId,omitempty" yaml:"smsfId,omitempty"`
	SeafData *SeafData `json:"seafData,omitempty" yaml:"seafData,omitempty"`
	// string with format 'bytes' as defined in OpenAPI
	Var5gMmCapability *string `json:"5gMmCapability,omitempty" yaml:"5gMmCapability,omitempty"`
	// String uniquely identifying a NF instance. The format of the NF Instance ID shall be a  Universally Unique Identifier (UUID) version 4, as described in IETF RFC 4122.
	...
	PcfAmpServiceSetId *string `json:"pcfAmpServiceSetId,omitempty" yaml:"pcfAmpServiceSetId,omitempty"`
	// NF Service Set Identifier (see clause 28.12 of 3GPP TS 23.003) formatted as the following  string \"set<Set ID>.sn<Service Name>.nfi<NF Instance ID>.5gc.mnc<MNC>.mcc<MCC>\", or  \"set<SetID>.sn<ServiceName>.nfi<NFInstanceID>.5gc.nid<NID>.mnc<MNC>.mcc<MCC>\" with  <MCC> encoded as defined in clause 5.4.2 (\"Mcc\" data type definition)   <MNC> encoding the Mobile Network Code part of the PLMN, comprising 3 digits.    If there are only 2 significant digits in the MNC, one \"0\" digit shall be inserted    at the left side to fill the 3 digits coding of MNC.  Pattern: '^[0-9]{3}$' <NID> encoded as defined in clause 5.4.2 (\"Nid\" data type definition)  <NFInstanceId> encoded as defined in clause 5.3.2  <ServiceName> encoded as defined in 3GPP TS 29.510  <Set ID> encoded as a string of characters consisting of alphabetic    characters (A-Z and a-z), digits (0-9) and/or the hyphen (-) and that shall end    with either an alphabetic character or a digit.
	PcfUepServiceSetId *string          `json:"pcfUepServiceSetId,omitempty" yaml:"pcfUepServiceSetId,omitempty"`
	PcfBinding         *SbiBindingLevel `json:"pcfBinding,omitempty" yaml:"pcfBinding,omitempty"`
	// String providing an URI formatted according to RFC 3986.
	PcfAmPolicyUri         *string            `json:"pcfAmPolicyUri,omitempty" yaml:"pcfAmPolicyUri,omitempty"`
	AmPolicyReqTriggerList []PolicyReqTrigger `json:"amPolicyReqTriggerList,omitempty" yaml:"amPolicyReqTriggerList,omitempty"`
	// String providing an URI formatted according to RFC 3986.
	PcfUePolicyUri         *string            `json:"pcfUePolicyUri,omitempty" yaml:"pcfUePolicyUri,omitempty"`
	UePolicyReqTriggerList []PolicyReqTrigger `json:"uePolicyReqTriggerList,omitempty" yaml:"uePolicyReqTriggerList,omitempty"`
	// String uniquely identifying a NF instance. The format of the NF Instance ID shall be a  Universally Unique Identifier (UUID) version 4, as described in IETF RFC 4122.
	HpcfId *string `json:"hpcfId,omitempty" yaml:"hpcfId,omitempty"`
	// NF Set Identifier (see clause 28.12 of 3GPP TS 23.003), formatted as the following string \"set<Set ID>.<nftype>set.5gc.mnc<MNC>.mcc<MCC>\", or  \"set<SetID>.<NFType>set.5gc.nid<NID>.mnc<MNC>.mcc<MCC>\" with  <MCC> encoded as defined in clause 5.4.2 (\"Mcc\" data type definition)  <MNC> encoding the Mobile Network Code part of the PLMN, comprising 3 digits.    If there are only 2 significant digits in the MNC, one \"0\" digit shall be inserted    at the left side to fill the 3 digits coding of MNC.  Pattern: '^[0-9]{3}$' <NFType> encoded as a value defined in Table 6.1.6.3.3-1 of 3GPP TS 29.510 but    with lower case characters <Set ID> encoded as a string of characters consisting of    alphabetic characters (A-Z and a-z), digits (0-9) and/or the hyphen (-) and that    shall end with either an alphabetic character or a digit.
	HpcfSetId                *string                   `json:"hpcfSetId,omitempty" yaml:"hpcfSetId,omitempty"`
	RestrictedRatList        []RatType                 `json:"restrictedRatList,omitempty" yaml:"restrictedRatList,omitempty"`
	ForbiddenAreaList        []Area                    `json:"forbiddenAreaList,omitempty" yaml:"forbiddenAreaList,omitempty"`
	...
	RestrictedCoreNwTypeList []CoreNetworkType         `json:"restrictedCoreNwTypeList,omitempty" yaml:"restrictedCoreNwTypeList,omitempty"`
	EventSubscriptionList    []ExtAmfEventSubscription `json:"eventSubscriptionList,omitempty" yaml:"eventSubscriptionList,omitempty"`
	MmContextList            []MmContext               `json:"mmContextList,omitempty" yaml:"mmContextList,omitempty"`
	SessionContextList       []PduSessionContext       `json:"sessionContextList,omitempty" yaml:"sessionContextList,omitempty"`
	...
	ServiceGapExpiryTime *time.Time `json:"serviceGapExpiryTime,omitempty" yaml:"serviceGapExpiryTime,omitempty"`
	...
	// string with format 'bytes' as defined in OpenAPI
	MsClassmark2               *string                   `json:"msClassmark2,omitempty" yaml:"msClassmark2,omitempty"`
	SupportedCodecList         []string                  `json:"supportedCodecList,omitempty" yaml:"supportedCodecList,omitempty"`
	SmallDataRateStatusInfos   []SmallDataRateStatusInfo `json:"smallDataRateStatusInfos,omitempty" yaml:"smallDataRateStatusInfos,omitempty"`
	RestrictedPrimaryRatList   []RatType                 `json:"restrictedPrimaryRatList,omitempty" yaml:"restrictedPrimaryRatList,omitempty"`
	RestrictedSecondaryRatList []RatType                 `json:"restrictedSecondaryRatList,omitempty" yaml:"restrictedSecondaryRatList,omitempty"`
	V2xContext                 *V2xContext               `json:"v2xContext,omitempty" yaml:"v2xContext,omitempty"`
	LteCatMInd                 *bool                     `json:"lteCatMInd,omitempty" yaml:"lteCatMInd,omitempty"`
	RedCapInd                  *bool                     `json:"redCapInd,omitempty" yaml:"redCapInd,omitempty"`
	...
	ManagementMdtInd           *bool                     `json:"managementMdtInd,omitempty" yaml:"managementMdtInd,omitempty"`
	// A map (list of key-value pairs where PlmnId serves as key) of Booleans
	AdjacenPlmnMngtMdtInds     *map[string]bool        `json:"adjacenPlmnMngtMdtInds,omitempty" yaml:"adjacenPlmnMngtMdtInds,omitempty"`
	ImmediateMdtConf           *ImmediateMdtConf       `json:"immediateMdtConf,omitempty" yaml:"immediateMdtConf,omitempty"`
	EcRestrictionDataWb        *EcRestrictionDataWb    `json:"ecRestrictionDataWb,omitempty" yaml:"ecRestrictionDataWb,omitempty"`
	...
	ProseContext               *ProseContext           `json:"proseContext,omitempty" yaml:"proseContext,omitempty"`
	AnalyticsSubscriptionList  []AnalyticsSubscription `json:"analyticsSubscriptionList,omitempty" yaml:"analyticsSubscriptionList,omitempty"`
	PcfAmpBindingInfo          *string                 `json:"pcfAmpBindingInfo,omitempty" yaml:"pcfAmpBindingInfo,omitempty"`
	PcfUepBindingInfo          *string                 `json:"pcfUepBindingInfo,omitempty" yaml:"pcfUepBindingInfo,omitempty"`
	UsedServiceAreaRestriction *ServiceAreaRestriction `json:"usedServiceAreaRestriction,omitempty" yaml:"usedServiceAreaRestriction,omitempty"`
	// A map(list of key-value pairs) where praId serves as key.
	PraInAmPolicy *map[string]PresenceInfo `json:"praInAmPolicy,omitempty" yaml:"praInAmPolicy,omitempty"`
	// A map(list of key-value pairs) where praId serves as key.
	PraInUePolicy         *map[string]PresenceInfo  `json:"praInUePolicy,omitempty" yaml:"praInUePolicy,omitempty"`
	UpdpSubscriptionData  *UpdpSubscriptionData     `json:"updpSubscriptionData,omitempty" yaml:"updpSubscriptionData,omitempty"`
	SmPolicyNotifyPduList []PduSessionInfo          `json:"smPolicyNotifyPduList,omitempty" yaml:"smPolicyNotifyPduList,omitempty"`
	...
	AstiDistributionIndication *bool                    `json:"astiDistributionIndication,omitempty" yaml:"astiDistributionIndication,omitempty"`
	TsErrorBudget              *int32                   `json:"tsErrorBudget,omitempty" yaml:"tsErrorBudget,omitempty"`
	SnpnOnboardInd             *bool                    `json:"snpnOnboardInd,omitempty" yaml:"snpnOnboardInd,omitempty"`
	SmfSelInfo                 NullableSmfSelectionData `json:"smfSelInfo" yaml:"smfSelInfo,omitempty"`
	// A map(list of key-value pairs) where Snssai serves as key.
	PcfUeSliceMbrList *map[string]SliceMbr `json:"pcfUeSliceMbrList,omitempty" yaml:"pcfUeSliceMbrList,omitempty"`
	// NF Set Identifier (see clause 28.12 of 3GPP TS 23.003), formatted as the following string \"set<Set ID>.<nftype>set.5gc.mnc<MNC>.mcc<MCC>\", or  \"set<SetID>.<NFType>set.5gc.nid<NID>.mnc<MNC>.mcc<MCC>\" with  <MCC> encoded as defined in clause 5.4.2 (\"Mcc\" data type definition)  <MNC> encoding the Mobile Network Code part of the PLMN, comprising 3 digits.    If there are only 2 significant digits in the MNC, one \"0\" digit shall be inserted    at the left side to fill the 3 digits coding of MNC.  Pattern: '^[0-9]{3}$' <NFType> encoded as a value defined in Table 6.1.6.3.3-1 of 3GPP TS 29.510 but    with lower case characters <Set ID> encoded as a string of characters consisting of    alphabetic characters (A-Z and a-z), digits (0-9) and/or the hyphen (-) and that    shall end with either an alphabetic character or a digit.
	SmsfSetId *string `json:"smsfSetId,omitempty" yaml:"smsfSetId,omitempty"`
	// NF Service Set Identifier (see clause 28.12 of 3GPP TS 23.003) formatted as the following  string \"set<Set ID>.sn<Service Name>.nfi<NF Instance ID>.5gc.mnc<MNC>.mcc<MCC>\", or  \"set<SetID>.sn<ServiceName>.nfi<NFInstanceID>.5gc.nid<NID>.mnc<MNC>.mcc<MCC>\" with  <MCC> encoded as defined in clause 5.4.2 (\"Mcc\" data type definition)   <MNC> encoding the Mobile Network Code part of the PLMN, comprising 3 digits.    If there are only 2 significant digits in the MNC, one \"0\" digit shall be inserted    at the left side to fill the 3 digits coding of MNC.  Pattern: '^[0-9]{3}$' <NID> encoded as defined in clause 5.4.2 (\"Nid\" data type definition)  <NFInstanceId> encoded as defined in clause 5.3.2  <ServiceName> encoded as defined in 3GPP TS 29.510  <Set ID> encoded as a string of characters consisting of alphabetic    characters (A-Z and a-z), digits (0-9) and/or the hyphen (-) and that shall end    with either an alphabetic character or a digit.
	SmsfServiceSetId      *string                         `json:"smsfServiceSetId,omitempty" yaml:"smsfServiceSetId,omitempty"`
	SmsfBindingInfo       *string                         `json:"smsfBindingInfo,omitempty" yaml:"smsfBindingInfo,omitempty"`
	DisasterRoamingInd    *bool                           `json:"disasterRoamingInd,omitempty" yaml:"disasterRoamingInd,omitempty"`
	DisasterPlmn          *PlmnId                         `json:"disasterPlmn,omitempty" yaml:"disasterPlmn,omitempty"`
	...
	AsTimeDisParam        NullableAsTimeDistributionParam `json:"asTimeDisParam" yaml:"asTimeDisParam,omitempty"`
	AmPolicyInfoContainer *AmPolicyInfoContainer          `json:"amPolicyInfoContainer,omitempty" yaml:"amPolicyInfoContainer,omitempty"`
	A2xContext            *A2xContext                     `json:"a2xContext,omitempty" yaml:"a2xContext,omitempty"`
	MbsrOperationAllowed  *MbsrOperationAllowed           `json:"mbsrOperationAllowed,omitempty" yaml:"mbsrOperationAllowed,omitempty"`
	LcsUpContext          *LcsUpContext                   `json:"lcsUpContext,omitempty" yaml:"lcsUpContext,omitempty"`
	ReconnectInd          *bool                           `json:"reconnectInd,omitempty" yaml:"reconnectInd,omitempty"`
}
...
func NewUeContext() *UeContext {
	...
	var reconnectInd bool = false
	this.ReconnectInd = &reconnectInd
	return &this
}
...
func (o *UeContext) GetSupiUnauthInd() bool {
	if o == nil || openapi.IsNil(o.SupiUnauthInd) {
		var ret bool
		return ret
	}
...
func (o *UeContext) GetAusfGroupId() string {
	if o == nil || openapi.IsNil(o.AusfGroupId) {
		var ret string
		return ret
	}
...
func (o *UeContext) GetGroupList() []string {
	if o == nil || openapi.IsNil(o.GroupList) {
		var ret []string
		return ret
	}
	return o.GroupList
...
func (o *UeContext) GetDrxParameter() string {
	if o == nil || openapi.IsNil(o.DrxParameter) {
		var ret string
		return ret
	}
...
func (o *UeContext) GetSubRfsp() int32 {
	if o == nil || openapi.IsNil(o.SubRfsp) {
		var ret int32
		return ret
	}
	return *o.SubRfsp
...
func (o *UeContext) GetPcfRfsp() int32 {
	if o == nil || openapi.IsNil(o.PcfRfsp) {
		var ret int32
		return ret
	}
	return *o.PcfRfsp
...
// GetPcfRfspOk returns a tuple with the PcfRfsp field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UeContext) GetPcfRfspOk() (*int32, bool) {
	if o == nil || openapi.IsNil(o.PcfRfsp) {
		return nil, false
	}
	return o.PcfRfsp, true
}
...
func (o *UeContext) GetUsedRfsp() int32 {
	if o == nil || openapi.IsNil(o.UsedRfsp) {
		var ret int32
		return ret
	}
	return *o.UsedRfsp
...
func (o *UeContext) GetSubUeAmbr() Ambr {
	if o == nil || openapi.IsNil(o.SubUeAmbr) {
		var ret Ambr
		return ret
	}
	return *o.SubUeAmbr
...
func (o *UeContext) GetPcfUeAmbr() Ambr {
	if o == nil || openapi.IsNil(o.PcfUeAmbr) {
		var ret Ambr
		return ret
	}
	return *o.PcfUeAmbr
...
// GetPcfUeAmbrOk returns a tuple with the PcfUeAmbr field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UeContext) GetPcfUeAmbrOk() (*Ambr, bool) {
	if o == nil || openapi.IsNil(o.PcfUeAmbr) {
		return nil, false
	}
	return o.PcfUeAmbr, true
}
...
func (o *UeContext) GetSubUeSliceMbrList() map[string]SliceMbr {
	if o == nil || openapi.IsNil(o.SubUeSliceMbrList) {
...
func (o *UeContext) GetSmsfId() string {
	if o == nil || openapi.IsNil(o.SmsfId) {
		var ret string
		return ret
	}
	return *o.SmsfId
...
func (o *UeContext) GetSeafData() SeafData {
	if o == nil || openapi.IsNil(o.SeafData) {
		var ret SeafData
		return ret
	}
	return *o.SeafData
...
func (o *UeContext) GetVar5gMmCapability() string {
	if o == nil || openapi.IsNil(o.Var5gMmCapability) {
		var ret string
		return ret
	}
...
func (o *UeContext) GetPcfAmpServiceSetId() string {
	if o == nil || openapi.IsNil(o.PcfAmpServiceSetId) {
		var ret string
		return ret
	}
...
func (o *UeContext) GetPcfUepServiceSetId() string {
	if o == nil || openapi.IsNil(o.PcfUepServiceSetId) {
		var ret string
		return ret
	}
...
func (o *UeContext) GetPcfBinding() SbiBindingLevel {
	if o == nil || openapi.IsNil(o.PcfBinding) {
...
func (o *UeContext) GetPcfAmPolicyUri() string {
	if o == nil || openapi.IsNil(o.PcfAmPolicyUri) {
		var ret string
		return ret
	}
...
func (o *UeContext) GetAmPolicyReqTriggerList() []PolicyReqTrigger {
	if o == nil || openapi.IsNil(o.AmPolicyReqTriggerList) {
...
func (o *UeContext) GetPcfUePolicyUri() string {
	if o == nil || openapi.IsNil(o.PcfUePolicyUri) {
		var ret string
		return ret
	}
...
func (o *UeContext) GetUePolicyReqTriggerList() []PolicyReqTrigger {
	if o == nil || openapi.IsNil(o.UePolicyReqTriggerList) {
		var ret []PolicyReqTrigger
		return ret
	}
...
func (o *UeContext) GetHpcfSetId() string {
	if o == nil || openapi.IsNil(o.HpcfSetId) {
		var ret string
		return ret
	}
	return *o.HpcfSetId
...
func (o *UeContext) GetRestrictedRatList() []RatType {
	if o == nil || openapi.IsNil(o.RestrictedRatList) {
		var ret []RatType
		return ret
	}
...
func (o *UeContext) GetForbiddenAreaList() []Area {
	if o == nil || openapi.IsNil(o.ForbiddenAreaList) {
		var ret []Area
		return ret
	}
...
func (o *UeContext) GetRestrictedCoreNwTypeList() []CoreNetworkType {
	if o == nil || openapi.IsNil(o.RestrictedCoreNwTypeList) {
...
func (o *UeContext) GetEventSubscriptionList() []ExtAmfEventSubscription {
	if o == nil || openapi.IsNil(o.EventSubscriptionList) {
...
func (o *UeContext) GetMmContextList() []MmContext {
	if o == nil || openapi.IsNil(o.MmContextList) {
		var ret []MmContext
		return ret
	}
...
func (o *UeContext) GetSessionContextList() []PduSessionContext {
	if o == nil || openapi.IsNil(o.SessionContextList) {
...
func (o *UeContext) GetServiceGapExpiryTime() time.Time {
	if o == nil || openapi.IsNil(o.ServiceGapExpiryTime) {
		var ret time.Time
		return ret
	}
...
func (o *UeContext) GetMsClassmark2() string {
	if o == nil || openapi.IsNil(o.MsClassmark2) {
		var ret string
		return ret
	}
...
func (o *UeContext) GetSupportedCodecList() []string {
	if o == nil || openapi.IsNil(o.SupportedCodecList) {
		var ret []string
		return ret
	}
...
func (o *UeContext) GetSmallDataRateStatusInfos() []SmallDataRateStatusInfo {
	if o == nil || openapi.IsNil(o.SmallDataRateStatusInfos) {
...
func (o *UeContext) GetRestrictedPrimaryRatList() []RatType {
	if o == nil || openapi.IsNil(o.RestrictedPrimaryRatList) {
		var ret []RatType
		return ret
	}
...
func (o *UeContext) GetRestrictedSecondaryRatList() []RatType {
	if o == nil || openapi.IsNil(o.RestrictedSecondaryRatList) {
		var ret []RatType
		return ret
	}
...
func (o *UeContext) GetV2xContext() V2xContext {
	if o == nil || openapi.IsNil(o.V2xContext) {
		var ret V2xContext
		return ret
	}
	return *o.V2xContext
...
func (o *UeContext) GetLteCatMInd() bool {
	if o == nil || openapi.IsNil(o.LteCatMInd) {
		var ret bool
		return ret
	}
	return *o.LteCatMInd
...
func (o *UeContext) GetRedCapInd() bool {
	if o == nil || openapi.IsNil(o.RedCapInd) {
		var ret bool
		return ret
	}
	return *o.RedCapInd
...
func (o *UeContext) GetManagementMdtInd() bool {
	if o == nil || openapi.IsNil(o.ManagementMdtInd) {
		var ret bool
		return ret
	}
...
// GetAdjacenPlmnMngtMdtInds returns the AdjacenPlmnMngtMdtInds field value if set, zero value otherwise.
func (o *UeContext) GetAdjacenPlmnMngtMdtInds() map[string]bool {
	if o == nil || openapi.IsNil(o.AdjacenPlmnMngtMdtInds) {
		var ret map[string]bool
		return ret
	}
	return *o.AdjacenPlmnMngtMdtInds
}

// GetAdjacenPlmnMngtMdtIndsOk returns a tuple with the AdjacenPlmnMngtMdtInds field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UeContext) GetAdjacenPlmnMngtMdtIndsOk() (*map[string]bool, bool) {
	if o == nil || openapi.IsNil(o.AdjacenPlmnMngtMdtInds) {
		return nil, false
	}
	return o.AdjacenPlmnMngtMdtInds, true
}

// HasAdjacenPlmnMngtMdtInds returns a boolean if a field has been set.
func (o *UeContext) HasAdjacenPlmnMngtMdtInds() bool {
	if o != nil && !openapi.IsNil(o.AdjacenPlmnMngtMdtInds) {
		return true
	}
...
// SetAdjacenPlmnMngtMdtInds gets a reference to the given map[string]bool and assigns it to the AdjacenPlmnMngtMdtInds field.
func (o *UeContext) SetAdjacenPlmnMngtMdtInds(v map[string]bool) {
	o.AdjacenPlmnMngtMdtInds = &v
}
...
func (o *UeContext) GetImmediateMdtConf() ImmediateMdtConf {
	if o == nil || openapi.IsNil(o.ImmediateMdtConf) {
...
func (o *UeContext) GetEcRestrictionDataWb() EcRestrictionDataWb {
	if o == nil || openapi.IsNil(o.EcRestrictionDataWb) {
...
func (o *UeContext) GetProseContext() ProseContext {
	if o == nil || openapi.IsNil(o.ProseContext) {
...
func (o *UeContext) GetAnalyticsSubscriptionList() []AnalyticsSubscription {
	if o == nil || openapi.IsNil(o.AnalyticsSubscriptionList) {
...
func (o *UeContext) GetPcfAmpBindingInfo() string {
	if o == nil || openapi.IsNil(o.PcfAmpBindingInfo) {
		var ret string
		return ret
	}
...
func (o *UeContext) GetPcfUepBindingInfo() string {
	if o == nil || openapi.IsNil(o.PcfUepBindingInfo) {
		var ret string
		return ret
	}
...
func (o *UeContext) GetUsedServiceAreaRestriction() ServiceAreaRestriction {
	if o == nil || openapi.IsNil(o.UsedServiceAreaRestriction) {
		var ret ServiceAreaRestriction
		return ret
	}
...
func (o *UeContext) GetPraInAmPolicy() map[string]PresenceInfo {
	if o == nil || openapi.IsNil(o.PraInAmPolicy) {
...
func (o *UeContext) GetPraInUePolicy() map[string]PresenceInfo {
	if o == nil || openapi.IsNil(o.PraInUePolicy) {
		var ret map[string]PresenceInfo
		return ret
	}
...
func (o *UeContext) GetUpdpSubscriptionData() UpdpSubscriptionData {
	if o == nil || openapi.IsNil(o.UpdpSubscriptionData) {
...
func (o *UeContext) GetSmPolicyNotifyPduList() []PduSessionInfo {
	if o == nil || openapi.IsNil(o.SmPolicyNotifyPduList) {
...
func (o *UeContext) GetAstiDistributionIndication() bool {
	if o == nil || openapi.IsNil(o.AstiDistributionIndication) {
		var ret bool
		return ret
	}
...
func (o *UeContext) GetTsErrorBudget() int32 {
	if o == nil || openapi.IsNil(o.TsErrorBudget) {
		var ret int32
		return ret
	}
...
func (o *UeContext) GetSnpnOnboardInd() bool {
	if o == nil || openapi.IsNil(o.SnpnOnboardInd) {
		var ret bool
		return ret
	}
...
func (o *UeContext) GetPcfUeSliceMbrList() map[string]SliceMbr {
	if o == nil || openapi.IsNil(o.PcfUeSliceMbrList) {
		var ret map[string]SliceMbr
		return ret
	}
...
func (o *UeContext) GetSmsfServiceSetId() string {
	if o == nil || openapi.IsNil(o.SmsfServiceSetId) {
		var ret string
		return ret
	}
...
func (o *UeContext) GetSmsfBindingInfo() string {
	if o == nil || openapi.IsNil(o.SmsfBindingInfo) {
		var ret string
		return ret
	}
...
func (o *UeContext) GetDisasterPlmn() PlmnId {
	if o == nil || openapi.IsNil(o.DisasterPlmn) {
		var ret PlmnId
		return ret
	}
...
func (o *UeContext) GetSatelliteBackhaulCat() SatelliteBackhaulCategory {
...
// and a boolean to check if the value has been set.
func (o *UeContext) GetSatelliteBackhaulCatOk() (*SatelliteBackhaulCategory, bool) {
	if o == nil || openapi.IsNil(o.SatelliteBackhaulCat) {
		return nil, false
	}
...
func (o *UeContext) HasSatelliteBackhaulCat() bool {
	if o != nil && !openapi.IsNil(o.SatelliteBackhaulCat) {
		return true
	}
...
func (o *UeContext) SetSatelliteBackhaulCat(v SatelliteBackhaulCategory) {
...
func (o *UeContext) GetAsTimeDisParam() AsTimeDistributionParam {
	if o == nil || openapi.IsNil(o.AsTimeDisParam.Get()) {
...
// GetAmPolicyInfoContainer returns the AmPolicyInfoContainer field value if set, zero value otherwise.
func (o *UeContext) GetAmPolicyInfoContainer() AmPolicyInfoContainer {
	if o == nil || openapi.IsNil(o.AmPolicyInfoContainer) {
		var ret AmPolicyInfoContainer
		return ret
	}
	return *o.AmPolicyInfoContainer
}

// GetAmPolicyInfoContainerOk returns a tuple with the AmPolicyInfoContainer field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UeContext) GetAmPolicyInfoContainerOk() (*AmPolicyInfoContainer, bool) {
	if o == nil || openapi.IsNil(o.AmPolicyInfoContainer) {
		return nil, false
	}
	return o.AmPolicyInfoContainer, true
}

// HasAmPolicyInfoContainer returns a boolean if a field has been set.
func (o *UeContext) HasAmPolicyInfoContainer() bool {
	if o != nil && !openapi.IsNil(o.AmPolicyInfoContainer) {
		return true
	}
...
// SetAmPolicyInfoContainer gets a reference to the given AmPolicyInfoContainer and assigns it to the AmPolicyInfoContainer field.
func (o *UeContext) SetAmPolicyInfoContainer(v AmPolicyInfoContainer) {
	o.AmPolicyInfoContainer = &v
}

// GetA2xContext returns the A2xContext field value if set, zero value otherwise.
func (o *UeContext) GetA2xContext() A2xContext {
	if o == nil || openapi.IsNil(o.A2xContext) {
		var ret A2xContext
		return ret
	}
	return *o.A2xContext
...
// GetA2xContextOk returns a tuple with the A2xContext field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UeContext) GetA2xContextOk() (*A2xContext, bool) {
	if o == nil || openapi.IsNil(o.A2xContext) {
		return nil, false
	}
	return o.A2xContext, true
}

// HasA2xContext returns a boolean if a field has been set.
func (o *UeContext) HasA2xContext() bool {
	if o != nil && !openapi.IsNil(o.A2xContext) {
		return true
	}
...
// SetA2xContext gets a reference to the given A2xContext and assigns it to the A2xContext field.
func (o *UeContext) SetA2xContext(v A2xContext) {
	o.A2xContext = &v
}

// GetMbsrOperationAllowed returns the MbsrOperationAllowed field value if set, zero value otherwise.
func (o *UeContext) GetMbsrOperationAllowed() MbsrOperationAllowed {
...
// and a boolean to check if the value has been set.
func (o *UeContext) GetMbsrOperationAllowedOk() (*MbsrOperationAllowed, bool) {
	if o == nil || openapi.IsNil(o.MbsrOperationAllowed) {
		return nil, false
	}
...
func (o *UeContext) HasMbsrOperationAllowed() bool {
	if o != nil && !openapi.IsNil(o.MbsrOperationAllowed) {
		return true
	}
...
func (o *UeContext) SetMbsrOperationAllowed(v MbsrOperationAllowed) {
	o.MbsrOperationAllowed = &v
}

// GetLcsUpContext returns the LcsUpContext field value if set, zero value otherwise.
func (o *UeContext) GetLcsUpContext() LcsUpContext {
	if o == nil || openapi.IsNil(o.LcsUpContext) {
		var ret LcsUpContext
		return ret
	}
	return *o.LcsUpContext
}

// GetLcsUpContextOk returns a tuple with the LcsUpContext field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UeContext) GetLcsUpContextOk() (*LcsUpContext, bool) {
	if o == nil || openapi.IsNil(o.LcsUpContext) {
		return nil, false
	}
	return o.LcsUpContext, true
}

// HasLcsUpContext returns a boolean if a field has been set.
func (o *UeContext) HasLcsUpContext() bool {
	if o != nil && !openapi.IsNil(o.LcsUpContext) {
		return true
	}
...
// SetLcsUpContext gets a reference to the given LcsUpContext and assigns it to the LcsUpContext field.
func (o *UeContext) SetLcsUpContext(v LcsUpContext) {
	o.LcsUpContext = &v
}

// GetReconnectInd returns the ReconnectInd field value if set, zero value otherwise.
func (o *UeContext) GetReconnectInd() bool {
	if o == nil || openapi.IsNil(o.ReconnectInd) {
		var ret bool
		return ret
	}
	return *o.ReconnectInd
}

// GetReconnectIndOk returns a tuple with the ReconnectInd field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UeContext) GetReconnectIndOk() (*bool, bool) {
	if o == nil || openapi.IsNil(o.ReconnectInd) {
		return nil, false
	}
	return o.ReconnectInd, true
}

// HasReconnectInd returns a boolean if a field has been set.
func (o *UeContext) HasReconnectInd() bool {
	if o != nil && !openapi.IsNil(o.ReconnectInd) {
		return true
	}
...
// SetReconnectInd gets a reference to the given bool and assigns it to the ReconnectInd field.
func (o *UeContext) SetReconnectInd(v bool) {
	o.ReconnectInd = &v
}

func (o UeContext) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.Supi) {
		toSerialize["supi"] = o.Supi
	}
	if !openapi.IsNil(o.SupiUnauthInd) {
	...
	if !openapi.IsNil(o.AusfGroupId) {
	...
	if !openapi.IsNil(o.GroupList) {
		toSerialize["groupList"] = o.GroupList
	}
	if !openapi.IsNil(o.DrxParameter) {
		toSerialize["drxParameter"] = o.DrxParameter
	}
	if !openapi.IsNil(o.SubRfsp) {
		toSerialize["subRfsp"] = o.SubRfsp
	}
	if !openapi.IsNil(o.PcfRfsp) {
		toSerialize["pcfRfsp"] = o.PcfRfsp
	}
	if !openapi.IsNil(o.UsedRfsp) {
		toSerialize["usedRfsp"] = o.UsedRfsp
	}
	if !openapi.IsNil(o.SubUeAmbr) {
		toSerialize["subUeAmbr"] = o.SubUeAmbr
	}
	if !openapi.IsNil(o.PcfUeAmbr) {
		toSerialize["pcfUeAmbr"] = o.PcfUeAmbr
	}
	if !openapi.IsNil(o.SubUeSliceMbrList) {
		toSerialize["subUeSliceMbrList"] = o.SubUeSliceMbrList
	}
	if !openapi.IsNil(o.SmsfId) {
		toSerialize["smsfId"] = o.SmsfId
	}
	if !openapi.IsNil(o.SeafData) {
		toSerialize["seafData"] = o.SeafData
	}
	if !openapi.IsNil(o.Var5gMmCapability) {
	...
	if !openapi.IsNil(o.ServiceGapExpiryTime) {
	...
	if !openapi.IsNil(o.ManagementMdtInd) {
		toSerialize["managementMdtInd"] = o.ManagementMdtInd
	}
	if !openapi.IsNil(o.AdjacenPlmnMngtMdtInds) {
		toSerialize["adjacenPlmnMngtMdtInds"] = o.AdjacenPlmnMngtMdtInds
	}
	if !openapi.IsNil(o.ImmediateMdtConf) {
		toSerialize["immediateMdtConf"] = o.ImmediateMdtConf
	}
	if !openapi.IsNil(o.EcRestrictionDataWb) {
	...
	if !openapi.IsNil(o.DisasterPlmn) {
	...
	if !openapi.IsNil(o.AmPolicyInfoContainer) {
		toSerialize["amPolicyInfoContainer"] = o.AmPolicyInfoContainer
	}
	if !openapi.IsNil(o.A2xContext) {
		toSerialize["a2xContext"] = o.A2xContext
	}
	if !openapi.IsNil(o.MbsrOperationAllowed) {
		toSerialize["mbsrOperationAllowed"] = o.MbsrOperationAllowed
	}
	if !openapi.IsNil(o.LcsUpContext) {
		toSerialize["lcsUpContext"] = o.LcsUpContext
	}
	if !openapi.IsNil(o.ReconnectInd) {
		toSerialize["reconnectInd"] = o.ReconnectInd
	}
