...
var _ openapi.MappedNullable = &NwdafCond{}
...
type NwdafCond struct {
	...
	AnalyticsIds       []string          `json:"analyticsIds,omitempty" yaml:"analyticsIds,omitempty"`
...
func (o *NwdafCond) GetAnalyticsIds() []string {
	if o == nil || openapi.IsNil(o.AnalyticsIds) {
		var ret []string
		return ret
	}
...
func (o NwdafCond) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["conditionType"] = o.ConditionType
	if !openapi.IsNil(o.AnalyticsIds) {
