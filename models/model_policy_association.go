...
var _ openapi.MappedNullable = &PolicyAssociation{}

// PolicyAssociation Represents an individual AM Policy Association resource.
type PolicyAssociation struct {
	Request *PolicyAssociationRequest `json:"request,omitempty" yaml:"request,omitempty"`
	...
	Pras           *map[string]PresenceInfo        `json:"pras,omitempty" yaml:"pras,omitempty"`
	...
	// Represents the network slice usage control information. The key of the map shall be set to the on-demand S-NSSAI (within the \"snssai\" attribute of the corresponding map entry encoded using the SliceUsgCtrlInfo data structure) to which the network slice usage control information is related.
...
func (o *PolicyAssociation) GetRequest() PolicyAssociationRequest {
	if o == nil || openapi.IsNil(o.Request) {
...
func (o *PolicyAssociation) GetRfspValTime() int32 {
...
// and a boolean to check if the value has been set.
func (o *PolicyAssociation) GetRfspValTimeOk() (*int32, bool) {
	if o == nil || openapi.IsNil(o.RfspValTime) {
		return nil, false
	}
...
func (o *PolicyAssociation) HasRfspValTime() bool {
	if o != nil && !openapi.IsNil(o.RfspValTime) {
		return true
	}
...
func (o *PolicyAssociation) SetRfspValTime(v int32) {
	o.RfspValTime = &v
}
...
func (o *PolicyAssociation) GetSliceUsgCtrlInfoSets() map[string]SliceUsgCtrlInfo {
...
// and a boolean to check if the value has been set.
func (o *PolicyAssociation) GetSliceUsgCtrlInfoSetsOk() (*map[string]SliceUsgCtrlInfo, bool) {
	if o == nil || openapi.IsNil(o.SliceUsgCtrlInfoSets) {
		return nil, false
	}
...
func (o *PolicyAssociation) HasSliceUsgCtrlInfoSets() bool {
	if o != nil && !openapi.IsNil(o.SliceUsgCtrlInfoSets) {
		return true
	}
...
func (o *PolicyAssociation) SetSliceUsgCtrlInfoSets(v map[string]SliceUsgCtrlInfo) {
	o.SliceUsgCtrlInfoSets = &v
}

// GetChfInfo returns the ChfInfo field value if set, zero value otherwise.
func (o *PolicyAssociation) GetChfInfo() ChargingInformation {
...
// and a boolean to check if the value has been set.
func (o *PolicyAssociation) GetChfInfoOk() (*ChargingInformation, bool) {
	if o == nil || openapi.IsNil(o.ChfInfo) {
		return nil, false
	}
...
func (o *PolicyAssociation) HasChfInfo() bool {
	if o != nil && !openapi.IsNil(o.ChfInfo) {
		return true
	}
...
func (o *PolicyAssociation) SetChfInfo(v ChargingInformation) {
	o.ChfInfo = &v
}
...
func (o PolicyAssociation) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.Request) {
