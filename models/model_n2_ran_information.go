...
var _ openapi.MappedNullable = &N2RanInformation{}

// N2RanInformation Represents the RAN related N2 information data part
type N2RanInformation struct {
	N2InfoContent N2InfoContent `json:"n2InfoContent" yaml:"n2InfoContent"`
}
...
func (o N2RanInformation) ToMap() (map[string]any, error) {
