...
var _ openapi.MappedNullable = &NiddAuthorizationInfo{}

// NiddAuthorizationInfo Information related to active NIDD Authorizations
type NiddAuthorizationInfo struct {
	NiddAuthorizationList []AuthorizationInfo `json:"niddAuthorizationList" yaml:"niddAuthorizationList"`
}
...
func (o NiddAuthorizationInfo) ToMap() (map[string]any, error) {
