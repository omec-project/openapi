...
var _ openapi.MappedNullable = &SvcExperience{}

// SvcExperience Contains a mean opinion score with the customized range.
type SvcExperience struct {
	// string with format 'float' as defined in OpenAPI.
	Mos *float32 `json:"mos,omitempty" yaml:"mos,omitempty"`
	// string with format 'float' as defined in OpenAPI.
	UpperRange *float32 `json:"upperRange,omitempty" yaml:"upperRange,omitempty"`
	// string with format 'float' as defined in OpenAPI.
	LowerRange *float32 `json:"lowerRange,omitempty" yaml:"lowerRange,omitempty"`
}
...
func (o *SvcExperience) GetUpperRange() float32 {
	if o == nil || openapi.IsNil(o.UpperRange) {
		var ret float32
		return ret
	}
	return *o.UpperRange
...
func (o *SvcExperience) GetLowerRange() float32 {
	if o == nil || openapi.IsNil(o.LowerRange) {
		var ret float32
		return ret
	}
	return *o.LowerRange
...
func (o SvcExperience) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.Mos) {
		toSerialize["mos"] = o.Mos
	}
	if !openapi.IsNil(o.UpperRange) {
		toSerialize["upperRange"] = o.UpperRange
	}
	if !openapi.IsNil(o.LowerRange) {
