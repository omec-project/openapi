...
var _ openapi.MappedNullable = &PostSmContexts400Response{}

// PostSmContexts400Response struct for PostSmContexts400Response
type PostSmContexts400Response struct {
	JsonData              *SmContextCreateError `json:"jsonData,omitempty" yaml:"jsonData,omitempty" multipart:"contentType:application/json,ref:{jsonData}"`
	...
	BinaryDataN2SmMessage **os.File             `json:"binaryDataN2SmMessage,omitempty" yaml:"binaryDataN2SmMessage,omitempty" multipart:"contentType:application/vnd.3gpp.ngap,ref:{binaryDataN2SmMessage}"`
}
...
func (o *PostSmContexts400Response) GetBinaryDataN2SmMessage() *os.File {
	if o == nil || openapi.IsNil(o.BinaryDataN2SmMessage) {
		var ret *os.File
		return ret
	}
...
func (o PostSmContexts400Response) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.BinaryDataN2SmMessage) {
