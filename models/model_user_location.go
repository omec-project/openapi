...
var _ openapi.MappedNullable = &UserLocation{}
...
type UserLocation struct {
	EutraLocation *EutraLocation       `json:"eutraLocation,omitempty" yaml:"eutraLocation,omitempty"`
	NrLocation    *NrLocation          `json:"nrLocation,omitempty" yaml:"nrLocation,omitempty"`
	N3gaLocation  *N3gaLocation        `json:"n3gaLocation,omitempty" yaml:"n3gaLocation,omitempty"`
	UtraLocation  NullableUtraLocation `json:"utraLocation" yaml:"utraLocation,omitempty"`
	GeraLocation  NullableGeraLocation `json:"geraLocation" yaml:"geraLocation,omitempty"`
}
...
func (o *UserLocation) GetEutraLocation() EutraLocation {
	if o == nil || openapi.IsNil(o.EutraLocation) {
...
func (o *UserLocation) GetNrLocation() NrLocation {
	if o == nil || openapi.IsNil(o.NrLocation) {
		var ret NrLocation
		return ret
	}
	return *o.NrLocation
...
func (o *UserLocation) GetN3gaLocation() N3gaLocation {
	if o == nil || openapi.IsNil(o.N3gaLocation) {
...
func (o *UserLocation) GetUtraLocation() UtraLocation {
	if o == nil || openapi.IsNil(o.UtraLocation.Get()) {
...
func (o *UserLocation) GetGeraLocation() GeraLocation {
	if o == nil || openapi.IsNil(o.GeraLocation.Get()) {
...
func (o UserLocation) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.EutraLocation) {
		toSerialize["eutraLocation"] = o.EutraLocation
	}
	if !openapi.IsNil(o.NrLocation) {
		toSerialize["nrLocation"] = o.NrLocation
	}
	if !openapi.IsNil(o.N3gaLocation) {
