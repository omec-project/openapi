...
var _ openapi.MappedNullable = &ConfirmationDataResponse{}

// ConfirmationDataResponse Contains the result of the authentication
type ConfirmationDataResponse struct {
	AuthResult AuthResult `json:"authResult" yaml:"authResult"`
...
func (o ConfirmationDataResponse) ToMap() (map[string]any, error) {
