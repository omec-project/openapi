...
var _ openapi.MappedNullable = &AmfEventSubscriptionAddInfo{}
...
func (o *AmfEventSubscriptionAddInfo) GetAccessToken() string {
...
// and a boolean to check if the value has been set.
func (o *AmfEventSubscriptionAddInfo) GetAccessTokenOk() (*string, bool) {
	if o == nil || openapi.IsNil(o.AccessToken) {
		return nil, false
	}
...
func (o *AmfEventSubscriptionAddInfo) HasAccessToken() bool {
	if o != nil && !openapi.IsNil(o.AccessToken) {
		return true
	}
...
func (o *AmfEventSubscriptionAddInfo) SetAccessToken(v string) {
	o.AccessToken = &v
}

func (o AmfEventSubscriptionAddInfo) ToMap() (map[string]any, error) {
