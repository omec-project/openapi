...
type ParameterProvisionProfileDataDocumentAPI interface {
	...
	*/
	QueryPPData(ctx context.Context, ueId string) ApiQueryPPDataRequest

	// QueryPPDataExecute executes the request
	//   @return PpProfileData
	QueryPPDataExecute(r ApiQueryPPDataRequest) (*models.PpProfileData, *http.Response, error)
}
...
type ApiQueryPPDataRequest struct {
	ctx               context.Context
	ApiService        ParameterProvisionProfileDataDocumentAPI
	ueId              string
...
func (r ApiQueryPPDataRequest) Execute() (*models.PpProfileData, *http.Response, error) {
...
//
//	@return PpProfileData
func (a *ParameterProvisionProfileDataDocumentAPIService) QueryPPDataExecute(r ApiQueryPPDataRequest) (*models.PpProfileData, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    any
		formFiles           []formFile
		localVarReturnValue *models.PpProfileData
	)
