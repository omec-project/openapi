...
var _ openapi.MappedNullable = &AmInfluData{}

// AmInfluData struct for AmInfluData
type AmInfluData struct {
	...
	// When set to true, it indicates whether the data is applicable for any UE. Otherwise set to \"false\". Default value is \"false\" if omitted.
	AnyUeInd *bool `json:"anyUeInd,omitempty" yaml:"anyUeInd,omitempty"`
	// Indicates a list of PLMNs representing the home PLMN for the inbound roaming UEs in LBO roaming scenario.
	RoamUePlmnIds []PlmnId `json:"roamUePlmnIds,omitempty" yaml:"roamUePlmnIds,omitempty"`
	// indicating a time in seconds.
	PolicyDuration *int32 `json:"policyDuration,omitempty" yaml:"policyDuration,omitempty"`
	// List of AM related events for which a subscription is required.
	EvSubs []AmInfluEvent `json:"evSubs,omitempty" yaml:"evSubs,omitempty"`
...
// GetRoamUePlmnIds returns the RoamUePlmnIds field value if set, zero value otherwise.
func (o *AmInfluData) GetRoamUePlmnIds() []PlmnId {
	if o == nil || openapi.IsNil(o.RoamUePlmnIds) {
		var ret []PlmnId
		return ret
	}
	return o.RoamUePlmnIds
}

// GetRoamUePlmnIdsOk returns a tuple with the RoamUePlmnIds field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AmInfluData) GetRoamUePlmnIdsOk() ([]PlmnId, bool) {
	if o == nil || openapi.IsNil(o.RoamUePlmnIds) {
		return nil, false
	}
	return o.RoamUePlmnIds, true
}

// HasRoamUePlmnIds returns a boolean if a field has been set.
func (o *AmInfluData) HasRoamUePlmnIds() bool {
	if o != nil && !openapi.IsNil(o.RoamUePlmnIds) {
		return true
	}
...
// SetRoamUePlmnIds gets a reference to the given []PlmnId and assigns it to the RoamUePlmnIds field.
func (o *AmInfluData) SetRoamUePlmnIds(v []PlmnId) {
	o.RoamUePlmnIds = v
}
...
func (o *AmInfluData) GetPolicyDuration() int32 {
	if o == nil || openapi.IsNil(o.PolicyDuration) {
		var ret int32
		return ret
	}
...
func (o *AmInfluData) GetEvSubs() []AmInfluEvent {
	if o == nil || openapi.IsNil(o.EvSubs) {
...
func (o *AmInfluData) GetThruReq() bool {
	if o == nil || openapi.IsNil(o.ThruReq) {
		var ret bool
		return ret
	}
	return *o.ThruReq
...
func (o *AmInfluData) GetCovReq() []ServiceAreaCoverageInfo {
	if o == nil || openapi.IsNil(o.CovReq) {
...
func (o AmInfluData) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.RoamUePlmnIds) {
		toSerialize["roamUePlmnIds"] = o.RoamUePlmnIds
	}
	if !openapi.IsNil(o.PolicyDuration) {
		toSerialize["policyDuration"] = o.PolicyDuration
	}
	if !openapi.IsNil(o.EvSubs) {
	...
	if !openapi.IsNil(o.ThruReq) {
		toSerialize["thruReq"] = o.ThruReq
	}
	if !openapi.IsNil(o.CovReq) {
