...
var _ openapi.MappedNullable = &Av5GHeAka{}
...
type Av5GHeAka struct {
	...
	XresStar string `json:"xresStar" yaml:"xresStar" validate:"regexp=^[A-Fa-f0-9]{32}$"`
	Autn     string `json:"autn" yaml:"autn" validate:"regexp=^[A-Fa-f0-9]{32}$"`
	Kausf    string `json:"kausf" yaml:"kausf" validate:"regexp=^[A-Fa-f0-9]{64}$"`
}
...
func (o Av5GHeAka) ToMap() (map[string]any, error) {
