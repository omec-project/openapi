...
var _ openapi.MappedNullable = &N2InformationTransferError{}
...
type N2InformationTransferError struct {
	...
	PwsErrorInfo *PWSErrorData  `json:"pwsErrorInfo,omitempty" yaml:"pwsErrorInfo,omitempty"`
}
...
func (o *N2InformationTransferError) GetPwsErrorInfo() PWSErrorData {
	if o == nil || openapi.IsNil(o.PwsErrorInfo) {
...
func (o N2InformationTransferError) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["error"] = o.Error
	if !openapi.IsNil(o.PwsErrorInfo) {
