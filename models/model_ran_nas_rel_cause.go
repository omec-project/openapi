...
var _ openapi.MappedNullable = &RanNasRelCause{}
...
type RanNasRelCause struct {
	...
	Var5gMmCause *int32 `json:"5gMmCause,omitempty" yaml:"5gMmCause,omitempty"`
	// Unsigned Integer, i.e. only value 0 and integers above 0 are permissible.
	Var5gSmCause *int32 `json:"5gSmCause,omitempty" yaml:"5gSmCause,omitempty"`
	// Defines the EPS RAN/NAS release cause.
	EpsCause *string `json:"epsCause,omitempty" yaml:"epsCause,omitempty"`
}
...
func (o *RanNasRelCause) GetVar5gMmCause() int32 {
	if o == nil || openapi.IsNil(o.Var5gMmCause) {
		var ret int32
		return ret
	}
...
func (o *RanNasRelCause) GetVar5gSmCause() int32 {
	if o == nil || openapi.IsNil(o.Var5gSmCause) {
		var ret int32
		return ret
	}
...
func (o *RanNasRelCause) GetEpsCause() string {
	if o == nil || openapi.IsNil(o.EpsCause) {
		var ret string
		return ret
	}
	return *o.EpsCause
