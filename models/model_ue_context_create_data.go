...
var _ openapi.MappedNullable = &UeContextCreateData{}
...
type UeContextCreateData struct {
	...
	TargetId           NgRanTargetId     `json:"targetId" yaml:"targetId"`
	SourceToTargetData N2InfoContent     `json:"sourceToTargetData" yaml:"sourceToTargetData"`
	PduSessionList     []N2SmInformation `json:"pduSessionList" yaml:"pduSessionList"`
	// String providing an URI formatted according to RFC 3986.
	N2NotifyUri                *string        `json:"n2NotifyUri,omitempty" yaml:"n2NotifyUri,omitempty"`
...
func (o *UeContextCreateData) GetN2NotifyUri() string {
	if o == nil || openapi.IsNil(o.N2NotifyUri) {
		var ret string
		return ret
	}
...
func (o UeContextCreateData) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.N2NotifyUri) {
