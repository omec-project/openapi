...
var _ openapi.MappedNullable = &SmallDataRateStatus{}
...
type SmallDataRateStatus struct {
	...
	RemainPacketsUl *int32 `json:"remainPacketsUl,omitempty" yaml:"remainPacketsUl,omitempty"`
	...
	RemainPacketsDl *int32 `json:"remainPacketsDl,omitempty" yaml:"remainPacketsDl,omitempty"`
	...
	RemainExReportsUl *int32 `json:"remainExReportsUl,omitempty" yaml:"remainExReportsUl,omitempty"`
	...
	RemainExReportsDl *int32 `json:"remainExReportsDl,omitempty" yaml:"remainExReportsDl,omitempty"`
}
...
func (o *SmallDataRateStatus) GetRemainPacketsUl() int32 {
	if o == nil || openapi.IsNil(o.RemainPacketsUl) {
		var ret int32
		return ret
	}
...
func (o *SmallDataRateStatus) GetRemainPacketsDl() int32 {
	if o == nil || openapi.IsNil(o.RemainPacketsDl) {
		var ret int32
		return ret
	}
...
func (o *SmallDataRateStatus) GetRemainExReportsUl() int32 {
	if o == nil || openapi.IsNil(o.RemainExReportsUl) {
		var ret int32
		return ret
	}
...
func (o *SmallDataRateStatus) GetRemainExReportsDl() int32 {
	if o == nil || openapi.IsNil(o.RemainExReportsDl) {
		var ret int32
		return ret
	}
...
func (o SmallDataRateStatus) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.RemainPacketsUl) {
		toSerialize["remainPacketsUl"] = o.RemainPacketsUl
	}
	if !openapi.IsNil(o.RemainPacketsDl) {
		toSerialize["remainPacketsDl"] = o.RemainPacketsDl
	}
	if !openapi.IsNil(o.ValidityTime) {
		toSerialize["validityTime"] = o.ValidityTime
	}
	if !openapi.IsNil(o.RemainExReportsUl) {
		toSerialize["remainExReportsUl"] = o.RemainExReportsUl
	}
	if !openapi.IsNil(o.RemainExReportsDl) {
