...
var _ openapi.MappedNullable = &UsageThresholdRm{}
...
type UsageThresholdRm struct {
	...
	Duration openapi.NullableInt32 `json:"duration" yaml:"duration,omitempty"`
	// Unsigned integer identifying a volume in units of bytes with \"nullable=true\" property.
	TotalVolume openapi.NullableInt64 `json:"totalVolume" yaml:"totalVolume,omitempty"`
	// Unsigned integer identifying a volume in units of bytes with \"nullable=true\" property.
	DownlinkVolume openapi.NullableInt64 `json:"downlinkVolume" yaml:"downlinkVolume,omitempty"`
	// Unsigned integer identifying a volume in units of bytes with \"nullable=true\" property.
	UplinkVolume openapi.NullableInt64 `json:"uplinkVolume" yaml:"uplinkVolume,omitempty"`
}
...
func (o *UsageThresholdRm) GetDuration() int32 {
	if o == nil || openapi.IsNil(o.Duration.Get()) {
		var ret int32
		return ret
	}
...
// SetDuration gets a reference to the given openapi.NullableInt32 and assigns it to the Duration field.
...
func (o *UsageThresholdRm) GetTotalVolume() int64 {
	if o == nil || openapi.IsNil(o.TotalVolume.Get()) {
		var ret int64
		return ret
	}
...
// SetTotalVolume gets a reference to the given openapi.NullableInt64 and assigns it to the TotalVolume field.
...
func (o *UsageThresholdRm) GetDownlinkVolume() int64 {
	if o == nil || openapi.IsNil(o.DownlinkVolume.Get()) {
		var ret int64
		return ret
	}
...
// SetDownlinkVolume gets a reference to the given openapi.NullableInt64 and assigns it to the DownlinkVolume field.
...
func (o *UsageThresholdRm) GetUplinkVolume() int64 {
	if o == nil || openapi.IsNil(o.UplinkVolume.Get()) {
		var ret int64
		return ret
	}
...
// SetUplinkVolume gets a reference to the given openapi.NullableInt64 and assigns it to the UplinkVolume field.
...
func (o UsageThresholdRm) ToMap() (map[string]any, error) {
