...
var _ openapi.MappedNullable = &NefEventExposureSubsc{}
...
type NefEventExposureSubsc struct {
	...
	EventsSubs    []NefEventSubs        `json:"eventsSubs" yaml:"eventsSubs"`
	EventsRepInfo *ReportingInformation `json:"eventsRepInfo,omitempty" yaml:"eventsRepInfo,omitempty"`
	// String providing an URI formatted according to RFC 3986.
	NotifUri    string                 `json:"notifUri" yaml:"notifUri"`
	NotifId     string                 `json:"notifId" yaml:"notifId"`
	EventNotifs []NefEventNotification `json:"eventNotifs,omitempty" yaml:"eventNotifs,omitempty"`
...
func (o *NefEventExposureSubsc) GetEventsRepInfo() ReportingInformation {
	if o == nil || openapi.IsNil(o.EventsRepInfo) {
