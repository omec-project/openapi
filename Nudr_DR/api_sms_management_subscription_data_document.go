...
type SMSManagementSubscriptionDataDocumentAPI interface {
	...
	*/
	QuerySmsMngData(ctx context.Context, ueId string, servingPlmnId string) ApiQuerySmsMngDataRequest

	// QuerySmsMngDataExecute executes the request
	//   @return SmsManagementSubscriptionData
	QuerySmsMngDataExecute(r ApiQuerySmsMngDataRequest) (*models.SmsManagementSubscriptionData, *http.Response, error)
}
...
type ApiQuerySmsMngDataRequest struct {
	ctx               context.Context
	ApiService        SMSManagementSubscriptionDataDocumentAPI
	ueId              string
...
func (r ApiQuerySmsMngDataRequest) Execute() (*models.SmsManagementSubscriptionData, *http.Response, error) {
...
//
//	@return SmsManagementSubscriptionData
func (a *SMSManagementSubscriptionDataDocumentAPIService) QuerySmsMngDataExecute(r ApiQuerySmsMngDataRequest) (*models.SmsManagementSubscriptionData, *http.Response, error) {
	var (
