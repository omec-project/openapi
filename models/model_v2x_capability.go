...
var _ openapi.MappedNullable = &V2xCapability{}

// V2xCapability Indicate the supported V2X Capability by the PCF.
type V2xCapability struct {
	LteV2x *bool `json:"lteV2x,omitempty" yaml:"lteV2x,omitempty"`
	NrV2x  *bool `json:"nrV2x,omitempty" yaml:"nrV2x,omitempty"`
}
...
func (o *V2xCapability) GetLteV2x() bool {
	if o == nil || openapi.IsNil(o.LteV2x) {
		var ret bool
		return ret
	}
	return *o.LteV2x
...
func (o *V2xCapability) GetNrV2x() bool {
	if o == nil || openapi.IsNil(o.NrV2x) {
		var ret bool
		return ret
	}
	return *o.NrV2x
...
func (o V2xCapability) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.LteV2x) {
		toSerialize["lteV2x"] = o.LteV2x
	}
	if !openapi.IsNil(o.NrV2x) {
