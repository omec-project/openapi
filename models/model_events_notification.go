...
var _ openapi.MappedNullable = &EventsNotification{}
...
type EventsNotification struct {
	...
	AdReports     []AppDetectionReport          `json:"adReports,omitempty" yaml:"adReports,omitempty"`
	...
	AnChargAddr   NullableAccNetChargingAddress `json:"anChargAddr" yaml:"anChargAddr,omitempty"`
	AnChargIds    []AccessNetChargingIdentifier `json:"anChargIds,omitempty" yaml:"anChargIds,omitempty"`
	AnGwAddr      NullableAnGwAddress           `json:"anGwAddr" yaml:"anGwAddr,omitempty"`
	L4sReports    []L4sSupport                  `json:"l4sReports,omitempty" yaml:"l4sReports,omitempty"`
	// String providing an URI formatted according to RFC 3986.
	EvSubsUri                 string                       `json:"evSubsUri" yaml:"evSubsUri"`
	EvNotifs                  []AfEventNotification        `json:"evNotifs" yaml:"evNotifs"`
	FailedResourcAllocReports []ResourcesAllocationInfo    `json:"failedResourcAllocReports,omitempty" yaml:"failedResourcAllocReports,omitempty"`
	SuccResourcAllocReports   []ResourcesAllocationInfo    `json:"succResourcAllocReports,omitempty" yaml:"succResourcAllocReports,omitempty"`
	NoNetLocSupp              *NetLocAccessSupport         `json:"noNetLocSupp,omitempty" yaml:"noNetLocSupp,omitempty"`
	OutOfCredReports          []OutOfCreditInformation     `json:"outOfCredReports,omitempty" yaml:"outOfCredReports,omitempty"`
	...
	QosMonReports             []QosMonitoringReportPcf     `json:"qosMonReports,omitempty" yaml:"qosMonReports,omitempty"`
	QosMonDatRateReps         []QosMonitoringReportPcf     `json:"qosMonDatRateReps,omitempty" yaml:"qosMonDatRateReps,omitempty"`
	PdvMonReports             []PdvMonitoringReport        `json:"pdvMonReports,omitempty" yaml:"pdvMonReports,omitempty"`
	CongestReports            []QosMonitoringReportPcf     `json:"congestReports,omitempty" yaml:"congestReports,omitempty"`
	RttMonReports             []QosMonitoringReportPcf     `json:"rttMonReports,omitempty" yaml:"rttMonReports,omitempty"`
	...
	Ipv4AddrList            []string                        `json:"ipv4AddrList,omitempty" yaml:"ipv4AddrList,omitempty"`
	Ipv6PrefixList          []string                        `json:"ipv6PrefixList,omitempty" yaml:"ipv6PrefixList,omitempty"`
...
func (o *EventsNotification) GetAdReports() []AppDetectionReport {
	if o == nil || openapi.IsNil(o.AdReports) {
...
func (o *EventsNotification) GetAnChargAddr() AccNetChargingAddress {
	if o == nil || openapi.IsNil(o.AnChargAddr.Get()) {
...
func (o *EventsNotification) GetAnChargIds() []AccessNetChargingIdentifier {
	if o == nil || openapi.IsNil(o.AnChargIds) {
...
func (o *EventsNotification) GetAnGwAddr() AnGwAddress {
	if o == nil || openapi.IsNil(o.AnGwAddr.Get()) {
		var ret AnGwAddress
		return ret
	}
...
func (o *EventsNotification) GetFailedResourcAllocReports() []ResourcesAllocationInfo {
	if o == nil || openapi.IsNil(o.FailedResourcAllocReports) {
...
func (o *EventsNotification) GetSuccResourcAllocReports() []ResourcesAllocationInfo {
	if o == nil || openapi.IsNil(o.SuccResourcAllocReports) {
		var ret []ResourcesAllocationInfo
		return ret
	}
...
func (o *EventsNotification) GetNoNetLocSupp() NetLocAccessSupport {
	if o == nil || openapi.IsNil(o.NoNetLocSupp) {
...
func (o *EventsNotification) GetOutOfCredReports() []OutOfCreditInformation {
	if o == nil || openapi.IsNil(o.OutOfCredReports) {
...
func (o *EventsNotification) GetQosMonReports() []QosMonitoringReportPcf {
	if o == nil || openapi.IsNil(o.QosMonReports) {
		var ret []QosMonitoringReportPcf
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *EventsNotification) GetQosMonReportsOk() ([]QosMonitoringReportPcf, bool) {
	if o == nil || openapi.IsNil(o.QosMonReports) {
		return nil, false
	}
...
// SetQosMonReports gets a reference to the given []QosMonitoringReportPcf and assigns it to the QosMonReports field.
func (o *EventsNotification) SetQosMonReports(v []QosMonitoringReportPcf) {
	o.QosMonReports = v
}

// GetQosMonDatRateReps returns the QosMonDatRateReps field value if set, zero value otherwise.
func (o *EventsNotification) GetQosMonDatRateReps() []QosMonitoringReportPcf {
...
// and a boolean to check if the value has been set.
func (o *EventsNotification) GetQosMonDatRateRepsOk() ([]QosMonitoringReportPcf, bool) {
	if o == nil || openapi.IsNil(o.QosMonDatRateReps) {
		return nil, false
	}
...
// SetQosMonDatRateReps gets a reference to the given []QosMonitoringReportPcf and assigns it to the QosMonDatRateReps field.
func (o *EventsNotification) SetQosMonDatRateReps(v []QosMonitoringReportPcf) {
...
func (o *EventsNotification) GetPdvMonReports() []PdvMonitoringReport {
	if o == nil || openapi.IsNil(o.PdvMonReports) {
...
func (o *EventsNotification) GetCongestReports() []QosMonitoringReportPcf {
	if o == nil || openapi.IsNil(o.CongestReports) {
		var ret []QosMonitoringReportPcf
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *EventsNotification) GetCongestReportsOk() ([]QosMonitoringReportPcf, bool) {
	if o == nil || openapi.IsNil(o.CongestReports) {
		return nil, false
	}
...
// SetCongestReports gets a reference to the given []QosMonitoringReportPcf and assigns it to the CongestReports field.
func (o *EventsNotification) SetCongestReports(v []QosMonitoringReportPcf) {
	o.CongestReports = v
}

// GetRttMonReports returns the RttMonReports field value if set, zero value otherwise.
func (o *EventsNotification) GetRttMonReports() []QosMonitoringReportPcf {
	if o == nil || openapi.IsNil(o.RttMonReports) {
		var ret []QosMonitoringReportPcf
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *EventsNotification) GetRttMonReportsOk() ([]QosMonitoringReportPcf, bool) {
	if o == nil || openapi.IsNil(o.RttMonReports) {
		return nil, false
	}
...
// SetRttMonReports gets a reference to the given []QosMonitoringReportPcf and assigns it to the RttMonReports field.
func (o *EventsNotification) SetRttMonReports(v []QosMonitoringReportPcf) {
	o.RttMonReports = v
}
...
func (o *EventsNotification) GetUeLocTime() time.Time {
	if o == nil || openapi.IsNil(o.UeLocTime) {
		var ret time.Time
		return ret
	}
	return *o.UeLocTime
...
func (o *EventsNotification) GetUsgRep() AccumulatedUsage {
	if o == nil || openapi.IsNil(o.UsgRep) {
...
func (o *EventsNotification) GetUrspEnfRep() string {
	if o == nil || openapi.IsNil(o.UrspEnfRep) {
		var ret string
		return ret
	}
	return *o.UrspEnfRep
...
func (o *EventsNotification) GetIpv4AddrList() []string {
	if o == nil || openapi.IsNil(o.Ipv4AddrList) {
		var ret []string
		return ret
	}
...
func (o *EventsNotification) GetIpv6PrefixList() []string {
	if o == nil || openapi.IsNil(o.Ipv6PrefixList) {
		var ret []string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *EventsNotification) GetIpv6PrefixListOk() ([]string, bool) {
	if o == nil || openapi.IsNil(o.Ipv6PrefixList) {
		return nil, false
	}
...
// SetIpv6PrefixList gets a reference to the given []string and assigns it to the Ipv6PrefixList field.
func (o *EventsNotification) SetIpv6PrefixList(v []string) {
	o.Ipv6PrefixList = v
}
...
func (o EventsNotification) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.AdReports) {
	...
	if !openapi.IsNil(o.PdvMonReports) {
		toSerialize["pdvMonReports"] = o.PdvMonReports
	}
	if !openapi.IsNil(o.CongestReports) {
		toSerialize["congestReports"] = o.CongestReports
	}
	if !openapi.IsNil(o.RttMonReports) {
	...
	if !openapi.IsNil(o.Ipv4AddrList) {
		toSerialize["ipv4AddrList"] = o.Ipv4AddrList
	}
	if !openapi.IsNil(o.Ipv6PrefixList) {
