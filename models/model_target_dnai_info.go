...
var _ openapi.MappedNullable = &TargetDnaiInfo{}
...
type TargetDnaiInfo struct {
	...
	SmfSelectionType SmfSelectionType `json:"smfSelectionType" yaml:"smfSelectionType"`
}
...
func (o TargetDnaiInfo) ToMap() (map[string]any, error) {
