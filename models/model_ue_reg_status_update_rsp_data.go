...
var _ openapi.MappedNullable = &UeRegStatusUpdateRspData{}
...
type UeRegStatusUpdateRspData struct {
	RegStatusTransferComplete bool `json:"regStatusTransferComplete" yaml:"regStatusTransferComplete"`
}
...
func (o UeRegStatusUpdateRspData) ToMap() (map[string]any, error) {
