...
var _ openapi.MappedNullable = &EpsNasSecurityMode{}

// EpsNasSecurityMode Indicates the EPS NAS Security Mode
type EpsNasSecurityMode struct {
	IntegrityAlgorithm EpsNasIntegrityAlgorithm `json:"integrityAlgorithm" yaml:"integrityAlgorithm"`
	CipheringAlgorithm EpsNasCipheringAlgorithm `json:"cipheringAlgorithm" yaml:"cipheringAlgorithm"`
}
...
func (o EpsNasSecurityMode) ToMap() (map[string]any, error) {
