...
type RetrieveTheRoamingInformationOfTheEPCDomainDocumentAPI interface {
	...
	*/
	QueryRoamingInformation(ctx context.Context, ueId string) ApiQueryRoamingInformationRequest

	// QueryRoamingInformationExecute executes the request
	//   @return RoamingInfoUpdate
	QueryRoamingInformationExecute(r ApiQueryRoamingInformationRequest) (*models.RoamingInfoUpdate, *http.Response, error)
}
...
type ApiQueryRoamingInformationRequest struct {
	ctx        context.Context
	ApiService RetrieveTheRoamingInformationOfTheEPCDomainDocumentAPI
	ueId       string
}

func (r ApiQueryRoamingInformationRequest) Execute() (*models.RoamingInfoUpdate, *http.Response, error) {
...
//
//	@return RoamingInfoUpdate
func (a *RetrieveTheRoamingInformationOfTheEPCDomainDocumentAPIService) QueryRoamingInformationExecute(r ApiQueryRoamingInformationRequest) (*models.RoamingInfoUpdate, *http.Response, error) {
	var (
