...
var _ openapi.MappedNullable = &RelativeCartesianLocation{}
...
type RelativeCartesianLocation struct {
	...
	// string with format 'float' as defined in OpenAPI.
	Z *float32 `json:"z,omitempty" yaml:"z,omitempty"`
}
...
func (o RelativeCartesianLocation) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["x"] = o.X
	toSerialize["y"] = o.Y
	if !openapi.IsNil(o.Z) {
		toSerialize["z"] = o.Z
	}
