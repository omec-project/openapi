...
var _ openapi.MappedNullable = &SmContextCreateData{}
...
type SmContextCreateData struct {
	...
	RoamingUeInd        *bool   `json:"roamingUeInd,omitempty" yaml:"roamingUeInd,omitempty"`
	...
	ServingNfId         string           `json:"servingNfId" yaml:"servingNfId"`
	...
	ServingNetwork      PlmnIdNid        `json:"servingNetwork" yaml:"servingNetwork"`
	RequestType         *RequestType     `json:"requestType,omitempty" yaml:"requestType,omitempty"`
	...
	PerLadnDnnSnssaiInd *bool            `json:"perLadnDnnSnssaiInd,omitempty" yaml:"perLadnDnnSnssaiInd,omitempty"`
	...
	SmContextStatusUri string `json:"smContextStatusUri" yaml:"smContextStatusUri"`
	// String providing an URI formatted according to RFC 3986.
	HSmfUri *string `json:"hSmfUri,omitempty" yaml:"hSmfUri,omitempty"`
	// String uniquely identifying a NF instance. The format of the NF Instance ID shall be a  Universally Unique Identifier (UUID) version 4, as described in IETF RFC 4122.
	HSmfId *string `json:"hSmfId,omitempty" yaml:"hSmfId,omitempty"`
	// String providing an URI formatted according to RFC 3986.
	SmfUri *string `json:"smfUri,omitempty" yaml:"smfUri,omitempty"`
	// String uniquely identifying a NF instance. The format of the NF Instance ID shall be a  Universally Unique Identifier (UUID) version 4, as described in IETF RFC 4122.
	SmfId             *string  `json:"smfId,omitempty" yaml:"smfId,omitempty"`
	AdditionalHsmfUri []string `json:"additionalHsmfUri,omitempty" yaml:"additionalHsmfUri,omitempty"`
	AdditionalHsmfId  []string `json:"additionalHsmfId,omitempty" yaml:"additionalHsmfId,omitempty"`
	AdditionalSmfUri  []string `json:"additionalSmfUri,omitempty" yaml:"additionalSmfUri,omitempty"`
	AdditionalSmfId   []string `json:"additionalSmfId,omitempty" yaml:"additionalSmfId,omitempty"`
	// Unsigned integer identifying a PDU session, within the range 0 to 255, as specified in  clause 11.2.3.1b, bits 1 to 8, of 3GPP TS 24.007. If the PDU Session ID is allocated by the  Core Network for UEs not supporting N1 mode, reserved range 64 to 95 is used. PDU Session ID  within the reserved range is only visible in the Core Network.
	OldPduSessionId         *int32  `json:"oldPduSessionId,omitempty" yaml:"oldPduSessionId,omitempty"`
	PduSessionsActivateList []int32 `json:"pduSessionsActivateList,omitempty" yaml:"pduSessionsActivateList,omitempty"`
	// UE EPS PDN Connection container from SMF to AMF
	UeEpsPdnConnection *string  `json:"ueEpsPdnConnection,omitempty" yaml:"ueEpsPdnConnection,omitempty"`
	...
	// String providing an URI formatted according to RFC 3986.
	NrfUri *string `json:"nrfUri,omitempty" yaml:"nrfUri,omitempty"`
	...
	IndirectForwardingFlag *bool                      `json:"indirectForwardingFlag,omitempty" yaml:"indirectForwardingFlag,omitempty"`
	DirectForwardingFlag   *bool                      `json:"directForwardingFlag,omitempty" yaml:"directForwardingFlag,omitempty"`
	TargetId               *NgRanTargetId             `json:"targetId,omitempty" yaml:"targetId,omitempty"`
	// EPS bearer context status
	EpsBearerCtxStatus      *string          `json:"epsBearerCtxStatus,omitempty" yaml:"epsBearerCtxStatus,omitempty" validate:"regexp=^[A-Fa-f0-9]{4}$"`
	CpCiotEnabled           *bool            `json:"cpCiotEnabled,omitempty" yaml:"cpCiotEnabled,omitempty"`
	CpOnlyInd               *bool            `json:"cpOnlyInd,omitempty" yaml:"cpOnlyInd,omitempty"`
	InvokeNef               *bool            `json:"invokeNef,omitempty" yaml:"invokeNef,omitempty"`
	...
	N3gPathSwitchSupportInd *bool            `json:"n3gPathSwitchSupportInd,omitempty" yaml:"n3gPathSwitchSupportInd,omitempty"`
	...
	// String providing an URI formatted according to RFC 3986.
	SmContextRef       *string    `json:"smContextRef,omitempty" yaml:"smContextRef,omitempty"`
	SmContextSmfPlmnId *PlmnIdNid `json:"smContextSmfPlmnId,omitempty" yaml:"smContextSmfPlmnId,omitempty"`
	// String uniquely identifying a NF instance. The format of the NF Instance ID shall be a  Universally Unique Identifier (UUID) version 4, as described in IETF RFC 4122.
	SmContextSmfId *string `json:"smContextSmfId,omitempty" yaml:"smContextSmfId,omitempty"`
	// NF Set Identifier (see clause 28.12 of 3GPP TS 23.003), formatted as the following string \"set<Set ID>.<nftype>set.5gc.mnc<MNC>.mcc<MCC>\", or  \"set<SetID>.<NFType>set.5gc.nid<NID>.mnc<MNC>.mcc<MCC>\" with  <MCC> encoded as defined in clause 5.4.2 (\"Mcc\" data type definition)  <MNC> encoding the Mobile Network Code part of the PLMN, comprising 3 digits.    If there are only 2 significant digits in the MNC, one \"0\" digit shall be inserted    at the left side to fill the 3 digits coding of MNC.  Pattern: '^[0-9]{3}$' <NFType> encoded as a value defined in Table 6.1.6.3.3-1 of 3GPP TS 29.510 but    with lower case characters <Set ID> encoded as a string of characters consisting of    alphabetic characters (A-Z and a-z), digits (0-9) and/or the hyphen (-) and that    shall end with either an alphabetic character or a digit.
	SmContextSmfSetId *string `json:"smContextSmfSetId,omitempty" yaml:"smContextSmfSetId,omitempty"`
	...
	SmContextSmfServiceSetId *string              `json:"smContextSmfServiceSetId,omitempty" yaml:"smContextSmfServiceSetId,omitempty"`
	SmContextSmfBinding      *SbiBindingLevel     `json:"smContextSmfBinding,omitempty" yaml:"smContextSmfBinding,omitempty"`
	...
	SmfTransferInd           *bool                `json:"smfTransferInd,omitempty" yaml:"smfTransferInd,omitempty"`
	// String uniquely identifying a NF instance. The format of the NF Instance ID shall be a  Universally Unique Identifier (UUID) version 4, as described in IETF RFC 4122.
	OldSmfId *string `json:"oldSmfId,omitempty" yaml:"oldSmfId,omitempty"`
	// String providing an URI formatted according to RFC 3986.
	OldSmContextRef     *string          `json:"oldSmContextRef,omitempty" yaml:"oldSmContextRef,omitempty"`
	...
	SamePcfSelectionInd *bool            `json:"samePcfSelectionInd,omitempty" yaml:"samePcfSelectionInd,omitempty"`
	// DNAI (Data network access identifier), see clause 5.6.7 of 3GPP TS 23.501.
	TargetDnai *string `json:"targetDnai,omitempty" yaml:"targetDnai,omitempty"`
	// String providing an URI formatted according to RFC 3986.
	NrfManagementUri *string `json:"nrfManagementUri,omitempty" yaml:"nrfManagementUri,omitempty"`
	// String providing an URI formatted according to RFC 3986.
	NrfDiscoveryUri *string `json:"nrfDiscoveryUri,omitempty" yaml:"nrfDiscoveryUri,omitempty"`
	// String providing an URI formatted according to RFC 3986.
	NrfAccessTokenUri *string `json:"nrfAccessTokenUri,omitempty" yaml:"nrfAccessTokenUri,omitempty"`
	...
	UpipSupported              *bool                      `json:"upipSupported,omitempty" yaml:"upipSupported,omitempty"`
	...
	SmContextSmfOauth2Required *bool                      `json:"smContextSmfOauth2Required,omitempty" yaml:"smContextSmfOauth2Required,omitempty"`
	// A string carrying the GEO Satellite ID.
	GeoSatelliteId      *string                      `json:"geoSatelliteId,omitempty" yaml:"geoSatelliteId,omitempty"`
	HrsboAllowedInd     *bool                        `json:"hrsboAllowedInd,omitempty" yaml:"hrsboAllowedInd,omitempty"`
	EstabRejectionInd   *bool                        `json:"estabRejectionInd,omitempty" yaml:"estabRejectionInd,omitempty"`
	EstabRejectionCause *EstablishmentRejectionCause `json:"estabRejectionCause,omitempty" yaml:"estabRejectionCause,omitempty"`
}
...
func NewSmContextCreateData(servingNfId string, servingNetwork PlmnIdNid, anType AccessType, smContextStatusUri string) *SmContextCreateData {
	...
	this.AnType = anType
	var perLadnDnnSnssaiInd bool = false
	this.PerLadnDnnSnssaiInd = &perLadnDnnSnssaiInd
	...
	var n3gPathSwitchSupportInd bool = false
	this.N3gPathSwitchSupportInd = &n3gPathSwitchSupportInd
	...
	var hrsboAllowedInd bool = false
	this.HrsboAllowedInd = &hrsboAllowedInd
	return &this
}
...
func (o *SmContextCreateData) GetRoamingUeInd() bool {
	if o == nil || openapi.IsNil(o.RoamingUeInd) {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *SmContextCreateData) GetRoamingUeIndOk() (*bool, bool) {
	if o == nil || openapi.IsNil(o.RoamingUeInd) {
		return nil, false
	}
...
func (o *SmContextCreateData) HasRoamingUeInd() bool {
	if o != nil && !openapi.IsNil(o.RoamingUeInd) {
		return true
	}
...
func (o *SmContextCreateData) SetRoamingUeInd(v bool) {
	o.RoamingUeInd = &v
}
...
func (o *SmContextCreateData) GetAltSnssai() Snssai {
...
// and a boolean to check if the value has been set.
func (o *SmContextCreateData) GetAltSnssaiOk() (*Snssai, bool) {
	if o == nil || openapi.IsNil(o.AltSnssai) {
		return nil, false
	}
...
func (o *SmContextCreateData) HasAltSnssai() bool {
	if o != nil && !openapi.IsNil(o.AltSnssai) {
		return true
	}
...
func (o *SmContextCreateData) SetAltSnssai(v Snssai) {
	o.AltSnssai = &v
}
...
func (o *SmContextCreateData) GetAltHplmnSnssai() Snssai {
...
// and a boolean to check if the value has been set.
func (o *SmContextCreateData) GetAltHplmnSnssaiOk() (*Snssai, bool) {
	if o == nil || openapi.IsNil(o.AltHplmnSnssai) {
		return nil, false
	}
...
func (o *SmContextCreateData) HasAltHplmnSnssai() bool {
	if o != nil && !openapi.IsNil(o.AltHplmnSnssai) {
		return true
	}
...
func (o *SmContextCreateData) SetAltHplmnSnssai(v Snssai) {
	o.AltHplmnSnssai = &v
}
...
// GetPerLadnDnnSnssaiInd returns the PerLadnDnnSnssaiInd field value if set, zero value otherwise.
func (o *SmContextCreateData) GetPerLadnDnnSnssaiInd() bool {
	if o == nil || openapi.IsNil(o.PerLadnDnnSnssaiInd) {
		var ret bool
		return ret
	}
	return *o.PerLadnDnnSnssaiInd
}

// GetPerLadnDnnSnssaiIndOk returns a tuple with the PerLadnDnnSnssaiInd field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SmContextCreateData) GetPerLadnDnnSnssaiIndOk() (*bool, bool) {
	if o == nil || openapi.IsNil(o.PerLadnDnnSnssaiInd) {
		return nil, false
	}
	return o.PerLadnDnnSnssaiInd, true
}

// HasPerLadnDnnSnssaiInd returns a boolean if a field has been set.
func (o *SmContextCreateData) HasPerLadnDnnSnssaiInd() bool {
	if o != nil && !openapi.IsNil(o.PerLadnDnnSnssaiInd) {
		return true
	}
...
// SetPerLadnDnnSnssaiInd gets a reference to the given bool and assigns it to the PerLadnDnnSnssaiInd field.
func (o *SmContextCreateData) SetPerLadnDnnSnssaiInd(v bool) {
	o.PerLadnDnnSnssaiInd = &v
}
...
func (o *SmContextCreateData) GetHSmfId() string {
	if o == nil || openapi.IsNil(o.HSmfId) {
		var ret string
		return ret
	}
	return *o.HSmfId
...
func (o *SmContextCreateData) GetAdditionalHsmfUri() []string {
	if o == nil || openapi.IsNil(o.AdditionalHsmfUri) {
		var ret []string
		return ret
	}
...
func (o *SmContextCreateData) GetAdditionalHsmfId() []string {
	if o == nil || openapi.IsNil(o.AdditionalHsmfId) {
		var ret []string
		return ret
	}
...
func (o *SmContextCreateData) GetAdditionalSmfUri() []string {
	if o == nil || openapi.IsNil(o.AdditionalSmfUri) {
		var ret []string
		return ret
	}
...
func (o *SmContextCreateData) GetAdditionalSmfId() []string {
	if o == nil || openapi.IsNil(o.AdditionalSmfId) {
		var ret []string
		return ret
	}
...
func (o *SmContextCreateData) GetPduSessionsActivateList() []int32 {
	if o == nil || openapi.IsNil(o.PduSessionsActivateList) {
		var ret []int32
		return ret
	}
...
func (o *SmContextCreateData) GetUeEpsPdnConnection() string {
	if o == nil || openapi.IsNil(o.UeEpsPdnConnection) {
		var ret string
		return ret
	}
...
func (o *SmContextCreateData) GetNrfUri() string {
	if o == nil || openapi.IsNil(o.NrfUri) {
		var ret string
		return ret
	}
	return *o.NrfUri
...
func (o *SmContextCreateData) GetIndirectForwardingFlag() bool {
	if o == nil || openapi.IsNil(o.IndirectForwardingFlag) {
		var ret bool
		return ret
	}
...
func (o *SmContextCreateData) GetDirectForwardingFlag() bool {
	if o == nil || openapi.IsNil(o.DirectForwardingFlag) {
		var ret bool
		return ret
	}
...
// GetN3gPathSwitchSupportInd returns the N3gPathSwitchSupportInd field value if set, zero value otherwise.
func (o *SmContextCreateData) GetN3gPathSwitchSupportInd() bool {
	if o == nil || openapi.IsNil(o.N3gPathSwitchSupportInd) {
		var ret bool
		return ret
	}
	return *o.N3gPathSwitchSupportInd
}

// GetN3gPathSwitchSupportIndOk returns a tuple with the N3gPathSwitchSupportInd field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SmContextCreateData) GetN3gPathSwitchSupportIndOk() (*bool, bool) {
	if o == nil || openapi.IsNil(o.N3gPathSwitchSupportInd) {
		return nil, false
	}
	return o.N3gPathSwitchSupportInd, true
}

// HasN3gPathSwitchSupportInd returns a boolean if a field has been set.
func (o *SmContextCreateData) HasN3gPathSwitchSupportInd() bool {
	if o != nil && !openapi.IsNil(o.N3gPathSwitchSupportInd) {
		return true
	}
...
// SetN3gPathSwitchSupportInd gets a reference to the given bool and assigns it to the N3gPathSwitchSupportInd field.
func (o *SmContextCreateData) SetN3gPathSwitchSupportInd(v bool) {
	o.N3gPathSwitchSupportInd = &v
}
...
func (o *SmContextCreateData) GetSmContextRef() string {
	if o == nil || openapi.IsNil(o.SmContextRef) {
		var ret string
		return ret
	}
...
func (o *SmContextCreateData) GetSmContextSmfPlmnId() PlmnIdNid {
	if o == nil || openapi.IsNil(o.SmContextSmfPlmnId) {
		var ret PlmnIdNid
		return ret
	}
...
func (o *SmContextCreateData) GetSmContextSmfId() string {
	if o == nil || openapi.IsNil(o.SmContextSmfId) {
		var ret string
		return ret
	}
...
func (o *SmContextCreateData) GetSmContextSmfSetId() string {
	if o == nil || openapi.IsNil(o.SmContextSmfSetId) {
		var ret string
		return ret
	}
...
func (o *SmContextCreateData) GetSmContextSmfServiceSetId() string {
	if o == nil || openapi.IsNil(o.SmContextSmfServiceSetId) {
		var ret string
		return ret
	}
...
func (o *SmContextCreateData) GetSmContextSmfBinding() SbiBindingLevel {
	if o == nil || openapi.IsNil(o.SmContextSmfBinding) {
...
func (o *SmContextCreateData) GetSmfTransferInd() bool {
	if o == nil || openapi.IsNil(o.SmfTransferInd) {
		var ret bool
		return ret
	}
...
func (o *SmContextCreateData) GetOldSmfId() string {
	if o == nil || openapi.IsNil(o.OldSmfId) {
		var ret string
		return ret
	}
	return *o.OldSmfId
...
func (o *SmContextCreateData) GetSamePcfSelectionInd() bool {
	if o == nil || openapi.IsNil(o.SamePcfSelectionInd) {
		var ret bool
		return ret
	}
...
func (o *SmContextCreateData) GetNrfManagementUri() string {
	if o == nil || openapi.IsNil(o.NrfManagementUri) {
		var ret string
		return ret
	}
...
func (o *SmContextCreateData) GetNrfDiscoveryUri() string {
	if o == nil || openapi.IsNil(o.NrfDiscoveryUri) {
		var ret string
		return ret
	}
...
func (o *SmContextCreateData) GetNrfAccessTokenUri() string {
	if o == nil || openapi.IsNil(o.NrfAccessTokenUri) {
		var ret string
		return ret
	}
...
func (o *SmContextCreateData) GetSmContextSmfOauth2Required() bool {
	if o == nil || openapi.IsNil(o.SmContextSmfOauth2Required) {
		var ret bool
		return ret
	}
...
func (o *SmContextCreateData) GetGeoSatelliteId() string {
...
// and a boolean to check if the value has been set.
func (o *SmContextCreateData) GetGeoSatelliteIdOk() (*string, bool) {
	if o == nil || openapi.IsNil(o.GeoSatelliteId) {
		return nil, false
	}
...
func (o *SmContextCreateData) HasGeoSatelliteId() bool {
	if o != nil && !openapi.IsNil(o.GeoSatelliteId) {
		return true
	}
...
func (o *SmContextCreateData) SetGeoSatelliteId(v string) {
	o.GeoSatelliteId = &v
}

// GetHrsboAllowedInd returns the HrsboAllowedInd field value if set, zero value otherwise.
func (o *SmContextCreateData) GetHrsboAllowedInd() bool {
	if o == nil || openapi.IsNil(o.HrsboAllowedInd) {
		var ret bool
		return ret
	}
	return *o.HrsboAllowedInd
}

// GetHrsboAllowedIndOk returns a tuple with the HrsboAllowedInd field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SmContextCreateData) GetHrsboAllowedIndOk() (*bool, bool) {
	if o == nil || openapi.IsNil(o.HrsboAllowedInd) {
		return nil, false
	}
	return o.HrsboAllowedInd, true
}

// HasHrsboAllowedInd returns a boolean if a field has been set.
func (o *SmContextCreateData) HasHrsboAllowedInd() bool {
	if o != nil && !openapi.IsNil(o.HrsboAllowedInd) {
		return true
	}
...
// SetHrsboAllowedInd gets a reference to the given bool and assigns it to the HrsboAllowedInd field.
func (o *SmContextCreateData) SetHrsboAllowedInd(v bool) {
	o.HrsboAllowedInd = &v
}

// GetEstabRejectionInd returns the EstabRejectionInd field value if set, zero value otherwise.
func (o *SmContextCreateData) GetEstabRejectionInd() bool {
	if o == nil || openapi.IsNil(o.EstabRejectionInd) {
		var ret bool
		return ret
	}
	return *o.EstabRejectionInd
}

// GetEstabRejectionIndOk returns a tuple with the EstabRejectionInd field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SmContextCreateData) GetEstabRejectionIndOk() (*bool, bool) {
	if o == nil || openapi.IsNil(o.EstabRejectionInd) {
		return nil, false
	}
	return o.EstabRejectionInd, true
}

// HasEstabRejectionInd returns a boolean if a field has been set.
func (o *SmContextCreateData) HasEstabRejectionInd() bool {
	if o != nil && !openapi.IsNil(o.EstabRejectionInd) {
		return true
	}
...
// SetEstabRejectionInd gets a reference to the given bool and assigns it to the EstabRejectionInd field.
func (o *SmContextCreateData) SetEstabRejectionInd(v bool) {
	o.EstabRejectionInd = &v
}

// GetEstabRejectionCause returns the EstabRejectionCause field value if set, zero value otherwise.
func (o *SmContextCreateData) GetEstabRejectionCause() EstablishmentRejectionCause {
	if o == nil || openapi.IsNil(o.EstabRejectionCause) {
		var ret EstablishmentRejectionCause
		return ret
	}
	return *o.EstabRejectionCause
}

// GetEstabRejectionCauseOk returns a tuple with the EstabRejectionCause field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SmContextCreateData) GetEstabRejectionCauseOk() (*EstablishmentRejectionCause, bool) {
	if o == nil || openapi.IsNil(o.EstabRejectionCause) {
		return nil, false
	}
	return o.EstabRejectionCause, true
}

// HasEstabRejectionCause returns a boolean if a field has been set.
func (o *SmContextCreateData) HasEstabRejectionCause() bool {
	if o != nil && !openapi.IsNil(o.EstabRejectionCause) {
		return true
	}
...
// SetEstabRejectionCause gets a reference to the given EstablishmentRejectionCause and assigns it to the EstabRejectionCause field.
func (o *SmContextCreateData) SetEstabRejectionCause(v EstablishmentRejectionCause) {
	o.EstabRejectionCause = &v
}

func (o SmContextCreateData) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.RoamingUeInd) {
	...
	if !openapi.IsNil(o.PerLadnDnnSnssaiInd) {
		toSerialize["perLadnDnnSnssaiInd"] = o.PerLadnDnnSnssaiInd
	}
	...
	if !openapi.IsNil(o.PduSessionsActivateList) {
		toSerialize["pduSessionsActivateList"] = o.PduSessionsActivateList
	}
	if !openapi.IsNil(o.UeEpsPdnConnection) {
	...
	if !openapi.IsNil(o.IndirectForwardingFlag) {
		toSerialize["indirectForwardingFlag"] = o.IndirectForwardingFlag
	}
	if !openapi.IsNil(o.DirectForwardingFlag) {
	...
	if !openapi.IsNil(o.N3gPathSwitchSupportInd) {
		toSerialize["n3gPathSwitchSupportInd"] = o.N3gPathSwitchSupportInd
	}
	...
	if !openapi.IsNil(o.SmfTransferInd) {
		toSerialize["smfTransferInd"] = o.SmfTransferInd
	}
	if !openapi.IsNil(o.OldSmfId) {
	...
	if !openapi.IsNil(o.SmContextSmfOauth2Required) {
	...
	if !openapi.IsNil(o.HrsboAllowedInd) {
		toSerialize["hrsboAllowedInd"] = o.HrsboAllowedInd
	}
	if !openapi.IsNil(o.EstabRejectionInd) {
		toSerialize["estabRejectionInd"] = o.EstabRejectionInd
	}
	if !openapi.IsNil(o.EstabRejectionCause) {
		toSerialize["estabRejectionCause"] = o.EstabRejectionCause
	}
