...
type CancelLocationAPI interface {
	...
	*/
	...
	// CancelLocationExecute executes the request
	CancelLocationExecute(r ApiCancelLocationRequest) (*http.Response, error)
}
...
type ApiCancelLocationRequest struct {
	ctx           context.Context
	ApiService    CancelLocationAPI
	cancelLocData *models.CancelLocData
}

func (r ApiCancelLocationRequest) CancelLocData(cancelLocData models.CancelLocData) ApiCancelLocationRequest {
	r.cancelLocData = &cancelLocData
	return r
}
...
func (a *CancelLocationAPIService) CancelLocationExecute(r ApiCancelLocationRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CancelLocationAPIService.CancelLocation")
	if err != nil {
		return nil, &openapi.GenericOpenAPIError{RawError: err.Error()}
	}

	localVarPath := localBasePath + "/cancel-location"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.cancelLocData == nil {
		return nil, openapi.ReportError("cancelLocData is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.cancelLocData
