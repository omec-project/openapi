...
var _ openapi.MappedNullable = &RedundantTransmissionExpPerTS{}
...
type RedundantTransmissionExpPerTS struct {
	...
	ObsvRedTransExp ObservedRedundantTransExp `json:"obsvRedTransExp" yaml:"obsvRedTransExp"`
	...
	RedTransStatus *bool `json:"redTransStatus,omitempty" yaml:"redTransStatus,omitempty"`
...
func (o *RedundantTransmissionExpPerTS) GetRedTransStatus() bool {
	if o == nil || openapi.IsNil(o.RedTransStatus) {
		var ret bool
		return ret
	}
