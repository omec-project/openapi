...
var _ openapi.MappedNullable = &NetworkAreaInfo{}
...
type NetworkAreaInfo struct {
	...
	Ecgis []Ecgi `json:"ecgis,omitempty" yaml:"ecgis,omitempty"`
	// Contains a list of NR cell identities.
	Ncgis []Ncgi `json:"ncgis,omitempty" yaml:"ncgis,omitempty"`
	// Contains a list of NG RAN nodes.
	GRanNodeIds []GlobalRanNodeId `json:"gRanNodeIds,omitempty" yaml:"gRanNodeIds,omitempty"`
	// Contains a list of tracking area identities.
	Tais []Tai `json:"tais,omitempty" yaml:"tais,omitempty"`
}
...
func (o *NetworkAreaInfo) GetEcgis() []Ecgi {
	if o == nil || openapi.IsNil(o.Ecgis) {
		var ret []Ecgi
		return ret
	}
	return o.Ecgis
...
func (o *NetworkAreaInfo) GetNcgis() []Ncgi {
	if o == nil || openapi.IsNil(o.Ncgis) {
		var ret []Ncgi
		return ret
	}
	return o.Ncgis
...
func (o *NetworkAreaInfo) GetGRanNodeIds() []GlobalRanNodeId {
	if o == nil || openapi.IsNil(o.GRanNodeIds) {
...
func (o NetworkAreaInfo) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.Ecgis) {
		toSerialize["ecgis"] = o.Ecgis
	}
	if !openapi.IsNil(o.Ncgis) {
		toSerialize["ncgis"] = o.Ncgis
	}
	if !openapi.IsNil(o.GRanNodeIds) {
		toSerialize["gRanNodeIds"] = o.GRanNodeIds
	}
	if !openapi.IsNil(o.Tais) {
