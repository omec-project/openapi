...
type CAGACKDocumentAPI interface {
	...
	*/
	QueryCagAck(ctx context.Context, ueId string) ApiQueryCagAckRequest

	// QueryCagAckExecute executes the request
	//   @return CagAckData
	QueryCagAckExecute(r ApiQueryCagAckRequest) (*models.CagAckData, *http.Response, error)
}
...
func (r ApiQueryCagAckRequest) Execute() (*models.CagAckData, *http.Response, error) {
	return r.ApiService.QueryCagAckExecute(r)
}
...
//
//	@return CagAckData
func (a *CAGACKDocumentAPIService) QueryCagAckExecute(r ApiQueryCagAckRequest) (*models.CagAckData, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    any
		formFiles           []formFile
		localVarReturnValue *models.CagAckData
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CAGACKDocumentAPIService.QueryCagAck")
	if err != nil {
