...
var _ openapi.MappedNullable = &PostSmContextsRequest{}

// PostSmContextsRequest struct for PostSmContextsRequest
type PostSmContextsRequest struct {
	JsonData                      *SmContextCreateData `json:"jsonData,omitempty" yaml:"jsonData,omitempty" multipart:"contentType:application/json,ref:{jsonData}"`
...
func (o PostSmContextsRequest) ToMap() (map[string]any, error) {
