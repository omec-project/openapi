...
var _ openapi.MappedNullable = &PduSessionContext{}
...
type PduSessionContext struct {
	...
	SmContextRef string  `json:"smContextRef" yaml:"smContextRef"`
	...
	AdditionalAccessType *AccessType     `json:"additionalAccessType,omitempty" yaml:"additionalAccessType,omitempty"`
	...
	HsmfSetId *string `json:"hsmfSetId,omitempty" yaml:"hsmfSetId,omitempty"`
	...
	HsmfServiceSetId *string          `json:"hsmfServiceSetId,omitempty" yaml:"hsmfServiceSetId,omitempty"`
	SmfBinding       *SbiBindingLevel `json:"smfBinding,omitempty" yaml:"smfBinding,omitempty"`
	// String uniquely identifying a NF instance. The format of the NF Instance ID shall be a  Universally Unique Identifier (UUID) version 4, as described in IETF RFC 4122.
	VsmfId *string `json:"vsmfId,omitempty" yaml:"vsmfId,omitempty"`
	// NF Set Identifier (see clause 28.12 of 3GPP TS 23.003), formatted as the following string \"set<Set ID>.<nftype>set.5gc.mnc<MNC>.mcc<MCC>\", or  \"set<SetID>.<NFType>set.5gc.nid<NID>.mnc<MNC>.mcc<MCC>\" with  <MCC> encoded as defined in clause 5.4.2 (\"Mcc\" data type definition)  <MNC> encoding the Mobile Network Code part of the PLMN, comprising 3 digits.    If there are only 2 significant digits in the MNC, one \"0\" digit shall be inserted    at the left side to fill the 3 digits coding of MNC.  Pattern: '^[0-9]{3}$' <NFType> encoded as a value defined in Table 6.1.6.3.3-1 of 3GPP TS 29.510 but    with lower case characters <Set ID> encoded as a string of characters consisting of    alphabetic characters (A-Z and a-z), digits (0-9) and/or the hyphen (-) and that    shall end with either an alphabetic character or a digit.
	VsmfSetId *string `json:"vsmfSetId,omitempty" yaml:"vsmfSetId,omitempty"`
	// NF Service Set Identifier (see clause 28.12 of 3GPP TS 23.003) formatted as the following  string \"set<Set ID>.sn<Service Name>.nfi<NF Instance ID>.5gc.mnc<MNC>.mcc<MCC>\", or  \"set<SetID>.sn<ServiceName>.nfi<NFInstanceID>.5gc.nid<NID>.mnc<MNC>.mcc<MCC>\" with  <MCC> encoded as defined in clause 5.4.2 (\"Mcc\" data type definition)   <MNC> encoding the Mobile Network Code part of the PLMN, comprising 3 digits.    If there are only 2 significant digits in the MNC, one \"0\" digit shall be inserted    at the left side to fill the 3 digits coding of MNC.  Pattern: '^[0-9]{3}$' <NID> encoded as defined in clause 5.4.2 (\"Nid\" data type definition)  <NFInstanceId> encoded as defined in clause 5.3.2  <ServiceName> encoded as defined in 3GPP TS 29.510  <Set ID> encoded as a string of characters consisting of alphabetic    characters (A-Z and a-z), digits (0-9) and/or the hyphen (-) and that shall end    with either an alphabetic character or a digit.
	VsmfServiceSetId *string          `json:"vsmfServiceSetId,omitempty" yaml:"vsmfServiceSetId,omitempty"`
	VsmfBinding      *SbiBindingLevel `json:"vsmfBinding,omitempty" yaml:"vsmfBinding,omitempty"`
	// String uniquely identifying a NF instance. The format of the NF Instance ID shall be a  Universally Unique Identifier (UUID) version 4, as described in IETF RFC 4122.
	IsmfId *string `json:"ismfId,omitempty" yaml:"ismfId,omitempty"`
	// NF Set Identifier (see clause 28.12 of 3GPP TS 23.003), formatted as the following string \"set<Set ID>.<nftype>set.5gc.mnc<MNC>.mcc<MCC>\", or  \"set<SetID>.<NFType>set.5gc.nid<NID>.mnc<MNC>.mcc<MCC>\" with  <MCC> encoded as defined in clause 5.4.2 (\"Mcc\" data type definition)  <MNC> encoding the Mobile Network Code part of the PLMN, comprising 3 digits.    If there are only 2 significant digits in the MNC, one \"0\" digit shall be inserted    at the left side to fill the 3 digits coding of MNC.  Pattern: '^[0-9]{3}$' <NFType> encoded as a value defined in Table 6.1.6.3.3-1 of 3GPP TS 29.510 but    with lower case characters <Set ID> encoded as a string of characters consisting of    alphabetic characters (A-Z and a-z), digits (0-9) and/or the hyphen (-) and that    shall end with either an alphabetic character or a digit.
	IsmfSetId *string `json:"ismfSetId,omitempty" yaml:"ismfSetId,omitempty"`
	// NF Service Set Identifier (see clause 28.12 of 3GPP TS 23.003) formatted as the following  string \"set<Set ID>.sn<Service Name>.nfi<NF Instance ID>.5gc.mnc<MNC>.mcc<MCC>\", or  \"set<SetID>.sn<ServiceName>.nfi<NFInstanceID>.5gc.nid<NID>.mnc<MNC>.mcc<MCC>\" with  <MCC> encoded as defined in clause 5.4.2 (\"Mcc\" data type definition)   <MNC> encoding the Mobile Network Code part of the PLMN, comprising 3 digits.    If there are only 2 significant digits in the MNC, one \"0\" digit shall be inserted    at the left side to fill the 3 digits coding of MNC.  Pattern: '^[0-9]{3}$' <NID> encoded as defined in clause 5.4.2 (\"Nid\" data type definition)  <NFInstanceId> encoded as defined in clause 5.3.2  <ServiceName> encoded as defined in 3GPP TS 29.510  <Set ID> encoded as a string of characters consisting of alphabetic    characters (A-Z and a-z), digits (0-9) and/or the hyphen (-) and that shall end    with either an alphabetic character or a digit.
	IsmfServiceSetId *string          `json:"ismfServiceSetId,omitempty" yaml:"ismfServiceSetId,omitempty"`
	IsmfBinding      *SbiBindingLevel `json:"ismfBinding,omitempty" yaml:"ismfBinding,omitempty"`
	// Contains the Identifier of the selected Network Slice instance
	NsInstance           *string            `json:"nsInstance,omitempty" yaml:"nsInstance,omitempty"`
	SmfServiceInstanceId *string            `json:"smfServiceInstanceId,omitempty" yaml:"smfServiceInstanceId,omitempty"`
	MaPduSession         *bool              `json:"maPduSession,omitempty" yaml:"maPduSession,omitempty"`
	...
	VsmfBindingInfo     *string `json:"vsmfBindingInfo,omitempty" yaml:"vsmfBindingInfo,omitempty"`
	IsmfBindingInfo     *string `json:"ismfBindingInfo,omitempty" yaml:"ismfBindingInfo,omitempty"`
	AdditionalSnssai    *Snssai `json:"additionalSnssai,omitempty" yaml:"additionalSnssai,omitempty"`
	AltAdditionalSnssai *Snssai `json:"altAdditionalSnssai,omitempty" yaml:"altAdditionalSnssai,omitempty"`
	// String providing an URI formatted according to RFC 3986.
	...
	AnchorSmfSupportedFeatures *string `json:"anchorSmfSupportedFeatures,omitempty" yaml:"anchorSmfSupportedFeatures,omitempty" validate:"regexp=^[A-Fa-f0-9]*$"`
...
func (o *PduSessionContext) GetAltSnssai() Snssai {
...
// and a boolean to check if the value has been set.
func (o *PduSessionContext) GetAltSnssaiOk() (*Snssai, bool) {
	if o == nil || openapi.IsNil(o.AltSnssai) {
		return nil, false
	}
...
func (o *PduSessionContext) HasAltSnssai() bool {
	if o != nil && !openapi.IsNil(o.AltSnssai) {
		return true
	}
...
func (o *PduSessionContext) SetAltSnssai(v Snssai) {
	o.AltSnssai = &v
}
...
func (o *PduSessionContext) GetAdditionalAccessType() AccessType {
	if o == nil || openapi.IsNil(o.AdditionalAccessType) {
		var ret AccessType
		return ret
	}
...
func (o *PduSessionContext) GetHsmfSetId() string {
	if o == nil || openapi.IsNil(o.HsmfSetId) {
		var ret string
		return ret
	}
	return *o.HsmfSetId
...
func (o *PduSessionContext) GetHsmfServiceSetId() string {
	if o == nil || openapi.IsNil(o.HsmfServiceSetId) {
		var ret string
		return ret
	}
...
func (o *PduSessionContext) GetSmfBinding() SbiBindingLevel {
	if o == nil || openapi.IsNil(o.SmfBinding) {
...
func (o *PduSessionContext) GetVsmfSetId() string {
	if o == nil || openapi.IsNil(o.VsmfSetId) {
		var ret string
		return ret
	}
	return *o.VsmfSetId
...
func (o *PduSessionContext) GetVsmfServiceSetId() string {
	if o == nil || openapi.IsNil(o.VsmfServiceSetId) {
		var ret string
		return ret
	}
...
func (o *PduSessionContext) GetVsmfBinding() SbiBindingLevel {
	if o == nil || openapi.IsNil(o.VsmfBinding) {
		var ret SbiBindingLevel
		return ret
	}
...
func (o *PduSessionContext) GetIsmfSetId() string {
	if o == nil || openapi.IsNil(o.IsmfSetId) {
		var ret string
		return ret
	}
	return *o.IsmfSetId
...
func (o *PduSessionContext) GetIsmfServiceSetId() string {
	if o == nil || openapi.IsNil(o.IsmfServiceSetId) {
		var ret string
		return ret
	}
...
func (o *PduSessionContext) GetIsmfBinding() SbiBindingLevel {
	if o == nil || openapi.IsNil(o.IsmfBinding) {
		var ret SbiBindingLevel
		return ret
	}
...
func (o *PduSessionContext) GetNsInstance() string {
	if o == nil || openapi.IsNil(o.NsInstance) {
		var ret string
		return ret
	}
	return *o.NsInstance
...
func (o *PduSessionContext) GetMaPduSession() bool {
	if o == nil || openapi.IsNil(o.MaPduSession) {
		var ret bool
		return ret
	}
...
func (o *PduSessionContext) GetVsmfBindingInfo() string {
	if o == nil || openapi.IsNil(o.VsmfBindingInfo) {
		var ret string
		return ret
	}
...
func (o *PduSessionContext) GetIsmfBindingInfo() string {
	if o == nil || openapi.IsNil(o.IsmfBindingInfo) {
		var ret string
		return ret
	}
...
// GetAltAdditionalSnssai returns the AltAdditionalSnssai field value if set, zero value otherwise.
func (o *PduSessionContext) GetAltAdditionalSnssai() Snssai {
	if o == nil || openapi.IsNil(o.AltAdditionalSnssai) {
		var ret Snssai
		return ret
	}
	return *o.AltAdditionalSnssai
}

// GetAltAdditionalSnssaiOk returns a tuple with the AltAdditionalSnssai field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PduSessionContext) GetAltAdditionalSnssaiOk() (*Snssai, bool) {
	if o == nil || openapi.IsNil(o.AltAdditionalSnssai) {
		return nil, false
	}
	return o.AltAdditionalSnssai, true
}

// HasAltAdditionalSnssai returns a boolean if a field has been set.
func (o *PduSessionContext) HasAltAdditionalSnssai() bool {
	if o != nil && !openapi.IsNil(o.AltAdditionalSnssai) {
		return true
	}
...
// SetAltAdditionalSnssai gets a reference to the given Snssai and assigns it to the AltAdditionalSnssai field.
func (o *PduSessionContext) SetAltAdditionalSnssai(v Snssai) {
	o.AltAdditionalSnssai = &v
}
...
func (o *PduSessionContext) GetAnchorSmfSupportedFeatures() string {
	if o == nil || openapi.IsNil(o.AnchorSmfSupportedFeatures) {
		var ret string
		return ret
	}
...
func (o *PduSessionContext) GetHrsboAllowedInd() bool {
...
// and a boolean to check if the value has been set.
func (o *PduSessionContext) GetHrsboAllowedIndOk() (*bool, bool) {
	if o == nil || openapi.IsNil(o.HrsboAllowedInd) {
		return nil, false
	}
...
func (o *PduSessionContext) HasHrsboAllowedInd() bool {
	if o != nil && !openapi.IsNil(o.HrsboAllowedInd) {
		return true
	}
...
func (o *PduSessionContext) SetHrsboAllowedInd(v bool) {
	o.HrsboAllowedInd = &v
}

func (o PduSessionContext) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.AdditionalAccessType) {
	...
	if !openapi.IsNil(o.MaPduSession) {
	...
	if !openapi.IsNil(o.VsmfBindingInfo) {
		toSerialize["vsmfBindingInfo"] = o.VsmfBindingInfo
	}
	if !openapi.IsNil(o.IsmfBindingInfo) {
	...
	if !openapi.IsNil(o.AltAdditionalSnssai) {
		toSerialize["altAdditionalSnssai"] = o.AltAdditionalSnssai
	}
	...
	if !openapi.IsNil(o.AnchorSmfSupportedFeatures) {
