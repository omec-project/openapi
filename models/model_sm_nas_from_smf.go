...
var _ openapi.MappedNullable = &SmNasFromSmf{}
...
type SmNasFromSmf struct {
	SmNasType string `json:"smNasType" yaml:"smNasType"`
	// string with format 'date-time' as defined in OpenAPI.
	TimeStamp time.Time `json:"timeStamp" yaml:"timeStamp"`
	// indicating a time in seconds.
	BackoffTimer    int32           `json:"backoffTimer" yaml:"backoffTimer"`
	AppliedSmccType AppliedSmccType `json:"appliedSmccType" yaml:"appliedSmccType"`
}
...
func (o SmNasFromSmf) ToMap() (map[string]any, error) {
