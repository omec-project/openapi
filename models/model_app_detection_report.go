...
var _ openapi.MappedNullable = &AppDetectionReport{}
...
type AppDetectionReport struct {
	AdNotifType AppDetectionNotifType `json:"adNotifType" yaml:"adNotifType"`
	// Contains an AF application identifier.
	AfAppId string `json:"afAppId" yaml:"afAppId"`
}
...
func (o AppDetectionReport) ToMap() (map[string]any, error) {
