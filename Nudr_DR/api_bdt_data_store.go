...
type BdtDataStoreAPI interface {
	...
	*/
	ReadBdtData(ctx context.Context) ApiReadBdtDataRequest

	// ReadBdtDataExecute executes the request
	//   @return []BdtData
	ReadBdtDataExecute(r ApiReadBdtDataRequest) ([]models.BdtData, *http.Response, error)
}
...
func (r ApiReadBdtDataRequest) Execute() ([]models.BdtData, *http.Response, error) {
	return r.ApiService.ReadBdtDataExecute(r)
}
...
//
//	@return []BdtData
func (a *BdtDataStoreAPIService) ReadBdtDataExecute(r ApiReadBdtDataRequest) ([]models.BdtData, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BdtDataStoreAPIService.ReadBdtData")
	if err != nil {
		return localVarReturnValue, nil, &openapi.GenericOpenAPIError{RawError: err.Error()}
	}

	localVarPath := localBasePath + "/policy-data/bdt-data"
	...
	if r.bdtRefIds != nil {
		openapi.ParameterAddToHeaderOrQuery(localVarQueryParams, "bdt-ref-ids", r.bdtRefIds, "form", "csv")
	}
	if r.suppFeat != nil {
