...
var _ openapi.MappedNullable = &AnalyticsSubscription{}
...
type AnalyticsSubscription struct {
	...
	NwdafId *string `json:"nwdafId,omitempty" yaml:"nwdafId,omitempty"`
	...
	NwdafSubscriptionList []NwdafSubscription `json:"nwdafSubscriptionList" yaml:"nwdafSubscriptionList"`
}
...
func (o *AnalyticsSubscription) GetNwdafId() string {
	if o == nil || openapi.IsNil(o.NwdafId) {
		var ret string
		return ret
	}
	return *o.NwdafId
...
func (o AnalyticsSubscription) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.NwdafId) {
