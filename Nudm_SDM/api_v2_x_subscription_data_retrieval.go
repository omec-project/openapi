...
type V2XSubscriptionDataRetrievalAPI interface {
	...
	*/
	...
	GetV2xDataExecute(r ApiGetV2xDataRequest) (*models.V2xSubscriptionData, *http.Response, error)
}
...
func (r ApiGetV2xDataRequest) Execute() (*models.V2xSubscriptionData, *http.Response, error) {
...
//
//	@return V2xSubscriptionData
func (a *V2XSubscriptionDataRetrievalAPIService) GetV2xDataExecute(r ApiGetV2xDataRequest) (*models.V2xSubscriptionData, *http.Response, error) {
	var (
