...
var _ openapi.MappedNullable = &ReleaseSmContextRequest{}

// ReleaseSmContextRequest struct for ReleaseSmContextRequest
type ReleaseSmContextRequest struct {
	JsonData                  *SmContextReleaseData `json:"jsonData,omitempty" yaml:"jsonData,omitempty" multipart:"contentType:application/json,ref:{jsonData}"`
...
func (o ReleaseSmContextRequest) ToMap() (map[string]any, error) {
