...
type Arp struct {
	...
	PreemptCap           PreemptCap  `json:"preemptCap" yaml:"preemptCap"`
	PreemptVuln          PreemptVuln `json:"preemptVuln" yaml:"preemptVuln"`
...
func (o *Arp) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varArp)
	...
	*o = Arp(varArp)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "preemptCap")
		delete(additionalProperties, "preemptVuln")
