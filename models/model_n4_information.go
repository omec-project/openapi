...
var _ openapi.MappedNullable = &N4Information{}
...
func (o *N4Information) GetN4DnaiInfo() DnaiInformation {
	if o == nil || openapi.IsNil(o.N4DnaiInfo) {
...
func (o *N4Information) GetUlClBpId() string {
	if o == nil || openapi.IsNil(o.UlClBpId) {
		var ret string
		return ret
	}
	return *o.UlClBpId
...
func (o *N4Information) GetN9UlPdrIdList() []int32 {
	if o == nil || openapi.IsNil(o.N9UlPdrIdList) {
		var ret []int32
		return ret
	}
