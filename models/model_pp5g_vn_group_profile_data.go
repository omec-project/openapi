...
var _ openapi.MappedNullable = &Pp5gVnGroupProfileData{}
...
type Pp5gVnGroupProfileData struct {
	...
	AllowedMtcProviders *map[string][]AllowedMtcProviderInfo `json:"allowedMtcProviders,omitempty" yaml:"allowedMtcProviders,omitempty"`
...
func (o Pp5gVnGroupProfileData) ToMap() (map[string]any, error) {
