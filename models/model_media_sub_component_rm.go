...
var _ openapi.MappedNullable = &MediaSubComponentRm{}
...
func (o *MediaSubComponentRm) GetTosTrCl() string {
	if o == nil || openapi.IsNil(o.TosTrCl.Get()) {
		var ret string
		return ret
	}
...
// SetTosTrCl gets a reference to the given openapi.NullableString and assigns it to the TosTrCl field.
...
func (o MediaSubComponentRm) ToMap() (map[string]any, error) {
