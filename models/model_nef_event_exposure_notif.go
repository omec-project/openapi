...
var _ openapi.MappedNullable = &NefEventExposureNotif{}
...
type NefEventExposureNotif struct {
	...
	EventNotifs []NefEventNotification `json:"eventNotifs" yaml:"eventNotifs"`
}
...
func (o NefEventExposureNotif) ToMap() (map[string]any, error) {
