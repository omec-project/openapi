...
var _ openapi.MappedNullable = &NumberAverage{}
...
type NumberAverage struct {
	...
	// string with format 'float' as defined in OpenAPI.
	Variance float32 `json:"variance" yaml:"variance"`
	// string with format 'float' as defined in OpenAPI.
	Skewness *float32 `json:"skewness,omitempty" yaml:"skewness,omitempty"`
}
...
func (o *NumberAverage) GetSkewness() float32 {
	if o == nil || openapi.IsNil(o.Skewness) {
		var ret float32
		return ret
	}
	return *o.Skewness
...
func (o NumberAverage) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["number"] = o.Number
	toSerialize["variance"] = o.Variance
	if !openapi.IsNil(o.Skewness) {
