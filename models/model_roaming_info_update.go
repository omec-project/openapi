...
var _ openapi.MappedNullable = &RoamingInfoUpdate{}

// RoamingInfoUpdate Contains the Roaming Information Update
type RoamingInfoUpdate struct {
	Roaming     *bool  `json:"roaming,omitempty" yaml:"roaming,omitempty"`
...
func (o *RoamingInfoUpdate) GetRoaming() bool {
	if o == nil || openapi.IsNil(o.Roaming) {
		var ret bool
		return ret
	}
	return *o.Roaming
...
func (o RoamingInfoUpdate) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.Roaming) {
