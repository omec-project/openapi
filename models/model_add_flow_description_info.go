...
var _ openapi.MappedNullable = &AddFlowDescriptionInfo{}
...
type AddFlowDescriptionInfo struct {
	...
	FlowDir   *FlowDirection `json:"flowDir,omitempty" yaml:"flowDir,omitempty"`
}
...
func (o *AddFlowDescriptionInfo) GetFlowDir() FlowDirection {
	if o == nil || openapi.IsNil(o.FlowDir) {
...
func (o AddFlowDescriptionInfo) ToMap() (map[string]any, error) {
