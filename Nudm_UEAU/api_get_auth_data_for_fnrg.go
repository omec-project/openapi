...
type GetAuthDataForFNRGAPI interface {
	...
	*/
	GetRgAuthData(ctx context.Context, supiOrSuci string) ApiGetRgAuthDataRequest

	// GetRgAuthDataExecute executes the request
	//   @return RgAuthCtxUdm
	GetRgAuthDataExecute(r ApiGetRgAuthDataRequest) (*models.RgAuthCtxUdm, *http.Response, error)
}
...
type ApiGetRgAuthDataRequest struct {
	ctx               context.Context
	ApiService        GetAuthDataForFNRGAPI
	supiOrSuci        string
...
// serving PLMN ID
func (r ApiGetRgAuthDataRequest) PlmnId(plmnId models.PlmnId) ApiGetRgAuthDataRequest {
	r.plmnId = &plmnId
	return r
}
...
func (r ApiGetRgAuthDataRequest) Execute() (*models.RgAuthCtxUdm, *http.Response, error) {
...
//
//	@return RgAuthCtxUdm
func (a *GetAuthDataForFNRGAPIService) GetRgAuthDataExecute(r ApiGetRgAuthDataRequest) (*models.RgAuthCtxUdm, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    any
		formFiles           []formFile
		localVarReturnValue *models.RgAuthCtxUdm
	)
	...
	if r.authenticatedInd == nil {
		return localVarReturnValue, nil, openapi.ReportError("authenticatedInd is required and must be specified")
	}

	openapi.ParameterAddToHeaderOrQuery(localVarQueryParams, "authenticated-ind", r.authenticatedInd, "form", "")
