...
func (dst *UEAuthenticationCtx5gAuthData) UnmarshalJSON(data []byte) error {
	...
	err = openapi.NewStrictDecoder(data).Decode(&dst.Av5gAka)
	if err == nil {
	...
	if match > 1 { // more than 1 match
		...
		return openapi.ReportError("data matches more than one schema in oneOf(UEAuthenticationCtx5gAuthData)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return openapi.ReportError("data failed to match schemas in oneOf(UEAuthenticationCtx5gAuthData)")
	}
}
...
func (obj *UEAuthenticationCtx5gAuthData) GetActualInstance() any {
	if obj == nil {
		return nil
	}
	if obj.Av5gAka != nil {
...
func (obj UEAuthenticationCtx5gAuthData) GetActualInstanceValue() any {
	if obj.Av5gAka != nil {
		return *obj.Av5gAka
	}
