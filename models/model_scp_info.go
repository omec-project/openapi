...
var _ openapi.MappedNullable = &ScpInfo{}
...
type ScpInfo struct {
	...
	ScpDomainInfoList *map[string]ScpDomainInfo `json:"scpDomainInfoList,omitempty" yaml:"scpDomainInfoList,omitempty"`
	...
	ScpPorts          *map[string]int32  `json:"scpPorts,omitempty" yaml:"scpPorts,omitempty"`
	AddressDomains    []string           `json:"addressDomains,omitempty" yaml:"addressDomains,omitempty"`
	...
	Ipv4AddrRanges    []Ipv4AddressRange `json:"ipv4AddrRanges,omitempty" yaml:"ipv4AddrRanges,omitempty"`
	Ipv6PrefixRanges  []Ipv6PrefixRange  `json:"ipv6PrefixRanges,omitempty" yaml:"ipv6PrefixRanges,omitempty"`
	ServedNfSetIdList []string           `json:"servedNfSetIdList,omitempty" yaml:"servedNfSetIdList,omitempty"`
	RemotePlmnList    []PlmnId           `json:"remotePlmnList,omitempty" yaml:"remotePlmnList,omitempty"`
	RemoteSnpnList    []PlmnIdNid        `json:"remoteSnpnList,omitempty" yaml:"remoteSnpnList,omitempty"`
	IpReachability    *IpReachability    `json:"ipReachability,omitempty" yaml:"ipReachability,omitempty"`
	ScpCapabilities   []ScpCapability    `json:"scpCapabilities,omitempty" yaml:"scpCapabilities,omitempty"`
}
...
func (o *ScpInfo) GetScpDomainInfoList() map[string]ScpDomainInfo {
	if o == nil || openapi.IsNil(o.ScpDomainInfoList) {
...
func (o *ScpInfo) GetScpPrefix() string {
	if o == nil || openapi.IsNil(o.ScpPrefix) {
		var ret string
		return ret
	}
	return *o.ScpPrefix
...
func (o *ScpInfo) GetScpPorts() map[string]int32 {
	if o == nil || openapi.IsNil(o.ScpPorts) {
...
func (o *ScpInfo) GetAddressDomains() []string {
	if o == nil || openapi.IsNil(o.AddressDomains) {
		var ret []string
		return ret
	}
...
func (o *ScpInfo) GetIpv6Prefixes() []string {
...
// and a boolean to check if the value has been set.
func (o *ScpInfo) GetIpv6PrefixesOk() ([]string, bool) {
	if o == nil || openapi.IsNil(o.Ipv6Prefixes) {
		return nil, false
	}
...
func (o *ScpInfo) SetIpv6Prefixes(v []string) {
	o.Ipv6Prefixes = v
}
...
func (o *ScpInfo) GetIpv4AddrRanges() []Ipv4AddressRange {
	if o == nil || openapi.IsNil(o.Ipv4AddrRanges) {
...
func (o *ScpInfo) GetServedNfSetIdList() []string {
	if o == nil || openapi.IsNil(o.ServedNfSetIdList) {
		var ret []string
		return ret
	}
...
func (o *ScpInfo) GetRemotePlmnList() []PlmnId {
	if o == nil || openapi.IsNil(o.RemotePlmnList) {
		var ret []PlmnId
		return ret
	}
...
func (o *ScpInfo) GetRemoteSnpnList() []PlmnIdNid {
	if o == nil || openapi.IsNil(o.RemoteSnpnList) {
		var ret []PlmnIdNid
		return ret
	}
...
func (o *ScpInfo) GetIpReachability() IpReachability {
	if o == nil || openapi.IsNil(o.IpReachability) {
...
func (o *ScpInfo) GetScpCapabilities() []ScpCapability {
	if o == nil || openapi.IsNil(o.ScpCapabilities) {
...
func (o ScpInfo) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.ScpDomainInfoList) {
		toSerialize["scpDomainInfoList"] = o.ScpDomainInfoList
	}
	if !openapi.IsNil(o.ScpPrefix) {
		toSerialize["scpPrefix"] = o.ScpPrefix
	}
	if !openapi.IsNil(o.ScpPorts) {
		toSerialize["scpPorts"] = o.ScpPorts
	}
	if !openapi.IsNil(o.AddressDomains) {
	...
	if !openapi.IsNil(o.Ipv4AddrRanges) {
