...
var _ openapi.MappedNullable = &FlowInformation{}

// FlowInformation Contains the flow information.
type FlowInformation struct {
	// Defines a packet filter for an IP flow.
	FlowDescription    *string             `json:"flowDescription,omitempty" yaml:"flowDescription,omitempty"`
	EthFlowDescription *EthFlowDescription `json:"ethFlowDescription,omitempty" yaml:"ethFlowDescription,omitempty"`
	...
	FlowLabel     openapi.NullableString `json:"flowLabel" yaml:"flowLabel,omitempty"`
	FlowDirection *FlowDirectionRm       `json:"flowDirection,omitempty" yaml:"flowDirection,omitempty"`
}
...
func (o *FlowInformation) GetEthFlowDescription() EthFlowDescription {
	if o == nil || openapi.IsNil(o.EthFlowDescription) {
...
func (o *FlowInformation) GetPackFiltId() string {
	if o == nil || openapi.IsNil(o.PackFiltId) {
		var ret string
		return ret
	}
	return *o.PackFiltId
...
func (o *FlowInformation) GetPacketFilterUsage() bool {
	if o == nil || openapi.IsNil(o.PacketFilterUsage) {
		var ret bool
		return ret
	}
...
func (o *FlowInformation) GetTosTrafficClass() string {
	if o == nil || openapi.IsNil(o.TosTrafficClass.Get()) {
		var ret string
		return ret
	}
...
// SetTosTrafficClass gets a reference to the given openapi.NullableString and assigns it to the TosTrafficClass field.
...
func (o *FlowInformation) GetSpi() string {
	if o == nil || openapi.IsNil(o.Spi.Get()) {
		var ret string
		return ret
	}
	return *o.Spi.Get()
...
// SetSpi gets a reference to the given openapi.NullableString and assigns it to the Spi field.
...
func (o *FlowInformation) GetFlowLabel() string {
	if o == nil || openapi.IsNil(o.FlowLabel.Get()) {
		var ret string
		return ret
	}
...
// SetFlowLabel gets a reference to the given openapi.NullableString and assigns it to the FlowLabel field.
...
func (o *FlowInformation) GetFlowDirection() FlowDirectionRm {
	if o == nil || openapi.IsNil(o.FlowDirection) {
...
func (o FlowInformation) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.FlowDirection) {
