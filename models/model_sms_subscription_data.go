...
var _ openapi.MappedNullable = &SmsSubscriptionData{}

// SmsSubscriptionData struct for SmsSubscriptionData
type SmsSubscriptionData struct {
	SmsSubscribed       *bool   `json:"smsSubscribed,omitempty" yaml:"smsSubscribed,omitempty"`
	SharedSmsSubsDataId *string `json:"sharedSmsSubsDataId,omitempty" yaml:"sharedSmsSubsDataId,omitempty" validate:"regexp=^[0-9]{5,6}-.+$"`
...
func (o *SmsSubscriptionData) GetSmsSubscribed() bool {
	if o == nil || openapi.IsNil(o.SmsSubscribed) {
		var ret bool
		return ret
	}
...
func (o *SmsSubscriptionData) GetSharedSmsSubsDataId() string {
	if o == nil || openapi.IsNil(o.SharedSmsSubsDataId) {
		var ret string
		return ret
	}
...
func (o SmsSubscriptionData) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.SmsSubscribed) {
		toSerialize["smsSubscribed"] = o.SmsSubscribed
	}
	if !openapi.IsNil(o.SharedSmsSubsDataId) {
