...
var _ openapi.MappedNullable = &AnalyticsMetadataInfo{}
...
type AnalyticsMetadataInfo struct {
	...
	NumSamples    *int32                       `json:"numSamples,omitempty" yaml:"numSamples,omitempty"`
...
func (o *AnalyticsMetadataInfo) GetNumSamples() int32 {
	if o == nil || openapi.IsNil(o.NumSamples) {
		var ret int32
		return ret
	}
	return *o.NumSamples
...
func (o AnalyticsMetadataInfo) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.NumSamples) {
