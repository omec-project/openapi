...
var _ openapi.MappedNullable = &CipheringDataSet{}
...
type CipheringDataSet struct {
	...
	// Ciphering Key.
	CipheringKey string `json:"cipheringKey" yaml:"cipheringKey"`
	// First component of the initial ciphering counter.
	C0 string `json:"c0" yaml:"c0"`
	// string with format 'bytes' as defined in OpenAPI
	LtePosSibTypes *string `json:"ltePosSibTypes,omitempty" yaml:"ltePosSibTypes,omitempty"`
	// string with format 'bytes' as defined in OpenAPI
	NrPosSibTypes *string `json:"nrPosSibTypes,omitempty" yaml:"nrPosSibTypes,omitempty"`
	// string with format 'date-time' as defined in OpenAPI.
	ValidityStartTime time.Time `json:"validityStartTime" yaml:"validityStartTime"`
	// Validity Duration of the Ciphering Data Set.
	ValidityDuration int32 `json:"validityDuration" yaml:"validityDuration"`
	// string with format 'bytes' as defined in OpenAPI
	TaiList *string `json:"taiList,omitempty" yaml:"taiList,omitempty"`
}
...
func (o *CipheringDataSet) GetLtePosSibTypes() string {
	if o == nil || openapi.IsNil(o.LtePosSibTypes) {
		var ret string
		return ret
	}
...
func (o *CipheringDataSet) GetNrPosSibTypes() string {
	if o == nil || openapi.IsNil(o.NrPosSibTypes) {
		var ret string
		return ret
	}
