...
var _ openapi.MappedNullable = &AuthorizedNssaiAvailabilityData{}
...
type AuthorizedNssaiAvailabilityData struct {
	...
	RestrictedSnssaiList []RestrictedSnssai `json:"restrictedSnssaiList,omitempty" yaml:"restrictedSnssaiList,omitempty"`
...
func NewAuthorizedNssaiAvailabilityData(tai Tai, supportedSnssaiList []Snssai) *AuthorizedNssaiAvailabilityData {
...
func (o *AuthorizedNssaiAvailabilityData) GetSupportedSnssaiList() []Snssai {
	if o == nil {
		var ret []Snssai
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *AuthorizedNssaiAvailabilityData) GetSupportedSnssaiListOk() ([]Snssai, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AuthorizedNssaiAvailabilityData) SetSupportedSnssaiList(v []Snssai) {
...
func (o *AuthorizedNssaiAvailabilityData) GetRestrictedSnssaiList() []RestrictedSnssai {
	if o == nil || openapi.IsNil(o.RestrictedSnssaiList) {
...
func (o AuthorizedNssaiAvailabilityData) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["tai"] = o.Tai
	toSerialize["supportedSnssaiList"] = o.SupportedSnssaiList
	if !openapi.IsNil(o.RestrictedSnssaiList) {
