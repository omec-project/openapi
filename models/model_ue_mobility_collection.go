...
var _ openapi.MappedNullable = &UeMobilityCollection{}
...
type UeMobilityCollection struct {
	...
	AllAppInd *bool                    `json:"allAppInd,omitempty" yaml:"allAppInd,omitempty"`
	UeTrajs   []UeTrajectoryCollection `json:"ueTrajs" yaml:"ueTrajs"`
	Areas     []LocationArea5G         `json:"areas,omitempty" yaml:"areas,omitempty"`
}
...
func (o *UeMobilityCollection) GetAllAppInd() bool {
	if o == nil || openapi.IsNil(o.AllAppInd) {
		var ret bool
		return ret
	}
	return *o.AllAppInd
...
func (o *UeMobilityCollection) GetAreas() []LocationArea5G {
...
// and a boolean to check if the value has been set.
func (o *UeMobilityCollection) GetAreasOk() ([]LocationArea5G, bool) {
	if o == nil || openapi.IsNil(o.Areas) {
		return nil, false
	}
	return o.Areas, true
...
func (o *UeMobilityCollection) HasAreas() bool {
	if o != nil && !openapi.IsNil(o.Areas) {
		return true
	}
...
// SetAreas gets a reference to the given []LocationArea5G and assigns it to the Areas field.
func (o *UeMobilityCollection) SetAreas(v []LocationArea5G) {
	o.Areas = v
}

func (o UeMobilityCollection) ToMap() (map[string]any, error) {
