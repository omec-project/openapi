...
func Test_Nudr_DR_SubsToNotifyCollectionAPIService(t *testing.T) {
	t.Run("Test SubsToNotifyCollectionAPIService QuerySubsToNotify", func(t *testing.T) {
		...
		t.Skip("skip autogenerated mock test for operations with required non-path parameter ueId")
	...
	t.Run("Test SubsToNotifyCollectionAPIService RemoveMultipleSubscriptionDataSubscriptions", func(t *testing.T) {
		...
		httpRes, err := apiClient.SubsToNotifyCollectionAPI.RemoveMultipleSubscriptionDataSubscriptions(context.Background()).Execute()
	...
	t.Run("Test SubsToNotifyCollectionAPIService SubscriptionDataSubscriptions", func(t *testing.T) {
		t.Skip("skip autogenerated mock test for operations with response bodies")
		t.Skip("skip autogenerated mock test for operations with required non-path parameter subscriptionDataSubscriptions")
