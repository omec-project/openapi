...
type TriggerAMFFor3GPPAccessDeregistrationAPI interface {
	...
	*/
	DeregAMF(ctx context.Context, ueId string) ApiDeregAMFRequest

	// DeregAMFExecute executes the request
	DeregAMFExecute(r ApiDeregAMFRequest) (*http.Response, error)
}
...
type ApiDeregAMFRequest struct {
	ctx          context.Context
	ApiService   TriggerAMFFor3GPPAccessDeregistrationAPI
	ueId         string
	amfDeregInfo *models.AmfDeregInfo
}

func (r ApiDeregAMFRequest) AmfDeregInfo(amfDeregInfo models.AmfDeregInfo) ApiDeregAMFRequest {
...
func (a *TriggerAMFFor3GPPAccessDeregistrationAPIService) DeregAMFExecute(r ApiDeregAMFRequest) (*http.Response, error) {
	...
	if r.amfDeregInfo == nil {
		return nil, openapi.ReportError("amfDeregInfo is required and must be specified")
	}
