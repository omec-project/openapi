...
var _ openapi.MappedNullable = &GeraLocation{}
...
func (o *GeraLocation) GetLocationNumber() string {
	if o == nil || openapi.IsNil(o.LocationNumber) {
		var ret string
		return ret
	}
...
func (o *GeraLocation) GetVlrNumber() string {
	if o == nil || openapi.IsNil(o.VlrNumber) {
		var ret string
		return ret
	}
	return *o.VlrNumber
...
func (o *GeraLocation) GetMscNumber() string {
	if o == nil || openapi.IsNil(o.MscNumber) {
		var ret string
		return ret
	}
	return *o.MscNumber
...
func (o GeraLocation) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.LocationNumber) {
		toSerialize["locationNumber"] = o.LocationNumber
	}
	if !openapi.IsNil(o.Cgi) {
		toSerialize["cgi"] = o.Cgi
	}
	if !openapi.IsNil(o.Sai) {
		toSerialize["sai"] = o.Sai
	}
	if !openapi.IsNil(o.Lai) {
		toSerialize["lai"] = o.Lai
	}
	if !openapi.IsNil(o.Rai) {
		toSerialize["rai"] = o.Rai
	}
	if !openapi.IsNil(o.VlrNumber) {
		toSerialize["vlrNumber"] = o.VlrNumber
	}
	if !openapi.IsNil(o.MscNumber) {
