...
var _ openapi.MappedNullable = &PcfAddressingInfo{}
...
func (o *PcfAddressingInfo) GetPcfFqdn() string {
	if o == nil || openapi.IsNil(o.PcfFqdn) {
		var ret string
		return ret
	}
	return *o.PcfFqdn
...
func (o *PcfAddressingInfo) GetPcfIpEndPoints() []IpEndPoint {
	if o == nil || openapi.IsNil(o.PcfIpEndPoints) {
		var ret []IpEndPoint
		return ret
	}
...
func (o PcfAddressingInfo) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.PcfFqdn) {
		toSerialize["pcfFqdn"] = o.PcfFqdn
	}
	if !openapi.IsNil(o.PcfIpEndPoints) {
