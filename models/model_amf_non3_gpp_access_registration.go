...
var _ openapi.MappedNullable = &AmfNon3GppAccessRegistration{}

// AmfNon3GppAccessRegistration Represents the complete set of information relevant to the AMF when the UE has registered via non 3GPP access.
type AmfNon3GppAccessRegistration struct {
	...
	ImsVoPs ImsVoPs `json:"imsVoPs" yaml:"imsVoPs"`
...
func (o AmfNon3GppAccessRegistration) ToMap() (map[string]any, error) {
