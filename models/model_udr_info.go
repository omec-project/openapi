...
var _ openapi.MappedNullable = &UdrInfo{}
...
type UdrInfo struct {
	...
	SupportedDataSets              []DataSetId         `json:"supportedDataSets,omitempty" yaml:"supportedDataSets,omitempty"`
	SharedDataIdRanges             []SharedDataIdRange `json:"sharedDataIdRanges,omitempty" yaml:"sharedDataIdRanges,omitempty"`
}
...
func (o *UdrInfo) GetSupportedDataSets() []DataSetId {
	if o == nil || openapi.IsNil(o.SupportedDataSets) {
		var ret []DataSetId
		return ret
	}
...
func (o *UdrInfo) GetSharedDataIdRanges() []SharedDataIdRange {
	if o == nil || openapi.IsNil(o.SharedDataIdRanges) {
...
func (o UdrInfo) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.SupportedDataSets) {
		toSerialize["supportedDataSets"] = o.SupportedDataSets
	}
	if !openapi.IsNil(o.SharedDataIdRanges) {
