...
var _ openapi.MappedNullable = &M5QoSSpecification{}
...
type M5QoSSpecification struct {
	...
	MarBwDlBitRate string `json:"marBwDlBitRate" yaml:"marBwDlBitRate" validate:"regexp=^\\\\d+(\\\\.\\\\d+)? (bps|Kbps|Mbps|Gbps|Tbps)$"`
	// String representing a bit rate; the prefixes follow the standard symbols from The International System of Units, and represent x1000 multipliers, with the exception that prefix \"K\" is used to represent the standard symbol \"k\".
	MarBwUlBitRate string `json:"marBwUlBitRate" yaml:"marBwUlBitRate" validate:"regexp=^\\\\d+(\\\\.\\\\d+)? (bps|Kbps|Mbps|Gbps|Tbps)$"`
	// String representing a bit rate; the prefixes follow the standard symbols from The International System of Units, and represent x1000 multipliers, with the exception that prefix \"K\" is used to represent the standard symbol \"k\".
	MinDesBwDlBitRate *string `json:"minDesBwDlBitRate,omitempty" yaml:"minDesBwDlBitRate,omitempty" validate:"regexp=^\\\\d+(\\\\.\\\\d+)? (bps|Kbps|Mbps|Gbps|Tbps)$"`
	// String representing a bit rate; the prefixes follow the standard symbols from The International System of Units, and represent x1000 multipliers, with the exception that prefix \"K\" is used to represent the standard symbol \"k\".
	MinDesBwUlBitRate *string `json:"minDesBwUlBitRate,omitempty" yaml:"minDesBwUlBitRate,omitempty" validate:"regexp=^\\\\d+(\\\\.\\\\d+)? (bps|Kbps|Mbps|Gbps|Tbps)$"`
	// String representing a bit rate; the prefixes follow the standard symbols from The International System of Units, and represent x1000 multipliers, with the exception that prefix \"K\" is used to represent the standard symbol \"k\".
	MirBwDlBitRate string `json:"mirBwDlBitRate" yaml:"mirBwDlBitRate" validate:"regexp=^\\\\d+(\\\\.\\\\d+)? (bps|Kbps|Mbps|Gbps|Tbps)$"`
	// String representing a bit rate; the prefixes follow the standard symbols from The International System of Units, and represent x1000 multipliers, with the exception that prefix \"K\" is used to represent the standard symbol \"k\".
	MirBwUlBitRate string `json:"mirBwUlBitRate" yaml:"mirBwUlBitRate" validate:"regexp=^\\\\d+(\\\\.\\\\d+)? (bps|Kbps|Mbps|Gbps|Tbps)$"`
	DesLatency     *int32 `json:"desLatency,omitempty" yaml:"desLatency,omitempty"`
	DesLoss        *int32 `json:"desLoss,omitempty" yaml:"desLoss,omitempty"`
}
...
func (o *M5QoSSpecification) GetMinDesBwDlBitRate() string {
	if o == nil || openapi.IsNil(o.MinDesBwDlBitRate) {
		var ret string
		return ret
	}
...
func (o *M5QoSSpecification) GetMinDesBwUlBitRate() string {
	if o == nil || openapi.IsNil(o.MinDesBwUlBitRate) {
		var ret string
		return ret
	}
...
func (o *M5QoSSpecification) GetDesLatency() int32 {
	if o == nil || openapi.IsNil(o.DesLatency) {
		var ret int32
		return ret
	}
	return *o.DesLatency
...
func (o *M5QoSSpecification) GetDesLoss() int32 {
	if o == nil || openapi.IsNil(o.DesLoss) {
		var ret int32
		return ret
	}
	return *o.DesLoss
...
func (o M5QoSSpecification) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.DesLatency) {
		toSerialize["desLatency"] = o.DesLatency
	}
	if !openapi.IsNil(o.DesLoss) {
