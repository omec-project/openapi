...
var _ openapi.MappedNullable = &ScpDomainRoutingInfoSubscription{}
...
func (o *ScpDomainRoutingInfoSubscription) GetReqInstanceId() string {
	if o == nil || openapi.IsNil(o.ReqInstanceId) {
		var ret string
		return ret
	}
...
func (o ScpDomainRoutingInfoSubscription) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["callbackUri"] = o.CallbackUri
	if !openapi.IsNil(o.ValidityTime) {
		toSerialize["validityTime"] = o.ValidityTime
	}
	if !openapi.IsNil(o.ReqInstanceId) {
