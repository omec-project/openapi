...
func Test_Nnrf_NFManagement_SharedDataDocumentAPIService(t *testing.T) {
	...
	t.Run("Test SharedDataDocumentAPIService RegisterSharedData", func(t *testing.T) {
		t.Skip("skip autogenerated mock test for operations with response bodies")
		t.Skip("skip autogenerated mock test for operations with required non-path parameter sharedData")
		var sharedDataId string
