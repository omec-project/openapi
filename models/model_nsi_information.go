...
var _ openapi.MappedNullable = &NsiInformation{}
...
type NsiInformation struct {
	...
	// String providing an URI formatted according to RFC 3986.
	NrfNfMgtUri *string `json:"nrfNfMgtUri,omitempty" yaml:"nrfNfMgtUri,omitempty"`
	// String providing an URI formatted according to RFC 3986.
...
func (o *NsiInformation) GetNrfNfMgtUri() string {
	if o == nil || openapi.IsNil(o.NrfNfMgtUri) {
		var ret string
		return ret
	}
