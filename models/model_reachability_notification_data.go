...
var _ openapi.MappedNullable = &ReachabilityNotificationData{}

// ReachabilityNotificationData Data within the UE Reachability Info Notify
type ReachabilityNotificationData struct {
	ReachableUeList   []ReachableUeInfo `json:"reachableUeList,omitempty" yaml:"reachableUeList,omitempty"`
	UnreachableUeList []string          `json:"unreachableUeList,omitempty" yaml:"unreachableUeList,omitempty"`
}
...
func (o *ReachabilityNotificationData) GetReachableUeList() []ReachableUeInfo {
	if o == nil || openapi.IsNil(o.ReachableUeList) {
...
func (o *ReachabilityNotificationData) GetUnreachableUeList() []string {
	if o == nil || openapi.IsNil(o.UnreachableUeList) {
		var ret []string
		return ret
	}
...
func (o ReachabilityNotificationData) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.ReachableUeList) {
		toSerialize["reachableUeList"] = o.ReachableUeList
	}
	if !openapi.IsNil(o.UnreachableUeList) {
