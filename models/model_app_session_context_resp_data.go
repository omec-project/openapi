...
var _ openapi.MappedNullable = &AppSessionContextRespData{}
...
type AppSessionContextRespData struct {
	ServAuthInfo *ServAuthInfo `json:"servAuthInfo,omitempty" yaml:"servAuthInfo,omitempty"`
	// QoS monitoring parameter(s) that cannot be directly notified for the indicated flows.
	DirectNotifReports []DirectNotificationReport `json:"directNotifReports,omitempty" yaml:"directNotifReports,omitempty"`
	UeIds              []UeIdentityInfo           `json:"ueIds,omitempty" yaml:"ueIds,omitempty"`
...
func (o *AppSessionContextRespData) GetServAuthInfo() ServAuthInfo {
	if o == nil || openapi.IsNil(o.ServAuthInfo) {
...
func (o *AppSessionContextRespData) GetDirectNotifReports() []DirectNotificationReport {
	if o == nil || openapi.IsNil(o.DirectNotifReports) {
...
func (o AppSessionContextRespData) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.ServAuthInfo) {
		toSerialize["servAuthInfo"] = o.ServAuthInfo
	}
	if !openapi.IsNil(o.DirectNotifReports) {
