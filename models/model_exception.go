...
var _ openapi.MappedNullable = &Exception{}

// Exception Represents the Exception information.
type Exception struct {
	ExcepId    ExceptionId     `json:"excepId" yaml:"excepId"`
	ExcepLevel *int32          `json:"excepLevel,omitempty" yaml:"excepLevel,omitempty"`
	ExcepTrend *ExceptionTrend `json:"excepTrend,omitempty" yaml:"excepTrend,omitempty"`
}
...
func (o *Exception) GetExcepLevel() int32 {
	if o == nil || openapi.IsNil(o.ExcepLevel) {
		var ret int32
		return ret
	}
	return *o.ExcepLevel
...
func (o *Exception) GetExcepTrend() ExceptionTrend {
	if o == nil || openapi.IsNil(o.ExcepTrend) {
...
func (o Exception) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["excepId"] = o.ExcepId
	if !openapi.IsNil(o.ExcepLevel) {
		toSerialize["excepLevel"] = o.ExcepLevel
	}
	if !openapi.IsNil(o.ExcepTrend) {
