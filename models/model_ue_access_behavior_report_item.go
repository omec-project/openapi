...
var _ openapi.MappedNullable = &UeAccessBehaviorReportItem{}

// UeAccessBehaviorReportItem Report Item for UE Access Behavior Trends event.
type UeAccessBehaviorReportItem struct {
	StateTransitionType AccessStateTransitionType `json:"stateTransitionType" yaml:"stateTransitionType"`
...
func (o UeAccessBehaviorReportItem) ToMap() (map[string]any, error) {
