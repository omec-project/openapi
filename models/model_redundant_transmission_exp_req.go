...
var _ openapi.MappedNullable = &RedundantTransmissionExpReq{}
...
type RedundantTransmissionExpReq struct {
	RedTOrderCriter *RedTransExpOrderingCriterion `json:"redTOrderCriter,omitempty" yaml:"redTOrderCriter,omitempty"`
...
func (o *RedundantTransmissionExpReq) GetRedTOrderCriter() RedTransExpOrderingCriterion {
	if o == nil || openapi.IsNil(o.RedTOrderCriter) {
...
func (o RedundantTransmissionExpReq) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.RedTOrderCriter) {
