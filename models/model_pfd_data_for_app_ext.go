...
var _ openapi.MappedNullable = &PfdDataForAppExt{}
...
type PfdDataForAppExt struct {
	...
	Pfds          []PfdContent `json:"pfds" yaml:"pfds"`
	// string with format 'date-time' as defined in OpenAPI.
	CachingTime *time.Time `json:"cachingTime,omitempty" yaml:"cachingTime,omitempty"`
	// indicating a time in seconds.
	CachingTimer *int32 `json:"cachingTimer,omitempty" yaml:"cachingTimer,omitempty"`
	...
	// indicating a time in seconds.
	AllowedDelay *int32 `json:"allowedDelay,omitempty" yaml:"allowedDelay,omitempty"`
}
...
func (o *PfdDataForAppExt) GetCachingTime() time.Time {
	if o == nil || openapi.IsNil(o.CachingTime) {
		var ret time.Time
		return ret
	}
...
func (o *PfdDataForAppExt) GetCachingTimer() int32 {
	if o == nil || openapi.IsNil(o.CachingTimer) {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *PfdDataForAppExt) GetCachingTimerOk() (*int32, bool) {
	if o == nil || openapi.IsNil(o.CachingTimer) {
		return nil, false
	}
...
func (o *PfdDataForAppExt) HasCachingTimer() bool {
	if o != nil && !openapi.IsNil(o.CachingTimer) {
		return true
	}
...
func (o *PfdDataForAppExt) SetCachingTimer(v int32) {
	o.CachingTimer = &v
}
...
func (o *PfdDataForAppExt) GetAllowedDelay() int32 {
	if o == nil || openapi.IsNil(o.AllowedDelay) {
		var ret int32
		return ret
	}
...
func (o PfdDataForAppExt) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["applicationId"] = o.ApplicationId
	toSerialize["pfds"] = o.Pfds
	if !openapi.IsNil(o.CachingTime) {
		toSerialize["cachingTime"] = o.CachingTime
	}
	if !openapi.IsNil(o.CachingTimer) {
	...
	if !openapi.IsNil(o.AllowedDelay) {
