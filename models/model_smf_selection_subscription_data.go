...
var _ openapi.MappedNullable = &SmfSelectionSubscriptionData{}
...
type SmfSelectionSubscriptionData struct {
	...
	SubscribedSnssaiInfos *map[string]SnssaiInfo `json:"subscribedSnssaiInfos,omitempty" yaml:"subscribedSnssaiInfos,omitempty"`
	SharedSnssaiInfosId   *string                `json:"sharedSnssaiInfosId,omitempty" yaml:"sharedSnssaiInfosId,omitempty" validate:"regexp=^[0-9]{5,6}-.+$"`
...
func (o *SmfSelectionSubscriptionData) GetSubscribedSnssaiInfos() map[string]SnssaiInfo {
	if o == nil || openapi.IsNil(o.SubscribedSnssaiInfos) {
...
func (o *SmfSelectionSubscriptionData) GetSharedSnssaiInfosId() string {
	if o == nil || openapi.IsNil(o.SharedSnssaiInfosId) {
		var ret string
		return ret
	}
...
func (o SmfSelectionSubscriptionData) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.SupportedFeatures) {
		toSerialize["supportedFeatures"] = o.SupportedFeatures
	}
	if !openapi.IsNil(o.SubscribedSnssaiInfos) {
		toSerialize["subscribedSnssaiInfos"] = o.SubscribedSnssaiInfos
	}
	if !openapi.IsNil(o.SharedSnssaiInfosId) {
