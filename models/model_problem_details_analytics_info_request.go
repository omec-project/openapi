...
var _ openapi.MappedNullable = &ProblemDetailsAnalyticsInfoRequest{}
...
func (o *ProblemDetailsAnalyticsInfoRequest) GetSupportedApiVersions() []string {
...
// and a boolean to check if the value has been set.
func (o *ProblemDetailsAnalyticsInfoRequest) GetSupportedApiVersionsOk() ([]string, bool) {
	if o == nil || openapi.IsNil(o.SupportedApiVersions) {
		return nil, false
	}
...
func (o *ProblemDetailsAnalyticsInfoRequest) HasSupportedApiVersions() bool {
	if o != nil && !openapi.IsNil(o.SupportedApiVersions) {
		return true
	}
...
func (o *ProblemDetailsAnalyticsInfoRequest) SetSupportedApiVersions(v []string) {
	o.SupportedApiVersions = v
}

// GetNoProfileMatchInfo returns the NoProfileMatchInfo field value if set, zero value otherwise.
func (o *ProblemDetailsAnalyticsInfoRequest) GetNoProfileMatchInfo() NoProfileMatchInfo {
...
// and a boolean to check if the value has been set.
func (o *ProblemDetailsAnalyticsInfoRequest) GetNoProfileMatchInfoOk() (*NoProfileMatchInfo, bool) {
	if o == nil || openapi.IsNil(o.NoProfileMatchInfo) {
		return nil, false
	}
...
func (o *ProblemDetailsAnalyticsInfoRequest) HasNoProfileMatchInfo() bool {
	if o != nil && !openapi.IsNil(o.NoProfileMatchInfo) {
		return true
	}
...
func (o *ProblemDetailsAnalyticsInfoRequest) SetNoProfileMatchInfo(v NoProfileMatchInfo) {
...
func (o ProblemDetailsAnalyticsInfoRequest) ToMap() (map[string]any, error) {
