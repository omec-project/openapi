...
var _ openapi.MappedNullable = &EnableGroupReachabilityRspData{}
...
type EnableGroupReachabilityRspData struct {
	UeConnectedList []string `json:"ueConnectedList,omitempty" yaml:"ueConnectedList,omitempty"`
...
func (o *EnableGroupReachabilityRspData) GetUeConnectedList() []string {
	if o == nil || openapi.IsNil(o.UeConnectedList) {
		var ret []string
		return ret
	}
...
func (o EnableGroupReachabilityRspData) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.UeConnectedList) {
