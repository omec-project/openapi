...
var _ openapi.MappedNullable = &VsmfUpdateData{}
...
type VsmfUpdateData struct {
	...
	QosFlowsAddModRequestList []QosFlowAddModifyRequestItem `json:"qosFlowsAddModRequestList,omitempty" yaml:"qosFlowsAddModRequestList,omitempty"`
	QosFlowsRelRequestList    []QosFlowReleaseRequestItem   `json:"qosFlowsRelRequestList,omitempty" yaml:"qosFlowsRelRequestList,omitempty"`
	EpsBearerInfo             []EpsBearerInfo               `json:"epsBearerInfo,omitempty" yaml:"epsBearerInfo,omitempty"`
	AssignEbiList             []Arp                         `json:"assignEbiList,omitempty" yaml:"assignEbiList,omitempty"`
	...
	HsmfPduSessionUri *string `json:"hsmfPduSessionUri,omitempty" yaml:"hsmfPduSessionUri,omitempty"`
	// String uniquely identifying a NF instance. The format of the NF Instance ID shall be a  Universally Unique Identifier (UUID) version 4, as described in IETF RFC 4122.
	NewSmfId *string `json:"newSmfId,omitempty" yaml:"newSmfId,omitempty"`
	// String providing an URI formatted according to RFC 3986.
	NewSmfPduSessionUri *string `json:"newSmfPduSessionUri,omitempty" yaml:"newSmfPduSessionUri,omitempty"`
	...
	N1smCause         *string `json:"n1smCause,omitempty" yaml:"n1smCause,omitempty"`
	// indicating a time in seconds.
	BackOffTimer                *int32               `json:"backOffTimer,omitempty" yaml:"backOffTimer,omitempty"`
	...
	SmallDataRateControlEnabled *bool                `json:"smallDataRateControlEnabled,omitempty" yaml:"smallDataRateControlEnabled,omitempty"`
	QosMonitoringInfo           *QosMonitoringInfo   `json:"qosMonitoringInfo,omitempty" yaml:"qosMonitoringInfo,omitempty"`
	EpsPdnCnxInfo               *EpsPdnCnxInfo       `json:"epsPdnCnxInfo,omitempty" yaml:"epsPdnCnxInfo,omitempty"`
	N9DataForwardingInd         *bool                `json:"n9DataForwardingInd,omitempty" yaml:"n9DataForwardingInd,omitempty"`
	// indicating a time in seconds.
	...
	PduSessionRetainInd   *bool               `json:"pduSessionRetainInd,omitempty" yaml:"pduSessionRetainInd,omitempty"`
...
func (o *VsmfUpdateData) GetQosFlowsAddModRequestList() []QosFlowAddModifyRequestItem {
	if o == nil || openapi.IsNil(o.QosFlowsAddModRequestList) {
...
func (o *VsmfUpdateData) GetQosFlowsRelRequestList() []QosFlowReleaseRequestItem {
	if o == nil || openapi.IsNil(o.QosFlowsRelRequestList) {
...
func (o *VsmfUpdateData) GetAssignEbiList() []Arp {
	if o == nil || openapi.IsNil(o.AssignEbiList) {
		var ret []Arp
		return ret
	}
...
func (o *VsmfUpdateData) GetHsmfPduSessionUri() string {
	if o == nil || openapi.IsNil(o.HsmfPduSessionUri) {
		var ret string
		return ret
	}
...
func (o *VsmfUpdateData) GetNewSmfId() string {
	if o == nil || openapi.IsNil(o.NewSmfId) {
		var ret string
		return ret
	}
	return *o.NewSmfId
...
func (o *VsmfUpdateData) GetNewSmfPduSessionUri() string {
	if o == nil || openapi.IsNil(o.NewSmfPduSessionUri) {
		var ret string
		return ret
	}
...
func (o *VsmfUpdateData) GetN1smCause() string {
	if o == nil || openapi.IsNil(o.N1smCause) {
		var ret string
		return ret
	}
	return *o.N1smCause
...
func (o *VsmfUpdateData) GetBackOffTimer() int32 {
	if o == nil || openapi.IsNil(o.BackOffTimer) {
		var ret int32
		return ret
	}
...
func (o *VsmfUpdateData) GetQosMonitoringInfo() QosMonitoringInfo {
	if o == nil || openapi.IsNil(o.QosMonitoringInfo) {
...
func (o *VsmfUpdateData) GetN9DataForwardingInd() bool {
	if o == nil || openapi.IsNil(o.N9DataForwardingInd) {
		var ret bool
		return ret
	}
...
func (o *VsmfUpdateData) GetHrsboInfo() HrsboInfoFromHplmn {
...
// and a boolean to check if the value has been set.
func (o *VsmfUpdateData) GetHrsboInfoOk() (*HrsboInfoFromHplmn, bool) {
	if o == nil || openapi.IsNil(o.HrsboInfo) {
		return nil, false
	}
...
func (o *VsmfUpdateData) HasHrsboInfo() bool {
	if o != nil && !openapi.IsNil(o.HrsboInfo) {
		return true
	}
...
func (o *VsmfUpdateData) SetHrsboInfo(v HrsboInfoFromHplmn) {
	o.HrsboInfo = &v
}

// GetAltHplmnSnssai returns the AltHplmnSnssai field value if set, zero value otherwise.
func (o *VsmfUpdateData) GetAltHplmnSnssai() Snssai {
...
// and a boolean to check if the value has been set.
func (o *VsmfUpdateData) GetAltHplmnSnssaiOk() (*Snssai, bool) {
	if o == nil || openapi.IsNil(o.AltHplmnSnssai) {
		return nil, false
	}
...
func (o *VsmfUpdateData) HasAltHplmnSnssai() bool {
	if o != nil && !openapi.IsNil(o.AltHplmnSnssai) {
		return true
	}
...
func (o *VsmfUpdateData) SetAltHplmnSnssai(v Snssai) {
	o.AltHplmnSnssai = &v
}

// GetPduSessionRetainInd returns the PduSessionRetainInd field value if set, zero value otherwise.
func (o *VsmfUpdateData) GetPduSessionRetainInd() bool {
	if o == nil || openapi.IsNil(o.PduSessionRetainInd) {
		var ret bool
		return ret
	}
	return *o.PduSessionRetainInd
}

// GetPduSessionRetainIndOk returns a tuple with the PduSessionRetainInd field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VsmfUpdateData) GetPduSessionRetainIndOk() (*bool, bool) {
	if o == nil || openapi.IsNil(o.PduSessionRetainInd) {
		return nil, false
	}
	return o.PduSessionRetainInd, true
}

// HasPduSessionRetainInd returns a boolean if a field has been set.
func (o *VsmfUpdateData) HasPduSessionRetainInd() bool {
	if o != nil && !openapi.IsNil(o.PduSessionRetainInd) {
		return true
	}
...
// SetPduSessionRetainInd gets a reference to the given bool and assigns it to the PduSessionRetainInd field.
func (o *VsmfUpdateData) SetPduSessionRetainInd(v bool) {
	o.PduSessionRetainInd = &v
}

// GetPendingUpdateInfoList returns the PendingUpdateInfoList field value if set, zero value otherwise.
func (o *VsmfUpdateData) GetPendingUpdateInfoList() []PendingUpdateInfo {
...
// and a boolean to check if the value has been set.
func (o *VsmfUpdateData) GetPendingUpdateInfoListOk() ([]PendingUpdateInfo, bool) {
	if o == nil || openapi.IsNil(o.PendingUpdateInfoList) {
		return nil, false
	}
...
func (o *VsmfUpdateData) HasPendingUpdateInfoList() bool {
	if o != nil && !openapi.IsNil(o.PendingUpdateInfoList) {
		return true
	}
...
func (o *VsmfUpdateData) SetPendingUpdateInfoList(v []PendingUpdateInfo) {
	o.PendingUpdateInfoList = v
}

func (o VsmfUpdateData) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.QosFlowsAddModRequestList) {
		toSerialize["qosFlowsAddModRequestList"] = o.QosFlowsAddModRequestList
	}
	if !openapi.IsNil(o.QosFlowsRelRequestList) {
	...
	if !openapi.IsNil(o.AssignEbiList) {
	...
	if !openapi.IsNil(o.HsmfPduSessionUri) {
		toSerialize["hsmfPduSessionUri"] = o.HsmfPduSessionUri
	}
	if !openapi.IsNil(o.NewSmfId) {
		toSerialize["newSmfId"] = o.NewSmfId
	}
	if !openapi.IsNil(o.NewSmfPduSessionUri) {
	...
	if !openapi.IsNil(o.N1smCause) {
		toSerialize["n1smCause"] = o.N1smCause
	}
	if !openapi.IsNil(o.BackOffTimer) {
	...
	if !openapi.IsNil(o.QosMonitoringInfo) {
	...
	if !openapi.IsNil(o.N9DataForwardingInd) {
	...
	if !openapi.IsNil(o.PduSessionRetainInd) {
		toSerialize["pduSessionRetainInd"] = o.PduSessionRetainInd
	}
