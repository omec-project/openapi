...
var _ openapi.MappedNullable = &UcSubscriptionData{}
...
type UcSubscriptionData struct {
	...
	UserConsentPerPurposeList *map[string]UserConsent `json:"userConsentPerPurposeList,omitempty" yaml:"userConsentPerPurposeList,omitempty"`
}
...
func (o *UcSubscriptionData) GetUserConsentPerPurposeList() map[string]UserConsent {
	if o == nil || openapi.IsNil(o.UserConsentPerPurposeList) {
...
func (o UcSubscriptionData) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.UserConsentPerPurposeList) {
