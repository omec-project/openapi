...
var _ openapi.MappedNullable = &ConfirmationData{}

// ConfirmationData Contains the result of the authentication.
type ConfirmationData struct {
	// Contains the RES*.
	ResStar openapi.NullableString `json:"resStar" yaml:"resStar" validate:"regexp=[A-Fa-f0-9]{32}"`
...
func NewConfirmationData(resStar openapi.NullableString) *ConfirmationData {
...
func (o ConfirmationData) ToMap() (map[string]any, error) {
