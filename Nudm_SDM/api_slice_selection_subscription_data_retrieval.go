...
type SliceSelectionSubscriptionDataRetrievalAPI interface {
	...
	*/
	GetNSSAI(ctx context.Context, supi string) ApiGetNSSAIRequest

	// GetNSSAIExecute executes the request
	//   @return Nssai
	GetNSSAIExecute(r ApiGetNSSAIRequest) (*models.Nssai, *http.Response, error)
}
...
type ApiGetNSSAIRequest struct {
	ctx                context.Context
	ApiService         SliceSelectionSubscriptionDataRetrievalAPI
	supi               string
...
// serving PLMN ID
func (r ApiGetNSSAIRequest) PlmnId(plmnId models.PlmnId) ApiGetNSSAIRequest {
	r.plmnId = &plmnId
	return r
}
...
func (r ApiGetNSSAIRequest) Execute() (*models.Nssai, *http.Response, error) {
...
//
//	@return Nssai
func (a *SliceSelectionSubscriptionDataRetrievalAPIService) GetNSSAIExecute(r ApiGetNSSAIRequest) (*models.Nssai, *http.Response, error) {
	var (
