...
var _ openapi.MappedNullable = &SubscriptionData{}
...
type SubscriptionData struct {
	NfStatusNotificationUri string `json:"nfStatusNotificationUri" yaml:"nfStatusNotificationUri"`
	...
	ReqSnpnList       []PlmnIdNid  `json:"reqSnpnList,omitempty" yaml:"reqSnpnList,omitempty"`
	...
	RequesterFeatures *string `json:"requesterFeatures,omitempty" yaml:"requesterFeatures,omitempty" validate:"regexp=^[A-Fa-f0-9]*$"`
	// A string used to indicate the features supported by an API that is used as defined in clause  6.6 in 3GPP TS 29.500. The string shall contain a bitmask indicating supported features in  hexadecimal representation Each character in the string shall take a value of \"0\" to \"9\",  \"a\" to \"f\" or \"A\" to \"F\" and shall represent the support of 4 features as described in  table 5.2.2-3. The most significant character representing the highest-numbered features shall  appear first in the string, and the character representing features 1 to 4 shall appear last  in the string. The list of features and their numbering (starting with 1) are defined  separately for each API. If the string contains a lower number of characters than there are  defined features for an API, all features that would be represented by characters that are not  present in the string are not supported.
	...
	CompleteProfileSubscription *bool                             `json:"completeProfileSubscription,omitempty" yaml:"completeProfileSubscription,omitempty"`
}
...
func (o *SubscriptionData) GetReqNfInstanceId() string {
	if o == nil || openapi.IsNil(o.ReqNfInstanceId) {
		var ret string
		return ret
	}
...
// GetSharedDataIds returns the SharedDataIds field value if set, zero value otherwise.
func (o *SubscriptionData) GetSharedDataIds() []string {
	if o == nil || openapi.IsNil(o.SharedDataIds) {
		var ret []string
		return ret
	}
...
// GetSharedDataIdsOk returns a tuple with the SharedDataIds field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetSharedDataIds gets a reference to the given []string and assigns it to the SharedDataIds field.
...
func (o *SubscriptionData) GetSubscrCond() SubscrCond {
	if o == nil || openapi.IsNil(o.SubscrCond) {
		var ret SubscrCond
		return ret
	}
	return *o.SubscrCond
...
func (o *SubscriptionData) GetReqNotifEvents() []NotificationEventType {
	if o == nil || openapi.IsNil(o.ReqNotifEvents) {
...
func (o *SubscriptionData) GetNotifCondition() NotifCondition {
	if o == nil || openapi.IsNil(o.NotifCondition) {
...
func (o *SubscriptionData) GetReqNfType() NFType {
	if o == nil || openapi.IsNil(o.ReqNfType) {
		var ret NFType
		return ret
	}
	return *o.ReqNfType
...
func (o *SubscriptionData) GetReqNfFqdn() string {
	if o == nil || openapi.IsNil(o.ReqNfFqdn) {
		var ret string
		return ret
	}
	return *o.ReqNfFqdn
...
func (o *SubscriptionData) GetReqSnssais() []Snssai {
	if o == nil || openapi.IsNil(o.ReqSnssais) {
		var ret []Snssai
		return ret
	}
	return o.ReqSnssais
...
func (o *SubscriptionData) GetReqPerPlmnSnssais() []PlmnSnssai {
	if o == nil || openapi.IsNil(o.ReqPerPlmnSnssais) {
		var ret []PlmnSnssai
		return ret
	}
...
func (o *SubscriptionData) GetReqPlmnList() []PlmnId {
	if o == nil || openapi.IsNil(o.ReqPlmnList) {
		var ret []PlmnId
		return ret
	}
...
func (o *SubscriptionData) GetReqSnpnList() []PlmnIdNid {
	if o == nil || openapi.IsNil(o.ReqSnpnList) {
		var ret []PlmnIdNid
		return ret
	}
...
func (o *SubscriptionData) GetRequesterFeatures() string {
	if o == nil || openapi.IsNil(o.RequesterFeatures) {
		var ret string
		return ret
	}
...
func (o *SubscriptionData) GetHnrfUri() string {
	if o == nil || openapi.IsNil(o.HnrfUri) {
		var ret string
		return ret
	}
	return *o.HnrfUri
...
func (o *SubscriptionData) GetOnboardingCapability() bool {
	if o == nil || openapi.IsNil(o.OnboardingCapability) {
		var ret bool
		return ret
	}
...
func (o *SubscriptionData) GetTargetHni() string {
	if o == nil || openapi.IsNil(o.TargetHni) {
		var ret string
		return ret
	}
	return *o.TargetHni
...
func (o *SubscriptionData) GetPreferredLocality() string {
	if o == nil || openapi.IsNil(o.PreferredLocality) {
		var ret string
		return ret
	}
...
func (o *SubscriptionData) GetExtPreferredLocality() map[string][]LocalityDescription {
	if o == nil || openapi.IsNil(o.ExtPreferredLocality) {
...
func (o *SubscriptionData) GetCompleteProfileSubscription() bool {
	if o == nil || openapi.IsNil(o.CompleteProfileSubscription) {
		var ret bool
		return ret
	}
...
func (o SubscriptionData) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.ReqNotifEvents) {
