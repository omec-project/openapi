...
var _ openapi.MappedNullable = &QosMonitoringInfo{}

// QosMonitoringInfo QoS Monitoring Information
type QosMonitoringInfo struct {
	QosMonitoringInd *bool `json:"qosMonitoringInd,omitempty" yaml:"qosMonitoringInd,omitempty"`
}
...
func (o *QosMonitoringInfo) GetQosMonitoringInd() bool {
	if o == nil || openapi.IsNil(o.QosMonitoringInd) {
		var ret bool
		return ret
	}
...
func (o QosMonitoringInfo) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.QosMonitoringInd) {
