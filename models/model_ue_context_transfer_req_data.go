...
var _ openapi.MappedNullable = &UeContextTransferReqData{}
...
type UeContextTransferReqData struct {
	Reason     TransferReason      `json:"reason" yaml:"reason"`
	AccessType AccessType          `json:"accessType" yaml:"accessType"`
	PlmnId     *PlmnIdNid          `json:"plmnId,omitempty" yaml:"plmnId,omitempty"`
	RegRequest *N1MessageContainer `json:"regRequest,omitempty" yaml:"regRequest,omitempty"`
...
func (o *UeContextTransferReqData) GetRegRequest() N1MessageContainer {
	if o == nil || openapi.IsNil(o.RegRequest) {
...
func (o UeContextTransferReqData) ToMap() (map[string]any, error) {
