...
var _ openapi.MappedNullable = &PacketFilterInfo{}
...
type PacketFilterInfo struct {
	...
	PackFiltCont *string `json:"packFiltCont,omitempty" yaml:"packFiltCont,omitempty"`
	// Contains the Ipv4 Type-of-Service and mask field or the Ipv6 Traffic-Class field and mask field.
	TosTrafficClass *string `json:"tosTrafficClass,omitempty" yaml:"tosTrafficClass,omitempty"`
	// The security parameter index of the IPSec packet.
	Spi *string `json:"spi,omitempty" yaml:"spi,omitempty"`
	// The Ipv6 flow label header field.
	FlowLabel     *string        `json:"flowLabel,omitempty" yaml:"flowLabel,omitempty"`
	FlowDirection *FlowDirection `json:"flowDirection,omitempty" yaml:"flowDirection,omitempty"`
}
...
func (o *PacketFilterInfo) GetPackFiltCont() string {
	if o == nil || openapi.IsNil(o.PackFiltCont) {
		var ret string
		return ret
	}
...
func (o *PacketFilterInfo) GetTosTrafficClass() string {
	if o == nil || openapi.IsNil(o.TosTrafficClass) {
		var ret string
		return ret
	}
...
func (o *PacketFilterInfo) GetFlowLabel() string {
	if o == nil || openapi.IsNil(o.FlowLabel) {
		var ret string
		return ret
	}
	return *o.FlowLabel
