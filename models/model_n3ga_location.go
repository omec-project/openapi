...
var _ openapi.MappedNullable = &N3gaLocation{}
...
type N3gaLocation struct {
	...
	HfcNodeId  *HfcNodeId         `json:"hfcNodeId,omitempty" yaml:"hfcNodeId,omitempty"`
...
func (o *N3gaLocation) GetN3gppTai() Tai {
	if o == nil || openapi.IsNil(o.N3gppTai) {
		var ret Tai
		return ret
	}
	return *o.N3gppTai
...
func (o *N3gaLocation) GetUeIpv6Addr() string {
	if o == nil || openapi.IsNil(o.UeIpv6Addr) {
		var ret string
		return ret
	}
	return *o.UeIpv6Addr
...
// and a boolean to check if the value has been set.
func (o *N3gaLocation) GetUeIpv6AddrOk() (*string, bool) {
	if o == nil || openapi.IsNil(o.UeIpv6Addr) {
		return nil, false
	}
...
func (o *N3gaLocation) SetUeIpv6Addr(v string) {
	o.UeIpv6Addr = &v
}
...
func (o *N3gaLocation) GetProtocol() TransportProtocol {
	if o == nil || openapi.IsNil(o.Protocol) {
...
func (o *N3gaLocation) GetHfcNodeId() HfcNodeId {
	if o == nil || openapi.IsNil(o.HfcNodeId) {
		var ret HfcNodeId
		return ret
	}
	return *o.HfcNodeId
...
func (o *N3gaLocation) GetW5gbanLineType() LineType {
	if o == nil || openapi.IsNil(o.W5gbanLineType) {
		var ret LineType
		return ret
	}
...
func (o N3gaLocation) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.N3gppTai) {
	...
	if !openapi.IsNil(o.HfcNodeId) {
		toSerialize["hfcNodeId"] = o.HfcNodeId
	}
	if !openapi.IsNil(o.Gli) {
		toSerialize["gli"] = o.Gli
	}
	if !openapi.IsNil(o.W5gbanLineType) {
		toSerialize["w5gbanLineType"] = o.W5gbanLineType
	}
	if !openapi.IsNil(o.Gci) {
