...
var _ openapi.MappedNullable = &CommunicationCharacteristics{}

// CommunicationCharacteristics struct for CommunicationCharacteristics
type CommunicationCharacteristics struct {
	PpSubsRegTimer        NullablePpSubsRegTimer        `json:"ppSubsRegTimer" yaml:"ppSubsRegTimer,omitempty"`
	PpActiveTime          NullablePpActiveTime          `json:"ppActiveTime" yaml:"ppActiveTime,omitempty"`
	PpDlPacketCount       openapi.NullableInt32         `json:"ppDlPacketCount" yaml:"ppDlPacketCount,omitempty"`
	PpDlPacketCountExt    NullablePpDlPacketCountExt    `json:"ppDlPacketCountExt" yaml:"ppDlPacketCountExt,omitempty"`
	PpMaximumResponseTime NullablePpMaximumResponseTime `json:"ppMaximumResponseTime" yaml:"ppMaximumResponseTime,omitempty"`
	PpMaximumLatency      NullablePpMaximumLatency      `json:"ppMaximumLatency" yaml:"ppMaximumLatency,omitempty"`
}
...
func (o *CommunicationCharacteristics) GetPpSubsRegTimer() PpSubsRegTimer {
	if o == nil || openapi.IsNil(o.PpSubsRegTimer.Get()) {
...
func (o *CommunicationCharacteristics) GetPpActiveTime() PpActiveTime {
	if o == nil || openapi.IsNil(o.PpActiveTime.Get()) {
...
func (o *CommunicationCharacteristics) GetPpDlPacketCount() int32 {
	if o == nil || openapi.IsNil(o.PpDlPacketCount.Get()) {
		var ret int32
		return ret
	}
...
// SetPpDlPacketCount gets a reference to the given openapi.NullableInt32 and assigns it to the PpDlPacketCount field.
...
func (o *CommunicationCharacteristics) GetPpDlPacketCountExt() PpDlPacketCountExt {
	if o == nil || openapi.IsNil(o.PpDlPacketCountExt.Get()) {
...
func (o *CommunicationCharacteristics) GetPpMaximumResponseTime() PpMaximumResponseTime {
	if o == nil || openapi.IsNil(o.PpMaximumResponseTime.Get()) {
...
func (o *CommunicationCharacteristics) GetPpMaximumLatency() PpMaximumLatency {
	if o == nil || openapi.IsNil(o.PpMaximumLatency.Get()) {
...
func (o CommunicationCharacteristics) ToMap() (map[string]any, error) {
