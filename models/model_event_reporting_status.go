...
var _ openapi.MappedNullable = &EventReportingStatus{}
...
type EventReportingStatus struct {
	...
	EventReportCounter *int32 `json:"eventReportCounter,omitempty" yaml:"eventReportCounter,omitempty"`
	// Duration of event reporting.
	EventReportDuration *int32 `json:"eventReportDuration,omitempty" yaml:"eventReportDuration,omitempty"`
}
...
func (o *EventReportingStatus) GetEventReportCounter() int32 {
	if o == nil || openapi.IsNil(o.EventReportCounter) {
		var ret int32
		return ret
	}
...
func (o *EventReportingStatus) GetEventReportDuration() int32 {
	if o == nil || openapi.IsNil(o.EventReportDuration) {
		var ret int32
		return ret
	}
...
func (o EventReportingStatus) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.EventReportCounter) {
		toSerialize["eventReportCounter"] = o.EventReportCounter
	}
	if !openapi.IsNil(o.EventReportDuration) {
