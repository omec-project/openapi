...
var _ openapi.MappedNullable = &QosMonitoringInformationRm{}
...
type QosMonitoringInformationRm struct {
	...
	// Unsigned Integer, i.e. only value 0 and integers above 0 are permissible with the OpenAPI 'nullable: true' property.
	ConThreshUl openapi.NullableInt32 `json:"conThreshUl" yaml:"conThreshUl,omitempty"`
}
...
func (o *QosMonitoringInformationRm) GetConThreshDl() int32 {
	if o == nil || openapi.IsNil(o.ConThreshDl.Get()) {
		var ret int32
		return ret
	}
...
// SetConThreshDl gets a reference to the given openapi.NullableInt32 and assigns it to the ConThreshDl field.
...
func (o *QosMonitoringInformationRm) GetConThreshUl() int32 {
	if o == nil || openapi.IsNil(o.ConThreshUl.Get()) {
		var ret int32
		return ret
	}
...
// SetConThreshUl gets a reference to the given openapi.NullableInt32 and assigns it to the ConThreshUl field.
...
func (o QosMonitoringInformationRm) ToMap() (map[string]any, error) {
