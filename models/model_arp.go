...
var _ openapi.MappedNullable = &Arp{}
...
type Arp struct {
	...
	PriorityLevel openapi.NullableInt32   `json:"priorityLevel" yaml:"priorityLevel"`
	PreemptCap    PreemptionCapability    `json:"preemptCap" yaml:"preemptCap"`
	PreemptVuln   PreemptionVulnerability `json:"preemptVuln" yaml:"preemptVuln"`
}
...
func NewArp(priorityLevel openapi.NullableInt32, preemptCap PreemptionCapability, preemptVuln PreemptionVulnerability) *Arp {
	this := Arp{}
