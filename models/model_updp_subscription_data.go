...
var _ openapi.MappedNullable = &UpdpSubscriptionData{}
...
type UpdpSubscriptionData struct {
	UpdpNotifySubscriptionId string `json:"updpNotifySubscriptionId" yaml:"updpNotifySubscriptionId"`
	// String providing an URI formatted according to RFC 3986.
	UpdpNotifyCallbackUri string `json:"updpNotifyCallbackUri" yaml:"updpNotifyCallbackUri"`
	...
	UpdpCallbackBinding *string `json:"updpCallbackBinding,omitempty" yaml:"updpCallbackBinding,omitempty"`
}
...
func (o *UpdpSubscriptionData) GetUpdpCallbackBinding() string {
	if o == nil || openapi.IsNil(o.UpdpCallbackBinding) {
		var ret string
		return ret
	}
...
func (o UpdpSubscriptionData) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.UpdpCallbackBinding) {
