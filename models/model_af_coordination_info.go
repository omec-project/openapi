...
var _ openapi.MappedNullable = &AfCoordinationInfo{}
...
func (o *AfCoordinationInfo) GetSourceUeIpv6Prefix() string {
...
// and a boolean to check if the value has been set.
func (o *AfCoordinationInfo) GetSourceUeIpv6PrefixOk() (*string, bool) {
	if o == nil || openapi.IsNil(o.SourceUeIpv6Prefix) {
		return nil, false
	}
...
func (o *AfCoordinationInfo) SetSourceUeIpv6Prefix(v string) {
...
func (o *AfCoordinationInfo) GetNotificationInfoList() []NotificationInfo {
	if o == nil || openapi.IsNil(o.NotificationInfoList) {
...
func (o AfCoordinationInfo) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.NotificationInfoList) {
