...
var _ openapi.MappedNullable = &AreaScope{}

// AreaScope Contain the area based on Cells or Tracking Areas.
type AreaScope struct {
	EutraCellIdList []string `json:"eutraCellIdList,omitempty" yaml:"eutraCellIdList,omitempty"`
	...
	TacInfoPerPlmn *map[string]TacInfo `json:"tacInfoPerPlmn,omitempty" yaml:"tacInfoPerPlmn,omitempty"`
	// A map (list of key-value pairs) where PlmnId converted to a string serves as key
	CagInfoPerPlmn *map[string]CagInfo `json:"cagInfoPerPlmn,omitempty" yaml:"cagInfoPerPlmn,omitempty"`
	// A map (list of key-value pairs) where PlmnId converted to a string serves as key
	NidInfoPerPlmn *map[string]NidInfo `json:"nidInfoPerPlmn,omitempty" yaml:"nidInfoPerPlmn,omitempty"`
}
...
func (o *AreaScope) GetEutraCellIdList() []string {
	if o == nil || openapi.IsNil(o.EutraCellIdList) {
		var ret []string
		return ret
	}
...
func (o *AreaScope) GetTacInfoPerPlmn() map[string]TacInfo {
	if o == nil || openapi.IsNil(o.TacInfoPerPlmn) {
...
// GetCagInfoPerPlmn returns the CagInfoPerPlmn field value if set, zero value otherwise.
func (o *AreaScope) GetCagInfoPerPlmn() map[string]CagInfo {
	if o == nil || openapi.IsNil(o.CagInfoPerPlmn) {
		var ret map[string]CagInfo
		return ret
	}
	return *o.CagInfoPerPlmn
}

// GetCagInfoPerPlmnOk returns a tuple with the CagInfoPerPlmn field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AreaScope) GetCagInfoPerPlmnOk() (*map[string]CagInfo, bool) {
	if o == nil || openapi.IsNil(o.CagInfoPerPlmn) {
		return nil, false
	}
	return o.CagInfoPerPlmn, true
}
...
// SetCagInfoPerPlmn gets a reference to the given map[string]CagInfo and assigns it to the CagInfoPerPlmn field.
func (o *AreaScope) SetCagInfoPerPlmn(v map[string]CagInfo) {
	o.CagInfoPerPlmn = &v
}

// GetNidInfoPerPlmn returns the NidInfoPerPlmn field value if set, zero value otherwise.
func (o *AreaScope) GetNidInfoPerPlmn() map[string]NidInfo {
	if o == nil || openapi.IsNil(o.NidInfoPerPlmn) {
		var ret map[string]NidInfo
		return ret
	}
	return *o.NidInfoPerPlmn
}

// GetNidInfoPerPlmnOk returns a tuple with the NidInfoPerPlmn field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AreaScope) GetNidInfoPerPlmnOk() (*map[string]NidInfo, bool) {
	if o == nil || openapi.IsNil(o.NidInfoPerPlmn) {
		return nil, false
	}
	return o.NidInfoPerPlmn, true
}
...
// SetNidInfoPerPlmn gets a reference to the given map[string]NidInfo and assigns it to the NidInfoPerPlmn field.
func (o *AreaScope) SetNidInfoPerPlmn(v map[string]NidInfo) {
	o.NidInfoPerPlmn = &v
}

func (o AreaScope) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.EutraCellIdList) {
	...
	if !openapi.IsNil(o.TacInfoPerPlmn) {
		toSerialize["tacInfoPerPlmn"] = o.TacInfoPerPlmn
	}
	if !openapi.IsNil(o.CagInfoPerPlmn) {
		toSerialize["cagInfoPerPlmn"] = o.CagInfoPerPlmn
	}
	if !openapi.IsNil(o.NidInfoPerPlmn) {
		toSerialize["nidInfoPerPlmn"] = o.NidInfoPerPlmn
	}
