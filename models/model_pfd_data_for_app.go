...
var _ openapi.MappedNullable = &PfdDataForApp{}
...
type PfdDataForApp struct {
	...
	// string with format 'date-time' as defined in OpenAPI.
	PfdTimestamp *time.Time `json:"pfdTimestamp,omitempty" yaml:"pfdTimestamp,omitempty"`
...
func (o *PfdDataForApp) GetPfdTimestamp() time.Time {
	if o == nil || openapi.IsNil(o.PfdTimestamp) {
		var ret time.Time
		return ret
	}
...
func (o *PfdDataForApp) GetPartialFlag() bool {
	if o == nil || openapi.IsNil(o.PartialFlag) {
		var ret bool
		return ret
	}
...
func (o PfdDataForApp) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["applicationId"] = o.ApplicationId
	if !openapi.IsNil(o.Pfds) {
	...
	if !openapi.IsNil(o.PfdTimestamp) {
		toSerialize["pfdTimestamp"] = o.PfdTimestamp
	}
	if !openapi.IsNil(o.PartialFlag) {
