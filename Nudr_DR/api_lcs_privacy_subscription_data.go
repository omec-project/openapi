...
type LCSPrivacySubscriptionDataAPI interface {
	...
	*/
	...
	QueryLcsPrivacyDataExecute(r ApiQueryLcsPrivacyDataRequest) (*models.LcsPrivacyData, *http.Response, error)
}
...
func (r ApiQueryLcsPrivacyDataRequest) Execute() (*models.LcsPrivacyData, *http.Response, error) {
...
//
//	@return LcsPrivacyData
func (a *LCSPrivacySubscriptionDataAPIService) QueryLcsPrivacyDataExecute(r ApiQueryLcsPrivacyDataRequest) (*models.LcsPrivacyData, *http.Response, error) {
	var (
