...
var _ openapi.MappedNullable = &UEContextTransfer200Response{}

// UEContextTransfer200Response struct for UEContextTransfer200Response
type UEContextTransfer200Response struct {
	JsonData                    *UeContextTransferRspData `json:"jsonData,omitempty" yaml:"jsonData,omitempty" multipart:"contentType:application/json,ref:{jsonData}"`
...
func (o UEContextTransfer200Response) ToMap() (map[string]any, error) {
