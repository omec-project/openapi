...
type MessageWaitingDataDocumentAPI interface {
	...
	*/
	CreateMessageWaitingData(ctx context.Context, ueId string) ApiCreateMessageWaitingDataRequest

	// CreateMessageWaitingDataExecute executes the request
	//   @return MessageWaitingData
	CreateMessageWaitingDataExecute(r ApiCreateMessageWaitingDataRequest) (*models.MessageWaitingData, *http.Response, error)
	...
	*/
	DeleteMessageWaitingData(ctx context.Context, ueId string) ApiDeleteMessageWaitingDataRequest

	// DeleteMessageWaitingDataExecute executes the request
	DeleteMessageWaitingDataExecute(r ApiDeleteMessageWaitingDataRequest) (*http.Response, error)
	...
	*/
	ModifyMessageWaitingData(ctx context.Context, ueId string) ApiModifyMessageWaitingDataRequest

	// ModifyMessageWaitingDataExecute executes the request
	ModifyMessageWaitingDataExecute(r ApiModifyMessageWaitingDataRequest) (*http.Response, error)
	...
	*/
	QueryMessageWaitingData(ctx context.Context, ueId string) ApiQueryMessageWaitingDataRequest

	// QueryMessageWaitingDataExecute executes the request
	//   @return MessageWaitingData
	QueryMessageWaitingDataExecute(r ApiQueryMessageWaitingDataRequest) (*models.MessageWaitingData, *http.Response, error)
}
...
type ApiCreateMessageWaitingDataRequest struct {
	ctx                context.Context
	ApiService         MessageWaitingDataDocumentAPI
	ueId               string
	messageWaitingData *models.MessageWaitingData
}

func (r ApiCreateMessageWaitingDataRequest) MessageWaitingData(messageWaitingData models.MessageWaitingData) ApiCreateMessageWaitingDataRequest {
	r.messageWaitingData = &messageWaitingData
	return r
}

func (r ApiCreateMessageWaitingDataRequest) Execute() (*models.MessageWaitingData, *http.Response, error) {
...
//
//	@return MessageWaitingData
func (a *MessageWaitingDataDocumentAPIService) CreateMessageWaitingDataExecute(r ApiCreateMessageWaitingDataRequest) (*models.MessageWaitingData, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPut
		localVarPostBody    any
		formFiles           []formFile
		localVarReturnValue *models.MessageWaitingData
	)
	...
	if r.messageWaitingData == nil {
		return localVarReturnValue, nil, openapi.ReportError("messageWaitingData is required and must be specified")
	}
...
func (r ApiModifyMessageWaitingDataRequest) PatchItem(patchItem []models.PatchItem) ApiModifyMessageWaitingDataRequest {
...
func (r ApiQueryMessageWaitingDataRequest) Execute() (*models.MessageWaitingData, *http.Response, error) {
...
//
//	@return MessageWaitingData
func (a *MessageWaitingDataDocumentAPIService) QueryMessageWaitingDataExecute(r ApiQueryMessageWaitingDataRequest) (*models.MessageWaitingData, *http.Response, error) {
	var (
