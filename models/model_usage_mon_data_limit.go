...
var _ openapi.MappedNullable = &UsageMonDataLimit{}
...
type UsageMonDataLimit struct {
	...
	Scopes  *map[string]UsageMonDataScope `json:"scopes,omitempty" yaml:"scopes,omitempty"`
	UmLevel *UsageMonLevel                `json:"umLevel,omitempty" yaml:"umLevel,omitempty"`
	...
	UsageLimit  *UsageThreshold `json:"usageLimit,omitempty" yaml:"usageLimit,omitempty"`
	ResetPeriod *TimePeriod     `json:"resetPeriod,omitempty" yaml:"resetPeriod,omitempty"`
}
...
func (o *UsageMonDataLimit) GetUmLevel() UsageMonLevel {
	if o == nil || openapi.IsNil(o.UmLevel) {
...
func (o *UsageMonDataLimit) GetStartDate() time.Time {
	if o == nil || openapi.IsNil(o.StartDate) {
		var ret time.Time
		return ret
	}
	return *o.StartDate
...
func (o *UsageMonDataLimit) GetEndDate() time.Time {
	if o == nil || openapi.IsNil(o.EndDate) {
		var ret time.Time
		return ret
	}
	return *o.EndDate
...
func (o *UsageMonDataLimit) GetUsageLimit() UsageThreshold {
	if o == nil || openapi.IsNil(o.UsageLimit) {
...
func (o *UsageMonDataLimit) GetResetPeriod() TimePeriod {
	if o == nil || openapi.IsNil(o.ResetPeriod) {
		var ret TimePeriod
		return ret
	}
...
func (o UsageMonDataLimit) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["limitId"] = o.LimitId
	if !openapi.IsNil(o.Scopes) {
		toSerialize["scopes"] = o.Scopes
	}
	if !openapi.IsNil(o.UmLevel) {
		toSerialize["umLevel"] = o.UmLevel
	}
	if !openapi.IsNil(o.StartDate) {
		toSerialize["startDate"] = o.StartDate
	}
	if !openapi.IsNil(o.EndDate) {
		toSerialize["endDate"] = o.EndDate
	}
	if !openapi.IsNil(o.UsageLimit) {
		toSerialize["usageLimit"] = o.UsageLimit
	}
	if !openapi.IsNil(o.ResetPeriod) {
