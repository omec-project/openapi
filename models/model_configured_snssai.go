...
var _ openapi.MappedNullable = &ConfiguredSnssai{}
...
type ConfiguredSnssai struct {
	ConfiguredSnssai Snssai  `json:"configuredSnssai" yaml:"configuredSnssai"`
...
func (o ConfiguredSnssai) ToMap() (map[string]any, error) {
