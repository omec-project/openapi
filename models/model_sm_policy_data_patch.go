...
var _ openapi.MappedNullable = &SmPolicyDataPatch{}
...
type SmPolicyDataPatch struct {
	...
	SmPolicySnssaiData *map[string]SmPolicySnssaiDataPatch `json:"smPolicySnssaiData,omitempty" yaml:"smPolicySnssaiData,omitempty"`
}
...
func (o *SmPolicyDataPatch) GetSmPolicySnssaiData() map[string]SmPolicySnssaiDataPatch {
	if o == nil || openapi.IsNil(o.SmPolicySnssaiData) {
...
func (o SmPolicyDataPatch) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if o.UmData != nil {
		toSerialize["umData"] = o.UmData
	}
	if !openapi.IsNil(o.SmPolicySnssaiData) {
