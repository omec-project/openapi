...
type QosData struct {
	...
	// This data type is defined in the same way as the 'fiveQiPriorityLevel' data type, but with the OpenAPI 'nullable: true' property.
	PriorityLevel openapi.NullableInt32 `json:"priorityLevel" yaml:"priorityLevel,omitempty"`
	...
	PacketErrorRate *string                 `json:"packetErrorRate,omitempty" yaml:"packetErrorRate,omitempty" validate:"regexp=^([0-9]E-[0-9])$"`
...
func NewQosData(qosId string) *QosData {
	...
	this.AverWindow = *openapi.NewNullableInt32(&averWindow)
	return &this
}
...
func (o *QosData) GetMaxbrUl() string {
	if o == nil || openapi.IsNil(o.MaxbrUl.Get()) {
		var ret string
		return ret
	}
...
// SetMaxbrUl gets a reference to the given openapi.NullableString and assigns it to the MaxbrUl field.
...
func (o *QosData) GetMaxbrDl() string {
	if o == nil || openapi.IsNil(o.MaxbrDl.Get()) {
		var ret string
		return ret
	}
...
// SetMaxbrDl gets a reference to the given openapi.NullableString and assigns it to the MaxbrDl field.
...
func (o *QosData) GetGbrUl() string {
	if o == nil || openapi.IsNil(o.GbrUl.Get()) {
		var ret string
		return ret
	}
	return *o.GbrUl.Get()
...
// SetGbrUl gets a reference to the given openapi.NullableString and assigns it to the GbrUl field.
...
func (o *QosData) GetGbrDl() string {
	if o == nil || openapi.IsNil(o.GbrDl.Get()) {
		var ret string
		return ret
	}
	return *o.GbrDl.Get()
...
// SetGbrDl gets a reference to the given openapi.NullableString and assigns it to the GbrDl field.
...
func (o *QosData) GetPriorityLevel() int32 {
	if o == nil || openapi.IsNil(o.PriorityLevel.Get()) {
		var ret int32
		return ret
	}
...
// SetPriorityLevel gets a reference to the given openapi.NullableInt32 and assigns it to the PriorityLevel field.
...
func (o *QosData) GetAverWindow() int32 {
	if o == nil || openapi.IsNil(o.AverWindow.Get()) {
		var ret int32
		return ret
	}
...
// SetAverWindow gets a reference to the given openapi.NullableInt32 and assigns it to the AverWindow field.
...
func (o *QosData) GetMaxDataBurstVol() int32 {
	if o == nil || openapi.IsNil(o.MaxDataBurstVol.Get()) {
		var ret int32
		return ret
	}
...
// SetMaxDataBurstVol gets a reference to the given openapi.NullableInt32 and assigns it to the MaxDataBurstVol field.
...
func (o *QosData) GetReflectiveQos() bool {
	if o == nil || openapi.IsNil(o.ReflectiveQos) {
		var ret bool
		return ret
	}
...
func (o *QosData) GetDefQosFlowIndication() bool {
	if o == nil || openapi.IsNil(o.DefQosFlowIndication) {
		var ret bool
		return ret
	}
...
func (o *QosData) GetExtMaxDataBurstVol() int32 {
	if o == nil || openapi.IsNil(o.ExtMaxDataBurstVol.Get()) {
		var ret int32
		return ret
	}
...
// SetExtMaxDataBurstVol gets a reference to the given openapi.NullableInt32 and assigns it to the ExtMaxDataBurstVol field.
...
func (o *QosData) GetPacketErrorRate() string {
	if o == nil || openapi.IsNil(o.PacketErrorRate) {
		var ret string
		return ret
	}
...
func (o QosData) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.ReflectiveQos) {
	...
	if !openapi.IsNil(o.DefQosFlowIndication) {
	...
	if !openapi.IsNil(o.PacketErrorRate) {
