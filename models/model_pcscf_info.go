...
var _ openapi.MappedNullable = &PcscfInfo{}
...
type PcscfInfo struct {
	...
	ServedIpv6PrefixRanges  []Ipv6PrefixRange  `json:"servedIpv6PrefixRanges,omitempty" yaml:"servedIpv6PrefixRanges,omitempty"`
}
...
func (o *PcscfInfo) GetGmFqdn() string {
	if o == nil || openapi.IsNil(o.GmFqdn) {
		var ret string
		return ret
	}
	return *o.GmFqdn
...
func (o *PcscfInfo) GetGmIpv4Addresses() []string {
	if o == nil || openapi.IsNil(o.GmIpv4Addresses) {
		var ret []string
		return ret
	}
...
func (o *PcscfInfo) GetGmIpv6Addresses() []string {
	if o == nil || openapi.IsNil(o.GmIpv6Addresses) {
		var ret []string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *PcscfInfo) GetGmIpv6AddressesOk() ([]string, bool) {
	if o == nil || openapi.IsNil(o.GmIpv6Addresses) {
		return nil, false
	}
...
// SetGmIpv6Addresses gets a reference to the given []string and assigns it to the GmIpv6Addresses field.
func (o *PcscfInfo) SetGmIpv6Addresses(v []string) {
	o.GmIpv6Addresses = v
}

// GetMwFqdn returns the MwFqdn field value if set, zero value otherwise.
func (o *PcscfInfo) GetMwFqdn() string {
	if o == nil || openapi.IsNil(o.MwFqdn) {
		var ret string
		return ret
	}
	return *o.MwFqdn
...
func (o *PcscfInfo) GetMwIpv4Addresses() []string {
	if o == nil || openapi.IsNil(o.MwIpv4Addresses) {
		var ret []string
		return ret
	}
...
func (o *PcscfInfo) GetMwIpv6Addresses() []string {
	if o == nil || openapi.IsNil(o.MwIpv6Addresses) {
		var ret []string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *PcscfInfo) GetMwIpv6AddressesOk() ([]string, bool) {
	if o == nil || openapi.IsNil(o.MwIpv6Addresses) {
		return nil, false
	}
...
// SetMwIpv6Addresses gets a reference to the given []string and assigns it to the MwIpv6Addresses field.
func (o *PcscfInfo) SetMwIpv6Addresses(v []string) {
	o.MwIpv6Addresses = v
}
...
func (o *PcscfInfo) GetServedIpv4AddressRanges() []Ipv4AddressRange {
	if o == nil || openapi.IsNil(o.ServedIpv4AddressRanges) {
...
func (o *PcscfInfo) GetServedIpv6PrefixRanges() []Ipv6PrefixRange {
	if o == nil || openapi.IsNil(o.ServedIpv6PrefixRanges) {
...
func (o PcscfInfo) ToMap() (map[string]any, error) {
