...
type LCSBroadcastAssistanceSubscriptionDataAPI interface {
	...
	*/
	QueryLcsBcaData(ctx context.Context, ueId string, servingPlmnId string) ApiQueryLcsBcaDataRequest

	// QueryLcsBcaDataExecute executes the request
	//   @return LcsBroadcastAssistanceTypesData
	QueryLcsBcaDataExecute(r ApiQueryLcsBcaDataRequest) (*models.LcsBroadcastAssistanceTypesData, *http.Response, error)
}
...
type ApiQueryLcsBcaDataRequest struct {
	ctx               context.Context
	ApiService        LCSBroadcastAssistanceSubscriptionDataAPI
	ueId              string
...
func (r ApiQueryLcsBcaDataRequest) Execute() (*models.LcsBroadcastAssistanceTypesData, *http.Response, error) {
...
//
//	@return LcsBroadcastAssistanceTypesData
func (a *LCSBroadcastAssistanceSubscriptionDataAPIService) QueryLcsBcaDataExecute(r ApiQueryLcsBcaDataRequest) (*models.LcsBroadcastAssistanceTypesData, *http.Response, error) {
	var (
