...
var _ openapi.MappedNullable = &ProvideLocInfo{}

// ProvideLocInfo Data within Provide Location Information Response
type ProvideLocInfo struct {
	CurrentLoc         *bool           `json:"currentLoc,omitempty" yaml:"currentLoc,omitempty"`
	...
	GeoInfo            *GeographicArea `json:"geoInfo,omitempty" yaml:"geoInfo,omitempty"`
	// Indicates value of the age of the location estimate.
	LocationAge *int32   `json:"locationAge,omitempty" yaml:"locationAge,omitempty"`
...
func (o *ProvideLocInfo) GetCurrentLoc() bool {
	if o == nil || openapi.IsNil(o.CurrentLoc) {
		var ret bool
		return ret
	}
	return *o.CurrentLoc
...
func (o *ProvideLocInfo) GetGeoInfo() GeographicArea {
	if o == nil || openapi.IsNil(o.GeoInfo) {
...
func (o *ProvideLocInfo) GetLocationAge() int32 {
	if o == nil || openapi.IsNil(o.LocationAge) {
		var ret int32
		return ret
	}
...
func (o ProvideLocInfo) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.CurrentLoc) {
	...
	if !openapi.IsNil(o.GeoInfo) {
		toSerialize["geoInfo"] = o.GeoInfo
	}
	if !openapi.IsNil(o.LocationAge) {
