...
var _ openapi.MappedNullable = &MbsfnArea{}

// MbsfnArea Contains an MBSFN area information.
type MbsfnArea struct {
	// This IE shall contain the MBSFN Area ID.
	MbsfnAreaId *int32 `json:"mbsfnAreaId,omitempty" yaml:"mbsfnAreaId,omitempty"`
	// When present, this IE shall contain the Carrier Frequency (EARFCN).
	CarrierFrequency *int32 `json:"carrierFrequency,omitempty" yaml:"carrierFrequency,omitempty"`
}
...
func (o *MbsfnArea) GetMbsfnAreaId() int32 {
	if o == nil || openapi.IsNil(o.MbsfnAreaId) {
		var ret int32
		return ret
	}
...
func (o *MbsfnArea) GetCarrierFrequency() int32 {
	if o == nil || openapi.IsNil(o.CarrierFrequency) {
		var ret int32
		return ret
	}
...
func (o MbsfnArea) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.MbsfnAreaId) {
		toSerialize["mbsfnAreaId"] = o.MbsfnAreaId
	}
	if !openapi.IsNil(o.CarrierFrequency) {
