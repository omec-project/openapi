...
type SubscriptionDeletionAPI interface {
	...
	*/
	Unsubscribe(ctx context.Context, ueId string, subscriptionId string) ApiUnsubscribeRequest

	// UnsubscribeExecute executes the request
	UnsubscribeExecute(r ApiUnsubscribeRequest) (*http.Response, error)
}
...
type ApiUnsubscribeRequest struct {
	ctx            context.Context
	ApiService     SubscriptionDeletionAPI
	ueId           string
