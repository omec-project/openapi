...
var _ openapi.MappedNullable = &DnPerformanceReq{}

// DnPerformanceReq Represents other DN performance analytics requirements.
type DnPerformanceReq struct {
	DnPerfOrderCriter *DnPerfOrderingCriterion `json:"dnPerfOrderCriter,omitempty" yaml:"dnPerfOrderCriter,omitempty"`
...
func (o *DnPerformanceReq) GetDnPerfOrderCriter() DnPerfOrderingCriterion {
	if o == nil || openapi.IsNil(o.DnPerfOrderCriter) {
...
func (o DnPerformanceReq) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.DnPerfOrderCriter) {
