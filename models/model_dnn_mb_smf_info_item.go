...
var _ openapi.MappedNullable = &DnnMbSmfInfoItem{}
...
func NewDnnMbSmfInfoItem(dnn string) *DnnMbSmfInfoItem {
...
func (o *DnnMbSmfInfoItem) GetDnn() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *DnnMbSmfInfoItem) GetDnnOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Dnn, true
...
func (o *DnnMbSmfInfoItem) SetDnn(v string) {
	o.Dnn = v
}

func (o DnnMbSmfInfoItem) ToMap() (map[string]any, error) {
