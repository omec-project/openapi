...
func (dst *SubscrCond) UnmarshalJSON(data []byte) error {
	...
	err = openapi.NewStrictDecoder(data).Decode(&dst.AmfCond)
	if err == nil {
	...
	err = openapi.NewStrictDecoder(data).Decode(&dst.DccfCond)
	if err == nil {
	...
	err = openapi.NewStrictDecoder(data).Decode(&dst.GuamiListCond)
	if err == nil {
	...
	err = openapi.NewStrictDecoder(data).Decode(&dst.NefCond)
	if err == nil {
	...
	err = openapi.NewStrictDecoder(data).Decode(&dst.NetworkSliceCond)
	if err == nil {
	...
	err = openapi.NewStrictDecoder(data).Decode(&dst.NfGroupCond)
	if err == nil {
	...
	err = openapi.NewStrictDecoder(data).Decode(&dst.NfGroupListCond)
	if err == nil {
	...
	err = openapi.NewStrictDecoder(data).Decode(&dst.NfInstanceIdCond)
	if err == nil {
	...
	err = openapi.NewStrictDecoder(data).Decode(&dst.NfInstanceIdListCond)
	if err == nil {
	...
	err = openapi.NewStrictDecoder(data).Decode(&dst.NfServiceSetCond)
	if err == nil {
	...
	err = openapi.NewStrictDecoder(data).Decode(&dst.NfSetCond)
	if err == nil {
	...
	err = openapi.NewStrictDecoder(data).Decode(&dst.NfTypeCond)
	if err == nil {
	...
	err = openapi.NewStrictDecoder(data).Decode(&dst.NwdafCond)
	if err == nil {
	...
	err = openapi.NewStrictDecoder(data).Decode(&dst.ScpDomainCond)
	if err == nil {
	...
	err = openapi.NewStrictDecoder(data).Decode(&dst.ServiceNameCond)
	if err == nil {
	...
	err = openapi.NewStrictDecoder(data).Decode(&dst.ServiceNameListCond)
	if err == nil {
	...
	err = openapi.NewStrictDecoder(data).Decode(&dst.UpfCond)
	if err == nil {
	...
	if match > 1 { // more than 1 match
		...
		return openapi.ReportError("data matches more than one schema in oneOf(SubscrCond)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return openapi.ReportError("data failed to match schemas in oneOf(SubscrCond)")
	}
}
...
func (obj *SubscrCond) GetActualInstance() any {
	if obj == nil {
		return nil
	}
	if obj.AmfCond != nil {
...
func (obj SubscrCond) GetActualInstanceValue() any {
	if obj.AmfCond != nil {
		return *obj.AmfCond
	}
