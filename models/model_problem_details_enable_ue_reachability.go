...
var _ openapi.MappedNullable = &ProblemDetailsEnableUeReachability{}
...
func (o *ProblemDetailsEnableUeReachability) GetSupportedApiVersions() []string {
...
// and a boolean to check if the value has been set.
func (o *ProblemDetailsEnableUeReachability) GetSupportedApiVersionsOk() ([]string, bool) {
	if o == nil || openapi.IsNil(o.SupportedApiVersions) {
		return nil, false
	}
...
func (o *ProblemDetailsEnableUeReachability) HasSupportedApiVersions() bool {
	if o != nil && !openapi.IsNil(o.SupportedApiVersions) {
		return true
	}
...
func (o *ProblemDetailsEnableUeReachability) SetSupportedApiVersions(v []string) {
	o.SupportedApiVersions = v
}

// GetNoProfileMatchInfo returns the NoProfileMatchInfo field value if set, zero value otherwise.
func (o *ProblemDetailsEnableUeReachability) GetNoProfileMatchInfo() NoProfileMatchInfo {
...
// and a boolean to check if the value has been set.
func (o *ProblemDetailsEnableUeReachability) GetNoProfileMatchInfoOk() (*NoProfileMatchInfo, bool) {
	if o == nil || openapi.IsNil(o.NoProfileMatchInfo) {
		return nil, false
	}
...
func (o *ProblemDetailsEnableUeReachability) HasNoProfileMatchInfo() bool {
	if o != nil && !openapi.IsNil(o.NoProfileMatchInfo) {
		return true
	}
...
func (o *ProblemDetailsEnableUeReachability) SetNoProfileMatchInfo(v NoProfileMatchInfo) {
...
func (o ProblemDetailsEnableUeReachability) ToMap() (map[string]any, error) {
