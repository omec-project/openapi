...
func (r ApiCreateCagUpdateAckRequest) CagAckData(cagAckData models.CagAckData) ApiCreateCagUpdateAckRequest {
...
func (a *CAGUpdateAckDocumentAPIService) CreateCagUpdateAckExecute(r ApiCreateCagUpdateAckRequest) (*http.Response, error) {
	...
	if r.cagAckData == nil {
		return nil, openapi.ReportError("cagAckData is required and must be specified")
	}
