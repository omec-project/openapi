...
var _ openapi.MappedNullable = &AcceptableServiceInfo{}
...
func (o *AcceptableServiceInfo) GetAccBwMedComps() map[string]MediaComponent {
	if o == nil || openapi.IsNil(o.AccBwMedComps) {
...
func (o AcceptableServiceInfo) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.AccBwMedComps) {
