...
var _ openapi.MappedNullable = &OperatorSpecificDataContainer{}

// OperatorSpecificDataContainer Container for operator specific data.
type OperatorSpecificDataContainer struct {
	DataType           string  `json:"dataType" yaml:"dataType"`
	DataTypeDefinition *string `json:"dataTypeDefinition,omitempty" yaml:"dataTypeDefinition,omitempty"`
...
func NewOperatorSpecificDataContainer(dataType string, value any) *OperatorSpecificDataContainer {
...
func (o *OperatorSpecificDataContainer) GetDataTypeDefinition() string {
	if o == nil || openapi.IsNil(o.DataTypeDefinition) {
		var ret string
		return ret
	}
...
func (o *OperatorSpecificDataContainer) GetValue() any {
	if o == nil {
		var ret any
		return ret
	}
...
func (o *OperatorSpecificDataContainer) GetValueOk() (*any, bool) {
...
func (o *OperatorSpecificDataContainer) SetValue(v any) {
	o.Value = v
}
...
func (o OperatorSpecificDataContainer) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["dataType"] = o.DataType
	if !openapi.IsNil(o.DataTypeDefinition) {
