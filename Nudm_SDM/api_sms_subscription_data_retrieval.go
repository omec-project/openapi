...
type SMSSubscriptionDataRetrievalAPI interface {
	...
	*/
	GetSmsData(ctx context.Context, supi string) ApiGetSmsDataRequest

	// GetSmsDataExecute executes the request
	//   @return SmsSubscriptionData
	GetSmsDataExecute(r ApiGetSmsDataRequest) (*models.SmsSubscriptionData, *http.Response, error)
}
...
type ApiGetSmsDataRequest struct {
	ctx               context.Context
	ApiService        SMSSubscriptionDataRetrievalAPI
	supi              string
...
func (r ApiGetSmsDataRequest) PlmnId(plmnId models.PlmnId) ApiGetSmsDataRequest {
	r.plmnId = &plmnId
	return r
}
...
func (r ApiGetSmsDataRequest) Execute() (*models.SmsSubscriptionData, *http.Response, error) {
...
//
//	@return SmsSubscriptionData
func (a *SMSSubscriptionDataRetrievalAPIService) GetSmsDataExecute(r ApiGetSmsDataRequest) (*models.SmsSubscriptionData, *http.Response, error) {
	var (
