...
var _ openapi.MappedNullable = &SessionRuleReport{}
...
type SessionRuleReport struct {
	...
	RuleIds             []string                `json:"ruleIds" yaml:"ruleIds"`
	RuleStatus          RuleStatus              `json:"ruleStatus" yaml:"ruleStatus"`
	SessRuleFailureCode *SessionRuleFailureCode `json:"sessRuleFailureCode,omitempty" yaml:"sessRuleFailureCode,omitempty"`
...
func (o *SessionRuleReport) GetSessRuleFailureCode() SessionRuleFailureCode {
	if o == nil || openapi.IsNil(o.SessRuleFailureCode) {
...
func (o SessionRuleReport) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["ruleIds"] = o.RuleIds
	toSerialize["ruleStatus"] = o.RuleStatus
	if !openapi.IsNil(o.SessRuleFailureCode) {
