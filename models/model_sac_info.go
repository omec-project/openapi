...
var _ openapi.MappedNullable = &SACInfo{}
...
type SACInfo struct {
	NumericValNumUes     *int32 `json:"numericValNumUes,omitempty" yaml:"numericValNumUes,omitempty"`
	NumericValNumPduSess *int32 `json:"numericValNumPduSess,omitempty" yaml:"numericValNumPduSess,omitempty"`
	PercValueNumUes      *int32 `json:"percValueNumUes,omitempty" yaml:"percValueNumUes,omitempty"`
	PercValueNumPduSess  *int32 `json:"percValueNumPduSess,omitempty" yaml:"percValueNumPduSess,omitempty"`
	UesWithPduSessionInd *bool  `json:"uesWithPduSessionInd,omitempty" yaml:"uesWithPduSessionInd,omitempty"`
}
...
func NewSACInfo() *SACInfo {
	this := SACInfo{}
	var uesWithPduSessionInd bool = false
	this.UesWithPduSessionInd = &uesWithPduSessionInd
	return &this
}
...
func (o *SACInfo) GetNumericValNumUes() int32 {
	if o == nil || openapi.IsNil(o.NumericValNumUes) {
		var ret int32
		return ret
	}
...
func (o *SACInfo) GetNumericValNumPduSess() int32 {
	if o == nil || openapi.IsNil(o.NumericValNumPduSess) {
		var ret int32
		return ret
	}
...
func (o *SACInfo) GetPercValueNumPduSess() int32 {
	if o == nil || openapi.IsNil(o.PercValueNumPduSess) {
		var ret int32
		return ret
	}
...
// GetUesWithPduSessionInd returns the UesWithPduSessionInd field value if set, zero value otherwise.
func (o *SACInfo) GetUesWithPduSessionInd() bool {
	if o == nil || openapi.IsNil(o.UesWithPduSessionInd) {
		var ret bool
		return ret
	}
	return *o.UesWithPduSessionInd
}

// GetUesWithPduSessionIndOk returns a tuple with the UesWithPduSessionInd field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SACInfo) GetUesWithPduSessionIndOk() (*bool, bool) {
	if o == nil || openapi.IsNil(o.UesWithPduSessionInd) {
		return nil, false
	}
	return o.UesWithPduSessionInd, true
}

// HasUesWithPduSessionInd returns a boolean if a field has been set.
func (o *SACInfo) HasUesWithPduSessionInd() bool {
	if o != nil && !openapi.IsNil(o.UesWithPduSessionInd) {
		return true
	}
...
// SetUesWithPduSessionInd gets a reference to the given bool and assigns it to the UesWithPduSessionInd field.
func (o *SACInfo) SetUesWithPduSessionInd(v bool) {
	o.UesWithPduSessionInd = &v
}

func (o SACInfo) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.NumericValNumUes) {
		toSerialize["numericValNumUes"] = o.NumericValNumUes
	}
	if !openapi.IsNil(o.NumericValNumPduSess) {
	...
	if !openapi.IsNil(o.PercValueNumPduSess) {
		toSerialize["percValueNumPduSess"] = o.PercValueNumPduSess
	}
	if !openapi.IsNil(o.UesWithPduSessionInd) {
		toSerialize["uesWithPduSessionInd"] = o.UesWithPduSessionInd
	}
