...
var _ openapi.MappedNullable = &SmContextReleaseData{}
...
type SmContextReleaseData struct {
	...
	VsmfReleaseOnly *bool            `json:"vsmfReleaseOnly,omitempty" yaml:"vsmfReleaseOnly,omitempty"`
	...
	IsmfReleaseOnly *bool            `json:"ismfReleaseOnly,omitempty" yaml:"ismfReleaseOnly,omitempty"`
}
...
func (o *SmContextReleaseData) GetVsmfReleaseOnly() bool {
	if o == nil || openapi.IsNil(o.VsmfReleaseOnly) {
		var ret bool
		return ret
	}
...
func (o *SmContextReleaseData) GetIsmfReleaseOnly() bool {
	if o == nil || openapi.IsNil(o.IsmfReleaseOnly) {
		var ret bool
		return ret
	}
...
func (o SmContextReleaseData) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.VsmfReleaseOnly) {
	...
	if !openapi.IsNil(o.IsmfReleaseOnly) {
