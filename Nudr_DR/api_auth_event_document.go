...
type AuthEventDocumentAPI interface {
	...
	*/
	DeleteAuthenticationStatus(ctx context.Context, ueId string) ApiDeleteAuthenticationStatusRequest

	// DeleteAuthenticationStatusExecute executes the request
	DeleteAuthenticationStatusExecute(r ApiDeleteAuthenticationStatusRequest) (*http.Response, error)
	...
	*/
	QueryAuthenticationStatus(ctx context.Context, ueId string) ApiQueryAuthenticationStatusRequest

	// QueryAuthenticationStatusExecute executes the request
	//   @return AuthEvent
	QueryAuthenticationStatusExecute(r ApiQueryAuthenticationStatusRequest) (*models.AuthEvent, *http.Response, error)
}
...
type ApiDeleteAuthenticationStatusRequest struct {
	ctx        context.Context
	ApiService AuthEventDocumentAPI
	ueId       string
}
...
func (r ApiQueryAuthenticationStatusRequest) Execute() (*models.AuthEvent, *http.Response, error) {
...
//
//	@return AuthEvent
func (a *AuthEventDocumentAPIService) QueryAuthenticationStatusExecute(r ApiQueryAuthenticationStatusRequest) (*models.AuthEvent, *http.Response, error) {
	var (
