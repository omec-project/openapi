...
var _ openapi.MappedNullable = &HsmfUpdateData{}

// HsmfUpdateData Data within Update Request towards H-SMF, or from I-SMF to SMF
type HsmfUpdateData struct {
	RequestIndication RequestIndication `json:"requestIndication" yaml:"requestIndication"`
	...
	VcnTunnelInfo          *TunnelInfo   `json:"vcnTunnelInfo,omitempty" yaml:"vcnTunnelInfo,omitempty"`
	IcnTunnelInfo          *TunnelInfo   `json:"icnTunnelInfo,omitempty" yaml:"icnTunnelInfo,omitempty"`
	AdditionalCnTunnelInfo *TunnelInfo   `json:"additionalCnTunnelInfo,omitempty" yaml:"additionalCnTunnelInfo,omitempty"`
	...
	PauseCharging *bool         `json:"pauseCharging,omitempty" yaml:"pauseCharging,omitempty"`
	...
	QosFlowsRelNotifyList    []QosFlowItem          `json:"qosFlowsRelNotifyList,omitempty" yaml:"qosFlowsRelNotifyList,omitempty"`
	QosFlowsVsmfRejectedList []int32                `json:"qosFlowsVsmfRejectedList,omitempty" yaml:"qosFlowsVsmfRejectedList,omitempty"`
	QosFlowsNotifyList       []QosFlowNotifyItem    `json:"qosFlowsNotifyList,omitempty" yaml:"qosFlowsNotifyList,omitempty"`
	NotifyList               []PduSessionNotifyItem `json:"NotifyList,omitempty" yaml:"NotifyList,omitempty"`
	EpsBearerId              []int32                `json:"epsBearerId,omitempty" yaml:"epsBearerId,omitempty"`
	HoPreparationIndication  *bool                  `json:"hoPreparationIndication,omitempty" yaml:"hoPreparationIndication,omitempty"`
	...
	AlwaysOnRequested       *bool                        `json:"alwaysOnRequested,omitempty" yaml:"alwaysOnRequested,omitempty"`
	...
	UnavailableAccessInd    *UnavailableAccessIndication `json:"unavailableAccessInd,omitempty" yaml:"unavailableAccessInd,omitempty"`
	PsaInfo                 []PsaInformation             `json:"psaInfo,omitempty" yaml:"psaInfo,omitempty"`
	UlclBpInfo              *UlclBpInformation           `json:"ulclBpInfo,omitempty" yaml:"ulclBpInfo,omitempty"`
	...
	VsmfPduSessionUri *string `json:"vsmfPduSessionUri,omitempty" yaml:"vsmfPduSessionUri,omitempty"`
	// String uniquely identifying a NF instance. The format of the NF Instance ID shall be a  Universally Unique Identifier (UUID) version 4, as described in IETF RFC 4122.
	VsmfId                *string `json:"vsmfId,omitempty" yaml:"vsmfId,omitempty"`
	VSmfServiceInstanceId *string `json:"vSmfServiceInstanceId,omitempty" yaml:"vSmfServiceInstanceId,omitempty"`
	// String providing an URI formatted according to RFC 3986.
	IsmfPduSessionUri *string `json:"ismfPduSessionUri,omitempty" yaml:"ismfPduSessionUri,omitempty"`
	// String uniquely identifying a NF instance. The format of the NF Instance ID shall be a  Universally Unique Identifier (UUID) version 4, as described in IETF RFC 4122.
	IsmfId                *string               `json:"ismfId,omitempty" yaml:"ismfId,omitempty"`
	ISmfServiceInstanceId *string               `json:"iSmfServiceInstanceId,omitempty" yaml:"iSmfServiceInstanceId,omitempty"`
	DlServingPlmnRateCtl  openapi.NullableInt32 `json:"dlServingPlmnRateCtl" yaml:"dlServingPlmnRateCtl,omitempty"`
	...
	SecurityResult         *SecurityResult         `json:"securityResult,omitempty" yaml:"securityResult,omitempty"`
	UpSecurityInfo         *UpSecurityInfo         `json:"upSecurityInfo,omitempty" yaml:"upSecurityInfo,omitempty"`
	// String uniquely identifying a NF instance. The format of the NF Instance ID shall be a  Universally Unique Identifier (UUID) version 4, as described in IETF RFC 4122.
	AmfNfId                              *string                          `json:"amfNfId,omitempty" yaml:"amfNfId,omitempty"`
	...
	EcsAddrConfigInfos                   []EcsAddrConfigInfo              `json:"ecsAddrConfigInfos,omitempty" yaml:"ecsAddrConfigInfos,omitempty"`
	HrsboInfo                            *HrsboInfoFromVplmn              `json:"hrsboInfo,omitempty" yaml:"hrsboInfo,omitempty"`
...
func (o *HsmfUpdateData) GetPauseCharging() bool {
	if o == nil || openapi.IsNil(o.PauseCharging) {
		var ret bool
		return ret
	}
...
func (o *HsmfUpdateData) GetQosFlowsRelNotifyList() []QosFlowItem {
	if o == nil || openapi.IsNil(o.QosFlowsRelNotifyList) {
		var ret []QosFlowItem
		return ret
	}
...
// GetQosFlowsVsmfRejectedList returns the QosFlowsVsmfRejectedList field value if set, zero value otherwise.
func (o *HsmfUpdateData) GetQosFlowsVsmfRejectedList() []int32 {
	if o == nil || openapi.IsNil(o.QosFlowsVsmfRejectedList) {
		var ret []int32
		return ret
	}
	return o.QosFlowsVsmfRejectedList
}

// GetQosFlowsVsmfRejectedListOk returns a tuple with the QosFlowsVsmfRejectedList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *HsmfUpdateData) GetQosFlowsVsmfRejectedListOk() ([]int32, bool) {
	if o == nil || openapi.IsNil(o.QosFlowsVsmfRejectedList) {
		return nil, false
	}
	return o.QosFlowsVsmfRejectedList, true
}

// HasQosFlowsVsmfRejectedList returns a boolean if a field has been set.
func (o *HsmfUpdateData) HasQosFlowsVsmfRejectedList() bool {
	if o != nil && !openapi.IsNil(o.QosFlowsVsmfRejectedList) {
		return true
	}
...
// SetQosFlowsVsmfRejectedList gets a reference to the given []int32 and assigns it to the QosFlowsVsmfRejectedList field.
func (o *HsmfUpdateData) SetQosFlowsVsmfRejectedList(v []int32) {
	o.QosFlowsVsmfRejectedList = v
}
...
func (o *HsmfUpdateData) GetQosFlowsNotifyList() []QosFlowNotifyItem {
	if o == nil || openapi.IsNil(o.QosFlowsNotifyList) {
...
func (o *HsmfUpdateData) GetNotifyList() []PduSessionNotifyItem {
	if o == nil || openapi.IsNil(o.NotifyList) {
...
func (o *HsmfUpdateData) GetUnavailableAccessInd() UnavailableAccessIndication {
	if o == nil || openapi.IsNil(o.UnavailableAccessInd) {
...
func (o *HsmfUpdateData) GetPsaInfo() []PsaInformation {
	if o == nil || openapi.IsNil(o.PsaInfo) {
...
func (o *HsmfUpdateData) GetUlclBpInfo() UlclBpInformation {
	if o == nil || openapi.IsNil(o.UlclBpInfo) {
...
func (o *HsmfUpdateData) GetDlServingPlmnRateCtl() int32 {
	if o == nil || openapi.IsNil(o.DlServingPlmnRateCtl.Get()) {
		var ret int32
		return ret
	}
...
// SetDlServingPlmnRateCtl gets a reference to the given openapi.NullableInt32 and assigns it to the DlServingPlmnRateCtl field.
...
func (o *HsmfUpdateData) GetSecurityResult() SecurityResult {
	if o == nil || openapi.IsNil(o.SecurityResult) {
...
func (o *HsmfUpdateData) GetEcsAddrConfigInfos() []EcsAddrConfigInfo {
...
// and a boolean to check if the value has been set.
func (o *HsmfUpdateData) GetEcsAddrConfigInfosOk() ([]EcsAddrConfigInfo, bool) {
	if o == nil || openapi.IsNil(o.EcsAddrConfigInfos) {
		return nil, false
	}
...
func (o *HsmfUpdateData) HasEcsAddrConfigInfos() bool {
	if o != nil && !openapi.IsNil(o.EcsAddrConfigInfos) {
		return true
	}
...
func (o *HsmfUpdateData) SetEcsAddrConfigInfos(v []EcsAddrConfigInfo) {
	o.EcsAddrConfigInfos = v
}

// GetHrsboInfo returns the HrsboInfo field value if set, zero value otherwise.
func (o *HsmfUpdateData) GetHrsboInfo() HrsboInfoFromVplmn {
...
// and a boolean to check if the value has been set.
func (o *HsmfUpdateData) GetHrsboInfoOk() (*HrsboInfoFromVplmn, bool) {
	if o == nil || openapi.IsNil(o.HrsboInfo) {
		return nil, false
	}
...
func (o *HsmfUpdateData) HasHrsboInfo() bool {
	if o != nil && !openapi.IsNil(o.HrsboInfo) {
		return true
	}
...
func (o *HsmfUpdateData) SetHrsboInfo(v HrsboInfoFromVplmn) {
	o.HrsboInfo = &v
}

// GetAltSnssai returns the AltSnssai field value if set, zero value otherwise.
func (o *HsmfUpdateData) GetAltSnssai() Snssai {
...
// and a boolean to check if the value has been set.
func (o *HsmfUpdateData) GetAltSnssaiOk() (*Snssai, bool) {
	if o == nil || openapi.IsNil(o.AltSnssai) {
		return nil, false
	}
...
func (o *HsmfUpdateData) HasAltSnssai() bool {
	if o != nil && !openapi.IsNil(o.AltSnssai) {
		return true
	}
...
func (o *HsmfUpdateData) SetAltSnssai(v Snssai) {
	o.AltSnssai = &v
}

// GetNsReplTerminInd returns the NsReplTerminInd field value if set, zero value otherwise.
func (o *HsmfUpdateData) GetNsReplTerminInd() bool {
...
// and a boolean to check if the value has been set.
func (o *HsmfUpdateData) GetNsReplTerminIndOk() (*bool, bool) {
	if o == nil || openapi.IsNil(o.NsReplTerminInd) {
		return nil, false
	}
...
func (o *HsmfUpdateData) HasNsReplTerminInd() bool {
	if o != nil && !openapi.IsNil(o.NsReplTerminInd) {
		return true
	}
...
func (o *HsmfUpdateData) SetNsReplTerminInd(v bool) {
	o.NsReplTerminInd = &v
}

// GetDisasterRoamingInd returns the DisasterRoamingInd field value if set, zero value otherwise.
func (o *HsmfUpdateData) GetDisasterRoamingInd() bool {
...
// and a boolean to check if the value has been set.
func (o *HsmfUpdateData) GetDisasterRoamingIndOk() (*bool, bool) {
	if o == nil || openapi.IsNil(o.DisasterRoamingInd) {
		return nil, false
	}
...
func (o *HsmfUpdateData) HasDisasterRoamingInd() bool {
	if o != nil && !openapi.IsNil(o.DisasterRoamingInd) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *HsmfUpdateData) GetPduSetSupportIndOk() (*bool, bool) {
	if o == nil || openapi.IsNil(o.PduSetSupportInd) {
		return nil, false
	}
...
func (o *HsmfUpdateData) HasPduSetSupportInd() bool {
	if o != nil && !openapi.IsNil(o.PduSetSupportInd) {
		return true
	}
...
func (o *HsmfUpdateData) SetPduSetSupportInd(v bool) {
...
func (o *HsmfUpdateData) GetEcnMarkingCongestionInfoStatus() []EcnMarkingCongestionInfoStatus {
...
// and a boolean to check if the value has been set.
func (o *HsmfUpdateData) GetEcnMarkingCongestionInfoStatusOk() ([]EcnMarkingCongestionInfoStatus, bool) {
	if o == nil || openapi.IsNil(o.EcnMarkingCongestionInfoStatus) {
		return nil, false
	}
...
func (o *HsmfUpdateData) HasEcnMarkingCongestionInfoStatus() bool {
	if o != nil && !openapi.IsNil(o.EcnMarkingCongestionInfoStatus) {
		return true
	}
...
func (o *HsmfUpdateData) SetEcnMarkingCongestionInfoStatus(v []EcnMarkingCongestionInfoStatus) {
	o.EcnMarkingCongestionInfoStatus = v
}

func (o HsmfUpdateData) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.PauseCharging) {
	...
	if !openapi.IsNil(o.QosFlowsRelNotifyList) {
		toSerialize["qosFlowsRelNotifyList"] = o.QosFlowsRelNotifyList
	}
	if !openapi.IsNil(o.QosFlowsVsmfRejectedList) {
		toSerialize["qosFlowsVsmfRejectedList"] = o.QosFlowsVsmfRejectedList
	}
	if !openapi.IsNil(o.QosFlowsNotifyList) {
		toSerialize["qosFlowsNotifyList"] = o.QosFlowsNotifyList
	}
	if !openapi.IsNil(o.NotifyList) {
	...
	if !openapi.IsNil(o.UnavailableAccessInd) {
		toSerialize["unavailableAccessInd"] = o.UnavailableAccessInd
	}
	if !openapi.IsNil(o.PsaInfo) {
		toSerialize["psaInfo"] = o.PsaInfo
	}
	if !openapi.IsNil(o.UlclBpInfo) {
	...
	if !openapi.IsNil(o.SecurityResult) {
