...
type SMSF3GPPAccessRegistrationInfoRetrievalAPI interface {
	...
	*/
	Get3GppSmsfRegistration(ctx context.Context, ueId string) ApiGet3GppSmsfRegistrationRequest

	// Get3GppSmsfRegistrationExecute executes the request
	//   @return SmsfRegistration
	Get3GppSmsfRegistrationExecute(r ApiGet3GppSmsfRegistrationRequest) (*models.SmsfRegistration, *http.Response, error)
}
...
type ApiGet3GppSmsfRegistrationRequest struct {
	ctx               context.Context
	ApiService        SMSF3GPPAccessRegistrationInfoRetrievalAPI
	ueId              string
...
func (r ApiGet3GppSmsfRegistrationRequest) Execute() (*models.SmsfRegistration, *http.Response, error) {
...
//
//	@return SmsfRegistration
func (a *SMSF3GPPAccessRegistrationInfoRetrievalAPIService) Get3GppSmsfRegistrationExecute(r ApiGet3GppSmsfRegistrationRequest) (*models.SmsfRegistration, *http.Response, error) {
	var (
