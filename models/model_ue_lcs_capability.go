...
var _ openapi.MappedNullable = &UeLcsCapability{}

// UeLcsCapability Indicates the LCS capability supported by the UE..
type UeLcsCapability struct {
	LppSupport       *bool `json:"lppSupport,omitempty" yaml:"lppSupport,omitempty"`
	CiotOptimisation *bool `json:"ciotOptimisation,omitempty" yaml:"ciotOptimisation,omitempty"`
}
...
func (o *UeLcsCapability) GetLppSupport() bool {
	if o == nil || openapi.IsNil(o.LppSupport) {
		var ret bool
		return ret
	}
	return *o.LppSupport
...
func (o *UeLcsCapability) GetCiotOptimisation() bool {
	if o == nil || openapi.IsNil(o.CiotOptimisation) {
		var ret bool
		return ret
	}
...
func (o UeLcsCapability) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.LppSupport) {
		toSerialize["lppSupport"] = o.LppSupport
	}
	if !openapi.IsNil(o.CiotOptimisation) {
