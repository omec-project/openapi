...
var _ openapi.MappedNullable = &OdbData{}

// OdbData Contains information regarding operater  determined  barring.
type OdbData struct {
	RoamingOdb *RoamingOdb `json:"roamingOdb,omitempty" yaml:"roamingOdb,omitempty"`
}
...
func (o *OdbData) GetRoamingOdb() RoamingOdb {
	if o == nil || openapi.IsNil(o.RoamingOdb) {
		var ret RoamingOdb
		return ret
	}
	return *o.RoamingOdb
...
func (o OdbData) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.RoamingOdb) {
