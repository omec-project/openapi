...
var _ openapi.MappedNullable = &ScpDomainInfo{}
...
func (o *ScpDomainInfo) GetScpFqdn() string {
	if o == nil || openapi.IsNil(o.ScpFqdn) {
		var ret string
		return ret
	}
	return *o.ScpFqdn
...
func (o *ScpDomainInfo) GetScpIpEndPoints() []IpEndPoint {
	if o == nil || openapi.IsNil(o.ScpIpEndPoints) {
		var ret []IpEndPoint
		return ret
	}
...
func (o ScpDomainInfo) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.ScpFqdn) {
		toSerialize["scpFqdn"] = o.ScpFqdn
	}
	if !openapi.IsNil(o.ScpIpEndPoints) {
