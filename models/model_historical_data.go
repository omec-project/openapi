...
var _ openapi.MappedNullable = &HistoricalData{}
...
type HistoricalData struct {
	...
	SubsWithSources []SpecificDataSubscription `json:"subsWithSources,omitempty" yaml:"subsWithSources,omitempty"`
	// Historical data related to the analytics.
	Data []DataNotification `json:"data" yaml:"data"`
}
...
func (o *HistoricalData) GetSubsWithSources() []SpecificDataSubscription {
	if o == nil || openapi.IsNil(o.SubsWithSources) {
...
func (o HistoricalData) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.SubsWithSources) {
