	...
	return []Route{
		{
			...
			handleFunctions.DefaultAPI.NfconfigAccessMobilityGet,
		},
		{
			"NfconfigPlmnGet",
			http.MethodGet,
			"/nfconfig/plmn",
			handleFunctions.DefaultAPI.NfconfigPlmnGet,
		},
		{
			"NfconfigPlmnSnssaiGet",
			http.MethodGet,
			"/nfconfig/plmn-snssai",
			handleFunctions.DefaultAPI.NfconfigPlmnSnssaiGet,
		},
		{
			"NfconfigPolicyControlGet",
			http.MethodGet,
			"/nfconfig/policy-control",
			handleFunctions.DefaultAPI.NfconfigPolicyControlGet,
		},
		{
			"NfconfigSessionManagementGet",
			http.MethodGet,
			"/nfconfig/session-management",
			handleFunctions.DefaultAPI.NfconfigSessionManagementGet,
		},
	}
}
