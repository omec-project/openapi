...
type Report struct {
	...
	GroupMembListChanges             *GroupMembListChanges
...
// GroupMembListChangesAsReport is a convenience function that returns GroupMembListChanges wrapped in Report
func GroupMembListChangesAsReport(v *GroupMembListChanges) Report {
	return Report{
		GroupMembListChanges: v,
	}
}
...
func (dst *Report) UnmarshalJSON(data []byte) error {
	...
	err = openapi.NewStrictDecoder(data).Decode(&dst.ChangeOfSupiPeiAssociationReport)
	if err == nil {
	...
	err = openapi.NewStrictDecoder(data).Decode(&dst.CmInfoReport)
	if err == nil {
	...
	err = openapi.NewStrictDecoder(data).Decode(&dst.CnTypeChangeReport)
	if err == nil {
	...
	// try to unmarshal data into GroupMembListChanges
	err = openapi.NewStrictDecoder(data).Decode(&dst.GroupMembListChanges)
	if err == nil {
		jsonGroupMembListChanges, _ := json.Marshal(dst.GroupMembListChanges)
	...
	err = openapi.NewStrictDecoder(data).Decode(&dst.LocationReport)
	if err == nil {
	...
	err = openapi.NewStrictDecoder(data).Decode(&dst.LossConnectivityReport)
	if err == nil {
	...
	err = openapi.NewStrictDecoder(data).Decode(&dst.PdnConnectivityStatReport)
	if err == nil {
	...
	err = openapi.NewStrictDecoder(data).Decode(&dst.RoamingStatusReport)
	if err == nil {
	...
	if match > 1 { // more than 1 match
		...
		return openapi.ReportError("data matches more than one schema in oneOf(Report)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return openapi.ReportError("data failed to match schemas in oneOf(Report)")
	}
}
...
func (src Report) MarshalJSON() ([]byte, error) {
	...
	if src.GroupMembListChanges != nil {
		return json.Marshal(&src.GroupMembListChanges)
	}
...
func (obj *Report) GetActualInstance() any {
	if obj == nil {
		return nil
	}
	...
	if obj.GroupMembListChanges != nil {
		return obj.GroupMembListChanges
	}
...
func (obj Report) GetActualInstanceValue() any {
	if obj.ChangeOfSupiPeiAssociationReport != nil {
		return *obj.ChangeOfSupiPeiAssociationReport
	}
