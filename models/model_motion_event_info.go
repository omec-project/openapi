...
var _ openapi.MappedNullable = &MotionEventInfo{}
...
type MotionEventInfo struct {
	...
	LinearDistance int32           `json:"linearDistance" yaml:"linearDistance"`
...
func (o MotionEventInfo) ToMap() (map[string]any, error) {
