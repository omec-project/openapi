...
var _ openapi.MappedNullable = &N2InfoNotifyHandoverComplete200Response{}
...
type N2InfoNotifyHandoverComplete200Response struct {
	JsonData                     *N2InfoNotificationRspData `json:"jsonData,omitempty" yaml:"jsonData,omitempty" multipart:"contentType:application/json,ref:{jsonData}"`
...
func (o N2InfoNotifyHandoverComplete200Response) ToMap() (map[string]any, error) {
