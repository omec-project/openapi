...
func (o *Flows) GetFNums() []int32 {
	if o == nil || openapi.IsNil(o.FNums) {
		var ret []int32
		return ret
	}
	return o.FNums
...
func (o Flows) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.ContVers) {
		toSerialize["contVers"] = o.ContVers
	}
	if !openapi.IsNil(o.FNums) {
