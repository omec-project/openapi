...
var _ openapi.MappedNullable = &NrfInfo{}
...
type NrfInfo struct {
	...
	ServedUdrInfo map[string]NrfInfoServedUdrInfoValue `json:"servedUdrInfo,omitempty" yaml:"servedUdrInfo,omitempty"`
	// A map (list of key-value pairs) where nfInstanceId serves as key
	ServedUdrInfoList *map[string]map[string]NrfInfoServedUdrInfoValue `json:"servedUdrInfoList,omitempty" yaml:"servedUdrInfoList,omitempty"`
	// A map (list of key-value pairs) where nfInstanceId serves as key
	ServedUdmInfo map[string]NrfInfoServedUdmInfoValue `json:"servedUdmInfo,omitempty" yaml:"servedUdmInfo,omitempty"`
	// A map (list of key-value pairs) where nfInstanceId serves as key
	ServedUdmInfoList *map[string]map[string]NrfInfoServedUdmInfoValue `json:"servedUdmInfoList,omitempty" yaml:"servedUdmInfoList,omitempty"`
	// A map (list of key-value pairs) where nfInstanceId serves as key
	ServedAusfInfo map[string]NrfInfoServedAusfInfoValue `json:"servedAusfInfo,omitempty" yaml:"servedAusfInfo,omitempty"`
	// A map (list of key-value pairs) where nfInstanceId serves as key
	ServedAusfInfoList *map[string]map[string]NrfInfoServedAusfInfoValue `json:"servedAusfInfoList,omitempty" yaml:"servedAusfInfoList,omitempty"`
	// A map (list of key-value pairs) where nfInstanceId serves as key
	ServedAmfInfo map[string]NrfInfoServedAmfInfoValue `json:"servedAmfInfo,omitempty" yaml:"servedAmfInfo,omitempty"`
	// A map (list of key-value pairs) where nfInstanceId serves as key
	ServedAmfInfoList *map[string]map[string]NrfInfoServedAmfInfoValue `json:"servedAmfInfoList,omitempty" yaml:"servedAmfInfoList,omitempty"`
	// A map (list of key-value pairs) where nfInstanceId serves as key
	ServedSmfInfo map[string]NrfInfoServedSmfInfoValue `json:"servedSmfInfo,omitempty" yaml:"servedSmfInfo,omitempty"`
	// A map (list of key-value pairs) where nfInstanceId serves as key
	ServedSmfInfoList *map[string]map[string]NrfInfoServedSmfInfoValue `json:"servedSmfInfoList,omitempty" yaml:"servedSmfInfoList,omitempty"`
	// A map (list of key-value pairs) where nfInstanceId serves as key
	ServedUpfInfo map[string]NrfInfoServedUpfInfoValue `json:"servedUpfInfo,omitempty" yaml:"servedUpfInfo,omitempty"`
	// A map (list of key-value pairs) where nfInstanceId serves as key
	ServedUpfInfoList *map[string]map[string]NrfInfoServedUpfInfoValue `json:"servedUpfInfoList,omitempty" yaml:"servedUpfInfoList,omitempty"`
	// A map (list of key-value pairs) where nfInstanceId serves as key
	ServedPcfInfo map[string]NrfInfoServedPcfInfoValue `json:"servedPcfInfo,omitempty" yaml:"servedPcfInfo,omitempty"`
	// A map (list of key-value pairs) where nfInstanceId serves as key
	ServedPcfInfoList *map[string]map[string]NrfInfoServedPcfInfoValue `json:"servedPcfInfoList,omitempty" yaml:"servedPcfInfoList,omitempty"`
	// A map (list of key-value pairs) where nfInstanceId serves as key
	ServedBsfInfo map[string]NrfInfoServedBsfInfoValue `json:"servedBsfInfo,omitempty" yaml:"servedBsfInfo,omitempty"`
	// A map (list of key-value pairs) where nfInstanceId serves as key
	ServedBsfInfoList *map[string]map[string]NrfInfoServedBsfInfoValue `json:"servedBsfInfoList,omitempty" yaml:"servedBsfInfoList,omitempty"`
	// A map (list of key-value pairs) where nfInstanceId serves as key
	ServedChfInfo map[string]NrfInfoServedChfInfoValue `json:"servedChfInfo,omitempty" yaml:"servedChfInfo,omitempty"`
	// A map (list of key-value pairs) where nfInstanceId serves as key
	ServedChfInfoList *map[string]map[string]NrfInfoServedChfInfoValue `json:"servedChfInfoList,omitempty" yaml:"servedChfInfoList,omitempty"`
	// A map (list of key-value pairs) where nfInstanceId serves as key
	ServedNefInfo map[string]NrfInfoServedNefInfoValue `json:"servedNefInfo,omitempty" yaml:"servedNefInfo,omitempty"`
	// A map (list of key-value pairs) where nfInstanceId serves as key
	ServedNwdafInfo map[string]NrfInfoServedNwdafInfoValue `json:"servedNwdafInfo,omitempty" yaml:"servedNwdafInfo,omitempty"`
	// A map (list of key-value pairs) where NF Instance Id serves as key
	ServedNwdafInfoList *map[string]map[string]NwdafInfo `json:"servedNwdafInfoList,omitempty" yaml:"servedNwdafInfoList,omitempty"`
	// A map (list of key-value pairs) where nfInstanceId serves as key
	ServedPcscfInfoList *map[string]map[string]NrfInfoServedPcscfInfoListValueValue `json:"servedPcscfInfoList,omitempty" yaml:"servedPcscfInfoList,omitempty"`
	// A map (list of key-value pairs) where nfInstanceId serves as key
	ServedGmlcInfo map[string]NrfInfoServedGmlcInfoValue `json:"servedGmlcInfo,omitempty" yaml:"servedGmlcInfo,omitempty"`
	// A map (list of key-value pairs) where nfInstanceId serves as key
	ServedLmfInfo map[string]NrfInfoServedLmfInfoValue `json:"servedLmfInfo,omitempty" yaml:"servedLmfInfo,omitempty"`
	// A map (list of key-value pairs) where nfInstanceId serves as key
	ServedNfInfo *map[string]NfInfo `json:"servedNfInfo,omitempty" yaml:"servedNfInfo,omitempty"`
	// A map (list of key-value pairs) where nfInstanceId serves as key
	ServedHssInfoList *map[string]map[string]NrfInfoServedHssInfoListValueValue `json:"servedHssInfoList,omitempty" yaml:"servedHssInfoList,omitempty"`
	// A map (list of key-value pairs) where nfInstanceId serves as key
	ServedUdsfInfo map[string]NrfInfoServedUdsfInfoValue `json:"servedUdsfInfo,omitempty" yaml:"servedUdsfInfo,omitempty"`
	// A map (list of key-value pairs) where nfInstanceId serves as key
	ServedUdsfInfoList *map[string]map[string]NrfInfoServedUdsfInfoValue `json:"servedUdsfInfoList,omitempty" yaml:"servedUdsfInfoList,omitempty"`
	// A map (list of key-value pairs) where nfInstanceId serves as key
	ServedScpInfoList map[string]NrfInfoServedScpInfoListValue `json:"servedScpInfoList,omitempty" yaml:"servedScpInfoList,omitempty"`
	// A map (list of key-value pairs) where nfInstanceId serves as key
	ServedSeppInfoList map[string]NrfInfoServedSeppInfoListValue `json:"servedSeppInfoList,omitempty" yaml:"servedSeppInfoList,omitempty"`
	// A map (list of key-value pairs) where NF Instance Id serves as key
	ServedAanfInfoList *map[string]map[string]NrfInfoServedAanfInfoListValueValue `json:"servedAanfInfoList,omitempty" yaml:"servedAanfInfoList,omitempty"`
	Served5gDdnmfInfo  *map[string]FiveGDdnmfInfo                                 `json:"served5gDdnmfInfo,omitempty" yaml:"served5gDdnmfInfo,omitempty"`
	// A map (list of key-value pairs) where NF Instance Id serves as key
	ServedMfafInfoList *map[string]MfafInfo `json:"servedMfafInfoList,omitempty" yaml:"servedMfafInfoList,omitempty"`
	// A map (list of key-value pairs) where NF Instance Id serves as key
	ServedEasdfInfoList *map[string]map[string]EasdfInfo `json:"servedEasdfInfoList,omitempty" yaml:"servedEasdfInfoList,omitempty"`
	// A map (list of key-value pairs) where NF Instance Id serves as key
	ServedDccfInfoList *map[string]DccfInfo `json:"servedDccfInfoList,omitempty" yaml:"servedDccfInfoList,omitempty"`
	// A map (list of key-value pairs) where nfInstanceId serves as key
	ServedMbSmfInfoList *map[string]map[string]NrfInfoServedMbSmfInfoListValueValue `json:"servedMbSmfInfoList,omitempty" yaml:"servedMbSmfInfoList,omitempty"`
	// A map (list of key-value pairs) where NF Instance Id serves as key
	ServedTsctsfInfoList *map[string]map[string]TsctsfInfo `json:"servedTsctsfInfoList,omitempty" yaml:"servedTsctsfInfoList,omitempty"`
	// A map (list of key-value pairs) where NF Instance Id serves as key
	ServedMbUpfInfoList *map[string]map[string]MbUpfInfo `json:"servedMbUpfInfoList,omitempty" yaml:"servedMbUpfInfoList,omitempty"`
	// A map (list of key-value pairs) where NF Instance Id serves as key
	ServedTrustAfInfo *map[string]TrustAfInfo `json:"servedTrustAfInfo,omitempty" yaml:"servedTrustAfInfo,omitempty"`
	// A map (list of key-value pairs) where NF Instance Id serves as key
	ServedNssaafInfo *map[string]NssaafInfo `json:"servedNssaafInfo,omitempty" yaml:"servedNssaafInfo,omitempty"`
}
...
func (o *NrfInfo) GetServedUdrInfo() map[string]NrfInfoServedUdrInfoValue {
	if o == nil || openapi.IsNil(o.ServedUdrInfo) {
...
func (o *NrfInfo) GetServedUdrInfoOk() (map[string]NrfInfoServedUdrInfoValue, bool) {
	if o == nil || openapi.IsNil(o.ServedUdrInfo) {
		return map[string]NrfInfoServedUdrInfoValue{}, false
	}
...
func (o *NrfInfo) GetServedUdrInfoList() map[string]map[string]NrfInfoServedUdrInfoValue {
	if o == nil || openapi.IsNil(o.ServedUdrInfoList) {
...
func (o *NrfInfo) GetServedUdmInfo() map[string]NrfInfoServedUdmInfoValue {
	if o == nil || openapi.IsNil(o.ServedUdmInfo) {
...
func (o *NrfInfo) GetServedUdmInfoOk() (map[string]NrfInfoServedUdmInfoValue, bool) {
	if o == nil || openapi.IsNil(o.ServedUdmInfo) {
		return map[string]NrfInfoServedUdmInfoValue{}, false
	}
...
func (o *NrfInfo) GetServedUdmInfoList() map[string]map[string]NrfInfoServedUdmInfoValue {
	if o == nil || openapi.IsNil(o.ServedUdmInfoList) {
...
func (o *NrfInfo) GetServedAusfInfo() map[string]NrfInfoServedAusfInfoValue {
	if o == nil || openapi.IsNil(o.ServedAusfInfo) {
...
func (o *NrfInfo) GetServedAusfInfoOk() (map[string]NrfInfoServedAusfInfoValue, bool) {
	if o == nil || openapi.IsNil(o.ServedAusfInfo) {
		return map[string]NrfInfoServedAusfInfoValue{}, false
	}
...
func (o *NrfInfo) GetServedAusfInfoList() map[string]map[string]NrfInfoServedAusfInfoValue {
	if o == nil || openapi.IsNil(o.ServedAusfInfoList) {
...
func (o *NrfInfo) GetServedAmfInfo() map[string]NrfInfoServedAmfInfoValue {
	if o == nil || openapi.IsNil(o.ServedAmfInfo) {
...
func (o *NrfInfo) GetServedAmfInfoOk() (map[string]NrfInfoServedAmfInfoValue, bool) {
	if o == nil || openapi.IsNil(o.ServedAmfInfo) {
		return map[string]NrfInfoServedAmfInfoValue{}, false
	}
...
func (o *NrfInfo) GetServedAmfInfoList() map[string]map[string]NrfInfoServedAmfInfoValue {
	if o == nil || openapi.IsNil(o.ServedAmfInfoList) {
...
func (o *NrfInfo) GetServedSmfInfo() map[string]NrfInfoServedSmfInfoValue {
	if o == nil || openapi.IsNil(o.ServedSmfInfo) {
...
func (o *NrfInfo) GetServedSmfInfoOk() (map[string]NrfInfoServedSmfInfoValue, bool) {
	if o == nil || openapi.IsNil(o.ServedSmfInfo) {
		return map[string]NrfInfoServedSmfInfoValue{}, false
	}
...
func (o *NrfInfo) GetServedSmfInfoList() map[string]map[string]NrfInfoServedSmfInfoValue {
	if o == nil || openapi.IsNil(o.ServedSmfInfoList) {
...
func (o *NrfInfo) GetServedUpfInfo() map[string]NrfInfoServedUpfInfoValue {
	if o == nil || openapi.IsNil(o.ServedUpfInfo) {
...
func (o *NrfInfo) GetServedUpfInfoOk() (map[string]NrfInfoServedUpfInfoValue, bool) {
	if o == nil || openapi.IsNil(o.ServedUpfInfo) {
		return map[string]NrfInfoServedUpfInfoValue{}, false
	}
...
func (o *NrfInfo) GetServedUpfInfoList() map[string]map[string]NrfInfoServedUpfInfoValue {
	if o == nil || openapi.IsNil(o.ServedUpfInfoList) {
...
func (o *NrfInfo) GetServedPcfInfo() map[string]NrfInfoServedPcfInfoValue {
	if o == nil || openapi.IsNil(o.ServedPcfInfo) {
...
func (o *NrfInfo) GetServedPcfInfoOk() (map[string]NrfInfoServedPcfInfoValue, bool) {
	if o == nil || openapi.IsNil(o.ServedPcfInfo) {
		return map[string]NrfInfoServedPcfInfoValue{}, false
	}
...
func (o *NrfInfo) GetServedPcfInfoList() map[string]map[string]NrfInfoServedPcfInfoValue {
	if o == nil || openapi.IsNil(o.ServedPcfInfoList) {
...
func (o *NrfInfo) GetServedBsfInfo() map[string]NrfInfoServedBsfInfoValue {
	if o == nil || openapi.IsNil(o.ServedBsfInfo) {
...
func (o *NrfInfo) GetServedBsfInfoOk() (map[string]NrfInfoServedBsfInfoValue, bool) {
	if o == nil || openapi.IsNil(o.ServedBsfInfo) {
		return map[string]NrfInfoServedBsfInfoValue{}, false
	}
...
func (o *NrfInfo) GetServedBsfInfoList() map[string]map[string]NrfInfoServedBsfInfoValue {
	if o == nil || openapi.IsNil(o.ServedBsfInfoList) {
...
func (o *NrfInfo) GetServedChfInfo() map[string]NrfInfoServedChfInfoValue {
	if o == nil || openapi.IsNil(o.ServedChfInfo) {
...
func (o *NrfInfo) GetServedChfInfoOk() (map[string]NrfInfoServedChfInfoValue, bool) {
	if o == nil || openapi.IsNil(o.ServedChfInfo) {
		return map[string]NrfInfoServedChfInfoValue{}, false
	}
...
func (o *NrfInfo) GetServedChfInfoList() map[string]map[string]NrfInfoServedChfInfoValue {
	if o == nil || openapi.IsNil(o.ServedChfInfoList) {
...
func (o *NrfInfo) GetServedNefInfo() map[string]NrfInfoServedNefInfoValue {
	if o == nil || openapi.IsNil(o.ServedNefInfo) {
...
func (o *NrfInfo) GetServedNefInfoOk() (map[string]NrfInfoServedNefInfoValue, bool) {
	if o == nil || openapi.IsNil(o.ServedNefInfo) {
		return map[string]NrfInfoServedNefInfoValue{}, false
	}
...
func (o *NrfInfo) GetServedNwdafInfo() map[string]NrfInfoServedNwdafInfoValue {
	if o == nil || openapi.IsNil(o.ServedNwdafInfo) {
...
func (o *NrfInfo) GetServedNwdafInfoOk() (map[string]NrfInfoServedNwdafInfoValue, bool) {
	if o == nil || openapi.IsNil(o.ServedNwdafInfo) {
		return map[string]NrfInfoServedNwdafInfoValue{}, false
	}
...
func (o *NrfInfo) GetServedNwdafInfoList() map[string]map[string]NwdafInfo {
	if o == nil || openapi.IsNil(o.ServedNwdafInfoList) {
...
func (o *NrfInfo) GetServedPcscfInfoList() map[string]map[string]NrfInfoServedPcscfInfoListValueValue {
	if o == nil || openapi.IsNil(o.ServedPcscfInfoList) {
...
func (o *NrfInfo) GetServedGmlcInfo() map[string]NrfInfoServedGmlcInfoValue {
	if o == nil || openapi.IsNil(o.ServedGmlcInfo) {
...
func (o *NrfInfo) GetServedGmlcInfoOk() (map[string]NrfInfoServedGmlcInfoValue, bool) {
	if o == nil || openapi.IsNil(o.ServedGmlcInfo) {
		return map[string]NrfInfoServedGmlcInfoValue{}, false
	}
...
func (o *NrfInfo) GetServedLmfInfo() map[string]NrfInfoServedLmfInfoValue {
	if o == nil || openapi.IsNil(o.ServedLmfInfo) {
...
func (o *NrfInfo) GetServedLmfInfoOk() (map[string]NrfInfoServedLmfInfoValue, bool) {
	if o == nil || openapi.IsNil(o.ServedLmfInfo) {
		return map[string]NrfInfoServedLmfInfoValue{}, false
	}
...
func (o *NrfInfo) GetServedNfInfo() map[string]NfInfo {
	if o == nil || openapi.IsNil(o.ServedNfInfo) {
...
func (o *NrfInfo) GetServedHssInfoList() map[string]map[string]NrfInfoServedHssInfoListValueValue {
	if o == nil || openapi.IsNil(o.ServedHssInfoList) {
...
func (o *NrfInfo) GetServedUdsfInfo() map[string]NrfInfoServedUdsfInfoValue {
	if o == nil || openapi.IsNil(o.ServedUdsfInfo) {
...
func (o *NrfInfo) GetServedUdsfInfoOk() (map[string]NrfInfoServedUdsfInfoValue, bool) {
	if o == nil || openapi.IsNil(o.ServedUdsfInfo) {
		return map[string]NrfInfoServedUdsfInfoValue{}, false
	}
...
func (o *NrfInfo) GetServedUdsfInfoList() map[string]map[string]NrfInfoServedUdsfInfoValue {
	if o == nil || openapi.IsNil(o.ServedUdsfInfoList) {
...
func (o *NrfInfo) GetServedScpInfoList() map[string]NrfInfoServedScpInfoListValue {
	if o == nil || openapi.IsNil(o.ServedScpInfoList) {
...
func (o *NrfInfo) GetServedScpInfoListOk() (map[string]NrfInfoServedScpInfoListValue, bool) {
	if o == nil || openapi.IsNil(o.ServedScpInfoList) {
		return map[string]NrfInfoServedScpInfoListValue{}, false
	}
...
func (o *NrfInfo) GetServedSeppInfoList() map[string]NrfInfoServedSeppInfoListValue {
	if o == nil || openapi.IsNil(o.ServedSeppInfoList) {
...
func (o *NrfInfo) GetServedSeppInfoListOk() (map[string]NrfInfoServedSeppInfoListValue, bool) {
	if o == nil || openapi.IsNil(o.ServedSeppInfoList) {
		return map[string]NrfInfoServedSeppInfoListValue{}, false
	}
...
func (o *NrfInfo) GetServedAanfInfoList() map[string]map[string]NrfInfoServedAanfInfoListValueValue {
	if o == nil || openapi.IsNil(o.ServedAanfInfoList) {
...
func (o *NrfInfo) GetServed5gDdnmfInfo() map[string]FiveGDdnmfInfo {
	if o == nil || openapi.IsNil(o.Served5gDdnmfInfo) {
		var ret map[string]FiveGDdnmfInfo
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *NrfInfo) GetServed5gDdnmfInfoOk() (*map[string]FiveGDdnmfInfo, bool) {
	if o == nil || openapi.IsNil(o.Served5gDdnmfInfo) {
		return nil, false
	}
...
// SetServed5gDdnmfInfo gets a reference to the given map[string]FiveGDdnmfInfo and assigns it to the Served5gDdnmfInfo field.
func (o *NrfInfo) SetServed5gDdnmfInfo(v map[string]FiveGDdnmfInfo) {
...
func (o *NrfInfo) GetServedMfafInfoList() map[string]MfafInfo {
	if o == nil || openapi.IsNil(o.ServedMfafInfoList) {
...
func (o *NrfInfo) GetServedEasdfInfoList() map[string]map[string]EasdfInfo {
	if o == nil || openapi.IsNil(o.ServedEasdfInfoList) {
...
func (o *NrfInfo) GetServedDccfInfoList() map[string]DccfInfo {
	if o == nil || openapi.IsNil(o.ServedDccfInfoList) {
...
func (o *NrfInfo) GetServedMbSmfInfoList() map[string]map[string]NrfInfoServedMbSmfInfoListValueValue {
	if o == nil || openapi.IsNil(o.ServedMbSmfInfoList) {
...
func (o *NrfInfo) GetServedTsctsfInfoList() map[string]map[string]TsctsfInfo {
	if o == nil || openapi.IsNil(o.ServedTsctsfInfoList) {
...
func (o *NrfInfo) GetServedMbUpfInfoList() map[string]map[string]MbUpfInfo {
	if o == nil || openapi.IsNil(o.ServedMbUpfInfoList) {
...
func (o *NrfInfo) GetServedTrustAfInfo() map[string]TrustAfInfo {
	if o == nil || openapi.IsNil(o.ServedTrustAfInfo) {
...
func (o *NrfInfo) GetServedNssaafInfo() map[string]NssaafInfo {
	if o == nil || openapi.IsNil(o.ServedNssaafInfo) {
