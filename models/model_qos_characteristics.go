...
var _ openapi.MappedNullable = &QosCharacteristics{}
...
type QosCharacteristics struct {
	...
	PacketErrorRate string `json:"packetErrorRate" yaml:"packetErrorRate" validate:"regexp=^([0-9]E-[0-9])$"`
	// Unsigned integer indicating Averaging Window (see clause 5.7.3.6 and 5.7.4 of 3GPP TS 23.501), expressed in milliseconds.
	AveragingWindow *int32 `json:"averagingWindow,omitempty" yaml:"averagingWindow,omitempty"`
...
func (o *QosCharacteristics) GetAveragingWindow() int32 {
	if o == nil || openapi.IsNil(o.AveragingWindow) {
		var ret int32
		return ret
	}
...
func (o QosCharacteristics) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.AveragingWindow) {
