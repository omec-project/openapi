...
var _ openapi.MappedNullable = &SmsfInfo{}
...
type SmsfInfo struct {
	...
	RemotePlmnRangeList []PlmnRange `json:"remotePlmnRangeList,omitempty" yaml:"remotePlmnRangeList,omitempty"`
}
...
func (o *SmsfInfo) GetRemotePlmnRangeList() []PlmnRange {
	if o == nil || openapi.IsNil(o.RemotePlmnRangeList) {
		var ret []PlmnRange
		return ret
	}
...
func (o SmsfInfo) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.RoamingUeInd) {
		toSerialize["roamingUeInd"] = o.RoamingUeInd
	}
	if !openapi.IsNil(o.RemotePlmnRangeList) {
