...
var _ openapi.MappedNullable = &UeRegStatusUpdateReqData{}
...
type UeRegStatusUpdateReqData struct {
	TransferStatus       UeContextTransferStatus `json:"transferStatus" yaml:"transferStatus"`
	ToReleaseSessionList []int32                 `json:"toReleaseSessionList,omitempty" yaml:"toReleaseSessionList,omitempty"`
	PcfReselectedInd     *bool                   `json:"pcfReselectedInd,omitempty" yaml:"pcfReselectedInd,omitempty"`
	SmfChangeInfoList    []SmfChangeInfo         `json:"smfChangeInfoList,omitempty" yaml:"smfChangeInfoList,omitempty"`
	AnalyticsNotUsedList []string                `json:"analyticsNotUsedList,omitempty" yaml:"analyticsNotUsedList,omitempty"`
	ToReleaseSessionInfo []ReleaseSessionInfo    `json:"toReleaseSessionInfo,omitempty" yaml:"toReleaseSessionInfo,omitempty"`
}
...
func (o *UeRegStatusUpdateReqData) GetPcfReselectedInd() bool {
	if o == nil || openapi.IsNil(o.PcfReselectedInd) {
		var ret bool
		return ret
	}
...
func (o *UeRegStatusUpdateReqData) GetAnalyticsNotUsedList() []string {
	if o == nil || openapi.IsNil(o.AnalyticsNotUsedList) {
		var ret []string
		return ret
	}
...
func (o *UeRegStatusUpdateReqData) GetToReleaseSessionInfo() []ReleaseSessionInfo {
	if o == nil || openapi.IsNil(o.ToReleaseSessionInfo) {
...
func (o UeRegStatusUpdateReqData) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.PcfReselectedInd) {
	...
	if !openapi.IsNil(o.AnalyticsNotUsedList) {
		toSerialize["analyticsNotUsedList"] = o.AnalyticsNotUsedList
	}
	if !openapi.IsNil(o.ToReleaseSessionInfo) {
