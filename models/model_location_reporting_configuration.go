...
var _ openapi.MappedNullable = &LocationReportingConfiguration{}

// LocationReportingConfiguration struct for LocationReportingConfiguration
type LocationReportingConfiguration struct {
	CurrentLocation bool              `json:"currentLocation" yaml:"currentLocation"`
	OneTime         *bool             `json:"oneTime,omitempty" yaml:"oneTime,omitempty"`
	Accuracy        *LocationAccuracy `json:"accuracy,omitempty" yaml:"accuracy,omitempty"`
	N3gppAccuracy   *LocationAccuracy `json:"n3gppAccuracy,omitempty" yaml:"n3gppAccuracy,omitempty"`
}
...
func (o *LocationReportingConfiguration) GetOneTime() bool {
	if o == nil || openapi.IsNil(o.OneTime) {
		var ret bool
		return ret
	}
	return *o.OneTime
...
func (o *LocationReportingConfiguration) GetN3gppAccuracy() LocationAccuracy {
	if o == nil || openapi.IsNil(o.N3gppAccuracy) {
		var ret LocationAccuracy
		return ret
	}
