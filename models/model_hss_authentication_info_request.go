...
var _ openapi.MappedNullable = &HssAuthenticationInfoRequest{}
...
type HssAuthenticationInfoRequest struct {
	...
	HssAuthType           HssAuthType            `json:"hssAuthType" yaml:"hssAuthType"`
	NumOfRequestedVectors int32                  `json:"numOfRequestedVectors" yaml:"numOfRequestedVectors"`
	RequestingNodeType    *NodeType              `json:"requestingNodeType,omitempty" yaml:"requestingNodeType,omitempty"`
	ServingNetworkId      *PlmnId                `json:"servingNetworkId,omitempty" yaml:"servingNetworkId,omitempty"`
	ResynchronizationInfo *ResynchronizationInfo `json:"resynchronizationInfo,omitempty" yaml:"resynchronizationInfo,omitempty"`
	AnId                  *AccessNetworkId       `json:"anId,omitempty" yaml:"anId,omitempty"`
}
...
func (o *HssAuthenticationInfoRequest) GetRequestingNodeType() NodeType {
	if o == nil || openapi.IsNil(o.RequestingNodeType) {
		var ret NodeType
		return ret
	}
...
func (o *HssAuthenticationInfoRequest) GetServingNetworkId() PlmnId {
	if o == nil || openapi.IsNil(o.ServingNetworkId) {
		var ret PlmnId
		return ret
	}
...
func (o HssAuthenticationInfoRequest) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.RequestingNodeType) {
		toSerialize["requestingNodeType"] = o.RequestingNodeType
	}
	if !openapi.IsNil(o.ServingNetworkId) {
