...
type AMF3GppAccessRegistrationInfoRetrievalAPI interface {
	...
	*/
	Get3GppRegistration(ctx context.Context, ueId string) ApiGet3GppRegistrationRequest

	// Get3GppRegistrationExecute executes the request
	//   @return Amf3GppAccessRegistration
	Get3GppRegistrationExecute(r ApiGet3GppRegistrationRequest) (*models.Amf3GppAccessRegistration, *http.Response, error)
}
...
type ApiGet3GppRegistrationRequest struct {
	ctx               context.Context
	ApiService        AMF3GppAccessRegistrationInfoRetrievalAPI
	ueId              string
...
func (r ApiGet3GppRegistrationRequest) Execute() (*models.Amf3GppAccessRegistration, *http.Response, error) {
...
//
//	@return Amf3GppAccessRegistration
func (a *AMF3GppAccessRegistrationInfoRetrievalAPIService) Get3GppRegistrationExecute(r ApiGet3GppRegistrationRequest) (*models.Amf3GppAccessRegistration, *http.Response, error) {
	var (
