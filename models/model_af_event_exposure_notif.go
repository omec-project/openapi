...
var _ openapi.MappedNullable = &AfEventExposureNotif{}
...
type AfEventExposureNotif struct {
	...
	EventNotifs []AfEventNotificationAf `json:"eventNotifs" yaml:"eventNotifs"`
}
...
func NewAfEventExposureNotif(notifId string, eventNotifs []AfEventNotificationAf) *AfEventExposureNotif {
...
func (o *AfEventExposureNotif) GetEventNotifs() []AfEventNotificationAf {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *AfEventExposureNotif) GetEventNotifsOk() ([]AfEventNotificationAf, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AfEventExposureNotif) SetEventNotifs(v []AfEventNotificationAf) {
	o.EventNotifs = v
}

func (o AfEventExposureNotif) ToMap() (map[string]any, error) {
