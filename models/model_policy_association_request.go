...
var _ openapi.MappedNullable = &PolicyAssociationRequest{}
...
type PolicyAssociationRequest struct {
	...
	ServingPlmn   *PlmnIdNid                      `json:"servingPlmn,omitempty" yaml:"servingPlmn,omitempty"`
	...
	SuppFeat string `json:"suppFeat" yaml:"suppFeat" validate:"regexp=^[A-Fa-f0-9]*$"`
}
...
func (o *PolicyAssociationRequest) GetAltNotifIpv6Addrs() []string {
...
// and a boolean to check if the value has been set.
func (o *PolicyAssociationRequest) GetAltNotifIpv6AddrsOk() ([]string, bool) {
	if o == nil || openapi.IsNil(o.AltNotifIpv6Addrs) {
		return nil, false
	}
...
func (o *PolicyAssociationRequest) SetAltNotifIpv6Addrs(v []string) {
...
func (o *PolicyAssociationRequest) GetTimeZone() string {
	if o == nil || openapi.IsNil(o.TimeZone) {
		var ret string
		return ret
	}
	return *o.TimeZone
...
func (o *PolicyAssociationRequest) GetServingPlmn() PlmnIdNid {
	if o == nil || openapi.IsNil(o.ServingPlmn) {
		var ret PlmnIdNid
		return ret
	}
...
func (o *PolicyAssociationRequest) GetGroupIds() []string {
	if o == nil || openapi.IsNil(o.GroupIds) {
		var ret []string
		return ret
	}
	return o.GroupIds
...
func (o *PolicyAssociationRequest) GetPartAllowedNssai() map[string]PartiallyAllowedSnssai {
...
// and a boolean to check if the value has been set.
func (o *PolicyAssociationRequest) GetPartAllowedNssaiOk() (*map[string]PartiallyAllowedSnssai, bool) {
	if o == nil || openapi.IsNil(o.PartAllowedNssai) {
		return nil, false
	}
...
func (o *PolicyAssociationRequest) HasPartAllowedNssai() bool {
	if o != nil && !openapi.IsNil(o.PartAllowedNssai) {
		return true
	}
...
func (o *PolicyAssociationRequest) SetPartAllowedNssai(v map[string]PartiallyAllowedSnssai) {
	o.PartAllowedNssai = &v
}

// GetSnssaisPartRejected returns the SnssaisPartRejected field value if set, zero value otherwise.
func (o *PolicyAssociationRequest) GetSnssaisPartRejected() map[string]SnssaiPartRejected {
...
// and a boolean to check if the value has been set.
func (o *PolicyAssociationRequest) GetSnssaisPartRejectedOk() (*map[string]SnssaiPartRejected, bool) {
	if o == nil || openapi.IsNil(o.SnssaisPartRejected) {
		return nil, false
	}
...
func (o *PolicyAssociationRequest) HasSnssaisPartRejected() bool {
	if o != nil && !openapi.IsNil(o.SnssaisPartRejected) {
		return true
	}
...
func (o *PolicyAssociationRequest) SetSnssaisPartRejected(v map[string]SnssaiPartRejected) {
	o.SnssaisPartRejected = &v
}

// GetRejectedSnssais returns the RejectedSnssais field value if set, zero value otherwise.
func (o *PolicyAssociationRequest) GetRejectedSnssais() []Snssai {
...
// and a boolean to check if the value has been set.
func (o *PolicyAssociationRequest) GetRejectedSnssaisOk() ([]Snssai, bool) {
	if o == nil || openapi.IsNil(o.RejectedSnssais) {
		return nil, false
	}
...
func (o *PolicyAssociationRequest) HasRejectedSnssais() bool {
	if o != nil && !openapi.IsNil(o.RejectedSnssais) {
		return true
	}
...
func (o *PolicyAssociationRequest) SetRejectedSnssais(v []Snssai) {
	o.RejectedSnssais = v
}

// GetPendingNssai returns the PendingNssai field value if set, zero value otherwise.
func (o *PolicyAssociationRequest) GetPendingNssai() []Snssai {
...
// and a boolean to check if the value has been set.
func (o *PolicyAssociationRequest) GetPendingNssaiOk() ([]Snssai, bool) {
	if o == nil || openapi.IsNil(o.PendingNssai) {
		return nil, false
	}
...
func (o *PolicyAssociationRequest) HasPendingNssai() bool {
	if o != nil && !openapi.IsNil(o.PendingNssai) {
		return true
	}
...
func (o *PolicyAssociationRequest) SetPendingNssai(v []Snssai) {
	o.PendingNssai = v
}
...
func (o PolicyAssociationRequest) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.TimeZone) {
		toSerialize["timeZone"] = o.TimeZone
	}
	if !openapi.IsNil(o.ServingPlmn) {
