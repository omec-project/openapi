...
var _ openapi.MappedNullable = &QosNotificationControlInfo{}
...
type QosNotificationControlInfo struct {
	...
	NotifType     QosNotifType `json:"notifType" yaml:"notifType"`
	...
	AltQosNotSuppInd *bool `json:"altQosNotSuppInd,omitempty" yaml:"altQosNotSuppInd,omitempty"`
}
...
func (o *QosNotificationControlInfo) GetAltQosNotSuppInd() bool {
	if o == nil || openapi.IsNil(o.AltQosNotSuppInd) {
		var ret bool
		return ret
	}
...
func (o QosNotificationControlInfo) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.AltQosNotSuppInd) {
