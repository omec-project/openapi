...
var _ openapi.MappedNullable = &NrLocation{}

// NrLocation Contains the NR user location.
type NrLocation struct {
	Tai        Tai   `json:"tai" yaml:"tai"`
	Ncgi       Ncgi  `json:"ncgi" yaml:"ncgi"`
	IgnoreNcgi *bool `json:"ignoreNcgi,omitempty" yaml:"ignoreNcgi,omitempty"`
	...
	GlobalGnbId         NullableGlobalRanNodeId `json:"globalGnbId" yaml:"globalGnbId,omitempty"`
	NtnTaiInfo          *NtnTaiInfo             `json:"ntnTaiInfo,omitempty" yaml:"ntnTaiInfo,omitempty"`
}
...
func (o *NrLocation) GetIgnoreNcgi() bool {
	if o == nil || openapi.IsNil(o.IgnoreNcgi) {
		var ret bool
		return ret
	}
	return *o.IgnoreNcgi
...
func (o *NrLocation) GetGlobalGnbId() GlobalRanNodeId {
	if o == nil || openapi.IsNil(o.GlobalGnbId.Get()) {
...
func (o *NrLocation) GetNtnTaiInfo() NtnTaiInfo {
	if o == nil || openapi.IsNil(o.NtnTaiInfo) {
		var ret NtnTaiInfo
		return ret
	}
	return *o.NtnTaiInfo
...
func (o NrLocation) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["tai"] = o.Tai
	toSerialize["ncgi"] = o.Ncgi
	if !openapi.IsNil(o.IgnoreNcgi) {
