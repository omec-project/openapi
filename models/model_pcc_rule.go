...
var _ openapi.MappedNullable = &PccRule{}
...
type PccRule struct {
	...
	AppDescriptor *string `json:"appDescriptor,omitempty" yaml:"appDescriptor,omitempty"`
	...
	PccRuleId string `json:"pccRuleId" yaml:"pccRuleId"`
	...
	// Indicates the capability for AF to adjust the burst sending time, when it is provided and set to \"true\". The default value is \"false\" if omitted.
	CapBatAdaptation *bool                                     `json:"capBatAdaptation,omitempty" yaml:"capBatAdaptation,omitempty"`
	DdNotifCtrl      *DownlinkDataNotificationControl          `json:"ddNotifCtrl,omitempty" yaml:"ddNotifCtrl,omitempty"`
	DdNotifCtrl2     NullableDownlinkDataNotificationControlRm `json:"ddNotifCtrl2" yaml:"ddNotifCtrl2,omitempty"`
...
func (o *PccRule) GetAppDescriptor() string {
	if o == nil || openapi.IsNil(o.AppDescriptor) {
		var ret string
		return ret
	}
...
func (o *PccRule) GetProtoDescDl() ProtocolDescription {
...
// and a boolean to check if the value has been set.
func (o *PccRule) GetProtoDescDlOk() (*ProtocolDescription, bool) {
	if o == nil || openapi.IsNil(o.ProtoDescDl) {
		return nil, false
	}
...
func (o *PccRule) HasProtoDescDl() bool {
	if o != nil && !openapi.IsNil(o.ProtoDescDl) {
		return true
	}
...
func (o *PccRule) SetProtoDescDl(v ProtocolDescription) {
	o.ProtoDescDl = &v
}

// GetProtoDescUl returns the ProtoDescUl field value if set, zero value otherwise.
func (o *PccRule) GetProtoDescUl() ProtocolDescription {
...
// and a boolean to check if the value has been set.
func (o *PccRule) GetProtoDescUlOk() (*ProtocolDescription, bool) {
	if o == nil || openapi.IsNil(o.ProtoDescUl) {
		return nil, false
	}
...
func (o *PccRule) HasProtoDescUl() bool {
	if o != nil && !openapi.IsNil(o.ProtoDescUl) {
		return true
	}
...
func (o *PccRule) SetProtoDescUl(v ProtocolDescription) {
	o.ProtoDescUl = &v
}
...
func (o *PccRule) GetRefQosData() []string {
	if o == nil || openapi.IsNil(o.RefQosData) {
		var ret []string
		return ret
	}
	return o.RefQosData
...
func (o *PccRule) GetRefAltQosParams() []string {
	if o == nil || openapi.IsNil(o.RefAltQosParams) {
		var ret []string
		return ret
	}
...
func (o *PccRule) GetRefChgDataOk() ([]string, bool) {
	if o == nil || openapi.IsNil(o.RefChgData) {
		return nil, false
	}
...
func (o *PccRule) GetRefChgN3gDataOk() ([]string, bool) {
	if o == nil || openapi.IsNil(o.RefChgN3gData) {
		return nil, false
	}
...
func (o *PccRule) GetRefUmDataOk() ([]string, bool) {
	if o == nil || openapi.IsNil(o.RefUmData) {
		return nil, false
	}
...
func (o *PccRule) GetRefUmN3gDataOk() ([]string, bool) {
	if o == nil || openapi.IsNil(o.RefUmN3gData) {
		return nil, false
	}
...
func (o *PccRule) GetRefCondData() string {
	if o == nil || openapi.IsNil(o.RefCondData.Get()) {
		var ret string
		return ret
	}
...
// SetRefCondData gets a reference to the given openapi.NullableString and assigns it to the RefCondData field.
...
func (o *PccRule) GetRefQosMonOk() ([]string, bool) {
	if o == nil || openapi.IsNil(o.RefQosMon) {
		return nil, false
	}
...
func (o *PccRule) GetAddrPreserInd() bool {
	if o == nil || openapi.IsNil(o.AddrPreserInd.Get()) {
		var ret bool
		return ret
	}
...
// SetAddrPreserInd gets a reference to the given openapi.NullableBool and assigns it to the AddrPreserInd field.
...
func (o *PccRule) GetCapBatAdaptation() bool {
...
// and a boolean to check if the value has been set.
func (o *PccRule) GetCapBatAdaptationOk() (*bool, bool) {
	if o == nil || openapi.IsNil(o.CapBatAdaptation) {
		return nil, false
	}
...
func (o *PccRule) HasCapBatAdaptation() bool {
	if o != nil && !openapi.IsNil(o.CapBatAdaptation) {
		return true
	}
...
func (o *PccRule) SetCapBatAdaptation(v bool) {
...
func (o *PccRule) GetDdNotifCtrl() DownlinkDataNotificationControl {
	if o == nil || openapi.IsNil(o.DdNotifCtrl) {
...
func (o *PccRule) GetDdNotifCtrl2() DownlinkDataNotificationControlRm {
	if o == nil || openapi.IsNil(o.DdNotifCtrl2.Get()) {
...
func (o *PccRule) GetDisUeNotif() bool {
	if o == nil || openapi.IsNil(o.DisUeNotif.Get()) {
		var ret bool
		return ret
	}
...
// SetDisUeNotif gets a reference to the given openapi.NullableBool and assigns it to the DisUeNotif field.
...
func (o *PccRule) GetPackFiltAllPrec() int32 {
	if o == nil || openapi.IsNil(o.PackFiltAllPrec) {
		var ret int32
		return ret
	}
...
func (o *PccRule) GetNscSuppFeats() map[string]string {
...
// and a boolean to check if the value has been set.
func (o *PccRule) GetNscSuppFeatsOk() (*map[string]string, bool) {
	if o == nil || openapi.IsNil(o.NscSuppFeats) {
		return nil, false
	}
...
func (o *PccRule) HasNscSuppFeats() bool {
	if o != nil && !openapi.IsNil(o.NscSuppFeats) {
		return true
	}
...
func (o *PccRule) SetNscSuppFeats(v map[string]string) {
	o.NscSuppFeats = &v
}

// GetCallInfo returns the CallInfo field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *PccRule) GetCallInfo() CallInfo {
	if o == nil || openapi.IsNil(o.CallInfo.Get()) {
		var ret CallInfo
		return ret
	}
	return *o.CallInfo.Get()
}

// GetCallInfoOk returns a tuple with the CallInfo field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PccRule) GetCallInfoOk() (*CallInfo, bool) {
	if o == nil {
		return nil, false
	}
	return o.CallInfo.Get(), o.CallInfo.IsSet()
}

// HasCallInfo returns a boolean if a field has been set.
func (o *PccRule) HasCallInfo() bool {
	if o != nil && o.CallInfo.IsSet() {
		return true
	}
...
// SetCallInfo gets a reference to the given NullableCallInfo and assigns it to the CallInfo field.
func (o *PccRule) SetCallInfo(v CallInfo) {
	o.CallInfo.Set(&v)
}

// SetCallInfoNil sets the value for CallInfo to be an explicit nil
func (o *PccRule) SetCallInfoNil() {
	o.CallInfo.Set(nil)
}

// UnsetCallInfo ensures that no value is present for CallInfo, not even an explicit nil
func (o *PccRule) UnsetCallInfo() {
	o.CallInfo.Unset()
}

// GetTraffParaData returns the TraffParaData field value if set, zero value otherwise.
func (o *PccRule) GetTraffParaData() TrafficParaData {
	if o == nil || openapi.IsNil(o.TraffParaData) {
		var ret TrafficParaData
		return ret
	}
	return *o.TraffParaData
}

// GetTraffParaDataOk returns a tuple with the TraffParaData field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PccRule) GetTraffParaDataOk() (*TrafficParaData, bool) {
	if o == nil || openapi.IsNil(o.TraffParaData) {
		return nil, false
	}
	return o.TraffParaData, true
}

// HasTraffParaData returns a boolean if a field has been set.
func (o *PccRule) HasTraffParaData() bool {
	if o != nil && !openapi.IsNil(o.TraffParaData) {
		return true
	}
...
// SetTraffParaData gets a reference to the given TrafficParaData and assigns it to the TraffParaData field.
func (o *PccRule) SetTraffParaData(v TrafficParaData) {
	o.TraffParaData = &v
}
...
func (o PccRule) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.AppDescriptor) {
	...
	if !openapi.IsNil(o.RefQosData) {
		toSerialize["refQosData"] = o.RefQosData
	}
	if !openapi.IsNil(o.RefAltQosParams) {
	...
	if !openapi.IsNil(o.DdNotifCtrl) {
	...
	if !openapi.IsNil(o.PackFiltAllPrec) {
	...
	if o.CallInfo.IsSet() {
		toSerialize["callInfo"] = o.CallInfo.Get()
	}
	if !openapi.IsNil(o.TraffParaData) {
		toSerialize["traffParaData"] = o.TraffParaData
	}
