...
var _ openapi.MappedNullable = &NwdafRegistrationModification{}
...
type NwdafRegistrationModification struct {
	...
	AnalyticsIds []EventId `json:"analyticsIds,omitempty" yaml:"analyticsIds,omitempty"`
...
func (o NwdafRegistrationModification) ToMap() (map[string]any, error) {
