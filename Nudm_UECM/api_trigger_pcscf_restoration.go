...
type TriggerPCSCFRestorationAPI interface {
	...
	*/
	TriggerPCSCFRestoration(ctx context.Context) ApiTriggerPCSCFRestorationRequest

	// TriggerPCSCFRestorationExecute executes the request
	TriggerPCSCFRestorationExecute(r ApiTriggerPCSCFRestorationRequest) (*http.Response, error)
}
...
type ApiTriggerPCSCFRestorationRequest struct {
	ctx            context.Context
	ApiService     TriggerPCSCFRestorationAPI
	triggerRequest *models.TriggerRequest
}

func (r ApiTriggerPCSCFRestorationRequest) TriggerRequest(triggerRequest models.TriggerRequest) ApiTriggerPCSCFRestorationRequest {
	r.triggerRequest = &triggerRequest
	return r
}

func (r ApiTriggerPCSCFRestorationRequest) Execute() (*http.Response, error) {
	return r.ApiService.TriggerPCSCFRestorationExecute(r)
}
...
func (a *TriggerPCSCFRestorationAPIService) TriggerPCSCFRestorationExecute(r ApiTriggerPCSCFRestorationRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TriggerPCSCFRestorationAPIService.TriggerPCSCFRestoration")
	if err != nil {
		return nil, &openapi.GenericOpenAPIError{RawError: err.Error()}
	}

	localVarPath := localBasePath + "/restore-pcscf"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.triggerRequest == nil {
		return nil, openapi.ReportError("triggerRequest is required and must be specified")
	}
