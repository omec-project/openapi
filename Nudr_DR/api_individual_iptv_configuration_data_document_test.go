...
func Test_Nudr_DR_IndividualIPTVConfigurationDataDocumentAPIService(t *testing.T) {
	t.Run("Test IndividualIPTVConfigurationDataDocumentAPIService CreateOrReplaceIndividualIPTVConfigurationData", func(t *testing.T) {
		...
		t.Skip("skip autogenerated mock test for operations with required non-path parameter iptvConfigData")
	...
	t.Run("Test IndividualIPTVConfigurationDataDocumentAPIService DeleteIndividualIPTVConfigurationData", func(t *testing.T) {
		...
		httpRes, err := apiClient.IndividualIPTVConfigurationDataDocumentAPI.DeleteIndividualIPTVConfigurationData(context.Background(), configurationId).Execute()
	...
	t.Run("Test IndividualIPTVConfigurationDataDocumentAPIService PartialReplaceIndividualIPTVConfigurationData", func(t *testing.T) {
		t.Skip("skip autogenerated mock test for operations with response bodies")
		t.Skip("skip autogenerated mock test for operations with required non-path parameter iptvConfigDataPatch")
		var configurationId string
