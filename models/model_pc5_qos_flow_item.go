...
var _ openapi.MappedNullable = &Pc5QosFlowItem{}

// Pc5QosFlowItem Contains a PC5 QOS flow.
type Pc5QosFlowItem struct {
	// Unsigned integer representing a 5G QoS Identifier (see clause 5.7.2.1 of 3GPP TS 23.501, within the range 0 to 255.
	Pqi             int32            `json:"pqi" yaml:"pqi"`
	Pc5FlowBitRates *Pc5FlowBitRates `json:"pc5FlowBitRates,omitempty" yaml:"pc5FlowBitRates,omitempty"`
	// Unsigned Integer, i.e. only value 0 and integers above 0 are permissible.
	Range *int32 `json:"range,omitempty" yaml:"range,omitempty"`
}
...
func (o *Pc5QosFlowItem) GetPc5FlowBitRates() Pc5FlowBitRates {
	if o == nil || openapi.IsNil(o.Pc5FlowBitRates) {
...
func (o Pc5QosFlowItem) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["pqi"] = o.Pqi
	if !openapi.IsNil(o.Pc5FlowBitRates) {
