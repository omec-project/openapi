...
var _ openapi.MappedNullable = &NonUeN2MessageTransferRequest{}

// NonUeN2MessageTransferRequest struct for NonUeN2MessageTransferRequest
type NonUeN2MessageTransferRequest struct {
	JsonData                *N2InformationTransferReqData `json:"jsonData,omitempty" yaml:"jsonData,omitempty" multipart:"contentType:application/json,ref:{jsonData}"`
...
func (o NonUeN2MessageTransferRequest) ToMap() (map[string]any, error) {
