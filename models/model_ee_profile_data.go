...
var _ openapi.MappedNullable = &EeProfileData{}

// EeProfileData Event Exposure Profile Data.
type EeProfileData struct {
	RestrictedEventTypes []EventTypeUdm `json:"restrictedEventTypes,omitempty" yaml:"restrictedEventTypes,omitempty"`
	...
	AllowedMtcProvider *map[string][]MtcProvider `json:"allowedMtcProvider,omitempty" yaml:"allowedMtcProvider,omitempty"`
	IwkEpcRestricted   *bool                     `json:"iwkEpcRestricted,omitempty" yaml:"iwkEpcRestricted,omitempty"`
...
func (o *EeProfileData) GetRestrictedEventTypes() []EventTypeUdm {
	if o == nil || openapi.IsNil(o.RestrictedEventTypes) {
...
func (o *EeProfileData) GetRestrictedEventTypesOk() ([]EventTypeUdm, bool) {
	if o == nil || openapi.IsNil(o.RestrictedEventTypes) {
		return nil, false
	}
...
// SetRestrictedEventTypes gets a reference to the given []EventTypeUdm and assigns it to the RestrictedEventTypes field.
func (o *EeProfileData) SetRestrictedEventTypes(v []EventTypeUdm) {
...
func (o *EeProfileData) GetAllowedMtcProvider() map[string][]MtcProvider {
	if o == nil || openapi.IsNil(o.AllowedMtcProvider) {
...
func (o *EeProfileData) GetIwkEpcRestricted() bool {
	if o == nil || openapi.IsNil(o.IwkEpcRestricted) {
		var ret bool
		return ret
	}
...
func (o EeProfileData) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.RestrictedEventTypes) {
		toSerialize["restrictedEventTypes"] = o.RestrictedEventTypes
	}
	if !openapi.IsNil(o.SupportedFeatures) {
		toSerialize["supportedFeatures"] = o.SupportedFeatures
	}
	if !openapi.IsNil(o.AllowedMtcProvider) {
		toSerialize["allowedMtcProvider"] = o.AllowedMtcProvider
	}
	if !openapi.IsNil(o.IwkEpcRestricted) {
