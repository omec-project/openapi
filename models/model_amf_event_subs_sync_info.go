...
var _ openapi.MappedNullable = &AmfEventSubsSyncInfo{}

// AmfEventSubsSyncInfo AMF Event Subscriptions Information for synchronization
type AmfEventSubsSyncInfo struct {
	SubscriptionList []AmfEventSubscriptionInfo `json:"subscriptionList" yaml:"subscriptionList"`
}
...
func (o AmfEventSubsSyncInfo) ToMap() (map[string]any, error) {
