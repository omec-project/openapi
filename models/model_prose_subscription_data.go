...
var _ openapi.MappedNullable = &ProseSubscriptionData{}
...
func (o *ProseSubscriptionData) GetProseServiceAuth() ProseServiceAuth {
	if o == nil || openapi.IsNil(o.ProseServiceAuth) {
...
func (o *ProseSubscriptionData) GetProseAllowedPlmn() []ProSeAllowedPlmn {
	if o == nil || openapi.IsNil(o.ProseAllowedPlmn) {
...
func (o ProseSubscriptionData) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.ProseServiceAuth) {
		toSerialize["proseServiceAuth"] = o.ProseServiceAuth
	}
	if !openapi.IsNil(o.NrUePc5Ambr) {
		toSerialize["nrUePc5Ambr"] = o.NrUePc5Ambr
	}
	if !openapi.IsNil(o.ProseAllowedPlmn) {
