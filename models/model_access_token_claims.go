...
var _ openapi.MappedNullable = &AccessTokenClaims{}
...
type AccessTokenClaims struct {
	...
	Aud                AccessTokenClaimsAud `json:"aud" yaml:"aud"`
	Scope              string               `json:"scope" yaml:"scope" validate:"regexp=^([a-zA-Z0-9_:-]+)( [a-zA-Z0-9_:-]+)*$"`
	Exp                int32                `json:"exp" yaml:"exp"`
	ConsumerPlmnId     *PlmnId              `json:"consumerPlmnId,omitempty" yaml:"consumerPlmnId,omitempty"`
	ConsumerSnpnId     *PlmnIdNid           `json:"consumerSnpnId,omitempty" yaml:"consumerSnpnId,omitempty"`
	ProducerPlmnId     *PlmnId              `json:"producerPlmnId,omitempty" yaml:"producerPlmnId,omitempty"`
	ProducerSnpnId     *PlmnIdNid           `json:"producerSnpnId,omitempty" yaml:"producerSnpnId,omitempty"`
	ProducerSnssaiList []Snssai             `json:"producerSnssaiList,omitempty" yaml:"producerSnssaiList,omitempty"`
	ProducerNsiList    []string             `json:"producerNsiList,omitempty" yaml:"producerNsiList,omitempty"`
	...
	ProducerNfSetId *string `json:"producerNfSetId,omitempty" yaml:"producerNfSetId,omitempty"`
	...
	ProducerNfServiceSetId *string `json:"producerNfServiceSetId,omitempty" yaml:"producerNfServiceSetId,omitempty"`
	// String uniquely identifying a NF instance. The format of the NF Instance ID shall be a  Universally Unique Identifier (UUID) version 4, as described in IETF RFC 4122.
...
func (o *AccessTokenClaims) GetConsumerPlmnId() PlmnId {
	if o == nil || openapi.IsNil(o.ConsumerPlmnId) {
		var ret PlmnId
		return ret
	}
...
func (o *AccessTokenClaims) GetConsumerSnpnId() PlmnIdNid {
	if o == nil || openapi.IsNil(o.ConsumerSnpnId) {
		var ret PlmnIdNid
		return ret
	}
...
func (o *AccessTokenClaims) GetProducerPlmnId() PlmnId {
	if o == nil || openapi.IsNil(o.ProducerPlmnId) {
		var ret PlmnId
		return ret
	}
...
func (o *AccessTokenClaims) GetProducerSnpnId() PlmnIdNid {
	if o == nil || openapi.IsNil(o.ProducerSnpnId) {
		var ret PlmnIdNid
		return ret
	}
...
func (o *AccessTokenClaims) GetProducerSnssaiList() []Snssai {
	if o == nil || openapi.IsNil(o.ProducerSnssaiList) {
		var ret []Snssai
		return ret
	}
...
func (o *AccessTokenClaims) GetProducerNsiList() []string {
	if o == nil || openapi.IsNil(o.ProducerNsiList) {
		var ret []string
		return ret
	}
...
func (o *AccessTokenClaims) GetProducerNfSetId() string {
	if o == nil || openapi.IsNil(o.ProducerNfSetId) {
		var ret string
		return ret
	}
...
func (o *AccessTokenClaims) GetProducerNfServiceSetId() string {
	if o == nil || openapi.IsNil(o.ProducerNfServiceSetId) {
		var ret string
		return ret
	}
...
func (o AccessTokenClaims) ToMap() (map[string]any, error) {
