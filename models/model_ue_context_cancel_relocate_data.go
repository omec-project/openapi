...
var _ openapi.MappedNullable = &UeContextCancelRelocateData{}
...
type UeContextCancelRelocateData struct {
	...
	RelocationCancelRequest RefToBinaryData `json:"relocationCancelRequest" yaml:"relocationCancelRequest"`
}
...
func (o UeContextCancelRelocateData) ToMap() (map[string]any, error) {
