...
var _ openapi.MappedNullable = &TransferMtDataError{}
...
func (o *TransferMtDataError) GetNoProfileMatchInfo() NoProfileMatchInfo {
...
// and a boolean to check if the value has been set.
func (o *TransferMtDataError) GetNoProfileMatchInfoOk() (*NoProfileMatchInfo, bool) {
	if o == nil || openapi.IsNil(o.NoProfileMatchInfo) {
		return nil, false
	}
...
func (o *TransferMtDataError) HasNoProfileMatchInfo() bool {
	if o != nil && !openapi.IsNil(o.NoProfileMatchInfo) {
		return true
	}
...
func (o *TransferMtDataError) SetNoProfileMatchInfo(v NoProfileMatchInfo) {
...
func (o TransferMtDataError) ToMap() (map[string]any, error) {
