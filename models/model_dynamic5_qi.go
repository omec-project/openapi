...
var _ openapi.MappedNullable = &Dynamic5Qi{}
...
type Dynamic5Qi struct {
	...
	PacketErrRate string `json:"packetErrRate" yaml:"packetErrRate" validate:"regexp=^([0-9]E-[0-9])$"`
	...
	// Unsigned integer indicating Maximum Data Burst Volume (see clauses 5.7.3.7 and 5.7.4 of 3GPP TS 23.501), expressed in Bytes.
	ExtMaxDataBurstVol *int32 `json:"extMaxDataBurstVol,omitempty" yaml:"extMaxDataBurstVol,omitempty"`
	...
	ExtPacketDelBudget *int32 `json:"extPacketDelBudget,omitempty" yaml:"extPacketDelBudget,omitempty"`
	// Unsigned integer indicating Packet Delay Budget (see clauses 5.7.3.4 and 5.7.4 of 3GPP TS 23.501 [8])), expressed in 0.01 milliseconds.
	CnPacketDelayBudgetDl *int32 `json:"cnPacketDelayBudgetDl,omitempty" yaml:"cnPacketDelayBudgetDl,omitempty"`
	// Unsigned integer indicating Packet Delay Budget (see clauses 5.7.3.4 and 5.7.4 of 3GPP TS 23.501 [8])), expressed in 0.01 milliseconds.
	CnPacketDelayBudgetUl *int32 `json:"cnPacketDelayBudgetUl,omitempty" yaml:"cnPacketDelayBudgetUl,omitempty"`
}
...
func (o *Dynamic5Qi) GetAverWindow() int32 {
	if o == nil || openapi.IsNil(o.AverWindow) {
		var ret int32
		return ret
	}
	return *o.AverWindow
...
func (o *Dynamic5Qi) GetExtMaxDataBurstVol() int32 {
	if o == nil || openapi.IsNil(o.ExtMaxDataBurstVol) {
		var ret int32
		return ret
	}
...
func (o *Dynamic5Qi) GetExtPacketDelBudget() int32 {
	if o == nil || openapi.IsNil(o.ExtPacketDelBudget) {
		var ret int32
		return ret
	}
...
func (o *Dynamic5Qi) GetCnPacketDelayBudgetDl() int32 {
	if o == nil || openapi.IsNil(o.CnPacketDelayBudgetDl) {
		var ret int32
		return ret
	}
...
func (o *Dynamic5Qi) GetCnPacketDelayBudgetUl() int32 {
	if o == nil || openapi.IsNil(o.CnPacketDelayBudgetUl) {
		var ret int32
		return ret
	}
...
func (o Dynamic5Qi) ToMap() (map[string]any, error) {
