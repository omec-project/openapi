...
type AMFGroupSubscriptionInfoDocumentAPI interface {
	...
	*/
	CreateAmfGroupSubscriptions(ctx context.Context, ueGroupId string, subsId string) ApiCreateAmfGroupSubscriptionsRequest

	// CreateAmfGroupSubscriptionsExecute executes the request
	//   @return []AmfSubscriptionInfo
	CreateAmfGroupSubscriptionsExecute(r ApiCreateAmfGroupSubscriptionsRequest) ([]models.AmfSubscriptionInfo, *http.Response, error)
}
...
type ApiCreateAmfGroupSubscriptionsRequest struct {
	ctx                 context.Context
	ApiService          AMFGroupSubscriptionInfoDocumentAPI
	ueGroupId           string
	subsId              string
	amfSubscriptionInfo *[]models.AmfSubscriptionInfo
}

func (r ApiCreateAmfGroupSubscriptionsRequest) AmfSubscriptionInfo(amfSubscriptionInfo []models.AmfSubscriptionInfo) ApiCreateAmfGroupSubscriptionsRequest {
	r.amfSubscriptionInfo = &amfSubscriptionInfo
	return r
}

func (r ApiCreateAmfGroupSubscriptionsRequest) Execute() ([]models.AmfSubscriptionInfo, *http.Response, error) {
...
//
//	@return []AmfSubscriptionInfo
func (a *AMFGroupSubscriptionInfoDocumentAPIService) CreateAmfGroupSubscriptionsExecute(r ApiCreateAmfGroupSubscriptionsRequest) ([]models.AmfSubscriptionInfo, *http.Response, error) {
	var (
