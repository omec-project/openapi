...
var _ openapi.MappedNullable = &ReachabilityForSmsReport{}

// ReachabilityForSmsReport struct for ReachabilityForSmsReport
type ReachabilityForSmsReport struct {
	SmsfAccessType AccessType `json:"smsfAccessType" yaml:"smsfAccessType"`
...
func (o ReachabilityForSmsReport) ToMap() (map[string]any, error) {
