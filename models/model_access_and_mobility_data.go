...
var _ openapi.MappedNullable = &AccessAndMobilityData{}
...
type AccessAndMobilityData struct {
	...
	LocationTs *time.Time `json:"locationTs,omitempty" yaml:"locationTs,omitempty"`
	// String with format \"time-numoffset\" optionally appended by \"daylightSavingTime\", where  - \"time-numoffset\" shall represent the time zone adjusted for daylight saving time and be    encoded as time-numoffset as defined in clause 5.6 of IETF RFC 3339;  - \"daylightSavingTime\" shall represent the adjustment that has been made and shall be    encoded as \"+1\" or \"+2\" for a +1 or +2 hours adjustment.   The example is for 8 hours behind UTC, +1 hour adjustment for Daylight Saving Time.
	TimeZone *string `json:"timeZone,omitempty" yaml:"timeZone,omitempty"`
	// string with format 'date-time' as defined in OpenAPI.
	TimeZoneTs *time.Time  `json:"timeZoneTs,omitempty" yaml:"timeZoneTs,omitempty"`
	AccessType *AccessType `json:"accessType,omitempty" yaml:"accessType,omitempty"`
	RegStates  []RmInfo    `json:"regStates,omitempty" yaml:"regStates,omitempty"`
	// string with format 'date-time' as defined in OpenAPI.
	RegStatesTs *time.Time `json:"regStatesTs,omitempty" yaml:"regStatesTs,omitempty"`
	ConnStates  []CmInfo   `json:"connStates,omitempty" yaml:"connStates,omitempty"`
	// string with format 'date-time' as defined in OpenAPI.
	ConnStatesTs       *time.Time      `json:"connStatesTs,omitempty" yaml:"connStatesTs,omitempty"`
	ReachabilityStatus *UeReachability `json:"reachabilityStatus,omitempty" yaml:"reachabilityStatus,omitempty"`
	// string with format 'date-time' as defined in OpenAPI.
	ReachabilityStatusTs *time.Time  `json:"reachabilityStatusTs,omitempty" yaml:"reachabilityStatusTs,omitempty"`
	SmsOverNasStatus     *SmsSupport `json:"smsOverNasStatus,omitempty" yaml:"smsOverNasStatus,omitempty"`
	// string with format 'date-time' as defined in OpenAPI.
	SmsOverNasStatusTs *time.Time `json:"smsOverNasStatusTs,omitempty" yaml:"smsOverNasStatusTs,omitempty"`
	...
	RoamingStatus *bool `json:"roamingStatus,omitempty" yaml:"roamingStatus,omitempty"`
	// string with format 'date-time' as defined in OpenAPI.
	RoamingStatusTs *time.Time `json:"roamingStatusTs,omitempty" yaml:"roamingStatusTs,omitempty"`
	CurrentPlmn     *PlmnId    `json:"currentPlmn,omitempty" yaml:"currentPlmn,omitempty"`
	// string with format 'date-time' as defined in OpenAPI.
	CurrentPlmnTs *time.Time `json:"currentPlmnTs,omitempty" yaml:"currentPlmnTs,omitempty"`
	RatType       []RatType  `json:"ratType,omitempty" yaml:"ratType,omitempty"`
	// string with format 'date-time' as defined in OpenAPI.
	RatTypesTs *time.Time `json:"ratTypesTs,omitempty" yaml:"ratTypesTs,omitempty"`
...
func (o *AccessAndMobilityData) GetLocationTs() time.Time {
	if o == nil || openapi.IsNil(o.LocationTs) {
		var ret time.Time
		return ret
	}
	return *o.LocationTs
...
func (o *AccessAndMobilityData) GetTimeZoneTs() time.Time {
	if o == nil || openapi.IsNil(o.TimeZoneTs) {
		var ret time.Time
		return ret
	}
	return *o.TimeZoneTs
...
func (o *AccessAndMobilityData) GetRegStates() []RmInfo {
	if o == nil || openapi.IsNil(o.RegStates) {
		var ret []RmInfo
		return ret
	}
	return o.RegStates
...
func (o *AccessAndMobilityData) GetRegStatesTs() time.Time {
	if o == nil || openapi.IsNil(o.RegStatesTs) {
		var ret time.Time
		return ret
	}
...
func (o *AccessAndMobilityData) GetConnStates() []CmInfo {
	if o == nil || openapi.IsNil(o.ConnStates) {
		var ret []CmInfo
		return ret
	}
	return o.ConnStates
...
func (o *AccessAndMobilityData) GetConnStatesTs() time.Time {
	if o == nil || openapi.IsNil(o.ConnStatesTs) {
		var ret time.Time
		return ret
	}
...
func (o *AccessAndMobilityData) GetReachabilityStatus() UeReachability {
	if o == nil || openapi.IsNil(o.ReachabilityStatus) {
...
func (o *AccessAndMobilityData) GetReachabilityStatusTs() time.Time {
	if o == nil || openapi.IsNil(o.ReachabilityStatusTs) {
		var ret time.Time
		return ret
	}
...
func (o *AccessAndMobilityData) GetSmsOverNasStatus() SmsSupport {
	if o == nil || openapi.IsNil(o.SmsOverNasStatus) {
		var ret SmsSupport
		return ret
	}
...
func (o *AccessAndMobilityData) GetSmsOverNasStatusTs() time.Time {
	if o == nil || openapi.IsNil(o.SmsOverNasStatusTs) {
		var ret time.Time
		return ret
	}
...
func (o *AccessAndMobilityData) GetRoamingStatus() bool {
	if o == nil || openapi.IsNil(o.RoamingStatus) {
		var ret bool
		return ret
	}
...
func (o *AccessAndMobilityData) GetRoamingStatusTs() time.Time {
	if o == nil || openapi.IsNil(o.RoamingStatusTs) {
		var ret time.Time
		return ret
	}
...
func (o *AccessAndMobilityData) GetCurrentPlmn() PlmnId {
	if o == nil || openapi.IsNil(o.CurrentPlmn) {
		var ret PlmnId
		return ret
	}
...
func (o *AccessAndMobilityData) GetCurrentPlmnTs() time.Time {
	if o == nil || openapi.IsNil(o.CurrentPlmnTs) {
		var ret time.Time
		return ret
	}
...
func (o *AccessAndMobilityData) GetRatTypesTs() time.Time {
	if o == nil || openapi.IsNil(o.RatTypesTs) {
		var ret time.Time
		return ret
	}
	return *o.RatTypesTs
