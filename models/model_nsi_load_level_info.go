...
var _ openapi.MappedNullable = &NsiLoadLevelInfo{}
...
type NsiLoadLevelInfo struct {
	...
	LoadLevelInformation int32  `json:"loadLevelInformation" yaml:"loadLevelInformation"`
	...
	ResUsage *ResourceUsage `json:"resUsage,omitempty" yaml:"resUsage,omitempty"`
	// Unsigned Integer, i.e. only value 0 and integers above 0 are permissible.
	NumOfExceedLoadLevelThr *int32 `json:"numOfExceedLoadLevelThr,omitempty" yaml:"numOfExceedLoadLevelThr,omitempty"`
	...
	ExceedLoadLevelThrInd *bool            `json:"exceedLoadLevelThrInd,omitempty" yaml:"exceedLoadLevelThrInd,omitempty"`
	NetworkArea           *NetworkAreaInfo `json:"networkArea,omitempty" yaml:"networkArea,omitempty"`
	TimePeriod            *TimeWindow      `json:"timePeriod,omitempty" yaml:"timePeriod,omitempty"`
	...
	ResUsgThrCrossTimePeriod []TimeWindow   `json:"resUsgThrCrossTimePeriod,omitempty" yaml:"resUsgThrCrossTimePeriod,omitempty"`
	NumOfUes                 *NumberAverage `json:"numOfUes,omitempty" yaml:"numOfUes,omitempty"`
	NumOfPduSess             *NumberAverage `json:"numOfPduSess,omitempty" yaml:"numOfPduSess,omitempty"`
	// Unsigned Integer, i.e. only value 0 and integers above 0 are permissible.
...
func (o *NsiLoadLevelInfo) GetResUsage() ResourceUsage {
	if o == nil || openapi.IsNil(o.ResUsage) {
...
func (o *NsiLoadLevelInfo) GetNumOfExceedLoadLevelThr() int32 {
	if o == nil || openapi.IsNil(o.NumOfExceedLoadLevelThr) {
		var ret int32
		return ret
	}
...
func (o *NsiLoadLevelInfo) GetExceedLoadLevelThrInd() bool {
	if o == nil || openapi.IsNil(o.ExceedLoadLevelThrInd) {
		var ret bool
		return ret
	}
...
func (o *NsiLoadLevelInfo) GetResUsgThrCrossTimePeriod() []TimeWindow {
	if o == nil || openapi.IsNil(o.ResUsgThrCrossTimePeriod) {
		var ret []TimeWindow
		return ret
	}
...
func (o *NsiLoadLevelInfo) GetNumOfPduSess() NumberAverage {
	if o == nil || openapi.IsNil(o.NumOfPduSess) {
		var ret NumberAverage
		return ret
	}
...
func (o NsiLoadLevelInfo) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.ResUsage) {
		toSerialize["resUsage"] = o.ResUsage
	}
	if !openapi.IsNil(o.NumOfExceedLoadLevelThr) {
		toSerialize["numOfExceedLoadLevelThr"] = o.NumOfExceedLoadLevelThr
	}
	if !openapi.IsNil(o.ExceedLoadLevelThrInd) {
	...
	if !openapi.IsNil(o.ResUsgThrCrossTimePeriod) {
	...
	if !openapi.IsNil(o.NumOfPduSess) {
