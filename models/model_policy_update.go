...
var _ openapi.MappedNullable = &PolicyUpdate{}
...
type PolicyUpdate struct {
	...
	Pras           map[string]PresenceInfoRm       `json:"pras,omitempty" yaml:"pras,omitempty"`
	PcfUeInfo      NullablePcfUeCallbackInfo       `json:"pcfUeInfo" yaml:"pcfUeInfo,omitempty"`
	MatchPdus      []PduSessionInfo                `json:"matchPdus,omitempty" yaml:"matchPdus,omitempty"`
	AsTimeDisParam NullableAsTimeDistributionParam `json:"asTimeDisParam" yaml:"asTimeDisParam,omitempty"`
	// Contains the network slice replacement information. The key of the map shall be set to the concerned unavailable S-NSSAI provided within the \"snssai\" attribute of the corresponding map entry (encoded using the SnssaiReplaceInfo data structure) to which the network slice replacement information is related.
...
// GetRfspValTime returns the RfspValTime field value if set, zero value otherwise.
func (o *PolicyUpdate) GetRfspValTime() int32 {
	if o == nil || openapi.IsNil(o.RfspValTime) {
		var ret int32
		return ret
	}
	return *o.RfspValTime
}

// GetRfspValTimeOk returns a tuple with the RfspValTime field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PolicyUpdate) GetRfspValTimeOk() (*int32, bool) {
	if o == nil || openapi.IsNil(o.RfspValTime) {
		return nil, false
	}
	return o.RfspValTime, true
}

// HasRfspValTime returns a boolean if a field has been set.
func (o *PolicyUpdate) HasRfspValTime() bool {
	if o != nil && !openapi.IsNil(o.RfspValTime) {
		return true
	}
...
// SetRfspValTime gets a reference to the given int32 and assigns it to the RfspValTime field.
func (o *PolicyUpdate) SetRfspValTime(v int32) {
	o.RfspValTime = &v
}

// GetTargetRfsp returns the TargetRfsp field value if set, zero value otherwise.
func (o *PolicyUpdate) GetTargetRfsp() int32 {
	if o == nil || openapi.IsNil(o.TargetRfsp) {
		var ret int32
		return ret
	}
	return *o.TargetRfsp
...
func (o *PolicyUpdate) GetMatchPdusOk() ([]PduSessionInfo, bool) {
	if o == nil || openapi.IsNil(o.MatchPdus) {
		return nil, false
	}
...
// GetSnssaiReplInfos returns the SnssaiReplInfos field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *PolicyUpdate) GetSnssaiReplInfos() map[string]SnssaiReplaceInfo {
	if o == nil {
		var ret map[string]SnssaiReplaceInfo
		return ret
	}
	return o.SnssaiReplInfos
}

// GetSnssaiReplInfosOk returns a tuple with the SnssaiReplInfos field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PolicyUpdate) GetSnssaiReplInfosOk() (*map[string]SnssaiReplaceInfo, bool) {
	if o == nil || openapi.IsNil(o.SnssaiReplInfos) {
		return nil, false
	}
	return &o.SnssaiReplInfos, true
}

// HasSnssaiReplInfos returns a boolean if a field has been set.
func (o *PolicyUpdate) HasSnssaiReplInfos() bool {
	if o != nil && !openapi.IsNil(o.SnssaiReplInfos) {
		return true
	}
...
// SetSnssaiReplInfos gets a reference to the given map[string]SnssaiReplaceInfo and assigns it to the SnssaiReplInfos field.
func (o *PolicyUpdate) SetSnssaiReplInfos(v map[string]SnssaiReplaceInfo) {
	o.SnssaiReplInfos = v
}

// GetSliceUsgCtrlInfoSets returns the SliceUsgCtrlInfoSets field value if set, zero value otherwise.
func (o *PolicyUpdate) GetSliceUsgCtrlInfoSets() map[string]SliceUsgCtrlInfo {
	if o == nil || openapi.IsNil(o.SliceUsgCtrlInfoSets) {
		var ret map[string]SliceUsgCtrlInfo
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *PolicyUpdate) GetSliceUsgCtrlInfoSetsOk() (*map[string]SliceUsgCtrlInfo, bool) {
	if o == nil || openapi.IsNil(o.SliceUsgCtrlInfoSets) {
		return nil, false
	}
...
func (o *PolicyUpdate) HasSliceUsgCtrlInfoSets() bool {
	if o != nil && !openapi.IsNil(o.SliceUsgCtrlInfoSets) {
		return true
	}
...
// SetSliceUsgCtrlInfoSets gets a reference to the given map[string]SliceUsgCtrlInfo and assigns it to the SliceUsgCtrlInfoSets field.
func (o *PolicyUpdate) SetSliceUsgCtrlInfoSets(v map[string]SliceUsgCtrlInfo) {
...
func (o PolicyUpdate) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.RfspValTime) {
		toSerialize["rfspValTime"] = o.RfspValTime
	}
	if !openapi.IsNil(o.TargetRfsp) {
	...
	if o.SnssaiReplInfos != nil {
		toSerialize["snssaiReplInfos"] = o.SnssaiReplInfos
	}
