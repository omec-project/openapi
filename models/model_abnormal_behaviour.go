...
var _ openapi.MappedNullable = &AbnormalBehaviour{}
...
type AbnormalBehaviour struct {
	...
	Excep Exception `json:"excep" yaml:"excep"`
	...
	AddtMeasInfo *AdditionalMeasurement `json:"addtMeasInfo,omitempty" yaml:"addtMeasInfo,omitempty"`
}
...
func (o *AbnormalBehaviour) GetAddtMeasInfo() AdditionalMeasurement {
	if o == nil || openapi.IsNil(o.AddtMeasInfo) {
...
func (o AbnormalBehaviour) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.AddtMeasInfo) {
