...
var _ openapi.MappedNullable = &RetrieveData{}

// RetrieveData Data within Retrieve Request
type RetrieveData struct {
	SmallDataRateStatusReq *bool                  `json:"smallDataRateStatusReq,omitempty" yaml:"smallDataRateStatusReq,omitempty"`
	PduSessionContextType  *PduSessionContextType `json:"pduSessionContextType,omitempty" yaml:"pduSessionContextType,omitempty"`
}
...
func (o *RetrieveData) GetSmallDataRateStatusReq() bool {
	if o == nil || openapi.IsNil(o.SmallDataRateStatusReq) {
		var ret bool
		return ret
	}
...
func (o *RetrieveData) GetPduSessionContextType() PduSessionContextType {
	if o == nil || openapi.IsNil(o.PduSessionContextType) {
...
func (o RetrieveData) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.SmallDataRateStatusReq) {
		toSerialize["smallDataRateStatusReq"] = o.SmallDataRateStatusReq
	}
	if !openapi.IsNil(o.PduSessionContextType) {
