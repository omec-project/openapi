...
var _ openapi.MappedNullable = &UpdatePduSession400Response{}

// UpdatePduSession400Response struct for UpdatePduSession400Response
type UpdatePduSession400Response struct {
	JsonData               *HsmfUpdateError `json:"jsonData,omitempty" yaml:"jsonData,omitempty" multipart:"contentType:application/json,ref:{jsonData}"`
...
func (o UpdatePduSession400Response) ToMap() (map[string]any, error) {
