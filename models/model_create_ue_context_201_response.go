...
var _ openapi.MappedNullable = &CreateUEContext201Response{}

// CreateUEContext201Response struct for CreateUEContext201Response
type CreateUEContext201Response struct {
	JsonData                     *UeContextCreatedData `json:"jsonData,omitempty" yaml:"jsonData,omitempty" multipart:"contentType:application/json,ref:{jsonData}"`
...
func (o CreateUEContext201Response) ToMap() (map[string]any, error) {
