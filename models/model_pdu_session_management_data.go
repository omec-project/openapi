...
var _ openapi.MappedNullable = &PduSessionManagementData{}
...
type PduSessionManagementData struct {
	PduSessionStatus *PduSessionStatusUdr `json:"pduSessionStatus,omitempty" yaml:"pduSessionStatus,omitempty"`
	// string with format 'date-time' as defined in OpenAPI.
	PduSessionStatusTs *time.Time `json:"pduSessionStatusTs,omitempty" yaml:"pduSessionStatusTs,omitempty"`
	// DNAI (Data network access identifier), see clause 5.6.7 of 3GPP TS 23.501.
	Dnai *string `json:"dnai,omitempty" yaml:"dnai,omitempty"`
	// string with format 'date-time' as defined in OpenAPI.
	DnaiTs               *time.Time        `json:"dnaiTs,omitempty" yaml:"dnaiTs,omitempty"`
	N6TrafficRoutingInfo []RouteToLocation `json:"n6TrafficRoutingInfo,omitempty" yaml:"n6TrafficRoutingInfo,omitempty"`
	// string with format 'date-time' as defined in OpenAPI.
	N6TrafficRoutingInfoTs *time.Time `json:"n6TrafficRoutingInfoTs,omitempty" yaml:"n6TrafficRoutingInfoTs,omitempty"`
	...
	// UE IPv6 prefix.
	Ipv6Prefix  []string        `json:"ipv6Prefix,omitempty" yaml:"ipv6Prefix,omitempty"`
	...
	// string with format 'date-time' as defined in OpenAPI.
	IpAddrTs *time.Time `json:"ipAddrTs,omitempty" yaml:"ipAddrTs,omitempty"`
...
func (o *PduSessionManagementData) GetPduSessionStatus() PduSessionStatusUdr {
	if o == nil || openapi.IsNil(o.PduSessionStatus) {
		var ret PduSessionStatusUdr
		return ret
	}
...
func (o *PduSessionManagementData) GetPduSessionStatusOk() (*PduSessionStatusUdr, bool) {
	if o == nil || openapi.IsNil(o.PduSessionStatus) {
		return nil, false
	}
...
// SetPduSessionStatus gets a reference to the given PduSessionStatusUdr and assigns it to the PduSessionStatus field.
func (o *PduSessionManagementData) SetPduSessionStatus(v PduSessionStatusUdr) {
...
func (o *PduSessionManagementData) GetPduSessionStatusTs() time.Time {
	if o == nil || openapi.IsNil(o.PduSessionStatusTs) {
		var ret time.Time
		return ret
	}
...
func (o *PduSessionManagementData) GetDnaiTs() time.Time {
	if o == nil || openapi.IsNil(o.DnaiTs) {
		var ret time.Time
		return ret
	}
	return *o.DnaiTs
...
func (o *PduSessionManagementData) GetN6TrafficRoutingInfo() []RouteToLocation {
	if o == nil || openapi.IsNil(o.N6TrafficRoutingInfo) {
...
func (o *PduSessionManagementData) GetN6TrafficRoutingInfoTs() time.Time {
	if o == nil || openapi.IsNil(o.N6TrafficRoutingInfoTs) {
		var ret time.Time
		return ret
	}
...
func (o *PduSessionManagementData) GetIpv6Prefix() []string {
...
// and a boolean to check if the value has been set.
func (o *PduSessionManagementData) GetIpv6PrefixOk() ([]string, bool) {
	if o == nil || openapi.IsNil(o.Ipv6Prefix) {
		return nil, false
	}
...
func (o *PduSessionManagementData) SetIpv6Prefix(v []string) {
	o.Ipv6Prefix = v
}

// GetIpv6Addrs returns the Ipv6Addrs field value if set, zero value otherwise.
func (o *PduSessionManagementData) GetIpv6Addrs() []string {
...
// and a boolean to check if the value has been set.
func (o *PduSessionManagementData) GetIpv6AddrsOk() ([]string, bool) {
	if o == nil || openapi.IsNil(o.Ipv6Addrs) {
		return nil, false
	}
...
func (o *PduSessionManagementData) SetIpv6Addrs(v []string) {
	o.Ipv6Addrs = v
}
...
func (o *PduSessionManagementData) GetIpAddrTs() time.Time {
	if o == nil || openapi.IsNil(o.IpAddrTs) {
		var ret time.Time
		return ret
	}
	return *o.IpAddrTs
...
func (o PduSessionManagementData) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.PduSessionStatus) {
		toSerialize["pduSessionStatus"] = o.PduSessionStatus
	}
	if !openapi.IsNil(o.PduSessionStatusTs) {
		toSerialize["pduSessionStatusTs"] = o.PduSessionStatusTs
	}
	if !openapi.IsNil(o.Dnai) {
		toSerialize["dnai"] = o.Dnai
	}
	if !openapi.IsNil(o.DnaiTs) {
		toSerialize["dnaiTs"] = o.DnaiTs
	}
	if !openapi.IsNil(o.N6TrafficRoutingInfo) {
		toSerialize["n6TrafficRoutingInfo"] = o.N6TrafficRoutingInfo
	}
	if !openapi.IsNil(o.N6TrafficRoutingInfoTs) {
