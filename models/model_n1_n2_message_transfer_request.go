...
var _ openapi.MappedNullable = &N1N2MessageTransferRequest{}

// N1N2MessageTransferRequest struct for N1N2MessageTransferRequest
type N1N2MessageTransferRequest struct {
	JsonData                *N1N2MessageTransferReqData `json:"jsonData,omitempty" yaml:"jsonData,omitempty" multipart:"contentType:application/json,ref:{jsonData}"`
	...
	BinaryMtData            **os.File                   `json:"binaryMtData,omitempty" yaml:"binaryMtData,omitempty" multipart:"contentType:application/vnd.3gpp.5gnas,ref:{binaryMtData}"`
}
...
func (o *N1N2MessageTransferRequest) GetBinaryMtData() *os.File {
	if o == nil || openapi.IsNil(o.BinaryMtData) {
		var ret *os.File
		return ret
	}
...
func (o N1N2MessageTransferRequest) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.BinaryMtData) {
