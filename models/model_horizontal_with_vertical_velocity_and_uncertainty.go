...
var _ openapi.MappedNullable = &HorizontalWithVerticalVelocityAndUncertainty{}
...
type HorizontalWithVerticalVelocityAndUncertainty struct {
	...
	VSpeed     float32           `json:"vSpeed" yaml:"vSpeed"`
	VDirection VerticalDirection `json:"vDirection" yaml:"vDirection"`
	// Indicates value of speed uncertainty.
	HUncertainty float32 `json:"hUncertainty" yaml:"hUncertainty"`
	// Indicates value of speed uncertainty.
	VUncertainty float32 `json:"vUncertainty" yaml:"vUncertainty"`
}
...
func (o HorizontalWithVerticalVelocityAndUncertainty) ToMap() (map[string]any, error) {
