...
var _ openapi.MappedNullable = &UsageMonData{}
...
type UsageMonData struct {
	...
	AllowedUsage *UsageThreshold               `json:"allowedUsage,omitempty" yaml:"allowedUsage,omitempty"`
...
func (o *UsageMonData) GetAllowedUsage() UsageThreshold {
	if o == nil || openapi.IsNil(o.AllowedUsage) {
...
func (o *UsageMonData) GetResetTime() time.Time {
	if o == nil || openapi.IsNil(o.ResetTime) {
		var ret time.Time
		return ret
	}
	return *o.ResetTime
...
func (o UsageMonData) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.AllowedUsage) {
		toSerialize["allowedUsage"] = o.AllowedUsage
	}
	if !openapi.IsNil(o.ResetTime) {
