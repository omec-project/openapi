...
type SubscriptionsCollectionAPI interface {
	...
	*/
	...
	CreateSubscriptionExecute(r ApiCreateSubscriptionRequest) (*models.SubscriptionData, *http.Response, error)
}
...
func (a *SubscriptionsCollectionAPIService) CreateSubscriptionExecute(r ApiCreateSubscriptionRequest) (*models.SubscriptionData, *http.Response, error) {
	...
	if r.subscriptionData == nil {
		return localVarReturnValue, nil, openapi.ReportError("subscriptionData is required and must be specified")
	}
