...
var _ openapi.MappedNullable = &ServiceExperienceInfo{}

// ServiceExperienceInfo Represents service experience information.
type ServiceExperienceInfo struct {
	SvcExprc SvcExperience `json:"svcExprc" yaml:"svcExprc"`
	// string with format 'float' as defined in OpenAPI.
	SvcExprcVariance *float32 `json:"svcExprcVariance,omitempty" yaml:"svcExprcVariance,omitempty"`
	...
	SrvExpcType *ServiceExperienceType `json:"srvExpcType,omitempty" yaml:"srvExpcType,omitempty"`
	UeLocs      []LocationInfo         `json:"ueLocs,omitempty" yaml:"ueLocs,omitempty"`
	...
	AppServerInst *AddrFqdn `json:"appServerInst,omitempty" yaml:"appServerInst,omitempty"`
	...
	RatFreq    *RatFreqInformation  `json:"ratFreq,omitempty" yaml:"ratFreq,omitempty"`
	PduSesInfo *PduSessionInfoNwdaf `json:"pduSesInfo,omitempty" yaml:"pduSesInfo,omitempty"`
}
...
func (o *ServiceExperienceInfo) GetSvcExprcVariance() float32 {
	if o == nil || openapi.IsNil(o.SvcExprcVariance) {
		var ret float32
		return ret
	}
...
func (o *ServiceExperienceInfo) GetSrvExpcType() ServiceExperienceType {
	if o == nil || openapi.IsNil(o.SrvExpcType) {
...
func (o *ServiceExperienceInfo) GetUeLocs() []LocationInfo {
	if o == nil || openapi.IsNil(o.UeLocs) {
...
func (o *ServiceExperienceInfo) GetRatFreq() RatFreqInformation {
	if o == nil || openapi.IsNil(o.RatFreq) {
...
// GetPduSesInfo returns the PduSesInfo field value if set, zero value otherwise.
func (o *ServiceExperienceInfo) GetPduSesInfo() PduSessionInfoNwdaf {
	if o == nil || openapi.IsNil(o.PduSesInfo) {
...
// GetPduSesInfoOk returns a tuple with the PduSesInfo field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ServiceExperienceInfo) GetPduSesInfoOk() (*PduSessionInfoNwdaf, bool) {
	if o == nil || openapi.IsNil(o.PduSesInfo) {
		return nil, false
	}
	return o.PduSesInfo, true
}

// HasPduSesInfo returns a boolean if a field has been set.
func (o *ServiceExperienceInfo) HasPduSesInfo() bool {
	if o != nil && !openapi.IsNil(o.PduSesInfo) {
		return true
	}
...
// SetPduSesInfo gets a reference to the given PduSessionInfoNwdaf and assigns it to the PduSesInfo field.
func (o *ServiceExperienceInfo) SetPduSesInfo(v PduSessionInfoNwdaf) {
	o.PduSesInfo = &v
}

func (o ServiceExperienceInfo) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["svcExprc"] = o.SvcExprc
	if !openapi.IsNil(o.SvcExprcVariance) {
	...
	if !openapi.IsNil(o.SrvExpcType) {
		toSerialize["srvExpcType"] = o.SrvExpcType
	}
	if !openapi.IsNil(o.UeLocs) {
	...
	if !openapi.IsNil(o.RatFreq) {
		toSerialize["ratFreq"] = o.RatFreq
	}
	if !openapi.IsNil(o.PduSesInfo) {
		toSerialize["pduSesInfo"] = o.PduSesInfo
	}
