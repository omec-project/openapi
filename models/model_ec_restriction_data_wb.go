...
var _ openapi.MappedNullable = &EcRestrictionDataWb{}

// EcRestrictionDataWb Enhanced Coverage Restriction Data for WB-N1 mode
type EcRestrictionDataWb struct {
	EcModeARestricted *bool `json:"ecModeARestricted,omitempty" yaml:"ecModeARestricted,omitempty"`
	EcModeBRestricted bool  `json:"ecModeBRestricted" yaml:"ecModeBRestricted"`
}
...
func (o EcRestrictionDataWb) ToMap() (map[string]any, error) {
