...
var _ openapi.MappedNullable = &UeTrajectoryCollection{}
...
type UeTrajectoryCollection struct {
	...
	LocArea LocationArea5G `json:"locArea" yaml:"locArea"`
}
...
func (o UeTrajectoryCollection) ToMap() (map[string]any, error) {
