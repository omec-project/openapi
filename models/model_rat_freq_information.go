...
var _ openapi.MappedNullable = &RatFreqInformation{}
...
type RatFreqInformation struct {
	...
	AllFreq *bool `json:"allFreq,omitempty" yaml:"allFreq,omitempty"`
	...
	AllRat *bool `json:"allRat,omitempty" yaml:"allRat,omitempty"`
	...
	Freq            *int32             `json:"freq,omitempty" yaml:"freq,omitempty"`
	RatType         *RatType           `json:"ratType,omitempty" yaml:"ratType,omitempty"`
	SvcExpThreshold *ThresholdLevel    `json:"svcExpThreshold,omitempty" yaml:"svcExpThreshold,omitempty"`
...
func (o *RatFreqInformation) GetAllFreq() bool {
	if o == nil || openapi.IsNil(o.AllFreq) {
		var ret bool
		return ret
	}
	return *o.AllFreq
...
func (o *RatFreqInformation) GetAllRat() bool {
	if o == nil || openapi.IsNil(o.AllRat) {
		var ret bool
		return ret
	}
	return *o.AllRat
...
func (o *RatFreqInformation) GetSvcExpThreshold() ThresholdLevel {
	if o == nil || openapi.IsNil(o.SvcExpThreshold) {
...
func (o RatFreqInformation) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.AllFreq) {
		toSerialize["allFreq"] = o.AllFreq
	}
	if !openapi.IsNil(o.AllRat) {
		toSerialize["allRat"] = o.AllRat
	}
	if !openapi.IsNil(o.Freq) {
		toSerialize["freq"] = o.Freq
	}
	if !openapi.IsNil(o.RatType) {
		toSerialize["ratType"] = o.RatType
	}
	if !openapi.IsNil(o.SvcExpThreshold) {
