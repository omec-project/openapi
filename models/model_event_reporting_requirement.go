...
var _ openapi.MappedNullable = &EventReportingRequirement{}
...
type EventReportingRequirement struct {
	Accuracy *Accuracy `json:"accuracy,omitempty" yaml:"accuracy,omitempty"`
	// Each element indicates the preferred accuracy level per analytics subset. It may be present if the \"listOfAnaSubsets\" attribute is present in the subscription request.
	AccPerSubset []Accuracy `json:"accPerSubset,omitempty" yaml:"accPerSubset,omitempty"`
	// string with format 'date-time' as defined in OpenAPI.
	StartTs *time.Time `json:"startTs,omitempty" yaml:"startTs,omitempty"`
	// string with format 'date-time' as defined in OpenAPI.
	EndTs *time.Time `json:"endTs,omitempty" yaml:"endTs,omitempty"`
	// Offset period in units of seconds to the reporting time, if the value is negative means statistics in the past offset period, otherwise a positive value means prediction in the future offset period. May be present if the \"repPeriod\" attribute is included within the \"evtReq\" attribute or the \"repetitionPeriod\" attribute is included within the EventSubscription type.
	OffsetPeriod *int32 `json:"offsetPeriod,omitempty" yaml:"offsetPeriod,omitempty"`
	// Unsigned integer indicating Sampling Ratio (see clauses 4.15.1 of 3GPP TS 23.502), expressed in percent.
	SampRatio *int32 `json:"sampRatio,omitempty" yaml:"sampRatio,omitempty"`
	// Unsigned Integer, i.e. only value 0 and integers above 0 are permissible.
	MaxObjectNbr *int32 `json:"maxObjectNbr,omitempty" yaml:"maxObjectNbr,omitempty"`
	// Unsigned Integer, i.e. only value 0 and integers above 0 are permissible.
	MaxSupiNbr *int32 `json:"maxSupiNbr,omitempty" yaml:"maxSupiNbr,omitempty"`
	// string with format 'date-time' as defined in OpenAPI.
	TimeAnaNeeded     *time.Time                   `json:"timeAnaNeeded,omitempty" yaml:"timeAnaNeeded,omitempty"`
	AnaMeta           []AnalyticsMetadata          `json:"anaMeta,omitempty" yaml:"anaMeta,omitempty"`
	AnaMetaInd        *AnalyticsMetadataIndication `json:"anaMetaInd,omitempty" yaml:"anaMetaInd,omitempty"`
	HistAnaTimePeriod *TimeWindow                  `json:"histAnaTimePeriod,omitempty" yaml:"histAnaTimePeriod,omitempty"`
}
...
func (o *EventReportingRequirement) GetAccPerSubset() []Accuracy {
	if o == nil || openapi.IsNil(o.AccPerSubset) {
		var ret []Accuracy
		return ret
	}
...
func (o *EventReportingRequirement) GetOffsetPeriod() int32 {
	if o == nil || openapi.IsNil(o.OffsetPeriod) {
		var ret int32
		return ret
	}
...
func (o *EventReportingRequirement) GetMaxObjectNbr() int32 {
	if o == nil || openapi.IsNil(o.MaxObjectNbr) {
		var ret int32
		return ret
	}
...
func (o *EventReportingRequirement) GetMaxSupiNbr() int32 {
	if o == nil || openapi.IsNil(o.MaxSupiNbr) {
		var ret int32
		return ret
	}
	return *o.MaxSupiNbr
...
func (o *EventReportingRequirement) GetTimeAnaNeeded() time.Time {
	if o == nil || openapi.IsNil(o.TimeAnaNeeded) {
		var ret time.Time
		return ret
	}
...
func (o *EventReportingRequirement) GetAnaMeta() []AnalyticsMetadata {
	if o == nil || openapi.IsNil(o.AnaMeta) {
...
func (o *EventReportingRequirement) GetAnaMetaInd() AnalyticsMetadataIndication {
	if o == nil || openapi.IsNil(o.AnaMetaInd) {
...
func (o *EventReportingRequirement) GetHistAnaTimePeriod() TimeWindow {
	if o == nil || openapi.IsNil(o.HistAnaTimePeriod) {
		var ret TimeWindow
		return ret
	}
	return *o.HistAnaTimePeriod
}

// GetHistAnaTimePeriodOk returns a tuple with the HistAnaTimePeriod field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *EventReportingRequirement) GetHistAnaTimePeriodOk() (*TimeWindow, bool) {
	if o == nil || openapi.IsNil(o.HistAnaTimePeriod) {
		return nil, false
	}
	return o.HistAnaTimePeriod, true
}
...
func (o *EventReportingRequirement) SetHistAnaTimePeriod(v TimeWindow) {
	o.HistAnaTimePeriod = &v
}

func (o EventReportingRequirement) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.Accuracy) {
		toSerialize["accuracy"] = o.Accuracy
	}
	if !openapi.IsNil(o.AccPerSubset) {
