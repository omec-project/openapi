...
func (o *ThresholdValue) GetRttThres() int32 {
	if o == nil || openapi.IsNil(o.RttThres.Get()) {
		var ret int32
		return ret
	}
...
// SetRttThres gets a reference to the given openapi.NullableInt32 and assigns it to the RttThres field.
...
func (o *ThresholdValue) GetPlrThres() int32 {
	if o == nil || openapi.IsNil(o.PlrThres.Get()) {
		var ret int32
		return ret
	}
...
// SetPlrThres gets a reference to the given openapi.NullableInt32 and assigns it to the PlrThres field.
...
func (o ThresholdValue) ToMap() (map[string]any, error) {
