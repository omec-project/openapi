...
var _ openapi.MappedNullable = &ConditionData{}
...
type ConditionData struct {
	...
	CondId string `json:"condId" yaml:"condId"`
	// string with format 'date-time' as defined in OpenAPI with 'nullable:true' property.
	ActivationTime openapi.NullableTime `json:"activationTime" yaml:"activationTime,omitempty"`
	// string with format 'date-time' as defined in OpenAPI with 'nullable:true' property.
	DeactivationTime openapi.NullableTime `json:"deactivationTime" yaml:"deactivationTime,omitempty"`
...
func (o *ConditionData) GetActivationTime() time.Time {
	if o == nil || openapi.IsNil(o.ActivationTime.Get()) {
		var ret time.Time
		return ret
	}
...
// SetActivationTime gets a reference to the given openapi.NullableTime and assigns it to the ActivationTime field.
...
func (o *ConditionData) GetDeactivationTime() time.Time {
	if o == nil || openapi.IsNil(o.DeactivationTime.Get()) {
		var ret time.Time
		return ret
	}
...
// SetDeactivationTime gets a reference to the given openapi.NullableTime and assigns it to the DeactivationTime field.
...
func (o ConditionData) ToMap() (map[string]any, error) {
