...
var _ openapi.MappedNullable = &SnssaiRouteSelectionDescriptor{}
...
type SnssaiRouteSelectionDescriptor struct {
	...
	DnnRouteSelDescs []DnnRouteSelectionDescriptor `json:"dnnRouteSelDescs,omitempty" yaml:"dnnRouteSelDescs,omitempty"`
}
...
func (o *SnssaiRouteSelectionDescriptor) GetDnnRouteSelDescs() []DnnRouteSelectionDescriptor {
	if o == nil || openapi.IsNil(o.DnnRouteSelDescs) {
...
func (o SnssaiRouteSelectionDescriptor) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["snssai"] = o.Snssai
	if !openapi.IsNil(o.DnnRouteSelDescs) {
