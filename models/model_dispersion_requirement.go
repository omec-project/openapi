...
var _ openapi.MappedNullable = &DispersionRequirement{}

// DispersionRequirement Represents the dispersion analytics requirements.
type DispersionRequirement struct {
	DisperType      DispersionType               `json:"disperType" yaml:"disperType"`
	ClassCriters    []ClassCriterion             `json:"classCriters,omitempty" yaml:"classCriters,omitempty"`
	RankCriters     []RankingCriterion           `json:"rankCriters,omitempty" yaml:"rankCriters,omitempty"`
	DispOrderCriter *DispersionOrderingCriterion `json:"dispOrderCriter,omitempty" yaml:"dispOrderCriter,omitempty"`
	Order           *MatchingDirection           `json:"order,omitempty" yaml:"order,omitempty"`
}
...
func (o *DispersionRequirement) GetClassCriters() []ClassCriterion {
	if o == nil || openapi.IsNil(o.ClassCriters) {
...
func (o *DispersionRequirement) GetRankCriters() []RankingCriterion {
	if o == nil || openapi.IsNil(o.RankCriters) {
...
func (o *DispersionRequirement) GetDispOrderCriter() DispersionOrderingCriterion {
	if o == nil || openapi.IsNil(o.DispOrderCriter) {
...
func (o DispersionRequirement) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["disperType"] = o.DisperType
	if !openapi.IsNil(o.ClassCriters) {
		toSerialize["classCriters"] = o.ClassCriters
	}
	if !openapi.IsNil(o.RankCriters) {
		toSerialize["rankCriters"] = o.RankCriters
	}
	if !openapi.IsNil(o.DispOrderCriter) {
