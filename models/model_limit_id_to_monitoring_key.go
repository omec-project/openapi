...
var _ openapi.MappedNullable = &LimitIdToMonitoringKey{}
...
type LimitIdToMonitoringKey struct {
	...
	Monkey  []string `json:"monkey,omitempty" yaml:"monkey,omitempty"`
}
...
func (o *LimitIdToMonitoringKey) GetMonkey() []string {
	if o == nil || openapi.IsNil(o.Monkey) {
		var ret []string
		return ret
	}
	return o.Monkey
...
func (o LimitIdToMonitoringKey) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["limitId"] = o.LimitId
	if !openapi.IsNil(o.Monkey) {
