...
type NSSAIACKDocumentAPI interface {
	...
	*/
	QueryNssaiAck(ctx context.Context, ueId string) ApiQueryNssaiAckRequest

	// QueryNssaiAckExecute executes the request
	//   @return NssaiAckData
	QueryNssaiAckExecute(r ApiQueryNssaiAckRequest) (*models.NssaiAckData, *http.Response, error)
}
...
type ApiQueryNssaiAckRequest struct {
	ctx               context.Context
	ApiService        NSSAIACKDocumentAPI
	ueId              string
...
func (r ApiQueryNssaiAckRequest) Execute() (*models.NssaiAckData, *http.Response, error) {
...
//
//	@return NssaiAckData
func (a *NSSAIACKDocumentAPIService) QueryNssaiAckExecute(r ApiQueryNssaiAckRequest) (*models.NssaiAckData, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    any
		formFiles           []formFile
		localVarReturnValue *models.NssaiAckData
	)
