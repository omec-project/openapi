...
var _ openapi.MappedNullable = &PduSessionTsnBridge{}
...
type PduSessionTsnBridge struct {
	TsnBridgeInfo       TsnBridgeInfo              `json:"tsnBridgeInfo" yaml:"tsnBridgeInfo"`
...
func (o *PduSessionTsnBridge) GetUeIpv6AddrPrefix() string {
	if o == nil || openapi.IsNil(o.UeIpv6AddrPrefix) {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *PduSessionTsnBridge) GetUeIpv6AddrPrefixOk() (*string, bool) {
	if o == nil || openapi.IsNil(o.UeIpv6AddrPrefix) {
		return nil, false
	}
...
// SetUeIpv6AddrPrefix gets a reference to the given string and assigns it to the UeIpv6AddrPrefix field.
func (o *PduSessionTsnBridge) SetUeIpv6AddrPrefix(v string) {
	o.UeIpv6AddrPrefix = &v
}

func (o PduSessionTsnBridge) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.UeIpv6AddrPrefix) {
