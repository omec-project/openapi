...
var _ openapi.MappedNullable = &CipherRequestData{}

// CipherRequestData Information within Ciphering Key Data request.
type CipherRequestData struct {
	// String providing an URI formatted according to RFC 3986.
	AmfCallBackURI string `json:"amfCallBackURI" yaml:"amfCallBackURI"`
...
func (o CipherRequestData) ToMap() (map[string]any, error) {
