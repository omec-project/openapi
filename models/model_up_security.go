...
var _ openapi.MappedNullable = &UpSecurity{}

// UpSecurity Contains Userplain security information.
type UpSecurity struct {
	UpIntegr UpIntegrity       `json:"upIntegr" yaml:"upIntegr"`
	UpConfid UpConfidentiality `json:"upConfid" yaml:"upConfid"`
}
...
func (o UpSecurity) ToMap() (map[string]any, error) {
