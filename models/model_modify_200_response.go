...
func (dst *Modify200Response) UnmarshalJSON(data []byte) error {
	...
	err = openapi.NewStrictDecoder(data).Decode(&dst.SdmSubscription)
	if err == nil {
	...
	if match > 1 { // more than 1 match
		...
		return openapi.ReportError("data matches more than one schema in oneOf(Modify200Response)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return openapi.ReportError("data failed to match schemas in oneOf(Modify200Response)")
	}
}
...
func (obj *Modify200Response) GetActualInstance() any {
	if obj == nil {
		return nil
	}
...
func (obj Modify200Response) GetActualInstanceValue() any {
	if obj.PatchResult != nil {
		return *obj.PatchResult
	}
