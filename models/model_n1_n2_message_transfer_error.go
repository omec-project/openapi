...
var _ openapi.MappedNullable = &N1N2MessageTransferError{}
...
type N1N2MessageTransferError struct {
	...
	ErrInfo *N1N2MsgTxfrErrDetail `json:"errInfo,omitempty" yaml:"errInfo,omitempty"`
}
...
func (o *N1N2MessageTransferError) GetErrInfo() N1N2MsgTxfrErrDetail {
	if o == nil || openapi.IsNil(o.ErrInfo) {
...
func (o N1N2MessageTransferError) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["error"] = o.Error
	if !openapi.IsNil(o.ErrInfo) {
