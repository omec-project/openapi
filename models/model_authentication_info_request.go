...
var _ openapi.MappedNullable = &AuthenticationInfoRequest{}
...
type AuthenticationInfoRequest struct {
	...
	AusfInstanceId     string   `json:"ausfInstanceId" yaml:"ausfInstanceId"`
...
func (o *AuthenticationInfoRequest) GetAun3Ind() bool {
...
// and a boolean to check if the value has been set.
func (o *AuthenticationInfoRequest) GetAun3IndOk() (*bool, bool) {
	if o == nil || openapi.IsNil(o.Aun3Ind) {
		return nil, false
	}
...
func (o *AuthenticationInfoRequest) HasAun3Ind() bool {
	if o != nil && !openapi.IsNil(o.Aun3Ind) {
		return true
	}
...
func (o *AuthenticationInfoRequest) SetAun3Ind(v bool) {
	o.Aun3Ind = &v
}

func (o AuthenticationInfoRequest) ToMap() (map[string]any, error) {
