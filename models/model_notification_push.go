...
var _ openapi.MappedNullable = &NotificationPush{}
...
type NotificationPush struct {
	AppIds []string `json:"appIds" yaml:"appIds"`
	// indicating a time in seconds.
	AllowedDelay *int32        `json:"allowedDelay,omitempty" yaml:"allowedDelay,omitempty"`
	PfdOp        *PfdOperation `json:"pfdOp,omitempty" yaml:"pfdOp,omitempty"`
}
...
func (o *NotificationPush) GetPfdOp() PfdOperation {
	if o == nil || openapi.IsNil(o.PfdOp) {
