...
var _ openapi.MappedNullable = &Amf3GppAccessRegistrationModification{}

// Amf3GppAccessRegistrationModification This datatype contains the set of attributes obtained from type  Amf3GppAccessRegistration by deleting attributes that are not subject to modification by HTTP PATCH method.
type Amf3GppAccessRegistrationModification struct {
	...
	UeSrvccCapability   openapi.NullableBool `json:"ueSrvccCapability" yaml:"ueSrvccCapability,omitempty"`
...
func (o *Amf3GppAccessRegistrationModification) GetUeSrvccCapability() bool {
	if o == nil || openapi.IsNil(o.UeSrvccCapability.Get()) {
		var ret bool
		return ret
	}
...
// SetUeSrvccCapability gets a reference to the given openapi.NullableBool and assigns it to the UeSrvccCapability field.
...
func (o Amf3GppAccessRegistrationModification) ToMap() (map[string]any, error) {
