...
var _ openapi.MappedNullable = &UdmInfo{}
...
type UdmInfo struct {
	...
	RoutingIndicators              []string               `json:"routingIndicators,omitempty" yaml:"routingIndicators,omitempty"`
	InternalGroupIdentifiersRanges []InternalGroupIdRange `json:"internalGroupIdentifiersRanges,omitempty" yaml:"internalGroupIdentifiersRanges,omitempty"`
	SuciInfos                      []SuciInfo             `json:"suciInfos,omitempty" yaml:"suciInfos,omitempty"`
}
...
func (o *UdmInfo) GetRoutingIndicators() []string {
	if o == nil || openapi.IsNil(o.RoutingIndicators) {
		var ret []string
		return ret
	}
...
func (o *UdmInfo) GetInternalGroupIdentifiersRanges() []InternalGroupIdRange {
	if o == nil || openapi.IsNil(o.InternalGroupIdentifiersRanges) {
...
func (o *UdmInfo) GetSuciInfos() []SuciInfo {
	if o == nil || openapi.IsNil(o.SuciInfos) {
		var ret []SuciInfo
		return ret
	}
	return o.SuciInfos
...
func (o UdmInfo) ToMap() (map[string]any, error) {
