...
var _ openapi.MappedNullable = &EeSubscriptionExt{}
...
type EeSubscriptionExt struct {
	...
	MonitoringConfigurations map[string]MonitoringConfiguration `json:"monitoringConfigurations" yaml:"monitoringConfigurations"`
	ReportingOptions         *ReportingOptions                  `json:"reportingOptions,omitempty" yaml:"reportingOptions,omitempty"`
	...
	AmfSubscriptionInfoList    []AmfSubscriptionInfo `json:"amfSubscriptionInfoList,omitempty" yaml:"amfSubscriptionInfoList,omitempty"`
	SmfSubscriptionInfo        *SmfSubscriptionInfo  `json:"smfSubscriptionInfo,omitempty" yaml:"smfSubscriptionInfo,omitempty"`
...
func (o *EeSubscriptionExt) GetReportingOptions() ReportingOptions {
	if o == nil || openapi.IsNil(o.ReportingOptions) {
...
func (o *EeSubscriptionExt) GetEpcAppliedInd() bool {
	if o == nil || openapi.IsNil(o.EpcAppliedInd) {
		var ret bool
		return ret
	}
...
func (o *EeSubscriptionExt) GetScefDiamHost() string {
	if o == nil || openapi.IsNil(o.ScefDiamHost) {
		var ret string
		return ret
	}
...
func (o *EeSubscriptionExt) GetScefDiamRealm() string {
	if o == nil || openapi.IsNil(o.ScefDiamRealm) {
		var ret string
		return ret
	}
...
func (o *EeSubscriptionExt) GetSecondCallbackRef() string {
	if o == nil || openapi.IsNil(o.SecondCallbackRef) {
		var ret string
		return ret
	}
...
func (o *EeSubscriptionExt) GetUdrRestartInd() bool {
...
// and a boolean to check if the value has been set.
func (o *EeSubscriptionExt) GetUdrRestartIndOk() (*bool, bool) {
	if o == nil || openapi.IsNil(o.UdrRestartInd) {
		return nil, false
	}
...
func (o *EeSubscriptionExt) HasUdrRestartInd() bool {
	if o != nil && !openapi.IsNil(o.UdrRestartInd) {
		return true
	}
...
func (o *EeSubscriptionExt) SetUdrRestartInd(v bool) {
	o.UdrRestartInd = &v
}
...
func (o *EeSubscriptionExt) GetAmfSubscriptionInfoList() []AmfSubscriptionInfo {
	if o == nil || openapi.IsNil(o.AmfSubscriptionInfoList) {
...
func (o *EeSubscriptionExt) GetSmfSubscriptionInfo() SmfSubscriptionInfo {
	if o == nil || openapi.IsNil(o.SmfSubscriptionInfo) {
...
func (o EeSubscriptionExt) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.EpcAppliedInd) {
		toSerialize["epcAppliedInd"] = o.EpcAppliedInd
	}
	if !openapi.IsNil(o.ScefDiamHost) {
		toSerialize["scefDiamHost"] = o.ScefDiamHost
	}
	if !openapi.IsNil(o.ScefDiamRealm) {
	...
	if !openapi.IsNil(o.SecondCallbackRef) {
	...
	if !openapi.IsNil(o.AmfSubscriptionInfoList) {
		toSerialize["amfSubscriptionInfoList"] = o.AmfSubscriptionInfoList
	}
	if !openapi.IsNil(o.SmfSubscriptionInfo) {
