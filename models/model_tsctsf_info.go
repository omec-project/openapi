...
var _ openapi.MappedNullable = &TsctsfInfo{}
...
type TsctsfInfo struct {
	...
	SNssaiInfoList                 *map[string]SnssaiTsctsfInfoItem `json:"sNssaiInfoList,omitempty" yaml:"sNssaiInfoList,omitempty"`
...
func (o TsctsfInfo) ToMap() (map[string]any, error) {
