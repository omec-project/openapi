...
var _ openapi.MappedNullable = &PresenceInfoRm{}
...
type PresenceInfoRm struct {
	...
	PraId *string `json:"praId,omitempty" yaml:"praId,omitempty"`
	...
	AdditionalPraId *string        `json:"additionalPraId,omitempty" yaml:"additionalPraId,omitempty"`
	PresenceState   *PresenceState `json:"presenceState,omitempty" yaml:"presenceState,omitempty"`
	...
	EcgiList []Ecgi `json:"ecgiList,omitempty" yaml:"ecgiList,omitempty"`
	...
	NcgiList []Ncgi `json:"ncgiList,omitempty" yaml:"ncgiList,omitempty"`
	...
	GlobalRanNodeIdList []GlobalRanNodeId `json:"globalRanNodeIdList,omitempty" yaml:"globalRanNodeIdList,omitempty"`
	...
	GlobaleNbIdList []GlobalRanNodeId `json:"globaleNbIdList,omitempty" yaml:"globaleNbIdList,omitempty"`
}
...
func (o *PresenceInfoRm) GetPraId() string {
	if o == nil || openapi.IsNil(o.PraId) {
		var ret string
		return ret
	}
	return *o.PraId
...
func (o *PresenceInfoRm) GetAdditionalPraId() string {
	if o == nil || openapi.IsNil(o.AdditionalPraId) {
		var ret string
		return ret
	}
...
func (o *PresenceInfoRm) GetPresenceState() PresenceState {
	if o == nil || openapi.IsNil(o.PresenceState) {
...
func (o *PresenceInfoRm) GetEcgiList() []Ecgi {
	if o == nil || openapi.IsNil(o.EcgiList) {
		var ret []Ecgi
		return ret
	}
	return o.EcgiList
...
func (o *PresenceInfoRm) GetGlobalRanNodeIdList() []GlobalRanNodeId {
	if o == nil || openapi.IsNil(o.GlobalRanNodeIdList) {
...
func (o *PresenceInfoRm) GetGlobaleNbIdList() []GlobalRanNodeId {
	if o == nil || openapi.IsNil(o.GlobaleNbIdList) {
		var ret []GlobalRanNodeId
		return ret
	}
...
func (o PresenceInfoRm) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.PraId) {
		toSerialize["praId"] = o.PraId
	}
	if !openapi.IsNil(o.AdditionalPraId) {
		toSerialize["additionalPraId"] = o.AdditionalPraId
	}
	if !openapi.IsNil(o.PresenceState) {
