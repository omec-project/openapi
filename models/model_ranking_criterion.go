...
var _ openapi.MappedNullable = &RankingCriterion{}
...
type RankingCriterion struct {
	...
	HighBase int32 `json:"highBase" yaml:"highBase"`
	// Unsigned integer indicating Sampling Ratio (see clauses 4.15.1 of 3GPP TS 23.502), expressed in percent.
	LowBase int32 `json:"lowBase" yaml:"lowBase"`
}
...
func (o RankingCriterion) ToMap() (map[string]any, error) {
