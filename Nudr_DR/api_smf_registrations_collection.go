...
type SMFRegistrationsCollectionAPI interface {
	...
	*/
	QuerySmfRegList(ctx context.Context, ueId string) ApiQuerySmfRegListRequest

	// QuerySmfRegListExecute executes the request
	//   @return []SmfRegistration
	QuerySmfRegListExecute(r ApiQuerySmfRegListRequest) ([]models.SmfRegistration, *http.Response, error)
}
...
type ApiQuerySmfRegListRequest struct {
	ctx               context.Context
	ApiService        SMFRegistrationsCollectionAPI
	ueId              string
...
func (r ApiQuerySmfRegListRequest) Execute() ([]models.SmfRegistration, *http.Response, error) {
...
//
//	@return []SmfRegistration
func (a *SMFRegistrationsCollectionAPIService) QuerySmfRegListExecute(r ApiQuerySmfRegListRequest) ([]models.SmfRegistration, *http.Response, error) {
	var (
