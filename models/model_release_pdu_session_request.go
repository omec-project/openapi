...
var _ openapi.MappedNullable = &ReleasePduSessionRequest{}

// ReleasePduSessionRequest struct for ReleasePduSessionRequest
type ReleasePduSessionRequest struct {
	JsonData                    *ReleaseData `json:"jsonData,omitempty" yaml:"jsonData,omitempty" multipart:"contentType:application/json,ref:{jsonData}"`
...
func (o ReleasePduSessionRequest) ToMap() (map[string]any, error) {
