...
var _ openapi.MappedNullable = &EasdfInfo{}

// EasdfInfo Information of an EASDF NF Instance
type EasdfInfo struct {
	SNssaiEasdfInfoList  []SnssaiEasdfInfoItem `json:"sNssaiEasdfInfoList,omitempty" yaml:"sNssaiEasdfInfoList,omitempty"`
	EasdfN6IpAddressList []IpAddr              `json:"easdfN6IpAddressList,omitempty" yaml:"easdfN6IpAddressList,omitempty"`
	UpfN6IpAddressList   []IpAddr              `json:"upfN6IpAddressList,omitempty" yaml:"upfN6IpAddressList,omitempty"`
}
...
func (o *EasdfInfo) GetSNssaiEasdfInfoList() []SnssaiEasdfInfoItem {
	if o == nil || openapi.IsNil(o.SNssaiEasdfInfoList) {
...
func (o *EasdfInfo) GetEasdfN6IpAddressList() []IpAddr {
	if o == nil || openapi.IsNil(o.EasdfN6IpAddressList) {
		var ret []IpAddr
		return ret
	}
...
func (o *EasdfInfo) GetUpfN6IpAddressList() []IpAddr {
	if o == nil || openapi.IsNil(o.UpfN6IpAddressList) {
		var ret []IpAddr
		return ret
	}
...
func (o EasdfInfo) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.SNssaiEasdfInfoList) {
		toSerialize["sNssaiEasdfInfoList"] = o.SNssaiEasdfInfoList
	}
	if !openapi.IsNil(o.EasdfN6IpAddressList) {
		toSerialize["easdfN6IpAddressList"] = o.EasdfN6IpAddressList
	}
	if !openapi.IsNil(o.UpfN6IpAddressList) {
