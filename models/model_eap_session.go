...
var _ openapi.MappedNullable = &EapSession{}
...
type EapSession struct {
	...
	// Contains the Kseaf.
	KSeaf *string `json:"kSeaf,omitempty" yaml:"kSeaf,omitempty" validate:"regexp=[A-Fa-f0-9]{64}"`
	...
	Msk *string `json:"msk,omitempty" yaml:"msk,omitempty" validate:"regexp=[A-Fa-f0-9]{128}"`
}
...
func NewEapSession(eapPayload openapi.NullableString) *EapSession {
	this := EapSession{}
...
func (o *EapSession) GetKSeaf() string {
	if o == nil || openapi.IsNil(o.KSeaf) {
		var ret string
		return ret
	}
	return *o.KSeaf
...
func (o EapSession) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["eapPayload"] = o.EapPayload.Get()
	if !openapi.IsNil(o.KSeaf) {
