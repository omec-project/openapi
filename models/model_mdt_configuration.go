...
var _ openapi.MappedNullable = &MdtConfiguration{}

// MdtConfiguration contains contain MDT configuration data.
type MdtConfiguration struct {
	JobType               JobType                `json:"jobType" yaml:"jobType"`
	ReportType            *ReportTypeMdt         `json:"reportType,omitempty" yaml:"reportType,omitempty"`
	AreaScope             *AreaScope             `json:"areaScope,omitempty" yaml:"areaScope,omitempty"`
	MeasurementLteList    []MeasurementLteForMdt `json:"measurementLteList,omitempty" yaml:"measurementLteList,omitempty"`
	MeasurementNrList     []MeasurementNrForMdt  `json:"measurementNrList,omitempty" yaml:"measurementNrList,omitempty"`
	SensorMeasurementList []SensorMeasurement    `json:"sensorMeasurementList,omitempty" yaml:"sensorMeasurementList,omitempty"`
	ReportingTriggerList  []ReportingTrigger     `json:"reportingTriggerList,omitempty" yaml:"reportingTriggerList,omitempty"`
	ReportInterval        *ReportIntervalMdt     `json:"reportInterval,omitempty" yaml:"reportInterval,omitempty"`
	ReportIntervalNr      *ReportIntervalNrMdt   `json:"reportIntervalNr,omitempty" yaml:"reportIntervalNr,omitempty"`
	ReportAmount          *ReportAmountMdt       `json:"reportAmount,omitempty" yaml:"reportAmount,omitempty"`
	// A map (list of key-value pairs) where MeasurementLteForMdt serves as key;
	ReportAmountPerMeasurementLte *map[string]ReportAmountMdt `json:"reportAmountPerMeasurementLte,omitempty" yaml:"reportAmountPerMeasurementLte,omitempty"`
	// A map (list of key-value pairs) where MeasurementNrForMdt serves as key;
	ReportAmountPerMeasurementNr *map[string]ReportAmountMdt `json:"reportAmountPerMeasurementNr,omitempty" yaml:"reportAmountPerMeasurementNr,omitempty"`
	...
	EventThresholdRsrp *int32 `json:"eventThresholdRsrp,omitempty" yaml:"eventThresholdRsrp,omitempty"`
	...
	EventThresholdRsrpNr *int32 `json:"eventThresholdRsrpNr,omitempty" yaml:"eventThresholdRsrpNr,omitempty"`
	...
	EventThresholdRsrq *int32 `json:"eventThresholdRsrq,omitempty" yaml:"eventThresholdRsrq,omitempty"`
	...
	EventThresholdRsrqNr     *int32                     `json:"eventThresholdRsrqNr,omitempty" yaml:"eventThresholdRsrqNr,omitempty"`
	EventList                []EventForMdt              `json:"eventList,omitempty" yaml:"eventList,omitempty"`
	LoggingInterval          *LoggingIntervalMdt        `json:"loggingInterval,omitempty" yaml:"loggingInterval,omitempty"`
	LoggingIntervalNr        *LoggingIntervalNrMdt      `json:"loggingIntervalNr,omitempty" yaml:"loggingIntervalNr,omitempty"`
	LoggingDuration          *LoggingDurationMdt        `json:"loggingDuration,omitempty" yaml:"loggingDuration,omitempty"`
	LoggingDurationNr        *LoggingDurationNrMdt      `json:"loggingDurationNr,omitempty" yaml:"loggingDurationNr,omitempty"`
	PositioningMethod        *PositioningMethodMdt      `json:"positioningMethod,omitempty" yaml:"positioningMethod,omitempty"`
	AddPositioningMethodList []PositioningMethodMdt     `json:"addPositioningMethodList,omitempty" yaml:"addPositioningMethodList,omitempty"`
	CollectionPeriodRmmLte   *CollectionPeriodRmmLteMdt `json:"collectionPeriodRmmLte,omitempty" yaml:"collectionPeriodRmmLte,omitempty"`
	CollectionPeriodRmmNr    *CollectionPeriodRmmNrMdt  `json:"collectionPeriodRmmNr,omitempty" yaml:"collectionPeriodRmmNr,omitempty"`
	MeasurementPeriodLte     *MeasurementPeriodLteMdt   `json:"measurementPeriodLte,omitempty" yaml:"measurementPeriodLte,omitempty"`
	MdtAllowedPlmnIdList     []PlmnId                   `json:"mdtAllowedPlmnIdList,omitempty" yaml:"mdtAllowedPlmnIdList,omitempty"`
	MbsfnAreaList            []MbsfnArea                `json:"mbsfnAreaList,omitempty" yaml:"mbsfnAreaList,omitempty"`
	InterFreqTargetList      []InterFreqTargetInfo      `json:"interFreqTargetList,omitempty" yaml:"interFreqTargetList,omitempty"`
}
...
func (o *MdtConfiguration) GetReportType() ReportTypeMdt {
	if o == nil || openapi.IsNil(o.ReportType) {
...
func (o *MdtConfiguration) GetMeasurementLteList() []MeasurementLteForMdt {
	if o == nil || openapi.IsNil(o.MeasurementLteList) {
...
func (o *MdtConfiguration) GetMeasurementNrList() []MeasurementNrForMdt {
	if o == nil || openapi.IsNil(o.MeasurementNrList) {
...
func (o *MdtConfiguration) GetSensorMeasurementList() []SensorMeasurement {
	if o == nil || openapi.IsNil(o.SensorMeasurementList) {
...
func (o *MdtConfiguration) GetReportingTriggerList() []ReportingTrigger {
	if o == nil || openapi.IsNil(o.ReportingTriggerList) {
...
func (o *MdtConfiguration) GetReportInterval() ReportIntervalMdt {
	if o == nil || openapi.IsNil(o.ReportInterval) {
...
func (o *MdtConfiguration) GetReportIntervalNr() ReportIntervalNrMdt {
	if o == nil || openapi.IsNil(o.ReportIntervalNr) {
...
func (o *MdtConfiguration) GetReportAmount() ReportAmountMdt {
	if o == nil || openapi.IsNil(o.ReportAmount) {
...
// GetReportAmountPerMeasurementLte returns the ReportAmountPerMeasurementLte field value if set, zero value otherwise.
func (o *MdtConfiguration) GetReportAmountPerMeasurementLte() map[string]ReportAmountMdt {
	if o == nil || openapi.IsNil(o.ReportAmountPerMeasurementLte) {
...
func (o *MdtConfiguration) GetReportAmountPerMeasurementNr() map[string]ReportAmountMdt {
	if o == nil || openapi.IsNil(o.ReportAmountPerMeasurementNr) {
		var ret map[string]ReportAmountMdt
		return ret
	}
...
func (o *MdtConfiguration) GetEventThresholdRsrp() int32 {
	if o == nil || openapi.IsNil(o.EventThresholdRsrp) {
		var ret int32
		return ret
	}
...
func (o *MdtConfiguration) GetEventThresholdRsrpNr() int32 {
	if o == nil || openapi.IsNil(o.EventThresholdRsrpNr) {
		var ret int32
		return ret
	}
...
func (o *MdtConfiguration) GetEventThresholdRsrq() int32 {
	if o == nil || openapi.IsNil(o.EventThresholdRsrq) {
		var ret int32
		return ret
	}
...
func (o *MdtConfiguration) GetEventThresholdRsrqNr() int32 {
	if o == nil || openapi.IsNil(o.EventThresholdRsrqNr) {
		var ret int32
		return ret
	}
...
func (o *MdtConfiguration) GetEventList() []EventForMdt {
	if o == nil || openapi.IsNil(o.EventList) {
		var ret []EventForMdt
		return ret
	}
	return o.EventList
...
func (o *MdtConfiguration) GetLoggingInterval() LoggingIntervalMdt {
	if o == nil || openapi.IsNil(o.LoggingInterval) {
...
func (o *MdtConfiguration) GetLoggingIntervalNr() LoggingIntervalNrMdt {
	if o == nil || openapi.IsNil(o.LoggingIntervalNr) {
...
func (o *MdtConfiguration) GetLoggingDuration() LoggingDurationMdt {
	if o == nil || openapi.IsNil(o.LoggingDuration) {
...
func (o *MdtConfiguration) GetLoggingDurationNr() LoggingDurationNrMdt {
	if o == nil || openapi.IsNil(o.LoggingDurationNr) {
...
func (o *MdtConfiguration) GetPositioningMethod() PositioningMethodMdt {
	if o == nil || openapi.IsNil(o.PositioningMethod) {
...
func (o *MdtConfiguration) GetAddPositioningMethodList() []PositioningMethodMdt {
	if o == nil || openapi.IsNil(o.AddPositioningMethodList) {
		var ret []PositioningMethodMdt
		return ret
	}
...
func (o *MdtConfiguration) GetCollectionPeriodRmmLte() CollectionPeriodRmmLteMdt {
	if o == nil || openapi.IsNil(o.CollectionPeriodRmmLte) {
...
func (o *MdtConfiguration) GetCollectionPeriodRmmNr() CollectionPeriodRmmNrMdt {
	if o == nil || openapi.IsNil(o.CollectionPeriodRmmNr) {
...
func (o *MdtConfiguration) GetMeasurementPeriodLte() MeasurementPeriodLteMdt {
	if o == nil || openapi.IsNil(o.MeasurementPeriodLte) {
...
func (o *MdtConfiguration) GetMdtAllowedPlmnIdList() []PlmnId {
	if o == nil || openapi.IsNil(o.MdtAllowedPlmnIdList) {
		var ret []PlmnId
		return ret
	}
...
func (o *MdtConfiguration) GetMbsfnAreaList() []MbsfnArea {
	if o == nil || openapi.IsNil(o.MbsfnAreaList) {
		var ret []MbsfnArea
		return ret
	}
...
func (o *MdtConfiguration) GetInterFreqTargetList() []InterFreqTargetInfo {
	if o == nil || openapi.IsNil(o.InterFreqTargetList) {
