...
var _ openapi.MappedNullable = &BdtPolicy{}

// BdtPolicy Represents an Individual BDT policy resource.
type BdtPolicy struct {
	BdtPolData *BdtPolicyData `json:"bdtPolData,omitempty" yaml:"bdtPolData,omitempty"`
	BdtReqData *BdtReqData    `json:"bdtReqData,omitempty" yaml:"bdtReqData,omitempty"`
}
...
func (o BdtPolicy) ToMap() (map[string]any, error) {
