...
var _ openapi.MappedNullable = &ExpectedUeBehaviour{}
...
type ExpectedUeBehaviour struct {
	...
	StationaryIndication *StationaryIndicationRm `json:"stationaryIndication,omitempty" yaml:"stationaryIndication,omitempty"`
	// indicating a time in seconds with OpenAPI defined 'nullable: true' property.
	CommunicationDurationTime  openapi.NullableInt32         `json:"communicationDurationTime" yaml:"communicationDurationTime,omitempty"`
	ScheduledCommunicationType *ScheduledCommunicationTypeRm `json:"scheduledCommunicationType,omitempty" yaml:"scheduledCommunicationType,omitempty"`
	// indicating a time in seconds with OpenAPI defined 'nullable: true' property.
	PeriodicTime               openapi.NullableInt32                `json:"periodicTime" yaml:"periodicTime,omitempty"`
	ScheduledCommunicationTime NullableScheduledCommunicationTimeRm `json:"scheduledCommunicationTime" yaml:"scheduledCommunicationTime,omitempty"`
	...
	TrafficProfile    *TrafficProfileRm           `json:"trafficProfile,omitempty" yaml:"trafficProfile,omitempty"`
	BatteryIndication NullableBatteryIndicationRm `json:"batteryIndication" yaml:"batteryIndication,omitempty"`
...
func (o *ExpectedUeBehaviour) GetCommunicationDurationTime() int32 {
	if o == nil || openapi.IsNil(o.CommunicationDurationTime.Get()) {
		var ret int32
		return ret
	}
...
// SetCommunicationDurationTime gets a reference to the given openapi.NullableInt32 and assigns it to the CommunicationDurationTime field.
...
func (o *ExpectedUeBehaviour) GetPeriodicTime() int32 {
	if o == nil || openapi.IsNil(o.PeriodicTime.Get()) {
		var ret int32
		return ret
	}
...
// SetPeriodicTime gets a reference to the given openapi.NullableInt32 and assigns it to the PeriodicTime field.
...
func (o *ExpectedUeBehaviour) GetScheduledCommunicationTime() ScheduledCommunicationTimeRm {
	if o == nil || openapi.IsNil(o.ScheduledCommunicationTime.Get()) {
...
// SetScheduledCommunicationTime gets a reference to the given NullableScheduledCommunicationTimeRm and assigns it to the ScheduledCommunicationTime field.
...
func (o *ExpectedUeBehaviour) GetBatteryIndication() BatteryIndicationRm {
	if o == nil || openapi.IsNil(o.BatteryIndication.Get()) {
...
// SetBatteryIndication gets a reference to the given NullableBatteryIndicationRm and assigns it to the BatteryIndication field.
...
func (o ExpectedUeBehaviour) ToMap() (map[string]any, error) {
