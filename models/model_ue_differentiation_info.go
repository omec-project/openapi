...
var _ openapi.MappedNullable = &UeDifferentiationInfo{}
...
type UeDifferentiationInfo struct {
	PeriodicComInd *PeriodicCommunicationIndicator `json:"periodicComInd,omitempty" yaml:"periodicComInd,omitempty"`
	// indicating a time in seconds.
	PeriodicTime     *int32                      `json:"periodicTime,omitempty" yaml:"periodicTime,omitempty"`
	ScheduledComTime *ScheduledCommunicationTime `json:"scheduledComTime,omitempty" yaml:"scheduledComTime,omitempty"`
	StationaryInd    *StationaryIndication       `json:"stationaryInd,omitempty" yaml:"stationaryInd,omitempty"`
	TrafficProfile   *TrafficProfile             `json:"trafficProfile,omitempty" yaml:"trafficProfile,omitempty"`
	BatteryInd       *BatteryIndication          `json:"batteryInd,omitempty" yaml:"batteryInd,omitempty"`
...
func (o *UeDifferentiationInfo) GetPeriodicComInd() PeriodicCommunicationIndicator {
	if o == nil || openapi.IsNil(o.PeriodicComInd) {
...
func (o *UeDifferentiationInfo) GetScheduledComTime() ScheduledCommunicationTime {
	if o == nil || openapi.IsNil(o.ScheduledComTime) {
...
func (o *UeDifferentiationInfo) GetStationaryInd() StationaryIndication {
	if o == nil || openapi.IsNil(o.StationaryInd) {
