...
var _ openapi.MappedNullable = &TargetArea{}

// TargetArea TA list or TAI range list or any TA
type TargetArea struct {
	TaList       []Tai      `json:"taList,omitempty" yaml:"taList,omitempty"`
	TaiRangeList []TaiRange `json:"taiRangeList,omitempty" yaml:"taiRangeList,omitempty"`
	AnyTa        *bool      `json:"anyTa,omitempty" yaml:"anyTa,omitempty"`
}
...
func (o *TargetArea) GetTaList() []Tai {
	if o == nil || openapi.IsNil(o.TaList) {
		var ret []Tai
		return ret
	}
	return o.TaList
...
func (o *TargetArea) GetAnyTa() bool {
	if o == nil || openapi.IsNil(o.AnyTa) {
		var ret bool
		return ret
	}
	return *o.AnyTa
...
func (o TargetArea) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.TaList) {
		toSerialize["taList"] = o.TaList
	}
	if !openapi.IsNil(o.TaiRangeList) {
		toSerialize["taiRangeList"] = o.TaiRangeList
	}
	if !openapi.IsNil(o.AnyTa) {
