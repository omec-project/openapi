...
var _ openapi.MappedNullable = &RequestedRuleData{}
...
type RequestedRuleData struct {
	...
	ReqData []RequestedRuleDataType `json:"reqData" yaml:"reqData"`
}
...
func (o RequestedRuleData) ToMap() (map[string]any, error) {
