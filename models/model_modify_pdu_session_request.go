...
var _ openapi.MappedNullable = &ModifyPduSessionRequest{}

// ModifyPduSessionRequest struct for ModifyPduSessionRequest
type ModifyPduSessionRequest struct {
	JsonData                    *VsmfUpdateData `json:"jsonData,omitempty" yaml:"jsonData,omitempty" multipart:"contentType:application/json,ref:{jsonData}"`
...
func (o ModifyPduSessionRequest) ToMap() (map[string]any, error) {
