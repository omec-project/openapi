...
var _ openapi.MappedNullable = &UEAuthenticationCtx{}
...
type UEAuthenticationCtx struct {
	...
	Var5gAuthData UEAuthenticationCtx5gAuthData `json:"5gAuthData" yaml:"5gAuthData"`
	// A map(list of key-value pairs) where member serves as key
	Links              map[string]LinksValueSchema `json:"_links" yaml:"_links"`
	ServingNetworkName *string                     `json:"servingNetworkName,omitempty" yaml:"servingNetworkName,omitempty" validate:"regexp=^(5G:mnc[0-9]{3}[.]mcc[0-9]{3}[.]3gppnetwork[.]org(:[A-F0-9]{11})?)|5G:NSWO$"`
}
...
func (o *UEAuthenticationCtx) GetServingNetworkName() string {
	if o == nil || openapi.IsNil(o.ServingNetworkName) {
		var ret string
		return ret
	}
...
func (o UEAuthenticationCtx) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["authType"] = o.AuthType
	toSerialize["5gAuthData"] = o.Var5gAuthData
	toSerialize["_links"] = o.Links
	if !openapi.IsNil(o.ServingNetworkName) {
