...
type SMFSelectionSubscriptionDataRetrievalAPI interface {
	...
	*/
	GetSmfSelData(ctx context.Context, supi string) ApiGetSmfSelDataRequest

	// GetSmfSelDataExecute executes the request
	//   @return SmfSelectionSubscriptionData
	GetSmfSelDataExecute(r ApiGetSmfSelDataRequest) (*models.SmfSelectionSubscriptionData, *http.Response, error)
}
...
type ApiGetSmfSelDataRequest struct {
	ctx                context.Context
	ApiService         SMFSelectionSubscriptionDataRetrievalAPI
	supi               string
...
// serving PLMN ID
func (r ApiGetSmfSelDataRequest) PlmnId(plmnId models.PlmnId) ApiGetSmfSelDataRequest {
	r.plmnId = &plmnId
	return r
}
...
func (r ApiGetSmfSelDataRequest) Execute() (*models.SmfSelectionSubscriptionData, *http.Response, error) {
...
//
//	@return SmfSelectionSubscriptionData
func (a *SMFSelectionSubscriptionDataRetrievalAPIService) GetSmfSelDataExecute(r ApiGetSmfSelDataRequest) (*models.SmfSelectionSubscriptionData, *http.Response, error) {
	var (
