...
type UEsLocationInformationDocumentAPI interface {
	...
	*/
	QueryUeLocation(ctx context.Context, ueId string) ApiQueryUeLocationRequest

	// QueryUeLocationExecute executes the request
	//   @return LocationInfoUdm
	QueryUeLocationExecute(r ApiQueryUeLocationRequest) (*models.LocationInfoUdm, *http.Response, error)
}
...
type ApiQueryUeLocationRequest struct {
	ctx               context.Context
	ApiService        UEsLocationInformationDocumentAPI
	ueId              string
...
func (r ApiQueryUeLocationRequest) Execute() (*models.LocationInfoUdm, *http.Response, error) {
...
//
//	@return LocationInfoUdm
func (a *UEsLocationInformationDocumentAPIService) QueryUeLocationExecute(r ApiQueryUeLocationRequest) (*models.LocationInfoUdm, *http.Response, error) {
	var (
