...
var _ openapi.MappedNullable = &NsacfCapability{}
...
func (o *NsacfCapability) GetSupportUeSAC() bool {
	if o == nil || openapi.IsNil(o.SupportUeSAC) {
		var ret bool
		return ret
	}
...
func (o *NsacfCapability) GetSupportPduSAC() bool {
	if o == nil || openapi.IsNil(o.SupportPduSAC) {
		var ret bool
		return ret
	}
...
func (o *NsacfCapability) GetSupportUeWithPduSAC() bool {
	if o == nil || openapi.IsNil(o.SupportUeWithPduSAC) {
		var ret bool
		return ret
	}
...
func (o NsacfCapability) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.SupportUeSAC) {
		toSerialize["supportUeSAC"] = o.SupportUeSAC
	}
	if !openapi.IsNil(o.SupportPduSAC) {
		toSerialize["supportPduSAC"] = o.SupportPduSAC
	}
	if !openapi.IsNil(o.SupportUeWithPduSAC) {
