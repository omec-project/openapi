...
var _ openapi.MappedNullable = &UeContextRelocateData{}
...
type UeContextRelocateData struct {
	...
	ForwardRelocationRequest RefToBinaryData   `json:"forwardRelocationRequest" yaml:"forwardRelocationRequest"`
	PduSessionList           []N2SmInformation `json:"pduSessionList,omitempty" yaml:"pduSessionList,omitempty"`
...
func (o *UeContextRelocateData) GetPduSessionList() []N2SmInformation {
	if o == nil || openapi.IsNil(o.PduSessionList) {
...
func (o UeContextRelocateData) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.PduSessionList) {
