...
var _ openapi.MappedNullable = &AppSessionContextReqData{}
...
func (o *AppSessionContextReqData) GetAfReqData() AfRequestedData {
	if o == nil || openapi.IsNil(o.AfReqData) {
...
func (o *AppSessionContextReqData) GetMultiModalId() string {
	if o == nil || openapi.IsNil(o.MultiModalId) {
		var ret string
		return ret
	}
...
func (o *AppSessionContextReqData) GetQosDuration() int32 {
	if o == nil || openapi.IsNil(o.QosDuration) {
		var ret int32
		return ret
	}
...
func (o *AppSessionContextReqData) GetQosInactInt() int32 {
	if o == nil || openapi.IsNil(o.QosInactInt) {
		var ret int32
		return ret
	}
...
func (o *AppSessionContextReqData) GetServUrn() string {
	if o == nil || openapi.IsNil(o.ServUrn) {
		var ret string
		return ret
	}
	return *o.ServUrn
...
func (o *AppSessionContextReqData) GetUeIpv6() string {
...
// and a boolean to check if the value has been set.
func (o *AppSessionContextReqData) GetUeIpv6Ok() (*string, bool) {
	if o == nil || openapi.IsNil(o.UeIpv6) {
		return nil, false
	}
...
func (o *AppSessionContextReqData) SetUeIpv6(v string) {
	o.UeIpv6 = &v
}
...
func (o AppSessionContextReqData) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.MultiModalId) {
	...
	if !openapi.IsNil(o.QosDuration) {
		toSerialize["qosDuration"] = o.QosDuration
	}
	if !openapi.IsNil(o.QosInactInt) {
