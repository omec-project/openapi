...
var _ openapi.MappedNullable = &UserDataCongestionInfo{}

// UserDataCongestionInfo Represents the user data congestion information.
type UserDataCongestionInfo struct {
	NetworkArea    NetworkAreaInfo `json:"networkArea" yaml:"networkArea"`
	CongestionInfo CongestionInfo  `json:"congestionInfo" yaml:"congestionInfo"`
...
func (o UserDataCongestionInfo) ToMap() (map[string]any, error) {
