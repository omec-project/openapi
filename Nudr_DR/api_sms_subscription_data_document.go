...
type SMSSubscriptionDataDocumentAPI interface {
	...
	*/
	QuerySmsData(ctx context.Context, ueId string, servingPlmnId string) ApiQuerySmsDataRequest

	// QuerySmsDataExecute executes the request
	//   @return SmsSubscriptionData
	QuerySmsDataExecute(r ApiQuerySmsDataRequest) (*models.SmsSubscriptionData, *http.Response, error)
}
...
type ApiQuerySmsDataRequest struct {
	ctx               context.Context
	ApiService        SMSSubscriptionDataDocumentAPI
	ueId              string
...
func (r ApiQuerySmsDataRequest) Execute() (*models.SmsSubscriptionData, *http.Response, error) {
...
//
//	@return SmsSubscriptionData
func (a *SMSSubscriptionDataDocumentAPIService) QuerySmsDataExecute(r ApiQuerySmsDataRequest) (*models.SmsSubscriptionData, *http.Response, error) {
	var (
