...
type AuthenticationDataDocumentAPI interface {
	...
	*/
	QueryAuthSubsData(ctx context.Context, ueId string) ApiQueryAuthSubsDataRequest

	// QueryAuthSubsDataExecute executes the request
	//   @return AuthenticationSubscription
	QueryAuthSubsDataExecute(r ApiQueryAuthSubsDataRequest) (*models.AuthenticationSubscription, *http.Response, error)
}
...
type ApiQueryAuthSubsDataRequest struct {
	ctx               context.Context
	ApiService        AuthenticationDataDocumentAPI
	ueId              string
...
func (r ApiQueryAuthSubsDataRequest) Execute() (*models.AuthenticationSubscription, *http.Response, error) {
...
//
//	@return AuthenticationSubscription
func (a *AuthenticationDataDocumentAPIService) QueryAuthSubsDataExecute(r ApiQueryAuthSubsDataRequest) (*models.AuthenticationSubscription, *http.Response, error) {
	var (
