...
var _ openapi.MappedNullable = &AreaEventInfoExt{}

// AreaEventInfoExt Extended Area Event Information
type AreaEventInfoExt struct {
	AreaDefinition []ReportingArea `json:"areaDefinition" yaml:"areaDefinition"`
	OccurrenceInfo *OccurrenceInfo `json:"occurrenceInfo,omitempty" yaml:"occurrenceInfo,omitempty"`
	// Minimum interval between event reports.
	MinimumInterval *int32 `json:"minimumInterval,omitempty" yaml:"minimumInterval,omitempty"`
	// Maximum interval between event reports.
	MaximumInterval *int32 `json:"maximumInterval,omitempty" yaml:"maximumInterval,omitempty"`
	// Maximum time interval between consecutive evaluations by a UE of a trigger event.
	SamplingInterval *int32 `json:"samplingInterval,omitempty" yaml:"samplingInterval,omitempty"`
	// Maximum duration of event reporting.
	ReportingDuration    *int32           `json:"reportingDuration,omitempty" yaml:"reportingDuration,omitempty"`
	ReportingLocationReq *bool            `json:"reportingLocationReq,omitempty" yaml:"reportingLocationReq,omitempty"`
...
func (o *AreaEventInfoExt) GetOccurrenceInfo() OccurrenceInfo {
	if o == nil || openapi.IsNil(o.OccurrenceInfo) {
...
func (o *AreaEventInfoExt) GetMinimumInterval() int32 {
	if o == nil || openapi.IsNil(o.MinimumInterval) {
		var ret int32
		return ret
	}
...
func (o *AreaEventInfoExt) GetMaximumInterval() int32 {
	if o == nil || openapi.IsNil(o.MaximumInterval) {
		var ret int32
		return ret
	}
...
func (o *AreaEventInfoExt) GetSamplingInterval() int32 {
	if o == nil || openapi.IsNil(o.SamplingInterval) {
		var ret int32
		return ret
	}
...
func (o *AreaEventInfoExt) GetReportingDuration() int32 {
	if o == nil || openapi.IsNil(o.ReportingDuration) {
		var ret int32
		return ret
	}
...
func (o *AreaEventInfoExt) GetReportingLocationReq() bool {
	if o == nil || openapi.IsNil(o.ReportingLocationReq) {
		var ret bool
		return ret
	}
...
func (o *AreaEventInfoExt) GetAdditionalCheckInd() bool {
...
// and a boolean to check if the value has been set.
func (o *AreaEventInfoExt) GetAdditionalCheckIndOk() (*bool, bool) {
	if o == nil || openapi.IsNil(o.AdditionalCheckInd) {
		return nil, false
	}
...
func (o *AreaEventInfoExt) HasAdditionalCheckInd() bool {
	if o != nil && !openapi.IsNil(o.AdditionalCheckInd) {
		return true
	}
...
func (o *AreaEventInfoExt) SetAdditionalCheckInd(v bool) {
	o.AdditionalCheckInd = &v
}

func (o AreaEventInfoExt) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["areaDefinition"] = o.AreaDefinition
	if !openapi.IsNil(o.OccurrenceInfo) {
		toSerialize["occurrenceInfo"] = o.OccurrenceInfo
	}
	if !openapi.IsNil(o.MinimumInterval) {
		toSerialize["minimumInterval"] = o.MinimumInterval
	}
	if !openapi.IsNil(o.MaximumInterval) {
		toSerialize["maximumInterval"] = o.MaximumInterval
	}
	if !openapi.IsNil(o.SamplingInterval) {
		toSerialize["samplingInterval"] = o.SamplingInterval
	}
	if !openapi.IsNil(o.ReportingDuration) {
		toSerialize["reportingDuration"] = o.ReportingDuration
	}
	if !openapi.IsNil(o.ReportingLocationReq) {
