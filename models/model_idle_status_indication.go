...
var _ openapi.MappedNullable = &IdleStatusIndication{}
...
type IdleStatusIndication struct {
	...
	ActiveTime *int32 `json:"activeTime,omitempty" yaml:"activeTime,omitempty"`
	// indicating a time in seconds.
	SubsRegTimer            *int32 `json:"subsRegTimer,omitempty" yaml:"subsRegTimer,omitempty"`
	EdrxCycleLength         *int32 `json:"edrxCycleLength,omitempty" yaml:"edrxCycleLength,omitempty"`
	SuggestedNumOfDlPackets *int32 `json:"suggestedNumOfDlPackets,omitempty" yaml:"suggestedNumOfDlPackets,omitempty"`
}
...
func (o *IdleStatusIndication) GetActiveTime() int32 {
	if o == nil || openapi.IsNil(o.ActiveTime) {
		var ret int32
		return ret
	}
	return *o.ActiveTime
...
func (o *IdleStatusIndication) GetSubsRegTimer() int32 {
	if o == nil || openapi.IsNil(o.SubsRegTimer) {
		var ret int32
		return ret
	}
...
func (o *IdleStatusIndication) GetEdrxCycleLength() int32 {
	if o == nil || openapi.IsNil(o.EdrxCycleLength) {
		var ret int32
		return ret
	}
...
func (o *IdleStatusIndication) GetSuggestedNumOfDlPackets() int32 {
	if o == nil || openapi.IsNil(o.SuggestedNumOfDlPackets) {
		var ret int32
		return ret
	}
...
func (o IdleStatusIndication) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.TimeStamp) {
		toSerialize["timeStamp"] = o.TimeStamp
	}
	if !openapi.IsNil(o.ActiveTime) {
		toSerialize["activeTime"] = o.ActiveTime
	}
	if !openapi.IsNil(o.SubsRegTimer) {
		toSerialize["subsRegTimer"] = o.SubsRegTimer
	}
	if !openapi.IsNil(o.EdrxCycleLength) {
		toSerialize["edrxCycleLength"] = o.EdrxCycleLength
	}
	if !openapi.IsNil(o.SuggestedNumOfDlPackets) {
