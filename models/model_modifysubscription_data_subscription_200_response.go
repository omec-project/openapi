...
func (dst *ModifysubscriptionDataSubscription200Response) UnmarshalJSON(data []byte) error {
	...
	err = openapi.NewStrictDecoder(data).Decode(&dst.SubscriptionDataSubscriptions)
	if err == nil {
	...
	if match > 1 { // more than 1 match
		...
		return openapi.ReportError("data matches more than one schema in oneOf(ModifysubscriptionDataSubscription200Response)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return openapi.ReportError("data failed to match schemas in oneOf(ModifysubscriptionDataSubscription200Response)")
	}
}
...
func (obj *ModifysubscriptionDataSubscription200Response) GetActualInstance() any {
	if obj == nil {
		return nil
	}
...
func (obj ModifysubscriptionDataSubscription200Response) GetActualInstanceValue() any {
	if obj.PatchResult != nil {
		return *obj.PatchResult
	}
