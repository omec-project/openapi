...
var _ openapi.MappedNullable = &PfdContent{}
...
type PfdContent struct {
	...
	PfdId *string `json:"pfdId,omitempty" yaml:"pfdId,omitempty"`
...
func (o *PfdContent) GetPfdId() string {
	if o == nil || openapi.IsNil(o.PfdId) {
		var ret string
		return ret
	}
	return *o.PfdId
...
func (o *PfdContent) GetSourceNfType() NFType {
...
// and a boolean to check if the value has been set.
func (o *PfdContent) GetSourceNfTypeOk() (*NFType, bool) {
	if o == nil || openapi.IsNil(o.SourceNfType) {
		return nil, false
	}
...
func (o *PfdContent) HasSourceNfType() bool {
	if o != nil && !openapi.IsNil(o.SourceNfType) {
		return true
	}
...
func (o *PfdContent) SetSourceNfType(v NFType) {
	o.SourceNfType = &v
}

func (o PfdContent) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.PfdId) {
