...
var _ openapi.MappedNullable = &UeLocationTrendsReportItem{}
...
type UeLocationTrendsReportItem struct {
	...
	Spacing int32 `json:"spacing" yaml:"spacing"`
	// indicating a time in seconds.
...
func (o UeLocationTrendsReportItem) ToMap() (map[string]any, error) {
