...
var _ openapi.MappedNullable = &WlanPerformanceReq{}

// WlanPerformanceReq Represents other WLAN performance analytics requirements.
type WlanPerformanceReq struct {
	SsIds           []string               `json:"ssIds,omitempty" yaml:"ssIds,omitempty"`
	BssIds          []string               `json:"bssIds,omitempty" yaml:"bssIds,omitempty"`
	WlanOrderCriter *WlanOrderingCriterion `json:"wlanOrderCriter,omitempty" yaml:"wlanOrderCriter,omitempty"`
...
func (o *WlanPerformanceReq) GetSsIds() []string {
	if o == nil || openapi.IsNil(o.SsIds) {
		var ret []string
		return ret
	}
	return o.SsIds
...
func (o *WlanPerformanceReq) GetBssIds() []string {
	if o == nil || openapi.IsNil(o.BssIds) {
		var ret []string
		return ret
	}
	return o.BssIds
...
func (o *WlanPerformanceReq) GetWlanOrderCriter() WlanOrderingCriterion {
	if o == nil || openapi.IsNil(o.WlanOrderCriter) {
...
func (o WlanPerformanceReq) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.SsIds) {
		toSerialize["ssIds"] = o.SsIds
	}
	if !openapi.IsNil(o.BssIds) {
		toSerialize["bssIds"] = o.BssIds
	}
	if !openapi.IsNil(o.WlanOrderCriter) {
