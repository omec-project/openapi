...
var _ openapi.MappedNullable = &TsnQosContainer{}
...
type TsnQosContainer struct {
	...
	MaxTscBurstSize *int32 `json:"maxTscBurstSize,omitempty" yaml:"maxTscBurstSize,omitempty"`
	// Unsigned integer indicating Packet Delay Budget (see clauses 5.7.3.4 and 5.7.4 of 3GPP TS 23.501), expressed in milliseconds.
	TscPackDelay *int32 `json:"tscPackDelay,omitempty" yaml:"tscPackDelay,omitempty"`
	...
	MaxPer *string `json:"maxPer,omitempty" yaml:"maxPer,omitempty" validate:"regexp=^([0-9]E-[0-9])$"`
	// Represents the priority level of TSC Flows.
	TscPrioLevel *int32 `json:"tscPrioLevel,omitempty" yaml:"tscPrioLevel,omitempty"`
}
...
func (o *TsnQosContainer) GetMaxTscBurstSize() int32 {
	if o == nil || openapi.IsNil(o.MaxTscBurstSize) {
		var ret int32
		return ret
	}
...
func (o *TsnQosContainer) GetTscPackDelay() int32 {
	if o == nil || openapi.IsNil(o.TscPackDelay) {
		var ret int32
		return ret
	}
...
// GetMaxPer returns the MaxPer field value if set, zero value otherwise.
func (o *TsnQosContainer) GetMaxPer() string {
	if o == nil || openapi.IsNil(o.MaxPer) {
		var ret string
		return ret
	}
	return *o.MaxPer
...
// and a boolean to check if the value has been set.
func (o *TsnQosContainer) GetMaxPerOk() (*string, bool) {
	if o == nil || openapi.IsNil(o.MaxPer) {
		return nil, false
	}
	return o.MaxPer, true
}

// HasMaxPer returns a boolean if a field has been set.
func (o *TsnQosContainer) HasMaxPer() bool {
	if o != nil && !openapi.IsNil(o.MaxPer) {
		return true
	}
...
// SetMaxPer gets a reference to the given string and assigns it to the MaxPer field.
func (o *TsnQosContainer) SetMaxPer(v string) {
	o.MaxPer = &v
}
...
func (o *TsnQosContainer) GetTscPrioLevel() int32 {
	if o == nil || openapi.IsNil(o.TscPrioLevel) {
		var ret int32
		return ret
	}
...
func (o TsnQosContainer) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.MaxTscBurstSize) {
		toSerialize["maxTscBurstSize"] = o.MaxTscBurstSize
	}
	if !openapi.IsNil(o.TscPackDelay) {
		toSerialize["tscPackDelay"] = o.TscPackDelay
	}
	if !openapi.IsNil(o.MaxPer) {
		toSerialize["maxPer"] = o.MaxPer
	}
	if !openapi.IsNil(o.TscPrioLevel) {
