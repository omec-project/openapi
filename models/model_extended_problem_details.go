...
var _ openapi.MappedNullable = &ExtendedProblemDetails{}
...
type ExtendedProblemDetails struct {
	...
	AcceptableServInfo   *AcceptableServiceInfo `json:"acceptableServInfo,omitempty" yaml:"acceptableServInfo,omitempty"`
}
...
func (o *ExtendedProblemDetails) GetNoProfileMatchInfo() NoProfileMatchInfo {
...
// and a boolean to check if the value has been set.
func (o *ExtendedProblemDetails) GetNoProfileMatchInfoOk() (*NoProfileMatchInfo, bool) {
	if o == nil || openapi.IsNil(o.NoProfileMatchInfo) {
		return nil, false
	}
...
func (o *ExtendedProblemDetails) HasNoProfileMatchInfo() bool {
	if o != nil && !openapi.IsNil(o.NoProfileMatchInfo) {
		return true
	}
...
func (o *ExtendedProblemDetails) SetNoProfileMatchInfo(v NoProfileMatchInfo) {
...
func (o *ExtendedProblemDetails) GetAcceptableServInfo() AcceptableServiceInfo {
	if o == nil || openapi.IsNil(o.AcceptableServInfo) {
...
func (o ExtendedProblemDetails) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.AcceptableServInfo) {
