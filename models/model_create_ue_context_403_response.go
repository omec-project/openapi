...
var _ openapi.MappedNullable = &CreateUEContext403Response{}

// CreateUEContext403Response struct for CreateUEContext403Response
type CreateUEContext403Response struct {
	JsonData                *UeContextCreateError `json:"jsonData,omitempty" yaml:"jsonData,omitempty" multipart:"contentType:application/json,ref:{jsonData}"`
...
func (o CreateUEContext403Response) ToMap() (map[string]any, error) {
