...
var _ openapi.MappedNullable = &SACEventStatus{}
...
type SACEventStatus struct {
	ReachedNumUes     *SACInfo `json:"reachedNumUes,omitempty" yaml:"reachedNumUes,omitempty"`
	ReachedNumPduSess *SACInfo `json:"reachedNumPduSess,omitempty" yaml:"reachedNumPduSess,omitempty"`
}
...
func (o *SACEventStatus) GetReachedNumUes() SACInfo {
	if o == nil || openapi.IsNil(o.ReachedNumUes) {
		var ret SACInfo
		return ret
	}
...
func (o *SACEventStatus) GetReachedNumPduSess() SACInfo {
	if o == nil || openapi.IsNil(o.ReachedNumPduSess) {
		var ret SACInfo
		return ret
	}
...
func (o SACEventStatus) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.ReachedNumUes) {
		toSerialize["reachedNumUes"] = o.ReachedNumUes
	}
	if !openapi.IsNil(o.ReachedNumPduSess) {
