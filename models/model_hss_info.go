...
var _ openapi.MappedNullable = &HssInfo{}
...
type HssInfo struct {
	...
	HssDiameterAddress             *NetworkNodeDiameterAddress  `json:"hssDiameterAddress,omitempty" yaml:"hssDiameterAddress,omitempty"`
	AdditionalDiamAddresses        []NetworkNodeDiameterAddress `json:"additionalDiamAddresses,omitempty" yaml:"additionalDiamAddresses,omitempty"`
}
...
func (o *HssInfo) GetHssDiameterAddress() NetworkNodeDiameterAddress {
	if o == nil || openapi.IsNil(o.HssDiameterAddress) {
...
func (o *HssInfo) GetAdditionalDiamAddresses() []NetworkNodeDiameterAddress {
	if o == nil || openapi.IsNil(o.AdditionalDiamAddresses) {
		var ret []NetworkNodeDiameterAddress
		return ret
	}
...
func (o HssInfo) ToMap() (map[string]any, error) {
	...
	if !openapi.IsNil(o.HssDiameterAddress) {
		toSerialize["hssDiameterAddress"] = o.HssDiameterAddress
	}
	if !openapi.IsNil(o.AdditionalDiamAddresses) {
