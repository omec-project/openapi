...
var _ openapi.MappedNullable = &NfLoadLevelInformation{}
...
type NfLoadLevelInformation struct {
	...
	NfSetId            *string
	NfStatus           NullableNfStatusNwdaf
	NfCpuUsage         *int32
	NfMemoryUsage      *int32
	NfStorageUsage     *int32
	NfLoadLevelAverage *int32
	NfLoadLevelpeak    *int32
	NfLoadAvgInAoi     *int32
	Snssai             *Snssai
...
func (o *NfLoadLevelInformation) GetNfSetId() string {
	if o == nil || openapi.IsNil(o.NfSetId) {
		var ret string
		return ret
	}
	return *o.NfSetId
...
func (o *NfLoadLevelInformation) GetNfStatus() NfStatusNwdaf {
	if o == nil || openapi.IsNil(o.NfStatus.Get()) {
		var ret NfStatusNwdaf
		return ret
	}
	return *o.NfStatus.Get()
}

// GetNfStatusOk returns a tuple with the NfStatus field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *NfLoadLevelInformation) GetNfStatusOk() (*NfStatusNwdaf, bool) {
	if o == nil {
		return nil, false
	}
	return o.NfStatus.Get(), o.NfStatus.IsSet()
}

// HasNfStatus returns a boolean if a field has been set.
func (o *NfLoadLevelInformation) HasNfStatus() bool {
	if o != nil && o.NfStatus.IsSet() {
		return true
	}
...
// SetNfStatus gets a reference to the given NullableNfStatusNwdaf and assigns it to the NfStatus field.
func (o *NfLoadLevelInformation) SetNfStatus(v NfStatusNwdaf) {
	o.NfStatus.Set(&v)
}
...
func (o *NfLoadLevelInformation) GetNfLoadLevelAverage() int32 {
	if o == nil || openapi.IsNil(o.NfLoadLevelAverage) {
		var ret int32
		return ret
	}
...
func (o *NfLoadLevelInformation) GetNfLoadLevelpeak() int32 {
	if o == nil || openapi.IsNil(o.NfLoadLevelpeak) {
		var ret int32
		return ret
	}
...
func (o *NfLoadLevelInformation) GetNfLoadAvgInAoi() int32 {
	if o == nil || openapi.IsNil(o.NfLoadAvgInAoi) {
		var ret int32
		return ret
	}
...
func (o NfLoadLevelInformation) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["nfType"] = o.NfType
	toSerialize["nfInstanceId"] = o.NfInstanceId
	if !openapi.IsNil(o.NfSetId) {
		toSerialize["nfSetId"] = o.NfSetId
	}
	if o.NfStatus.IsSet() {
		toSerialize["nfStatus"] = o.NfStatus.Get()
	}
	...
	if !openapi.IsNil(o.NfLoadLevelAverage) {
		toSerialize["nfLoadLevelAverage"] = o.NfLoadLevelAverage
	}
	if !openapi.IsNil(o.NfLoadLevelpeak) {
		toSerialize["nfLoadLevelpeak"] = o.NfLoadLevelpeak
	}
	if !openapi.IsNil(o.NfLoadAvgInAoi) {
