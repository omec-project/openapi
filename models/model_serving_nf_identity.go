...
var _ openapi.MappedNullable = &ServingNfIdentity{}
...
type ServingNfIdentity struct {
	...
	SgsnAddr     NullableSgsnAddress `json:"sgsnAddr" yaml:"sgsnAddr,omitempty"`
}
...
func (o *ServingNfIdentity) GetServNfInstId() string {
	if o == nil || openapi.IsNil(o.ServNfInstId) {
		var ret string
		return ret
	}
...
func (o *ServingNfIdentity) SetAnGwAddrNil() {
	o.AnGwAddr.Set(nil)
}

// UnsetAnGwAddr ensures that no value is present for AnGwAddr, not even an explicit nil
func (o *ServingNfIdentity) UnsetAnGwAddr() {
	o.AnGwAddr.Unset()
}

// GetSgsnAddr returns the SgsnAddr field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ServingNfIdentity) GetSgsnAddr() SgsnAddress {
	if o == nil || openapi.IsNil(o.SgsnAddr.Get()) {
		var ret SgsnAddress
		return ret
	}
	return *o.SgsnAddr.Get()
}
...
// SetSgsnAddr gets a reference to the given NullableSgsnAddress and assigns it to the SgsnAddr field.
func (o *ServingNfIdentity) SetSgsnAddr(v SgsnAddress) {
	o.SgsnAddr.Set(&v)
}

// SetSgsnAddrNil sets the value for SgsnAddr to be an explicit nil
func (o *ServingNfIdentity) SetSgsnAddrNil() {
	o.SgsnAddr.Set(nil)
}

// UnsetSgsnAddr ensures that no value is present for SgsnAddr, not even an explicit nil
func (o *ServingNfIdentity) UnsetSgsnAddr() {
	o.SgsnAddr.Unset()
}

func (o ServingNfIdentity) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.ServNfInstId) {
	...
	if o.SgsnAddr.IsSet() {
		toSerialize["sgsnAddr"] = o.SgsnAddr.Get()
	}
