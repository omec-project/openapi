...
var _ openapi.MappedNullable = &PduSessionInformation{}
...
type PduSessionInformation struct {
	...
	PduSessId *int32             `json:"pduSessId,omitempty" yaml:"pduSessId,omitempty"`
	SessInfo  *PduSessionInfoSmf `json:"sessInfo,omitempty" yaml:"sessInfo,omitempty"`
}
...
func (o *PduSessionInformation) GetPduSessId() int32 {
	if o == nil || openapi.IsNil(o.PduSessId) {
		var ret int32
		return ret
	}
	return *o.PduSessId
...
func (o *PduSessionInformation) GetSessInfo() PduSessionInfoSmf {
	if o == nil || openapi.IsNil(o.SessInfo) {
		var ret PduSessionInfoSmf
		return ret
	}
	return *o.SessInfo
}
...
// and a boolean to check if the value has been set.
func (o *PduSessionInformation) GetSessInfoOk() (*PduSessionInfoSmf, bool) {
	if o == nil || openapi.IsNil(o.SessInfo) {
		return nil, false
	}
...
// SetSessInfo gets a reference to the given PduSessionInfoSmf and assigns it to the SessInfo field.
func (o *PduSessionInformation) SetSessInfo(v PduSessionInfoSmf) {
	o.SessInfo = &v
}

func (o PduSessionInformation) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.PduSessId) {
		toSerialize["pduSessId"] = o.PduSessId
	}
	if !openapi.IsNil(o.SessInfo) {
