...
var _ openapi.MappedNullable = &VsmfUpdateError{}
...
type VsmfUpdateError struct {
	...
	N1smCause             *string          `json:"n1smCause,omitempty" yaml:"n1smCause,omitempty" validate:"regexp=^[A-F0-9]{2}$"`
...
func (o *VsmfUpdateError) GetRetryAfter() int32 {
...
// and a boolean to check if the value has been set.
func (o *VsmfUpdateError) GetRetryAfterOk() (*int32, bool) {
	if o == nil || openapi.IsNil(o.RetryAfter) {
		return nil, false
	}
...
func (o *VsmfUpdateError) HasRetryAfter() bool {
	if o != nil && !openapi.IsNil(o.RetryAfter) {
		return true
	}
...
func (o *VsmfUpdateError) SetRetryAfter(v int32) {
	o.RetryAfter = &v
}

func (o VsmfUpdateError) ToMap() (map[string]any, error) {
