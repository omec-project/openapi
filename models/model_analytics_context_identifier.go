...
var _ openapi.MappedNullable = &AnalyticsContextIdentifier{}

// AnalyticsContextIdentifier struct for AnalyticsContextIdentifier
type AnalyticsContextIdentifier struct {
	...
	NfAnaCtxts []NwdafEvent `json:"nfAnaCtxts,omitempty" yaml:"nfAnaCtxts,omitempty"`
	// List of objects that indicate for which SUPI and analytics types combinations analytics context can be retrieved.
	UeAnaCtxts []UeAnalyticsContextDescriptor `json:"ueAnaCtxts,omitempty" yaml:"ueAnaCtxts,omitempty"`
}
...
func (o *AnalyticsContextIdentifier) GetNfAnaCtxts() []NwdafEvent {
	if o == nil || openapi.IsNil(o.NfAnaCtxts) {
		var ret []NwdafEvent
		return ret
	}
	return o.NfAnaCtxts
...
func (o *AnalyticsContextIdentifier) GetUeAnaCtxts() []UeAnalyticsContextDescriptor {
	if o == nil || openapi.IsNil(o.UeAnaCtxts) {
...
func (o AnalyticsContextIdentifier) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	if !openapi.IsNil(o.SubscriptionId) {
		toSerialize["subscriptionId"] = o.SubscriptionId
	}
	if !openapi.IsNil(o.NfAnaCtxts) {
		toSerialize["nfAnaCtxts"] = o.NfAnaCtxts
	}
	if !openapi.IsNil(o.UeAnaCtxts) {
