...
var _ openapi.MappedNullable = &BdtPolicyData{}
...
type BdtPolicyData struct {
	...
	TransfPolicies []TransferPolicy `json:"transfPolicies" yaml:"transfPolicies"`
	// Contains an identity of the selected transfer policy.
	SelTransPolicyId *int32 `json:"selTransPolicyId,omitempty" yaml:"selTransPolicyId,omitempty"`
...
func (o *BdtPolicyData) GetSelTransPolicyId() int32 {
	if o == nil || openapi.IsNil(o.SelTransPolicyId) {
		var ret int32
		return ret
	}
...
func (o BdtPolicyData) ToMap() (map[string]any, error) {
	toSerialize := map[string]any{}
	toSerialize["bdtRefId"] = o.BdtRefId
	toSerialize["transfPolicies"] = o.TransfPolicies
	if !openapi.IsNil(o.SelTransPolicyId) {
