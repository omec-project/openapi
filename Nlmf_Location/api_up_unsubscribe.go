...
type UPUnsubscribeAPI interface {
...
// UPUnsubscribeAPIService UPUnsubscribeAPI service
type UPUnsubscribeAPIService service

type ApiDeleteSubscriptionRequest struct {
	ctx            context.Context
	ApiService     UPUnsubscribeAPI
...
DeleteSubscription Deletes a subscription
	...
	@return ApiDeleteSubscriptionRequest
*/
func (a *UPUnsubscribeAPIService) DeleteSubscription(ctx context.Context, subscriptionId string) ApiDeleteSubscriptionRequest {
	return ApiDeleteSubscriptionRequest{
		ApiService:     a,
		ctx:            ctx,
...
func (a *UPUnsubscribeAPIService) DeleteSubscriptionExecute(r ApiDeleteSubscriptionRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UPUnsubscribeAPIService.DeleteSubscription")
	if err != nil {
		return nil, &openapi.GenericOpenAPIError{RawError: err.Error()}
	}

	localVarPath := localBasePath + "/up-subscriptions/{subscriptionId}"
