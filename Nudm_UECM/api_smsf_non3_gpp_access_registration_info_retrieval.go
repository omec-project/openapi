...
type SMSFNon3GPPAccessRegistrationInfoRetrievalAPI interface {
	...
	*/
	GetNon3GppSmsfRegistration(ctx context.Context, ueId string) ApiGetNon3GppSmsfRegistrationRequest

	// GetNon3GppSmsfRegistrationExecute executes the request
	//   @return SmsfRegistration
	GetNon3GppSmsfRegistrationExecute(r ApiGetNon3GppSmsfRegistrationRequest) (*models.SmsfRegistration, *http.Response, error)
}
...
type ApiGetNon3GppSmsfRegistrationRequest struct {
	ctx               context.Context
	ApiService        SMSFNon3GPPAccessRegistrationInfoRetrievalAPI
	ueId              string
...
func (r ApiGetNon3GppSmsfRegistrationRequest) Execute() (*models.SmsfRegistration, *http.Response, error) {
	return r.ApiService.GetNon3GppSmsfRegistrationExecute(r)
}
...
//
//	@return SmsfRegistration
func (a *SMSFNon3GPPAccessRegistrationInfoRetrievalAPIService) GetNon3GppSmsfRegistrationExecute(r ApiGetNon3GppSmsfRegistrationRequest) (*models.SmsfRegistration, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SMSFNon3GPPAccessRegistrationInfoRetrievalAPIService.GetNon3GppSmsfRegistration")
	if err != nil {
