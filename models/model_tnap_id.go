...
var _ openapi.MappedNullable = &TnapId{}
...
type TnapId struct {
	...
	CivicAddress *string `json:"civicAddress,omitempty" yaml:"civicAddress,omitempty"`
}
...
func (o TnapId) ToMap() (map[string]any, error) {
