...
var _ openapi.MappedNullable = &IpSmGwGuidance{}
...
type IpSmGwGuidance struct {
	MinDeliveryTime    int32 `json:"minDeliveryTime" yaml:"minDeliveryTime"`
	RecommDeliveryTime int32 `json:"recommDeliveryTime" yaml:"recommDeliveryTime"`
}
...
func (o IpSmGwGuidance) ToMap() (map[string]any, error) {
